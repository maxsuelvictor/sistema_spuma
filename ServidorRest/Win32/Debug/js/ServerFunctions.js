...
function TServidorMetodos(connectionInfo)
{
  this.executor = new ServerFunctionExecutor("TServidorMetodos",connectionInfo);
   ...
   */
  this.BuscarCores = function() {
    var returnObject = this.executor.executeMethod('BuscarCores', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.BuscarCores_URL = function() {
    return this.executor.getMethodURL("BuscarCores", "GET", [], arguments[0])[0];
  };
  ...
  this.BuscarRegioes = function() {
    var returnObject = this.executor.executeMethod('BuscarRegioes', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
