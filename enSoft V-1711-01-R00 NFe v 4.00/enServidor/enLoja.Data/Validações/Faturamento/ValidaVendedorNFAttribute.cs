...
{
    public class ValidaVendedorNFAttribute :ValidationAttribute, IClientValidatable
    {
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            if (!string.IsNullOrEmpty(value.ToString()))
            {
                ...
                if (vendedor != null && vendedor.ID_CARGO == 1)
                {
                    return new ValidationResult("Funcionário não está qualificado como Vendedor!", new[] { "ID_VENDEDOR" });
                }
            }
        ...
        public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
        {
            return new[] 
            {
                ...
                {
                    ErrorMessage = "Vendedor não é válido!",
                    ValidationType = "validavendedornf"
                }
            };
        }
    }
