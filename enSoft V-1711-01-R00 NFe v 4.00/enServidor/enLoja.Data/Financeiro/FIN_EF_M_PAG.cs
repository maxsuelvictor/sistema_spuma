...
{
    [Table("FIN_TB_M_PAG")]  //Contas a Pagar - Lançamento
    public class FIN_EF_M_PAG : NotifyingObject
    {
        ...
        public virtual ICollection<FIN_EF_M_PAG_PAG> FIN_EF_M_PAG_PAG
        {
            get { return GetValue(() => FIN_EF_M_PAG_PAG); }
            set { SetValue(() => FIN_EF_M_PAG_PAG, value); }
        }
