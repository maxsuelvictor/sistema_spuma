...
{
    [Table("FIN_TB_M_PAG_PAG")]
    public class FIN_EF_M_PAG_PAG : NotifyingObject
    {
        [Key, Column(Order = 1)]
        ...
        public virtual FIN_EF_M_PAG FIN_EF_M_PAG
        {
            get { return GetValue(() => FIN_EF_M_PAG); }
            set { SetValue(() => FIN_EF_M_PAG, value); }
        }
