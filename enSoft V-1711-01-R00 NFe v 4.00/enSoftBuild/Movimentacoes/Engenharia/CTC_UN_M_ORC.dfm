inherited CTC_FM_M_ORC: TCTC_FM_M_ORC
  ClientHeight = 654
  ClientWidth = 1111
  ...
  inherited pnlEsquerda: TPanel
    ...
    inherited pnlDatagrid: TPanel
      ...
      inherited dbGrid: TwwDBGrid
        Height = 520
        Selected.Strings = (
          'id_orc'#9'10'#9'C'#243'digo'#9'F'
          'int_nomeobr'#9'27'#9'Obra'#9'F'
          'dta_orc'#9'15'#9'Data'#9'F')
        ExplicitHeight = 520
      end
    end
  ...
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object txtObraDescricao: TDBText
        Left = 257
        Top = 26
        Width = 250
        Height = 21
        Color = 14342874
        DataField = 'int_nomeobr'
        DataSource = dso
        ParentColor = False
        Transparent = False
      end
      object lblDataObra: TLabel
        Left = 381
        Top = 7
        Width = 30
        Height = 13
      ...
      object txtObra: TJvDBComboEdit
        ...
        TabOrder = 2
        OnButtonClick = txtObraButtonClick
        OnExit = txtObraExit
      end
      object dpkDtaObra: TJvDBDateEdit
        Left = 417
        Top = 3
        Width = 90
        Height = 21
      ...
      object gbGrupo: TGroupBox
        ...
        object grdItens: TwwDBGrid
          ...
          TabStop = False
          ControlType.Strings = (
            'int_classeitetpr;CustomEdit;cbbClasse2;F')
          Selected.Strings = (
            'grupo'#9'10'#9'Grupo'#9#9
            'cod_prpoprio'#9'13'#9'C'#243'digo'#9#9
            'descricao'#9'40'#9'Descri'#231#227'o'#9#9
            'und'#9'8'#9'Unidade'#9#9
            'classe'#9'13'#9'Clase'#9'F'#9)
          ...
          object grdGrupoIButton: TwwIButton
            Left = 0
            Top = -1
            Width = 22
            Height = 22
        ...
        object pnlGrupo: TPanel
          ...
          object txtDescricao: TDBEdit
            ...
            DataSource = dsoGrupo
            TabOrder = 3
            OnExit = txtDescricaoExit
          end
          object txtUnid: TDBEdit
            Left = 410
            Top = 23
            Width = 50
            Height = 21
          ...
          object txtCodigo2: TDBEdit
            ...
            BevelOuter = bvNone
            Color = clWhite
            DataField = 'cod_prpoprio'
            DataSource = dsoGrupo
            TabOrder = 2
          end
          object txtGrupo: TDBEdit
            Left = 1
            Top = 23
            Width = 72
            Height = 21
      ...
      object gbComposicao: TGroupBox
        ...
        object grdComp: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'int_nomeitetpr'#9'45'#9'Descri'#231#227'o'#9#9
            'coeficiente'#9'8'#9'Qtde'#9#9
            'vlr_unitario'#9'10'#9'Vlr. Unit'#225'rio'#9#9
            'vlr_total'#9'11'#9'Vlr. Total'#9'F'#9
            'int_classeitetpr'#9'10'#9'int_classeitetpr'#9'F'#9)
          IniAttributes.Delimiter = ';;'
          IniAttributes.UnicodeIniFile = False
          TitleColor = clBtnFace
          FixedCols = 0
          ShowHorzScrollBar = True
          DataSource = dsoGrupoCom
          Options = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit, dgWordWrap]
          TabOrder = 2
          TitleAlignment = taLeftJustify
          TitleFont.Charset = DEFAULT_CHARSET
          ...
          TitleLines = 1
          TitleButtons = False
          OnDblClick = grdCompDblClick
          object grdCompIButton: TwwIButton
            Left = -1
            Top = -1
            Width = 22
            Height = 22
      ...
      object gbTotais: TGroupBox
        ...
        object Label14: TLabel
          ...
          Width = 79
          Height = 13
          Caption = 'Vlr. Unit. Total :'
        end
        object txtPerLs: TDBEdit
          Left = 45
          Top = 63
          Width = 38
          Height = 21
        ...
        object txtPerBDI: TDBEdit
          ...
          DataSource = dsoGrupo
          TabOrder = 4
          OnExit = txtPerBDIExit
        end
        object txtVrlBDI: TDBEdit
          Left = 88
          Top = 87
          Width = 90
          Height = 21
          ...
          Enabled = False
          TabOrder = 5
          OnExit = txtVrlBDIExit
        end
        object txtPerADM: TDBEdit
          Left = 45
          Top = 111
          Width = 38
          Height = 21
          ...
          DataSource = dsoGrupo
          TabOrder = 6
          OnExit = txtPerADMExit
        end
        object txtVrlADM: TDBEdit
          Left = 87
          Top = 111
          Width = 90
          Height = 21
          ...
          Enabled = False
          TabOrder = 7
          OnExit = txtVrlADMExit
        end
        object txtVrlTotTax: TDBEdit
          Left = 87
          Top = 135
          Width = 90
          Height = 21
          ...
          BevelOuter = bvNone
          Color = 14342874
          DataField = 'total_taxa'
          DataSource = dsoGrupo
          Enabled = False
          TabOrder = 8
        end
        object txtQtdeTot: TDBEdit
          Left = 87
          Top = 183
          Width = 90
          Height = 21
          ...
          DataSource = dsoGrupo
          TabOrder = 9
          OnEnter = txtQtdeTotEnter
          OnExit = txtQtdeTotExit
        end
        object txtVrlTot: TDBEdit
          Left = 87
          Top = 207
          Width = 90
          Height = 21
      ...
      object cbbEstrutura: TwwDBLookupCombo
        Left = 164
        Top = 49
        Width = 343
        Height = 21
        ...
        DataField = 'id_estrutura'
        DataSource = dso
        LookupTable = dmCtc.bus_cd_c_eoc
        LookupField = 'id_estrutura'
        TabOrder = 3
        AutoDropDown = False
        ShowButton = True
        PreciseEditRegion = False
        AllowClearKey = False
        OnEnter = cbbEstruturaEnter
        OnExit = cbbEstruturaExit
      end
      object txtGeral: TDBEdit
        Left = 504
        Top = 316
        Width = 83
        Height = 21
  ...
  object dsoGrupo: TwwDataSource [4]
    DataSet = dmCtc.ctc_cd_m_orc_ite
    Left = 136
    Top = 251
  end
  inherited dso: TwwDataSource
    DataSet = dmCtc.ctc_cd_m_orc
    Left = 139
    Top = 203
  end
  ...
  object dsoGrupoCom: TwwDataSource
    DataSet = dmCtc.ctc_cd_m_orc_ite_com
    Left = 136
    Top = 299
  end
end
