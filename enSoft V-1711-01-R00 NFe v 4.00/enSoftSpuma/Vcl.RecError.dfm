object ReconcileErrorForm: TReconcileErrorForm
  ...
  Caption = 'Erro de atualiza'#231#227'o'
  ClientHeight = 311
  ClientWidth = 527
  Color = clBtnFace
  ParentFont = True
  ...
  object Label1: TLabel
    ...
    Width = 100
    Height = 13
    Caption = 'Tipo da Atualiza'#231#227'o :'
  end
  ...
  object ConflictsOnly: TCheckBox
    ...
    Width = 153
    Height = 17
    Caption = 'Mostrar somente conflitos'
    TabOrder = 2
    OnClick = DisplayFieldValues
  end
  ...
  object ChangedOnly: TCheckBox
    ...
    Width = 166
    Height = 17
    Caption = 'Mostrar somente campos alterados'
    TabOrder = 3
    OnClick = DisplayFieldValues
  end
end
