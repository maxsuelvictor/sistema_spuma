inherited CSU_FM_M_OPR_ADM: TCSU_FM_M_OPR_ADM
  Caption = 'Consultas'
  ClientHeight = 592
  ClientWidth = 1094
  ...
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object jpgGerencial: TJvgPageControl
        Left = 0
        Top = 0
        Width = 1073
        Height = 521
        ...
        TabStyle.Font.Charset = ANSI_CHARSET
        ...
        TabSelectedStyle.BackgrColor = 14342874
        ...
        Options = [ftoAutoFontDirection, ftoExcludeGlyphs, ftoWordWrap]
        object tbFiltro: TTabSheet
          ...
          object Panel2: TPanel
            ...
            object gbxFiltro: TGroupBox
              ...
              object txtPeriodoIni: TJvDateEdit
                Left = 83
                Top = 37
                Width = 89
                Height = 21
              ...
              object txtPeriodoFinal: TJvDateEdit
                Left = 192
                Top = 37
                Width = 89
                Height = 21
        ...
        object tsOp: TTabSheet
          ...
          object Panel1: TPanel
            ...
            object PageControl1: TPageControl
              ...
              object tsItensProducao: TTabSheet
                ...
                object lblLegendaItePro: TLabel
                  ...
                  Width = 151
                  Height = 13
                  Caption = 'Registro Alterado Manualmente'
                end
                ...
                object dgItensProduzir: TwwDBGrid
                  Left = 0
                  Top = 54
                  Width = 952
                  Height = 321
                  Selected.Strings = (
                    ...
                    'int_nomeite'#9'65'#9'Item'#9'T'
                    'int_undvenda'#9'5'#9'Und'#9'T'
                    'int_nometam'#9'9'#9'Tamanho'#9'T'
                    'int_nomecor'#9'14'#9'Cor'#9'T'
                    'qtde_a_produzir'#9'10'#9'Qtde a Produzir'#9'T'
                    'qtde_produzida'#9'10'#9'Qtde Produzida'#9'T'
                    'int_rest_a_produzir'#9'12'#9'Restante a Produzir'#9'F'
                    
                      'saldo_fisico_momento'#9'10'#9'Saldo F'#237'sico'#9'F'#9'Saldos no momento da gera' +
                      #231#227'o'
                    'saldo_pendente'#9'10'#9'Saldo pendente'#9'F'#9'Saldos no momento da gera'#231#227'o'
                    
                      'saldo_disponivel_est'#9'10'#9'Saldo Dispon'#237'vel'#9'F'#9'Saldos no momento da ' +
                      'gera'#231#227'o'
                    
                      'saldo_disp_outras_opr'#9'10'#9'Saldo de outras O.P'#9'F'#9'Saldos no momento' +
                      ' da gera'#231#227'o')
                  ...
                  TitleButtons = False
                  UseTFields = False
                  OnCalcCellColors = dgItensProduzirCalcCellColors
                end
                object pnOrdenacaoItePro: TPanel
                  Left = 0
                  Top = 0
                  Width = 952
                  Height = 54
                  ...
                  object Label16: TLabel
                    ...
                    Width = 254
                    Height = 13
                    Caption = 'Qtde alterada manualmente pelo respons'#225'vel da O.P'
                  end
                  object rgOrdenarItePro: TRadioGroup
                    Left = 328
                    Top = 5
                    Width = 337
                    Height = 43
              ...
              object tsTotalItem: TTabSheet
                ...
                object wwDBGrid1: TwwDBGrid
                  ...
                  Selected.Strings = (
                    'id_item'#9'10'#9'C'#243'digo'#9'T'
                    'int_nomeite'#9'82'#9'Item'#9'T'
                    'id_und_venda'#9'3'#9'Und'#9'F'
                    'int_nometam'#9'9'#9'Tamanho'#9'T'
                    'int_nomecor'#9'14'#9'Cor'#9'T'
                    'qtde_total'#9'12'#9'Qtde total'#9'F')
                  IniAttributes.Delimiter = ';;'
                  IniAttributes.UnicodeIniFile = False
                  TitleColor = clBtnFace
                  FixedCols = 0
              ...
              object tsTotalItePed: TTabSheet
                ...
                object wwDBGrid2: TwwDBGrid
                  ...
                  Selected.Strings = (
                    ...
                    'int_nomefun'#9'35'#9'Vendedor'#9'F'
                    'qtde_total'#9'12'#9'Qtde total'#9'F'
                    'cubagem'#9'10'#9'Cubagem'#9'F')
                  IniAttributes.Delimiter = ';;'
                  IniAttributes.UnicodeIniFile = False
                  TitleColor = clBtnFace
                  FixedCols = 0
            ...
            object btnRequisicoes: TcxButton
              ...
              Font.Style = []
              ParentFont = False
              OnClick = btnRequisicoesClick
            end
            object btnPedidoVenda: TcxButton
              Left = 853
              Top = 512
              Width = 109
              Height = 30
            ...
            object dgOrdemProAcabados: TwwDBGrid
              Left = 0
              Top = 19
              Width = 960
              Height = 65
              Selected.Strings = (
                'num_lote'#9'8'#9'Nro Ordem Produ'#231#227'o'#9'F'
                'dta_emissao'#9'10'#9'Emiss'#227'o'#9'F'
                'id_responsavel'#9'18'#9'Cod. Resp.'#9'T'
                'int_nomeres'#9'59'#9'Respons'#225'vel'#9'T'
                'int_nometpp'#9'15'#9'Tipo Programa'#231#227'o'#9'T'
                'cub_produzir'#9'10'#9'Cubagem a Produzir'#9'T'
                'cub_pedidos'#9'10'#9'Cubagem Total'#9'T')
              IniAttributes.Delimiter = ';;'
              IniAttributes.UnicodeIniFile = False
              TitleColor = clBtnFace
              OnRowChanged = dgOrdemProAcabadosRowChanged
              FixedCols = 0
              ShowHorzScrollBar = True
              DataSource = dso
              Font.Charset = ANSI_CHARSET
              ...
              TitleButtons = False
              UseTFields = False
              OnCalcCellColors = dgOrdemProAcabadosCalcCellColors
            end
            object pnPedidosdoItem: TPanel
              Left = 168
              Top = 192
              Width = 545
              Height = 241
              ...
              object Label15: TLabel
                ...
                Alignment = taCenter
                AutoSize = False
                Caption = 'Pedidos de Venda do Item selecionado'
                Color = 14342874
                Font.Charset = DEFAULT_CHARSET
                Font.Color = clWindowText
                Font.Height = -11
              ...
              object wwDBGrid4: TwwDBGrid
                ...
                Height = 185
                Selected.Strings = (
                  'id_pedido'#9'7'#9'Pedido'
                  'int_num_lote_opr'#9'8'#9'Nro O.P'
                  'dta_pedido'#9'10'#9'Data'
                  'id_cliente'#9'8'#9'C'#243'd.'
                  'int_nomecli'#9'41'#9'Cliente'
        ...
        object TabSheet1: TTabSheet
          ...
          object Label8: TLabel
            ...
            Alignment = taCenter
            AutoSize = False
            Caption = 'Itens do Pedido Pendente'
            Color = clSkyBlue
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -12
          ...
          object Label9: TLabel
            ...
            Alignment = taCenter
            AutoSize = False
            Caption = 'Pedidos digitados e aprovados'
            Color = 14089410
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -12
          ...
          object lblQtdePedidosPen: TLabel
            Left = 247
            Top = 327
            Width = 97
            Height = 13
          ...
          object lblQtdePedidosDigApr: TLabel
            Left = 745
            Top = 327
            Width = 97
            Height = 13
          ...
          object grdPedidosItensPend: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'int_nomeite'#9'36'#9'Item'#9'F'
              'int_id_und_venda'#9'3'#9'Und'
              'int_nomecor'#9'8'#9'Cor'
              'int_nometam'#9'8'#9'Tamanho'
              'qtde'#9'5'#9'Qtde'
              'vlr_liquido'#9'11'#9'Vlr. L'#237'quido')
            IniAttributes.Delimiter = ';;'
            IniAttributes.UnicodeIniFile = False
          ...
          object btnFiltrarPedPend: TcxButton
            Left = 135
            Top = 30
            Width = 75
            Height = 21
            ...
            Font.Style = []
            ParentFont = False
            OnClick = btnFiltrarPedPendClick
          end
          object grdPedidosItensDigApr: TwwDBGrid
            Left = 479
            Top = 368
            Width = 481
            Height = 175
          ...
          object wwDBGrid3: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'dta_pedido'#9'10'#9'Data'
              'id_cliente'#9'8'#9'C'#243'd.'
              'int_nomecli'#9'37'#9'Cliente'
              'vlr_liquido'#9'9'#9'Vlr L'#237'quido'
              'cubagem'#9'8'#9'Cubagem')
            IniAttributes.Delimiter = ';;'
            IniAttributes.UnicodeIniFile = False
            TitleColor = clBtnFace
            FixedCols = 0
          ...
          object txtNroPedidoPedDig: TEdit
            Left = 565
            Top = 32
            Width = 65
            Height = 19
          ...
          object btnBuscarPedDig: TcxButton
            Left = 636
            Top = 32
            Width = 75
            Height = 21
        ...
        object TabSheet2: TTabSheet
          ...
          object Panel7: TPanel
            ...
            object grdItensPend: TwwDBGrid
              Left = 0
              Top = 89
              Width = 960
              Height = 424
              Selected.Strings = (
                'int_nomealm'#9'10'#9'Almoxarifado'
                'id_item'#9'10'#9'C'#243'digo'
                'descricao'#9'50'#9'Item'
                'id_und_venda'#9'3'#9'Und'
                'int_nomecor'#9'19'#9'Cor'#9'F'
                'int_nometam'#9'7'#9'Tamanho'
                'saldo_fisico'#9'10'#9'Saldo f'#237'sico'
                'qtde_pend'#9'10'#9'Pendente'
                'saldo_disponivel'#9'12'#9'Saldo dispon'#237'vel'
                'resta_produzir'#9'13'#9'Resta a produzir')
              IniAttributes.Delimiter = ';;'
              IniAttributes.UnicodeIniFile = False
              TitleColor = clBtnFace
              FixedCols = 0
              ...
              TitleLines = 1
              TitleButtons = True
              OnCalcCellColors = grdItensPendCalcCellColors
              OnTitleButtonClick = grdItensPendTitleButtonClick
            ...
            object pnFiltro: TPanel
              ...
              object Label17: TLabel
                ...
                Width = 319
                Height = 13
                Caption = 'Voc'#234' pode ordenar os registros abaixo clicando no nome da coluna'
                Font.Charset = ANSI_CHARSET
                Font.Color = clBlue
                Font.Height = -11
                Font.Name = 'Tahoma'
  ...
  inherited pnlTop: TJvPanel
    ...
    inherited pnlCima: TJvPanel
      ...
      inherited lblTitulo: TLabel
        Width = 1094
        Caption = 'Gerenciamento da Produ'#231#227'o'
        ExplicitWidth = 848
      end
  ...
  inherited dso: TwwDataSource
    DataSet = dmGeral.BUS_CD_M_CSU_OPR
    Left = 371
    Top = 195
  end
  ...
  object dsoOpp: TwwDataSource
    DataSet = dmGeral.BUS_CD_M_CSU_OPR_OPP
    Left = 696
    Top = 448
  end
  object dsQtdTotIte: TwwDataSource
    DataSet = BUS_CD_M_OPR_QTD_TOT_ITE
    Left = 192
    Top = 376
  end
  object dsQtdeItePed: TwwDataSource
    DataSet = BUS_CD_M_OPR_QTD_ITE_PED
    Left = 384
    Top = 408
  end
  object BUS_CD_M_OPR_QTD_TOT_ITE: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'BUS_DP_M_OPR_QTD_TOT_ITE'
    RemoteServer = dmGeral.pcConecao
    Left = 191
    Top = 438
  end
  object BUS_CD_M_OPR_QTD_ITE_PED: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'BUS_DP_M_OPR_QTD_ITE_PED'
    RemoteServer = dmGeral.pcConecao
    Left = 343
    Top = 430
  end
  ...
  object dsPedDig: TwwDataSource
    DataSet = BUS_CD_M_PED_DIG
    OnStateChange = dsoStateChange
    Left = 859
    Top = 155
  end
  object BUS_CD_M_PED_DIG: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'BUS_DP_M_PED'
    RemoteServer = dmGeral.pcConecao
    Left = 950
    Top = 154
    object BUS_CD_M_PED_DIGint_selecao: TBooleanField
      FieldName = 'int_selecao'
    end
    object BUS_CD_M_PED_DIGid_pedido: TIntegerField
      FieldName = 'id_pedido'
    end
    object BUS_CD_M_PED_DIGid_empresa: TIntegerField
      FieldName = 'id_empresa'
    end
    object BUS_CD_M_PED_DIGdta_pedido: TDateField
      FieldName = 'dta_pedido'
    end
    object BUS_CD_M_PED_DIGid_tipo_mov_estoque: TIntegerField
      FieldName = 'id_tipo_mov_estoque'
    end
    object BUS_CD_M_PED_DIGid_vendedor: TIntegerField
      FieldName = 'id_vendedor'
    end
    object BUS_CD_M_PED_DIGobs: TWideStringField
      FieldName = 'obs'
      Size = 100
    end
    object BUS_CD_M_PED_DIGvlr_bruto: TFMTBCDField
      FieldName = 'vlr_bruto'
      Precision = 18
      Size = 4
    end
    object BUS_CD_M_PED_DIGvlr_desconto: TFMTBCDField
      FieldName = 'vlr_desconto'
      Precision = 18
      Size = 4
    end
    object BUS_CD_M_PED_DIGper_desconto: TFloatField
      FieldName = 'per_desconto'
    end
    object BUS_CD_M_PED_DIGvlr_liquido: TFMTBCDField
      FieldName = 'vlr_liquido'
      DisplayFormat = '###,###,###,##0.00'
      Precision = 18
      Size = 4
    end
    object BUS_CD_M_PED_DIGhor_pedido: TSQLTimeStampField
      FieldName = 'hor_pedido'
    end
    object BUS_CD_M_PED_DIGid_condicao_pag: TIntegerField
      FieldName = 'id_condicao_pag'
    end
    object BUS_CD_M_PED_DIGpcp_obs: TWideStringField
      FieldName = 'pcp_obs'
      Size = 100
    end
    object BUS_CD_M_PED_DIGpcp_id_opr: TIntegerField
      FieldName = 'pcp_id_opr'
    end
    object BUS_CD_M_PED_DIGsituacao: TIntegerField
      FieldName = 'situacao'
    end
    object BUS_CD_M_PED_DIGsituacao_aprovacao: TIntegerField
      FieldName = 'situacao_aprovacao'
    end
    object BUS_CD_M_PED_DIGid_atendente: TIntegerField
      FieldName = 'id_atendente'
    end
    object BUS_CD_M_PED_DIGid_responsavel: TIntegerField
      FieldName = 'id_responsavel'
    end
    object BUS_CD_M_PED_DIGid_cliente: TIntegerField
      FieldName = 'id_cliente'
    end
    object BUS_CD_M_PED_DIGtipo_restricao: TWideStringField
      FieldName = 'tipo_restricao'
      Size = 100
    end
    object BUS_CD_M_PED_DIGid_almoxarifado: TIntegerField
      FieldName = 'id_almoxarifado'
    end
    object BUS_CD_M_PED_DIGjustificativa: TWideStringField
      FieldName = 'justificativa'
      Size = 100
    end
    object BUS_CD_M_PED_DIGid_usuario_lib: TIntegerField
      FieldName = 'id_usuario_lib'
    end
    object BUS_CD_M_PED_DIGcod_lme: TWideStringField
      FieldName = 'cod_lme'
    end
    object BUS_CD_M_PED_DIGrev_lme: TWideStringField
      FieldName = 'rev_lme'
      Size = 5
    end
    object BUS_CD_M_PED_DIGorigem: TIntegerField
      FieldName = 'origem'
    end
    object BUS_CD_M_PED_DIGdispositivo: TWideStringField
      FieldName = 'dispositivo'
      Size = 50
    end
    object BUS_CD_M_PED_DIGgps_latitude: TFloatField
      FieldName = 'gps_latitude'
    end
    object BUS_CD_M_PED_DIGgps_longitude: TFloatField
      FieldName = 'gps_longitude'
    end
    object BUS_CD_M_PED_DIGcubagem: TFloatField
      FieldName = 'cubagem'
    end
    object BUS_CD_M_PED_DIGid_orcamento: TIntegerField
      FieldName = 'id_orcamento'
    end
    object BUS_CD_M_PED_DIGenvia_carga: TBooleanField
      FieldName = 'envia_carga'
    end
    object BUS_CD_M_PED_DIGdta_prev_entrega: TDateField
      FieldName = 'dta_prev_entrega'
    end
    object BUS_CD_M_PED_DIGid_abertura: TIntegerField
      FieldName = 'id_abertura'
    end
    object BUS_CD_M_PED_DIGdias_cpg_prazo: TIntegerField
      FieldName = 'dias_cpg_prazo'
    end
    object BUS_CD_M_PED_DIGoffline: TBooleanField
      FieldName = 'offline'
    end
    object BUS_CD_M_PED_DIGconferido: TBooleanField
      FieldName = 'conferido'
    end
    object BUS_CD_M_PED_DIGid_conf: TIntegerField
      FieldName = 'id_conf'
    end
    object BUS_CD_M_PED_DIGdta_conf: TDateField
      FieldName = 'dta_conf'
    end
    object BUS_CD_M_PED_DIGhor_conf: TTimeField
      FieldName = 'hor_conf'
    end
    object BUS_CD_M_PED_DIGresultado_conf: TIntegerField
      FieldName = 'resultado_conf'
    end
    object BUS_CD_M_PED_DIGid_resp_conf: TIntegerField
      FieldName = 'id_resp_conf'
    end
    object BUS_CD_M_PED_DIGint_nomecli: TWideStringField
      FieldName = 'int_nomecli'
      ProviderFlags = []
      Size = 50
    end
    object BUS_CD_M_PED_DIGint_nometme: TWideStringField
      FieldName = 'int_nometme'
      ProviderFlags = []
      Size = 30
    end
    object BUS_CD_M_PED_DIGint_nomefun: TWideStringField
      FieldName = 'int_nomefun'
      ProviderFlags = []
      Size = 50
    end
    object BUS_CD_M_PED_DIGint_nomecpg: TWideStringField
      FieldName = 'int_nomecpg'
      ProviderFlags = []
      Size = 30
    end
    object BUS_CD_M_PED_DIGint_nomeate: TWideStringField
      FieldName = 'int_nomeate'
      ProviderFlags = []
      Size = 50
    end
    object BUS_CD_M_PED_DIGint_nome_rcn: TWideStringField
      FieldName = 'int_nome_rcn'
      ProviderFlags = []
      Size = 50
    end
    object BUS_CD_M_PED_DIGint_nomeres: TWideStringField
      FieldName = 'int_nomeres'
      ProviderFlags = []
      Size = 50
    end
    object BUS_CD_M_PED_DIGint_nomecid: TWideStringField
      FieldName = 'int_nomecid'
      ProviderFlags = []
      Size = 60
    end
    object BUS_CD_M_PED_DIGint_nomeest: TWideStringField
      FieldName = 'int_nomeest'
      ProviderFlags = []
      Size = 2
    end
    object BUS_CD_M_PED_DIGint_cpfcnpj: TWideStringField
      FieldName = 'int_cpfcnpj'
      ProviderFlags = []
      Size = 14
    end
    object BUS_CD_M_PED_DIGint_pessoacli: TIntegerField
      FieldName = 'int_pessoacli'
      ProviderFlags = []
    end
    object BUS_CD_M_PED_DIGint_id_perfil: TIntegerField
      FieldName = 'int_id_perfil'
      ProviderFlags = []
    end
    object BUS_CD_M_PED_DIGid_ors: TIntegerField
      FieldName = 'id_ors'
    end
    object BUS_CD_M_PED_DIGint_sitaprov: TWideStringField
      FieldName = 'int_sitaprov'
      ProviderFlags = []
    end
    object BUS_CD_M_PED_DIGint_sitped: TWideStringField
      FieldName = 'int_sitped'
      ProviderFlags = []
    end
    object BUS_CD_M_PED_DIGint_ie_rg_cli: TWideStringField
      FieldName = 'int_ie_rg_cli'
      ProviderFlags = []
    end
    object BUS_CD_M_PED_DIGint_nomereg: TWideStringField
      FieldName = 'int_nomereg'
      ProviderFlags = []
      Size = 50
    end
    object BUS_CD_M_PED_DIGint_num_lote_opr: TWideStringField
      FieldName = 'int_num_lote_opr'
      ProviderFlags = []
      Size = 15
    end
    object BUS_CD_M_PED_DIGBUS_SQ_M_PED_ITE: TDataSetField
      FieldName = 'BUS_SQ_M_PED_ITE'
    end
  end
  object BUS_CD_M_PED_DIG_ITE: TClientDataSet
    Aggregates = <>
    DataSetField = BUS_CD_M_PED_DIGBUS_SQ_M_PED_ITE
    Params = <>
    Left = 846
    Top = 282
  end
  object dsPedDigIte: TwwDataSource
    DataSet = BUS_CD_M_PED_DIG_ITE
    OnStateChange = dsoStateChange
    Left = 651
    Top = 275
  end
  object BUS_CD_M_EST_ALM_PEN: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'BUS_DP_M_EST_ALM_PEN'
    RemoteServer = dmGeral.pcConecao
    Left = 550
    Top = 450
  end
  object dsEstAlmPen: TwwDataSource
    DataSet = BUS_CD_M_EST_ALM_PEN
    Left = 552
    Top = 496
  end
  object dsPedItensSel: TwwDataSource
    DataSet = BUS_CD_M_PED_PEN_ITE_SEL
    OnStateChange = dsoStateChange
    Left = 483
    Top = 251
  end
  object BUS_CD_M_PED_PEN_ITE_SEL: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'BUS_DP_M_PED'
    RemoteServer = dmGeral.pcConecao
  ...
  object pmGer: TPopupMenu
    Left = 465
    Top = 208
    object Exibirpedidosquecontmesteproduto1: TMenuItem
      Caption = 'Exibir pedidos que cont'#233'm este produto'
      OnClick = Exibirpedidosquecontmesteproduto1Click
    end
  end
  object pmPedPen: TPopupMenu
    Left = 890
    Top = 397
