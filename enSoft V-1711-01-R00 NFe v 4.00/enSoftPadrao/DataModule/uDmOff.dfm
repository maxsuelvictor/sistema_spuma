object dmOff: TdmOff
  ...
  object BUS_CD_C_FU2: TClientDataSet
    ...
    Left = 472
    Top = 829
    object BUS_CD_C_FU2id_funcionario: TIntegerField
      FieldName = 'id_funcionario'
      Required = True
    end
    object BUS_CD_C_FU2nome: TStringField
      FieldName = 'nome'
      Size = 50
    end
    object BUS_CD_C_FU2doc_cpf: TStringField
      FieldName = 'doc_cpf'
      Size = 11
    end
    object BUS_CD_C_FU2login: TStringField
      FieldName = 'login'
      Size = 30
    end
    object BUS_CD_C_FU2senha: TStringField
      FieldName = 'senha'
      Size = 100
    end
    object BUS_CD_C_FU2seg_alt_vend_ped: TBooleanField
      FieldName = 'seg_alt_vend_ped'
    end
    object BUS_CD_C_FU2seg_habilitar_seg: TBooleanField
      FieldName = 'seg_habilitar_seg'
    end
    object BUS_CD_C_FU2seg_hab_bot_exc: TBooleanField
      FieldName = 'seg_hab_bot_exc'
    end
    object BUS_CD_C_FU2seg_vis_ult_cmp_ite: TBooleanField
      FieldName = 'seg_vis_ult_cmp_ite'
    end
    object BUS_CD_C_FU2seg_hab_bot_alt_fun: TBooleanField
      FieldName = 'seg_hab_bot_alt_fun'
    end
    object BUS_CD_C_FU2seg_alt_pre_pro: TBooleanField
  ...
  object CAD_FD_C_ITE: TFDQuery
    ...
    object CAD_FD_C_ITEloca_prateleira: TStringField
      FieldName = 'loca_prateleira'
      Origin = 'loca_prateleira'
      Size = 4
    end
    object CAD_FD_C_ITEloca_escaninho: TStringField
      FieldName = 'loca_escaninho'
      Origin = 'loca_escaninho'
      Size = 4
    end
  ...
  object BUS_CD_C_ITE: TClientDataSet
    ...
    object BUS_CD_C_ITEloca_prateleira: TStringField
      FieldName = 'loca_prateleira'
      Origin = 'loca_prateleira'
      Size = 4
    end
    object BUS_CD_C_ITEloca_escaninho: TStringField
      FieldName = 'loca_escaninho'
      Origin = 'loca_escaninho'
      Size = 4
    end
    object BUS_CD_C_ITECAD_FD_C_ITE_LOC: TDataSetField
      FieldName = 'CAD_FD_C_ITE_LOC'
    end
  end
  ...
  object CAD_FD_C_PAR_CTR: TFDQuery
    ...
    object CAD_FD_C_PAR_CTRutiliza_lote_na_entrada: TBooleanField
      FieldName = 'utiliza_lote_na_entrada'
      Origin = 'utiliza_lote_na_entrada'
    end
    object CAD_FD_C_PAR_CTRcte_tipo_estoque_ent: TIntegerField
      FieldName = 'cte_tipo_estoque_ent'
      Origin = 'cte_tipo_estoque_ent'
    end
    object CAD_FD_C_PAR_CTRcte_tipo_estoque_sai: TIntegerField
      FieldName = 'cte_tipo_estoque_sai'
      Origin = 'cte_tipo_estoque_sai'
    end
    object CAD_FD_C_PAR_CTRpreco_por_perfil: TBooleanField
      FieldName = 'preco_por_perfil'
      Origin = 'preco_por_perfil'
    end
    object CAD_FD_C_PAR_CTRcorrecao_prc_por_grupo: TBooleanField
      FieldName = 'correcao_prc_por_grupo'
      Origin = 'correcao_prc_por_grupo'
    end
  end
  object CAD_CD_C_PAR_CTR: TClientDataSet
    ...
    object CAD_CD_C_PAR_CTRutiliza_lote_na_entrada: TBooleanField
      FieldName = 'utiliza_lote_na_entrada'
    end
    object CAD_CD_C_PAR_CTRcte_tipo_estoque_ent: TIntegerField
      FieldName = 'cte_tipo_estoque_ent'
    end
    object CAD_CD_C_PAR_CTRcte_tipo_estoque_sai: TIntegerField
      FieldName = 'cte_tipo_estoque_sai'
    end
    object CAD_CD_C_PAR_CTRpreco_por_perfil: TBooleanField
      FieldName = 'preco_por_perfil'
    end
    object CAD_CD_C_PAR_CTRcorrecao_prc_por_grupo: TBooleanField
      FieldName = 'correcao_prc_por_grupo'
    end
  end
  ...
  object BUS_CD_C_PEC: TClientDataSet
    ...
    object BUS_CD_C_PECCAD_FD_C_PEC_EMP: TDataSetField
      FieldName = 'CAD_FD_C_PEC_EMP'
    end
  end
  ...
  object BUS_CD_C_FAM: TClientDataSet
    ...
    object BUS_CD_C_FAMCAD_FD_C_FAM_EMP: TDataSetField
      FieldName = 'CAD_FD_C_FAM_EMP'
    end
  end
  ...
  object BUS_CD_C_GRU: TClientDataSet
    ...
    object BUS_CD_C_GRUCAD_FD_C_GRU_EMP: TDataSetField
      FieldName = 'CAD_FD_C_GRU_EMP'
    end
  end
  ...
  object CAD_CD_C_GRU: TClientDataSet
    ...
    object CAD_CD_C_GRUCAD_FD_C_GRU_EMP: TDataSetField
      FieldName = 'CAD_FD_C_GRU_EMP'
    end
  end
  object CAD_CD_C_PEC: TClientDataSet
    ...
    object CAD_CD_C_PECCAD_FD_C_PEC_EMP: TDataSetField
      FieldName = 'CAD_FD_C_PEC_EMP'
    end
  end
  ...
  object CAD_CD_C_FAM: TClientDataSet
    ...
    object CAD_CD_C_FAMCAD_FD_C_FAM_EMP: TDataSetField
      FieldName = 'CAD_FD_C_FAM_EMP'
    end
  end
  object CAD_CD_C_ITE: TClientDataSet
    ...
    object CAD_CD_C_ITEloca_prateleira: TStringField
      FieldName = 'loca_prateleira'
      Origin = 'loca_prateleira'
      Size = 4
    end
    object CAD_CD_C_ITEloca_escaninho: TStringField
      FieldName = 'loca_escaninho'
      Origin = 'loca_escaninho'
      Size = 4
    end
    object CAD_CD_C_ITECAD_FD_C_ITE_LOC: TDataSetField
      FieldName = 'CAD_FD_C_ITE_LOC'
    end
  end
  object CAD_FD_C_ITE_PRC: TFDQuery
    ...
    object CAD_FD_C_ITE_PRCid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Origin = 'id_empresa'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
  ...
  object CAD_CD_C_ITE_PRC: TClientDataSet
    ...
    object CAD_CD_C_ITE_PRCid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Origin = 'id_empresa'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
  ...
  object EST_FD_M_CTE: TFDQuery
    Connection = conexao
    SQL.Strings = (
      'select cte.*, alm.descricao as int_nomealm'
      'from est_tb_m_cte cte'
      
        'left outer join cad_tb_c_alm alm on alm.id_almoxarifado=cte.id_a' +
        'lmoxarifado'
      'where 1=2')
    Left = 640
    Top = 736
    object EST_FD_M_CTEid_controle: TIntegerField
      FieldName = 'id_controle'
      Origin = 'id_controle'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object EST_FD_M_CTEdta_contagem: TDateField
      FieldName = 'dta_contagem'
      Origin = 'dta_contagem'
    end
    object EST_FD_M_CTEid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Origin = 'id_empresa'
      Required = True
    end
    object EST_FD_M_CTEobs: TStringField
      FieldName = 'obs'
      Origin = 'obs'
      Size = 50
    end
    object EST_FD_M_CTEcte_tipo: TIntegerField
      FieldName = 'cte_tipo'
      Origin = 'cte_tipo'
    end
    object EST_FD_M_CTElocalizacao: TStringField
      FieldName = 'localizacao'
      Origin = 'localizacao'
      Size = 30
    end
    object EST_FD_M_CTEdta_movimento: TDateField
      FieldName = 'dta_movimento'
      Origin = 'dta_movimento'
    end
    object EST_FD_M_CTEid_almoxarifado: TIntegerField
      FieldName = 'id_almoxarifado'
      Origin = 'id_almoxarifado'
    end
    object EST_FD_M_CTEper_inicial: TDateField
      FieldName = 'per_inicial'
      Origin = 'per_inicial'
    end
    object EST_FD_M_CTEper_final: TDateField
      FieldName = 'per_final'
      Origin = 'per_final'
    end
    object EST_FD_M_CTEstatus: TIntegerField
      FieldName = 'status'
      Origin = 'status'
    end
    object EST_FD_M_CTEcorrigir_custo_medio: TBooleanField
      FieldName = 'corrigir_custo_medio'
      Origin = 'corrigir_custo_medio'
    end
    object EST_FD_M_CTEint_nomealm: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'int_nomealm'
      Origin = 'descricao'
      ProviderFlags = []
  ...
  object EST_DP_M_CTE: TDataSetProvider
    DataSet = EST_FD_M_CTE
    Options = [poCascadeDeletes, poCascadeUpdates, poUseQuoteChar]
    OnDataRequest = EST_DP_M_CTEDataRequest
    Left = 744
    Top = 736
  end
  object EST_CD_M_CTE: TClientDataSet
    Aggregates = <>
    Params = <>
    ...
    object EST_CD_M_CTEdta_contagem: TDateField
      FieldName = 'dta_contagem'
      Origin = 'dta_contagem'
    end
    object EST_CD_M_CTEid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Origin = 'id_empresa'
      Required = True
    end
    object EST_CD_M_CTEobs: TStringField
      FieldName = 'obs'
      Origin = 'obs'
      Size = 50
    end
    object EST_CD_M_CTEcte_tipo: TIntegerField
      FieldName = 'cte_tipo'
      Origin = 'cte_tipo'
    end
    object EST_CD_M_CTElocalizacao: TStringField
      FieldName = 'localizacao'
      Origin = 'localizacao'
      Size = 30
    end
    object EST_CD_M_CTEdta_movimento: TDateField
      FieldName = 'dta_movimento'
      Origin = 'dta_movimento'
    end
    object EST_CD_M_CTEid_almoxarifado: TIntegerField
      FieldName = 'id_almoxarifado'
      Origin = 'id_almoxarifado'
    end
    object EST_CD_M_CTEper_inicial: TDateField
      FieldName = 'per_inicial'
      Origin = 'per_inicial'
    end
    object EST_CD_M_CTEper_final: TDateField
      FieldName = 'per_final'
      Origin = 'per_final'
    end
    object EST_CD_M_CTEstatus: TIntegerField
      FieldName = 'status'
      Origin = 'status'
    end
    object EST_CD_M_CTEcorrigir_custo_medio: TBooleanField
      FieldName = 'corrigir_custo_medio'
      Origin = 'corrigir_custo_medio'
    end
    object EST_CD_M_CTEint_nomealm: TStringField
      FieldName = 'int_nomealm'
      Origin = 'descricao'
      ProviderFlags = []
      Size = 50
    end
    object EST_CD_M_CTEEST_FD_M_CTE_ITE: TDataSetField
      FieldName = 'EST_FD_M_CTE_ITE'
    end
  end
  object EST_CD_M_CTE_ITE: TClientDataSet
    Aggregates = <>
    DataSetField = EST_CD_M_CTEEST_FD_M_CTE_ITE
    Params = <>
    BeforePost = EST_CD_M_CTE_ITEBeforePost
    OnNewRecord = EST_CD_M_CTE_ITENewRecord
    Left = 864
    Top = 792
    object EST_CD_M_CTE_ITEid_controle: TIntegerField
      FieldName = 'id_controle'
      Origin = 'id_controle'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    ...
    object EST_CD_M_CTE_ITEid_seq_item: TIntegerField
      FieldName = 'id_seq_item'
      Origin = 'id_seq_item'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object EST_CD_M_CTE_ITEid_cor: TIntegerField
      FieldName = 'id_cor'
      Origin = 'id_cor'
    end
    object EST_CD_M_CTE_ITEid_tamanho: TIntegerField
      FieldName = 'id_tamanho'
      Origin = 'id_tamanho'
    end
    object EST_CD_M_CTE_ITEid_busca_item: TIntegerField
      FieldName = 'id_busca_item'
      Origin = 'id_busca_item'
    end
    object EST_CD_M_CTE_ITEcontagem: TFloatField
      FieldName = 'contagem'
      Origin = 'contagem'
      OnChange = EST_CD_M_CTE_ITEcontagemChange
    end
    object EST_CD_M_CTE_ITEnum_lote: TStringField
      FieldName = 'num_lote'
      Origin = 'num_lote'
      OnChange = EST_CD_M_CTE_ITEnum_loteChange
      Size = 15
    end
    object EST_CD_M_CTE_ITEdiferenca: TFloatField
      FieldName = 'diferenca'
      Origin = 'diferenca'
    end
    object EST_CD_M_CTE_ITEtipo_diferenca: TIntegerField
      FieldName = 'tipo_diferenca'
      Origin = 'tipo_diferenca'
    end
    object EST_CD_M_CTE_ITEvlr_custo: TFloatField
      FieldName = 'vlr_custo'
      Origin = 'vlr_custo'
    end
    object EST_CD_M_CTE_ITEdta_vencimento: TDateField
      FieldName = 'dta_vencimento'
      Origin = 'dta_vencimento'
    end
    object EST_CD_M_CTE_ITEINT_NOMEITE: TStringField
      FieldName = 'INT_NOMEITE'
      Origin = 'descricao'
      ProviderFlags = []
      Size = 100
    end
    object EST_CD_M_CTE_ITEINT_NOMECOR: TStringField
      FieldName = 'INT_NOMECOR'
      Origin = 'descricao'
      ProviderFlags = []
      Size = 40
    end
    object EST_CD_M_CTE_ITEINT_NOMETAM: TStringField
      FieldName = 'INT_NOMETAM'
      Origin = 'descricao'
      ProviderFlags = []
      Size = 40
    end
    object EST_CD_M_CTE_ITEINT_NOMEUND: TStringField
    ...
    object EST_CD_M_CTE_ITEINT_TIPO_ITEM: TStringField
      FieldName = 'INT_TIPO_ITEM'
      Origin = 'tipo_item'
      ProviderFlags = []
      FixedChar = True
    ...
    object EST_CD_M_CTE_ITErua: TWideStringField
      FieldName = 'rua'
      Size = 4
    end
    object EST_CD_M_CTE_ITEprateleira: TWideStringField
      FieldName = 'prateleira'
      Size = 4
    end
    object EST_CD_M_CTE_ITEescaninho: TWideStringField
      FieldName = 'escaninho'
      Size = 4
    end
  end
  object EST_FD_M_CTE_ITE: TFDQuery
    MasterSource = EST_DS_M_CTE
    MasterFields = 'id_controle'
    DetailFields = 'id_controle'
    Connection = conexao
    FetchOptions.AssignedValues = [evCache]
    FetchOptions.Cache = [fiBlobs, fiMeta]
    SQL.Strings = (
      ...
      'COR.DESCRICAO AS INT_NOMECOR,'
      'TAM.DESCRICAO AS INT_NOMETAM,'
      'ITE.ID_UND_VENDA AS INT_NOMEUND, GRU.TIPO_ITEM AS INT_TIPO_ITEM'
      ''
      ''
      ''
      'from est_tb_m_cte_ite cti'
      'LEFT OUTER JOIN CAD_TB_C_ITE ITE ON ITE.ID_ITEM=CTI.ID_ITEM'
      'LEFT OUTER JOIN CAD_TB_C_GRU GRU ON GRU.ID_GRUPO=ITE.ID_GRUPO'
      'LEFT OUTER JOIN CAD_TB_C_COR COR ON COR.ID_COR=CTI.ID_COR'
      
        'LEFT OUTER JOIN CAD_TB_C_TAM TAM ON TAM.ID_TAMANHO=CTI.ID_TAMANH' +
        'O'
      ''
      ''
      'WHERE CTI.ID_CONTROLE=:ID_CONTROLE')
    Left = 640
    Top = 792
    ParamData = <
      item
    ...
    object EST_FD_M_CTE_ITEid_controle: TIntegerField
      FieldName = 'id_controle'
      Origin = 'id_controle'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object EST_FD_M_CTE_ITEid_item: TIntegerField
      FieldName = 'id_item'
      Origin = 'id_item'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object EST_FD_M_CTE_ITEid_seq_item: TIntegerField
      FieldName = 'id_seq_item'
      Origin = 'id_seq_item'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object EST_FD_M_CTE_ITEid_cor: TIntegerField
      FieldName = 'id_cor'
      Origin = 'id_cor'
    end
    object EST_FD_M_CTE_ITEid_tamanho: TIntegerField
      FieldName = 'id_tamanho'
      Origin = 'id_tamanho'
    end
    object EST_FD_M_CTE_ITEid_busca_item: TIntegerField
      FieldName = 'id_busca_item'
      Origin = 'id_busca_item'
    end
    object EST_FD_M_CTE_ITEcontagem: TFloatField
      FieldName = 'contagem'
      Origin = 'contagem'
    end
    object EST_FD_M_CTE_ITEnum_lote: TStringField
      FieldName = 'num_lote'
      Origin = 'num_lote'
      Size = 15
    end
    object EST_FD_M_CTE_ITEdiferenca: TFloatField
      FieldName = 'diferenca'
      Origin = 'diferenca'
    end
    object EST_FD_M_CTE_ITEtipo_diferenca: TIntegerField
      FieldName = 'tipo_diferenca'
      Origin = 'tipo_diferenca'
    end
    object EST_FD_M_CTE_ITEvlr_custo: TFloatField
      FieldName = 'vlr_custo'
      Origin = 'vlr_custo'
    end
    object EST_FD_M_CTE_ITEdta_vencimento: TDateField
      FieldName = 'dta_vencimento'
      Origin = 'dta_vencimento'
    end
    object EST_FD_M_CTE_ITEINT_NOMEITE: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'INT_NOMEITE'
      Origin = 'descricao'
      ProviderFlags = []
    ...
    object EST_FD_M_CTE_ITEINT_NOMECOR: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'INT_NOMECOR'
      Origin = 'descricao'
      ProviderFlags = []
    ...
    object EST_FD_M_CTE_ITEINT_NOMETAM: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'INT_NOMETAM'
      Origin = 'descricao'
      ProviderFlags = []
    ...
    object EST_FD_M_CTE_ITEINT_NOMEUND: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'INT_NOMEUND'
      Origin = 'id_und_venda'
      ProviderFlags = []
    ...
    object EST_FD_M_CTE_ITEINT_TIPO_ITEM: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'INT_TIPO_ITEM'
      Origin = 'tipo_item'
      ProviderFlags = []
    ...
    object EST_FD_M_CTE_ITErua: TWideStringField
      FieldName = 'rua'
      Origin = 'rua'
      Size = 4
    end
    object EST_FD_M_CTE_ITEprateleira: TWideStringField
      FieldName = 'prateleira'
      Origin = 'prateleira'
      Size = 4
    end
    object EST_FD_M_CTE_ITEescaninho: TWideStringField
      FieldName = 'escaninho'
      Origin = 'escaninho'
      Size = 4
    end
  ...
  object BUS_CD_M_CTE: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'EST_DP_M_CTE'
    Left = 984
  ...
  object EST_FD_M_LOT: TFDQuery
    ...
    SQL.Strings = (
      ...
      'FROM EST_TB_M_LOT LOT'
        ...
        'LEFT OUTER JOIN CAD_TB_C_ALM ALM ON ALM.ID_ALMOXARIFADO=LOT.ID_A' +
        'LMOXARIFADO'
      'LEFT OUTER JOIN CAD_TB_C_COR COR ON COR.ID_COR=LOT.ID_COR'
      
        'LEFT OUTER JOIN CAD_TB_C_TAM TAM ON TAM.ID_TAMANHO=LOT.ID_TAMANH' +
        'O'
      'where 1 = 2')
    Left = 600
    Top = 512
    object EST_FD_M_LOTid_item: TIntegerField
      FieldName = 'id_item'
      Origin = 'id_item'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object EST_FD_M_LOTnum_lote: TStringField
      FieldName = 'num_lote'
      Origin = 'num_lote'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    ...
    object EST_FD_M_LOTid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Origin = 'id_empresa'
      Required = True
    end
    object EST_FD_M_LOTid_almoxarifado: TIntegerField
      FieldName = 'id_almoxarifado'
      Origin = 'id_almoxarifado'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object EST_FD_M_LOTqtde_entrada: TFloatField
      FieldName = 'qtde_entrada'
      Origin = 'qtde_entrada'
      Required = True
    end
    object EST_FD_M_LOTqtde_saida: TFloatField
      FieldName = 'qtde_saida'
      Origin = 'qtde_saida'
      Required = True
    end
    object EST_FD_M_LOTqtde_atual: TFloatField
      FieldName = 'qtde_atual'
      Origin = 'qtde_atual'
      Required = True
    end
    object EST_FD_M_LOTid_fiscal: TIntegerField
      FieldName = 'id_fiscal'
      Origin = 'id_fiscal'
      Required = True
    end
    object EST_FD_M_LOTid_controle: TIntegerField
      FieldName = 'id_controle'
      Origin = 'id_controle'
      Required = True
    end
    object EST_FD_M_LOTid_cor: TIntegerField
      FieldName = 'id_cor'
      Origin = 'id_cor'
      Required = True
    end
    object EST_FD_M_LOTid_tamanho: TIntegerField
      FieldName = 'id_tamanho'
      Origin = 'id_tamanho'
      Required = True
    end
    object EST_FD_M_LOTdta_vencimento: TDateField
      FieldName = 'dta_vencimento'
      Origin = 'dta_vencimento'
    end
    object EST_FD_M_LOTINT_NOMEALM: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'INT_NOMEALM'
      Origin = 'descricao'
      ProviderFlags = []
    ...
    object EST_FD_M_LOTINT_NOMECOR: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'INT_NOMECOR'
      Origin = 'descricao'
      ProviderFlags = []
    ...
    object EST_FD_M_LOTINT_NOMETAM: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'INT_NOMETAM'
      Origin = 'descricao'
      ProviderFlags = []
  ...
  object EST_DP_M_LOT: TDataSetProvider
    DataSet = EST_FD_M_LOT
    Left = 728
    Top = 512
  end
  object EST_CD_M_LOT: TClientDataSet
    Aggregates = <>
    Params = <>
    ...
    object EST_CD_M_LOTnum_lote: TStringField
      FieldName = 'num_lote'
      Required = True
      Size = 15
    end
    object EST_CD_M_LOTid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Required = True
    end
    object EST_CD_M_LOTid_almoxarifado: TIntegerField
      FieldName = 'id_almoxarifado'
      Required = True
    end
    object EST_CD_M_LOTqtde_entrada: TFloatField
      FieldName = 'qtde_entrada'
      Required = True
    end
    object EST_CD_M_LOTqtde_saida: TFloatField
      FieldName = 'qtde_saida'
      Required = True
    end
    object EST_CD_M_LOTqtde_atual: TFloatField
      FieldName = 'qtde_atual'
      Required = True
    end
    object EST_CD_M_LOTid_fiscal: TIntegerField
      FieldName = 'id_fiscal'
      Required = True
    end
    object EST_CD_M_LOTid_controle: TIntegerField
      FieldName = 'id_controle'
      Required = True
    end
    object EST_CD_M_LOTid_cor: TIntegerField
      FieldName = 'id_cor'
      Required = True
    end
    object EST_CD_M_LOTid_tamanho: TIntegerField
      FieldName = 'id_tamanho'
      Required = True
    end
    object EST_CD_M_LOTdta_vencimento: TDateField
      FieldName = 'dta_vencimento'
    end
    object EST_CD_M_LOTINT_NOMEALM: TStringField
      FieldName = 'INT_NOMEALM'
      ProviderFlags = []
      ReadOnly = True
      Size = 50
    end
    object EST_CD_M_LOTINT_NOMECOR: TStringField
      FieldName = 'INT_NOMECOR'
      ProviderFlags = []
      ReadOnly = True
      Size = 40
    end
    object EST_CD_M_LOTINT_NOMETAM: TStringField
      FieldName = 'INT_NOMETAM'
      ProviderFlags = []
      ReadOnly = True
      Size = 40
  ...
  object BUS_FD_C_ITE_LOC: TFDQuery
    Connection = conexao
    SQL.Strings = (
      'SELECT LOC.loca_rua  '
      '        FROM cad_tb_c_ite_loc loc'
      '       WHERE LOC.ID_EMPRESA = 0 '
      '        GROUP BY LOC.loca_rua')
    Left = 64
    Top = 1192
  end
  object BUS_DP_C_ITE_LOC: TDataSetProvider
    DataSet = BUS_FD_C_ITE_LOC
    OnDataRequest = BUS_DP_C_ITE_LOCDataRequest
    Left = 176
    Top = 1192
  end
  object BUS_CD_C_ITE_LOC2: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'BUS_DP_C_ITE_LOC'
    Left = 304
    Top = 1192
  end
  object BUS_FD_QRY: TFDQuery
    Connection = conexao
    Left = 648
    Top = 888
  end
  object BUS_DP_QRY: TDataSetProvider
    DataSet = BUS_FD_QRY
    OnDataRequest = BUS_DP_QRYDataRequest
    Left = 768
    Top = 888
  end
  object BUS_CD_QRY: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'BUS_DP_QRY'
    Left = 880
    Top = 888
  end
  object BUS_CD_C_ITE_LOC: TClientDataSet
    Aggregates = <>
    DataSetField = BUS_CD_C_ITECAD_FD_C_ITE_LOC
    Filtered = True
    Params = <>
    Left = 408
    Top = 632
  ...
  object CAD_FD_C_ITE_LOC: TFDQuery
    MasterSource = CAD_DS_C_ITE
    MasterFields = 'id_item'
    DetailFields = 'id_item'
    Connection = conexao
    ...
    FetchOptions.Cache = [fiBlobs, fiMeta]
    SQL.Strings = (
      'SELECT * FROM CAD_TB_C_ITE_LOC LOC'
      'WHERE LOC.ID_ITEM =:ID_ITEM')
    Left = 64
    Top = 672
    ParamData = <
      item
    ...
    object CAD_FD_C_ITE_LOCid_item: TIntegerField
      FieldName = 'id_item'
      Origin = 'id_item'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CAD_FD_C_ITE_LOCid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Origin = 'id_empresa'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CAD_FD_C_ITE_LOCloca_rua: TWideStringField
      FieldName = 'loca_rua'
      Origin = 'loca_rua'
      Size = 4
    end
    object CAD_FD_C_ITE_LOCloca_prateleira: TWideStringField
      FieldName = 'loca_prateleira'
      Origin = 'loca_prateleira'
      Size = 4
    end
    object CAD_FD_C_ITE_LOCloca_escaninho: TWideStringField
      FieldName = 'loca_escaninho'
      Origin = 'loca_escaninho'
      Size = 4
    end
  end
  object BUS_CD_C_PEC_EMP: TClientDataSet
    Aggregates = <>
    DataSetField = BUS_CD_C_PECCAD_FD_C_PEC_EMP
    Filtered = True
    Params = <>
    Left = 376
    Top = 312
    object BUS_CD_C_PEC_EMPid_perfil_cli: TIntegerField
      FieldName = 'id_perfil_cli'
      Required = True
    end
    object BUS_CD_C_PEC_EMPid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Required = True
    end
    object BUS_CD_C_PEC_EMPper_correcao: TFloatField
      FieldName = 'per_correcao'
    end
    object BUS_CD_C_PEC_EMPper_correcao_aprazo: TFloatField
      FieldName = 'per_correcao_aprazo'
    end
    object BUS_CD_C_PEC_EMPper_correcao_financeiro: TFloatField
      FieldName = 'per_correcao_financeiro'
    end
  end
  object CAD_FD_C_FAM_EMP: TFDQuery
    MasterSource = CAD_DS_C_FAM
    MasterFields = 'id_familia'
    DetailFields = 'id_familia'
    Connection = conexao
    FetchOptions.AssignedValues = [evCache]
    FetchOptions.Cache = [fiBlobs, fiMeta]
    SQL.Strings = (
      'SELECT * FROM CAD_TB_C_FAM_EMP FMP'
      'WHERE FMP.ID_FAMILIA=:ID_FAMILIA')
    Left = 56
    Top = 408
    ParamData = <
      item
    ...
    object CAD_FD_C_FAM_EMPid_familia: TIntegerField
      FieldName = 'id_familia'
      Origin = 'id_familia'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CAD_FD_C_FAM_EMPid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Origin = 'id_empresa'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CAD_FD_C_FAM_EMPfaz_corr_preco_perfil: TBooleanField
      FieldName = 'faz_corr_preco_perfil'
      Origin = 'faz_corr_preco_perfil'
    end
  end
  ...
  object BUS_CD_C_FAM_EMP: TClientDataSet
    Aggregates = <>
    DataSetField = BUS_CD_C_FAMCAD_FD_C_FAM_EMP
    Filtered = True
    Params = <>
    Left = 384
    Top = 416
    object BUS_CD_C_FAM_EMPid_familia: TIntegerField
      FieldName = 'id_familia'
      Required = True
    end
    object BUS_CD_C_FAM_EMPid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Required = True
    end
    object BUS_CD_C_FAM_EMPfaz_corr_preco_perfil: TBooleanField
      FieldName = 'faz_corr_preco_perfil'
    end
  end
  object CAD_DS_C_PEC: TDataSource
    DataSet = CAD_FD_C_PEC
    Left = 160
    Top = 312
  end
  object CAD_FD_C_PEC_EMP: TFDQuery
    MasterSource = CAD_DS_C_PEC
    MasterFields = 'id_perfil_cli'
    DetailFields = 'id_perfil_cli'
    Connection = conexao
    FetchOptions.AssignedValues = [evCache]
    FetchOptions.Cache = [fiBlobs, fiMeta]
    SQL.Strings = (
      'SELECT * FROM CAD_TB_C_PEC_EMP PMP'
      'WHERE PMP.ID_PERFIL_CLI=:ID_PERFIL_CLI')
    Left = 48
    Top = 312
    ParamData = <
      item
    ...
    object CAD_FD_C_PEC_EMPid_perfil_cli: TIntegerField
      FieldName = 'id_perfil_cli'
      Origin = 'id_perfil_cli'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CAD_FD_C_PEC_EMPid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Origin = 'id_empresa'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CAD_FD_C_PEC_EMPper_correcao: TFloatField
      FieldName = 'per_correcao'
      Origin = 'per_correcao'
    end
    object CAD_FD_C_PEC_EMPper_correcao_aprazo: TFloatField
      FieldName = 'per_correcao_aprazo'
      Origin = 'per_correcao_aprazo'
    end
    object CAD_FD_C_PEC_EMPper_correcao_financeiro: TFloatField
      FieldName = 'per_correcao_financeiro'
      Origin = 'per_correcao_financeiro'
    end
  end
  object CAD_FD_C_GRU_EMP: TFDQuery
    MasterSource = CAD_DS_C_GRU
    ...
    FetchOptions.Cache = [fiBlobs, fiMeta]
    SQL.Strings = (
      'SELECT * FROM CAD_TB_C_GRU_EMP GMP'
    ...
    object CAD_FD_C_GRU_EMPid_grupo: TStringField
      FieldName = 'id_grupo'
      Origin = 'id_grupo'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    ...
    object CAD_FD_C_GRU_EMPid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Origin = 'id_empresa'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CAD_FD_C_GRU_EMPfator_corr_aprazo: TFloatField
      FieldName = 'fator_corr_aprazo'
      Origin = 'fator_corr_aprazo'
    end
    object CAD_FD_C_GRU_EMPfator_corr_avista: TFloatField
      FieldName = 'fator_corr_avista'
      Origin = 'fator_corr_avista'
    end
  end
  object CAD_DS_C_GRU: TDataSource
    DataSet = CAD_FD_C_GRU
    Left = 168
    Top = 528
  end
  object BUS_CD_C_GRU_EMP: TClientDataSet
    Aggregates = <>
    DataSetField = BUS_CD_C_GRUCAD_FD_C_GRU_EMP
    Filtered = True
    Params = <>
    Left = 376
    Top = 528
    object BUS_CD_C_GRU_EMPid_grupo: TStringField
      FieldName = 'id_grupo'
      Required = True
      FixedChar = True
      Size = 11
    end
    object BUS_CD_C_GRU_EMPid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Required = True
    end
    object BUS_CD_C_GRU_EMPfator_corr_aprazo: TFloatField
      FieldName = 'fator_corr_aprazo'
    end
    object BUS_CD_C_GRU_EMPfator_corr_avista: TFloatField
      FieldName = 'fator_corr_avista'
    end
  end
  object BUS_CD_C_ITE_CAT: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 864
    Top = 576
  end
  object BUS_DP_C_ITE_CAT: TDataSetProvider
    OnDataRequest = BUS_DP_C_ITE_CATDataRequest
    Left = 728
    Top = 576
  end
  object BUS_FD_C_ITE_CAT: TFDQuery
    Connection = conexao
    SQL.Strings = (
      
        ' select cat.descricao as int_nomecat,cit.* from cad_tb_c_ite_cat' +
        ' cit '
  ...
  object CAD_CD_C_PEC_EMP: TClientDataSet
    Aggregates = <>
    DataSetField = CAD_CD_C_PECCAD_FD_C_PEC_EMP
    Params = <>
    Left = 264
    Top = 312
    object CAD_CD_C_PEC_EMPid_perfil_cli: TIntegerField
      FieldName = 'id_perfil_cli'
      Required = True
    end
    object CAD_CD_C_PEC_EMPid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Required = True
    end
    object CAD_CD_C_PEC_EMPper_correcao: TFloatField
      FieldName = 'per_correcao'
    end
    object CAD_CD_C_PEC_EMPper_correcao_aprazo: TFloatField
      FieldName = 'per_correcao_aprazo'
    end
    object CAD_CD_C_PEC_EMPper_correcao_financeiro: TFloatField
      FieldName = 'per_correcao_financeiro'
    end
  end
  object CAD_CD_C_GRU_EMP: TClientDataSet
    Aggregates = <>
    DataSetField = CAD_CD_C_GRUCAD_FD_C_GRU_EMP
    Params = <>
    Left = 272
    Top = 528
    object CAD_CD_C_GRU_EMPid_grupo: TStringField
      FieldName = 'id_grupo'
      Required = True
      FixedChar = True
      Size = 11
    end
    object CAD_CD_C_GRU_EMPid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Required = True
    end
    object CAD_CD_C_GRU_EMPfator_corr_aprazo: TFloatField
      FieldName = 'fator_corr_aprazo'
    end
    object CAD_CD_C_GRU_EMPfator_corr_avista: TFloatField
      FieldName = 'fator_corr_avista'
    end
  end
  object CAD_CD_C_FAM_EMP: TClientDataSet
    Aggregates = <>
    DataSetField = CAD_CD_C_FAMCAD_FD_C_FAM_EMP
    Params = <>
    Left = 272
    Top = 416
    object CAD_CD_C_FAM_EMPid_familia: TIntegerField
      FieldName = 'id_familia'
      Required = True
    end
    object CAD_CD_C_FAM_EMPid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Required = True
    end
    object CAD_CD_C_FAM_EMPfaz_corr_preco_perfil: TBooleanField
      FieldName = 'faz_corr_preco_perfil'
    end
  end
  object CAD_CD_C_ITE_LOC: TClientDataSet
    Aggregates = <>
    DataSetField = CAD_CD_C_ITECAD_FD_C_ITE_LOC
    Params = <>
    Left = 280
    Top = 632
    object CAD_CD_C_ITE_LOCid_item: TIntegerField
      FieldName = 'id_item'
      Required = True
    end
    object CAD_CD_C_ITE_LOCid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Required = True
    end
    object CAD_CD_C_ITE_LOCloca_rua: TWideStringField
      FieldName = 'loca_rua'
      Size = 4
    end
    object CAD_CD_C_ITE_LOCloca_prateleira: TWideStringField
      FieldName = 'loca_prateleira'
      Size = 4
    end
    object CAD_CD_C_ITE_LOCloca_escaninho: TWideStringField
      FieldName = 'loca_escaninho'
      Size = 4
    end
  end
