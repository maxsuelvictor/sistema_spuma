...
type
  TOFI_FM_R_FIV = class(TPAD_FM_X_REL)
...
procedure TOFI_FM_R_FIV.PreencherCondicao;
var
  i: integer;
...
function TOFI_FM_R_FIV.TestarCampos:Boolean;
var
  mens: String;
begin
  result := True;
...
procedure TOFI_FM_R_FIV.txtPlacaButtonClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_FIV.txtPlacaEnter(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_FIV.txtPlacaExit(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_FIV.ExibirRel;
var
...
procedure TOFI_FM_R_FIV.btnImprimirClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_FIV.btnRemoverTodosEmpresaClick(Sender: TObject);
var
  i:integer;
begin
  inherited;
...
procedure TOFI_FM_R_FIV.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  FreeAndNil(OFI_FM_R_FIV);
end;

procedure TOFI_FM_R_FIV.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_FIV.lboxEmpDispDblClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_FIV.lboxEmpSelDblClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_FIV.menuItemEmpresasClick(Sender: TObject);
var
  i: integer;
begin
  inherited;
