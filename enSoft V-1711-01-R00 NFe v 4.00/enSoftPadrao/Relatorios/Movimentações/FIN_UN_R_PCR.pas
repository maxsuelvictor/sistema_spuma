...
type
  TFIN_FM_R_PCR = class(TPAD_FM_X_REL)
...
procedure TFIN_FM_R_PCR.btnImprimirClick(Sender: TObject);
begin
  inherited;
...
procedure TFIN_FM_R_PCR.btnRemoverRegistroClienteClick(Sender: TObject);
begin
  inherited;
...
procedure TFIN_FM_R_PCR.btnRemoverRegistrosClick(Sender: TObject);
var
  i:integer;
begin
  inherited;
...
procedure TFIN_FM_R_PCR.btnRemoverTodosCentroCustoClick(Sender: TObject);
var
 i:integer;
begin
  inherited;
...
procedure TFIN_FM_R_PCR.btnRemoverTodosEmpresaClick(Sender: TObject);
var
  i:integer;
begin
  inherited;
...
procedure TFIN_FM_R_PCR.btnRemoverTodosFormaPagClick(Sender: TObject);
var
 i:integer;
begin
  inherited;
...
procedure TFIN_FM_R_PCR.btnRemoverTodosLocalTituloClick(Sender: TObject);
var
 i:integer;
begin
  inherited;
...
procedure TFIN_FM_R_PCR.ExibirRel;
var
...
procedure TFIN_FM_R_PCR.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  FreeAndNil(FIN_FM_R_PCR);
end;

procedure TFIN_FM_R_PCR.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TFIN_FM_R_PCR.lboxCentroCustoDisponiveisDblClick(Sender: TObject);
begin
  inherited;
...
procedure TFIN_FM_R_PCR.lboxCentroCustoSelecionadoDblClick(Sender: TObject);
begin
  inherited;
...
procedure TFIN_FM_R_PCR.lboxClientesKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  if key = vk_f3 then
...
procedure TFIN_FM_R_PCR.lboxEmpresasDblClick(Sender: TObject);
begin
  inherited;
...
procedure TFIN_FM_R_PCR.lboxEmpresaSelecionadaDblClick(Sender: TObject);
begin
  inherited;
  inherited;
...
procedure TFIN_FM_R_PCR.lboxFormaDisponivelDblClick(Sender: TObject);
begin
  inherited;
...
procedure TFIN_FM_R_PCR.lboxFormaSelecionadaDblClick(Sender: TObject);
begin
  inherited;
...
procedure TFIN_FM_R_PCR.lboxLocaisDisponiveisDblClick(Sender: TObject);
begin
  inherited;
...
procedure TFIN_FM_R_PCR.lboxLocalSelecionadoDblClick(Sender: TObject);
begin
  inherited;
...
procedure TFIN_FM_R_PCR.lboxPlanosDisponiveisDblClick(Sender: TObject);
begin
  inherited;
  if lboxLocalSelecionado.ItemIndex > -1 then
     begin
...
procedure TFIN_FM_R_PCR.lboxPlanoSelecionadoDblClick(Sender: TObject);
begin
  inherited;
...
procedure TFIN_FM_R_PCR.MenuItemCentroCustoClick(Sender: TObject);
var
  i: integer;
begin
  inherited;
...
procedure TFIN_FM_R_PCR.menuItemEmpresasClick(Sender: TObject);
var
  i: integer;
begin
  inherited;
...
procedure TFIN_FM_R_PCR.MenuItemFormasPagamentoClick(Sender: TObject);
var
  i: integer;
begin
  inherited;
...
procedure TFIN_FM_R_PCR.MenuItemLocalTituloClick(Sender: TObject);
var
  i: integer;
begin
  inherited;
...
procedure TFIN_FM_R_PCR.MenuItemPlanoContaClick(Sender: TObject);
var
  i: integer;
begin
  inherited;
...
procedure TFIN_FM_R_PCR.PreencherCondicao;
var
  i: integer;
  Cond: String;
...
function TFIN_FM_R_PCR.TestarCampos: Boolean;
var
mens: String;
begin
