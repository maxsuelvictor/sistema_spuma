...
type
  TOFI_FM_R_HIV = class(TPAD_FM_X_REL)
    Label1: TLabel;
    Label2: TLabel;
...
procedure TOFI_FM_R_HIV.btnImprimirClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_HIV.btnRemoverTodosEmpresaClick(Sender: TObject);
var
  i:integer;
begin
  inherited;
...
procedure TOFI_FM_R_HIV.btnRemoverVeiculoClick(Sender: TObject);
var
  i:integer;
begin
  inherited;
...
procedure TOFI_FM_R_HIV.ExibirRel;
var
...
begin
  ...
  OFI_CD_R_HIV.Close;
  OFI_CD_R_HIV.Data :=
  OFI_CD_R_HIV.DataRequest(VarArrayOf([lbxRelatorios.ItemIndex, rDtaIni,rDtaFin,xCondEmpresa,xCondVeiculo,'1','']));
...
procedure TOFI_FM_R_HIV.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  FreeAndNil(OFI_FM_R_HIV);
end;

procedure TOFI_FM_R_HIV.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_HIV.lboxEmpresasDblClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_HIV.lboxEmpresaSelecionadaDblClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_HIV.lboxVeiculoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  if key = vk_f3 then
...
procedure TOFI_FM_R_HIV.menuItemEmpresasClick(Sender: TObject);
var
  i: integer;
begin
  inherited;
...
procedure TOFI_FM_R_HIV.PreencherCondicao;
var
  i: integer;
...
function TOFI_FM_R_HIV.TestarCampos: Boolean;
var
  mens: String;
begin
  result := True;
