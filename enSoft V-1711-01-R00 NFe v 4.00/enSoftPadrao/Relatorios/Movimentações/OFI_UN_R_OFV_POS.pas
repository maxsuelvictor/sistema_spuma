...
type
  TOFI_FM_R_OFV_POS = class(TPAD_FM_X_REL)
    lblPeriodo: TLabel;
...
var
  OFI_FM_R_OFV_POS: TOFI_FM_R_OFV_POS;
...
function TOFI_FM_R_OFV_POS.TestarCampos;
var
  mens: String;
begin
  result := True;
...
procedure TOFI_FM_R_OFV_POS.PreencherCondicao;
var
  i: integer;
...
procedure TOFI_FM_R_OFV_POS.ExibirRel;
var
        ...
        OFI_CD_R_OFV_POS_001.Data :=
                OFI_CD_R_OFV_POS_001.DataRequest(
                      VarArrayOf([rDtaIni,rDtaFin,rOrdIni,rOrdFin,rSituacao,xCondEmpresa,xCondFuncionario,
                                  xCondVeiculo,xCondPag,xCondAnalista,xCondTipoOrdem,cbTipoPeriodo.ItemIndex,'1','','']));
              ...
              begin
                ...
                OFI_CD_R_OFV_POS_002.Data :=
                          OFI_CD_R_OFV_POS_002.DataRequest(
                                VarArrayOf([rDtaIni,rDtaFin,rOrdIni,rOrdFin,rSituacao,xCondEmpresa,xCondFuncionario,
                                            xCondVeiculo,xCondPag,xCondAnalista,xCondTipoOrdem,lbxRelatorios.ItemIndex,cbTipoPeriodo.ItemIndex,'1','','']));
              end;
            ...
            if (not OFI_CD_R_OFV_POS_002.IsEmpty) or (not OFI_CD_R_OFV_POS_EST.IsEmpty) then
              begin
                PathImg := ExtractFilePath(Application.ExeName)+'emp'+dmGeral.CAD_CD_C_PAR.FieldByName('ID_EMPRESA').Text+'\LogoEmpresa.jpg';
                   ...
                   if (lbxRelatorios.Items[lbxRelatorios.ItemIndex] = '03 - Por Veículo') then
                     begin
                   ...
                   if (lbxRelatorios.Items[lbxRelatorios.ItemIndex] = '06 - Veículo com entrega atrasada') then
                     begin
...
procedure TOFI_FM_R_OFV_POS.btnImprimirClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.btnRemoverAnalistaClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.btnRemoverRegistroFuncionarioClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.btnRemoverTipoOrdServClick(Sender: TObject);
var
  i:integer;
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.btnRemoverTodasCondPagClick(Sender: TObject);
var
  i:integer;
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.btnRemoverTodosEmpresaClick(Sender: TObject);
var
  i:integer;
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.btnRemoverVeiculoClick(Sender: TObject);
var
  i:integer;
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.cbbFiltroTipoChange(Sender: TObject);
begin
  inherited;
  if (cbbFiltroTipo.ItemIndex = 0) then
    begin
...
procedure TOFI_FM_R_OFV_POS.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  FreeAndNil(OFI_FM_R_OFV_POS);
end;

procedure TOFI_FM_R_OFV_POS.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.lboxAnalistaKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
   if key = vk_f3 then
...
procedure TOFI_FM_R_OFV_POS.lboxCondDisponivelDblClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.lboxCondSelecionadoDblClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.lboxEmpresasDblClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.lboxEmpresaSelecionadaDblClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.lboxFuncionarioKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  if key = vk_f3 then
...
procedure TOFI_FM_R_OFV_POS.lboxTipoOrdServDisponivelDblClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.lboxTipoOrdServSelecionadoClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.lboxVeiculoDisponivelKeyDown(Sender: TObject;
...
procedure TOFI_FM_R_OFV_POS.lbxRelatoriosClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.MenuItemCondPagClick(Sender: TObject);
var
  i: integer;
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.menuItemEmpresasClick(Sender: TObject);
var
  i: integer;
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.MenuItemTipoOrdServClick(Sender: TObject);
var
  i: integer;
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.MenuItemVeiculoClick(Sender: TObject);
var
  i: integer;
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.OFI_FR_R_OFV_POS_05BeforePrint(
...
procedure TOFI_FM_R_OFV_POS.OFI_FR_R_OFV_POS_08BeforePrint(
  Sender: TfrxReportComponent);
begin
  inherited;
...
procedure TOFI_FM_R_OFV_POS.OFI_FR_R_OFV_POS_09BeforePrint(
  Sender: TfrxReportComponent);
begin
  inherited;
   if (OFI_CD_R_OFV_POS_003.FieldByName('INT_NOMEMEC').AsString <>'') then
...
procedure TOFI_FM_R_OFV_POS.OFI_FR_R_OFV_POS_10BeforePrint(
  Sender: TfrxReportComponent);
begin
  inherited;
   {if (OFI_CD_R_OFV_POS_003.FieldByName('INT_NOMEMEC').AsString <>'') then
