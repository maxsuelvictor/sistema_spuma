inherited CSU_FM_C_CLI_EXT: TCSU_FM_C_CLI_EXT
  ClientHeight = 646
  ExplicitLeft = -90
  ExplicitWidth = 1156
  ExplicitHeight = 674
  ...
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object pnVendas: TPanel
        ...
        BevelOuter = bvLowered
        TabOrder = 3
        object pnOFPrestCtaAberto: TPanel
          Left = 792
          Top = 2
          Width = 352
          Height = 197
          Align = alRight
          Caption = 'pnOFPrestCtaAberto'
          TabOrder = 0
          object Label21: TLabel
            ...
            AutoSize = False
            BiDiMode = bdLeftToRight
            Caption = 'Ordem Faturamento com Presta'#231#227'o de conta em Aberto'
            Color = 11448063
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clBlack
            Font.Height = -11
          ...
          object grdOFsPrestCtaAberto: TwwDBGrid
            Left = 1
            Top = 21
            Width = 350
            Height = 148
            Selected.Strings = (
              ...
              'vlr_liquido'#9'10'#9'Valor'
              'vlr_saldo'#9'12'#9'Saldo aberto')
          ...
          object Panel7: TPanel
            ...
            object txtVlrOFPrestCtaAberto: TEdit
              Left = 77
              Top = 3
              Width = 92
              Height = 21
              ...
              ReadOnly = True
              TabOrder = 0
              Text = 'txtVlrOFPrestCtaAberto'
            end
            object txtVlrOFPrestCtaSldAberto: TEdit
              Left = 242
              Top = 3
              Width = 92
              Height = 21
              ...
              ReadOnly = True
              TabOrder = 1
              Text = 'txtVlrOFPrestCtaSldAberto'
            end
          end
        end
        object pnOFs: TPanel
          ...
          object grdOFs: TwwDBGrid
            ...
            Selected.Strings = (
              'id_ors'#9'12'#9'O.F'
              'dta_emissao'#9'13'#9'Emiss'#227'o'
              'id_pedido'#9'14'#9'Pedido'
              'vlr_liquido'#9'16'#9'Valor')
            IniAttributes.Delimiter = ';;'
            IniAttributes.UnicodeIniFile = False
            TitleColor = clBtnFace
            FixedCols = 0
        ...
        object pnOFPrestCta: TPanel
          ...
          object Label26: TLabel
            ...
            AutoSize = False
            BiDiMode = bdLeftToRight
            Caption = 'Ordem Faturamento Prestado Conta'
            Color = 16563629
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
          ...
          object grdOFsPrestCta: TwwDBGrid
            Left = 1
            Top = 21
            Width = 398
            Height = 148
            Hint = 'Clique com o direito do mouse para visualizar a(s) baixa(s)'
            Selected.Strings = (
              'id_ors'#9'10'#9'O.F'
              'dta_emissao'#9'15'#9'Emiss'#227'o'
              'id_pedido'#9'18'#9'Pedido'
              'vlr_liquido'#9'14'#9'Valor')
            IniAttributes.Delimiter = ';;'
            IniAttributes.UnicodeIniFile = False
            TitleColor = clBtnFace
            FixedCols = 0
            ShowHorzScrollBar = True
            Align = alClient
            DataSource = dsOFPrestCta
            Options = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit, dgWordWrap]
            ParentShowHint = False
            PopupMenu = pmOFsPrestCta
            ShowHint = True
            TabOrder = 0
            TitleAlignment = taLeftJustify
            TitleFont.Charset = DEFAULT_CHARSET
          ...
          object Panel11: TPanel
            ...
            object txtVlrOFPrestCta: TEdit
              ...
              ReadOnly = True
              TabOrder = 0
              Text = 'txtVlrOFPrestCta'
            end
          end
        end
      end
      object pgInformacoesFin: TPageControl
        Left = 0
        Top = 311
        Width = 1146
        Height = 259
        ...
        Align = alClient
        TabOrder = 4
        object tbTitChq: TTabSheet
          Caption = 'T'#237'tulos e Cheques'
          object pnFiltroTitulos: TPanel
            Left = 0
            Top = 0
            Width = 1138
            Height = 48
            ...
            object deInicialFin: TJvDateEdit
              Left = 195
              Top = 21
              Width = 90
              Height = 21
          ...
          object pnTitulos: TPanel
            ...
            object pnTitPrestCta: TPanel
              ...
              object lblPagamentos: TLabel
                ...
                AutoSize = False
                BiDiMode = bdLeftToRight
                Caption = 'T'#237'tulos a Prestar Conta'
                Color = 14342874
                Font.Charset = DEFAULT_CHARSET
                Font.Color = clWindowText
                Font.Height = -11
              ...
              object Panel1: TPanel
                ...
                object txtVlrTotTitPresCta: TEdit
                  Left = 122
                  Top = 3
                  Width = 121
                  Height = 21
                  ...
                  ReadOnly = True
                  TabOrder = 0
                  Text = 'txtVlrTotTitPresCta'
                end
              end
              object grdTotTitPresCta: TwwDBGrid
                Left = 1
                Top = 21
                Width = 263
                Height = 130
                Selected.Strings = (
                  'descricao'#9'9'#9'Forma'
                  'num_parcela'#9'9'#9'Nro parcela'
                  'dta_vencimento'#9'10'#9'Vencimento'
                  'vlr_saldo'#9'10'#9'Vlr. Saldo')
                IniAttributes.Delimiter = ';;'
                IniAttributes.UnicodeIniFile = False
                TitleColor = clBtnFace
                FixedCols = 0
                ShowHorzScrollBar = True
                Align = alClient
                DataSource = dsTotTitPresCta
                Options = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit, dgWordWrap]
                PopupMenu = pmTitPrestCta
                TabOrder = 1
                TitleAlignment = taLeftJustify
                TitleFont.Charset = DEFAULT_CHARSET
                TitleFont.Color = clBlack
            ...
            object pnChequesDev: TPanel
              ...
              object Panel2: TPanel
                ...
                object txtVlrTotChqDev: TEdit
                  ...
                  ReadOnly = True
                  TabOrder = 0
                  Text = 'txtVlrTotChqDev'
                end
              end
              object grdTotChqDev: TwwDBGrid
                Left = 1
                Top = 21
                Width = 263
                Height = 130
                Selected.Strings = (
                  'descricao'#9'6'#9'Forma'
                  'che_cheque'#9'10'#9'Nro cheque'
                  'dta_vencimento'#9'10'#9'Vencimento'
                  'vlr_saldo'#9'8'#9'Valor')
                IniAttributes.Delimiter = ';;'
                IniAttributes.UnicodeIniFile = False
                TitleColor = clBtnFace
                FixedCols = 0
            ...
            object pnTitAberto: TPanel
              ...
              object Panel13: TPanel
                ...
                object txtVlrTitAberto: TEdit
                  ...
                  ReadOnly = True
                  TabOrder = 0
                  Text = 'txtVlrTitAberto'
                end
                object txtVlrTitAbertoVencido: TEdit
                  Left = 83
                  Top = 4
                  Width = 71
                  Height = 21
                  ...
                  ReadOnly = True
                  TabOrder = 1
                  Text = 'txtVlrTitAbertoVencido'
                end
              end
              object grdTotTitAberto: TwwDBGrid
                Left = 1
                Top = 21
                Width = 300
                Height = 130
                Selected.Strings = (
                  'descricao'#9'12'#9'Forma'
                  'num_parcela'#9'10'#9'Nro cheque'
                  'dta_vencimento'#9'10'#9'Vencimento'
                  'vlr_saldo'#9'9'#9'Vlr. Saldo')
                IniAttributes.Delimiter = ';;'
                IniAttributes.UnicodeIniFile = False
                TitleColor = clBtnFace
                FixedCols = 0
                ShowHorzScrollBar = True
                Align = alClient
                DataSource = dsTotTitAberto
                Options = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit, dgWordWrap]
                PopupMenu = pmTitAberto
                TabOrder = 1
                TitleAlignment = taLeftJustify
                TitleFont.Charset = DEFAULT_CHARSET
                TitleFont.Color = clBlack
            ...
            object pnChequesDepositar: TPanel
              Left = 569
              Top = 2
              Width = 302
              Height = 179
              ...
              object Panel6: TPanel
                ...
                object txtVlrChqDepositar: TEdit
                  Left = 204
                  Top = 3
                  Width = 81
                  Height = 21
                  ...
                  ReadOnly = True
                  TabOrder = 0
                  Text = 'txtVlrChqDepositar'
                end
                object txtVlrChqDepositarVencido: TEdit
                  Left = 82
                  Top = 3
                  Width = 72
                  Height = 21
                  ...
                  ReadOnly = True
                  TabOrder = 1
                  Text = 'txtVlrChqDepositarVencido'
                end
              end
              object grdChqDepositar: TwwDBGrid
                Left = 1
                Top = 21
                Width = 300
                Height = 130
        ...
        object tsTitPagos: TTabSheet
          Caption = 'T'#237'tulos pagos'
          ImageIndex = 1
          object pnTitPagos: TPanel
            Left = 0
            Top = 0
            Width = 312
            Height = 231
            ...
            object grdTotPagos: TwwDBGrid
              Left = 1
              Top = 21
              Width = 310
              Height = 182
              Selected.Strings = (
                'descricao'#9'11'#9'Forma'
                'num_parcela'#9'10'#9'Parcela/Chq'
                'dta_pagamento'#9'10'#9'Pago em'
                'vlr_pagamento'#9'10'#9'Valor pago')
              IniAttributes.Delimiter = ';;'
              IniAttributes.UnicodeIniFile = False
              TitleColor = clBtnFace
              FixedCols = 0
        ...
        object tsChqDaOF: TTabSheet
          Caption = 'Buscar informa'#231#245'es do nro do Cheque...'
          ImageIndex = 2
          OnShow = tsChqDaOFShow
          object pnChqDaOF: TPanel
            Left = 0
            Top = 0
            Width = 1138
            Height = 231
            ...
            object pnBaixasDoChq: TPanel
              ...
              object Label36: TLabel
                ...
                AutoSize = False
                BiDiMode = bdLeftToRight
                Caption = 'Baixa do Contas a Receber'
                Color = 14342874
                Font.Charset = DEFAULT_CHARSET
                Font.Color = clWindowText
                Font.Height = -11
              ...
              object Label37: TLabel
                ...
                AutoSize = False
                BiDiMode = bdLeftToRight
                Caption = 'T'#237'tulos/Cheques da Baixa'
                Color = 14342874
                Font.Charset = DEFAULT_CHARSET
                Font.Color = clWindowText
                Font.Height = -11
              ...
              object grdTitDaBaixa: TwwDBGrid
                Left = 0
                Top = 110
                Width = 431
                Height = 117
                Selected.Strings = (
                  'che_banco'#9'5'#9'Banco'
                  'che_agencia'#9'8'#9'Ag'#234'ncia'
                  'che_conta'#9'10'#9'Conta'
                  'che_cheque'#9'12'#9'Nro do cheque'
                  'dta_vencimento'#9'10'#9'Vencimento'
                  'vlr_pagamento'#9'9'#9'Valor'
                  'che_emitente'#9'50'#9'Emitente')
                IniAttributes.Delimiter = ';;'
                IniAttributes.UnicodeIniFile = False
                TitleColor = clBtnFace
                FixedCols = 0
              ...
              object grdBaixasDoCheque: TwwDBGrid
                Left = 0
                Top = 20
                Width = 431
                Height = 70
                Selected.Strings = (
                  'id_baixa'#9'10'#9'Baixa'
                  'dta_baixa'#9'10'#9'Data'
                  'int_nomecli'#9'16'#9'Cliente'
                  'int_nomefpg'#9'13'#9'Forma de Pgto'
                  'vlr_baixa'#9'13'#9'Valor')
                IniAttributes.Delimiter = ';;'
                IniAttributes.UnicodeIniFile = False
                TitleColor = clBtnFace
                FixedCols = 0
            ...
            object Panel3: TPanel
              ...
              object Label34: TLabel
                ...
                AutoSize = False
                BiDiMode = bdLeftToRight
                Caption = 'Informa'#231#245'es do(s) cheque(s) encontrado'
                Color = 14342874
                Font.Charset = DEFAULT_CHARSET
                Font.Color = clWindowText
                Font.Height = -11
              ...
              object gbFiltroChq: TGroupBox
                Left = 0
                Top = 0
                Width = 348
                Height = 49
                Align = alTop
                Caption = ' Digite o nro do cheque para que o sistema localize a O.F '
                TabOrder = 0
                object txtNroCheque: TEdit
                  Left = 13
                  Top = 20
                  Width = 121
                  Height = 21
                ...
                object btnFiltrarChqOF: TButton
                  Left = 140
                  Top = 19
                  Width = 60
                  Height = 21
                  Caption = 'Filtrar'
                  TabOrder = 1
                  OnClick = btnFiltrarChqOFClick
                end
              end
              object grdCheques: TwwDBGrid
                Left = 0
                Top = 69
                Width = 348
                Height = 158
                Selected.Strings = (
                  'id_titulo'#9'7'#9'T'#237'tulo'#9'F'#9
                  'id_cliente'#9'6'#9'C'#243'd.'#9#9
                  'int_nomecli'#9'11'#9'Cliente'#9#9
                  'che_cheque'#9'13'#9'Nro do Cheque'#9#9
                  'dta_vencimento'#9'10'#9'Vencimento'#9#9
                  'dta_emissao'#9'10'#9'Emiss'#227'o'#9#9
                  'vlr_parcela'#9'19'#9'Valor'#9#9
                  'che_conta'#9'10'#9'Conta'#9#9
                  'che_banco'#9'10'#9'Banco'#9#9
                  'che_agencia'#9'10'#9'Ag'#234'ncia'#9#9
                  'int_nomefpg'#9'30'#9'Forma de Pgto'#9#9
                  'che_emitente'#9'50'#9'Emitente'#9#9)
                IniAttributes.Delimiter = ';;'
                IniAttributes.UnicodeIniFile = False
                TitleColor = clBtnFace
                FixedCols = 0
            ...
            object Panel8: TPanel
              ...
              object grdChqOFs: TwwDBGrid
                ...
                Selected.Strings = (
                  'id_ors'#9'10'#9'O.F'
                  'dta_emissao'#9'10'#9'Emiss'#227'o'
                  'id_pedido'#9'8'#9'Pedido'
                  'int_nomecli'#9'10'#9'Cliente'
                  'vlr_liquido'#9'11'#9'Valor')
                IniAttributes.Delimiter = ';;'
                IniAttributes.UnicodeIniFile = False
                TitleColor = clBtnFace
                FixedCols = 0
  ...
  object dsOFPrestCta: TwwDataSource
    DataSet = cdsOFPrestCta
    OnStateChange = dsoStateChange
    Left = 643
    Top = 227
  end
  object dsOFPrestCtaAberto: TwwDataSource
    DataSet = cdsOFPrestCtaAberto
    OnStateChange = dsoStateChange
    Left = 955
    Top = 171
  end
  object cdsOFs: TClientDataSet
    PersistDataPacket.Data = {
      
      0000}
    Active = True
    Aggregates = <>
    FieldDefs = <
    ...
    Left = 218
    Top = 169
    object cdsOFsid_ors: TIntegerField
      DisplayLabel = 'O.F'
      DisplayWidth = 12
      FieldName = 'id_ors'
    end
    object cdsOFsdta_emissao: TDateField
      DisplayLabel = 'Emiss'#227'o'
      DisplayWidth = 13
      FieldName = 'dta_emissao'
    end
    object cdsOFsid_pedido: TIntegerField
      DisplayLabel = 'Pedido'
      DisplayWidth = 14
      FieldName = 'id_pedido'
    end
    object cdsOFsvlr_liquido: TFMTBCDField
      DisplayLabel = 'Valor'
      DisplayWidth = 16
  ...
  object cdsOFPrestCta: TClientDataSet
    PersistDataPacket.Data = {
      
      000557494454480200020020000000}
    Active = True
    Aggregates = <>
    Params = <>
    Left = 466
    Top = 209
    object cdsOFPrestCtaid_ors: TIntegerField
      DisplayLabel = 'O.F'
      DisplayWidth = 10
      FieldName = 'id_ors'
    end
    object cdsOFPrestCtadta_emissao: TDateField
      DisplayLabel = 'Emiss'#227'o'
      DisplayWidth = 15
      FieldName = 'dta_emissao'
    end
    object cdsOFPrestCtaid_pedido: TIntegerField
      DisplayLabel = 'Pedido'
      DisplayWidth = 18
      FieldName = 'id_pedido'
    end
    object cdsOFPrestCtavlr_liquido: TFMTBCDField
      DisplayLabel = 'Valor'
      DisplayWidth = 14
      FieldName = 'vlr_liquido'
      DisplayFormat = '###,###,###,##0.00'
    end
    object cdsOFPrestCtavlr_saldo: TFMTBCDField
      DisplayWidth = 10
      FieldName = 'vlr_saldo'
      Visible = False
      DisplayFormat = '###,###,###,##0.00'
  ...
  object cdsOFPrestCtaAberto: TClientDataSet
    PersistDataPacket.Data = {
      AB0000009619E0BD020000001800000005000000000003000000AB000669645F
      6F727304000100000000000B6474615F656D697373616F040006000000000009
      69645F70656469646F04000100000000000B766C725F6C69717569646F120012
    ...
    Left = 842
    Top = 169
    object cdsOFPrestCtaAbertoid_ors: TIntegerField
      DisplayLabel = 'O.F'
      DisplayWidth = 6
      FieldName = 'id_ors'
    end
    object cdsOFPrestCtaAbertodta_emissao: TDateField
      DisplayLabel = 'Emiss'#227'o'
      DisplayWidth = 10
      FieldName = 'dta_emissao'
    end
    object cdsOFPrestCtaAbertoid_pedido: TIntegerField
      DisplayLabel = 'Pedido'
      DisplayWidth = 10
      FieldName = 'id_pedido'
    end
    object cdsOFPrestCtaAbertovlr_liquido: TFMTBCDField
      DisplayLabel = 'Valor'
      DisplayWidth = 10
      FieldName = 'vlr_liquido'
      DisplayFormat = '###,###,###,##0.00'
    end
    object cdsOFPrestCtaAbertovlr_saldo: TFMTBCDField
      DisplayLabel = 'Saldo aberto'
      DisplayWidth = 12
      FieldName = 'vlr_saldo'
      DisplayFormat = '###,###,###,##0.00'
    end
  end
  object dsTotTitPresCta: TwwDataSource
    DataSet = cdsTotTitPresCta
    OnStateChange = dsoStateChange
    Left = 163
    Top = 598
  end
  object dsTotTitAberto: TwwDataSource
    DataSet = cdsTotTitAberto
    OnStateChange = dsoStateChange
    Left = 291
    Top = 595
  end
  object dsTotChqDev: TwwDataSource
    DataSet = cdsTotChqDev
    OnStateChange = dsoStateChange
    Left = 891
    Top = 603
  end
  object grdTotTitPagos: TwwDataSource
    DataSet = cdsTotTitPagos
    OnStateChange = dsoStateChange
    Left = 59
    Top = 539
  end
  object cdsTotTitPresCta: TClientDataSet
    PersistDataPacket.Data = {
      
      645F6F727304000100000000000000}
    Active = True
    Aggregates = <>
    FieldDefs = <
      item
    ...
    Left = 58
    Top = 599
    object cdsTotTitPresCtadescricao: TWideStringField
      DisplayLabel = 'Forma'
      DisplayWidth = 9
      FieldName = 'descricao'
      Size = 30
    end
    object cdsTotTitPresCtanum_parcela: TWideStringField
      DisplayLabel = 'Nro parcela'
      DisplayWidth = 9
      FieldName = 'num_parcela'
    end
    object cdsTotTitPresCtadta_vencimento: TDateField
      DisplayLabel = 'Vencimento'
      DisplayWidth = 10
      FieldName = 'dta_vencimento'
    end
    object cdsTotTitPresCtavlr_saldo: TFMTBCDField
      DisplayLabel = 'Vlr. Saldo'
      DisplayWidth = 10
      FieldName = 'vlr_saldo'
      DisplayFormat = '###,###,###,##0.00'
    end
    object cdsTotTitPresCtaid_ors: TIntegerField
      FieldName = 'id_ors'
      Visible = False
    end
  end
  object cdsTotTitAberto: TClientDataSet
    PersistDataPacket.Data = {
      
      645F6F727304000100000000000000}
    Active = True
    Aggregates = <>
    FieldDefs = <
    ...
    Left = 379
    Top = 599
    object cdsTotTitAbertodescricao: TWideStringField
      DisplayLabel = 'Forma'
      DisplayWidth = 12
      FieldName = 'descricao'
      Size = 30
    end
    object cdsTotTitAbertonum_parcela: TWideStringField
      DisplayLabel = 'Nro cheque'
      DisplayWidth = 10
      FieldName = 'num_parcela'
    end
    object cdsTotTitAbertodta_vencimento: TDateField
      DisplayLabel = 'Vencimento'
      DisplayWidth = 10
      FieldName = 'dta_vencimento'
    end
    object cdsTotTitAbertovlr_saldo: TFMTBCDField
      DisplayLabel = 'Vlr. Saldo'
      DisplayWidth = 9
      FieldName = 'vlr_saldo'
      DisplayFormat = '###,###,###,##0.00'
    end
    object cdsTotTitAbertoid_ors: TIntegerField
      FieldName = 'id_ors'
      Visible = False
    end
  end
  object cdsTotChqDev: TClientDataSet
    PersistDataPacket.Data = {
      
      00020008000557494454480200020020000000}
    Active = True
    Aggregates = <>
    Params = <>
    Left = 985
    Top = 607
    object cdsTotChqDevdescricao: TWideStringField
      DisplayLabel = 'Forma'
      DisplayWidth = 6
      FieldName = 'descricao'
      Size = 30
    end
    object cdsTotChqDevche_cheque: TIntegerField
      DisplayLabel = 'Nro cheque'
      DisplayWidth = 10
      FieldName = 'che_cheque'
    end
    object cdsTotChqDevdta_vencimento: TDateField
      DisplayLabel = 'Vencimento'
      DisplayWidth = 10
      FieldName = 'dta_vencimento'
    end
    object cdsTotChqDevvlr_saldo: TFMTBCDField
      DisplayLabel = 'Valor'
      DisplayWidth = 8
      FieldName = 'vlr_saldo'
    end
  end
  object cdsTotTitPagos: TClientDataSet
    PersistDataPacket.Data = {
      
      000000}
    Active = True
    Aggregates = <>
    FieldDefs = <
    ...
    Left = 928
    Top = 551
    object cdsTotTitPagosdescricao: TWideStringField
      DisplayLabel = 'Forma'
      DisplayWidth = 11
      FieldName = 'descricao'
      Size = 30
    end
    object cdsTotTitPagosnum_parcela: TWideStringField
      DisplayLabel = 'Parcela/Chq'
      DisplayWidth = 10
      FieldName = 'num_parcela'
      Size = 0
    end
    object cdsTotTitPagosdta_pagamento: TDateField
      DisplayLabel = 'Pago em'
      DisplayWidth = 10
      FieldName = 'dta_pagamento'
    end
    object cdsTotTitPagosvlr_pagamento: TFMTBCDField
      DisplayLabel = 'Valor pago'
      DisplayWidth = 10
      FieldName = 'vlr_pagamento'
    end
  end
  object dsTotChqDepositar: TDataSource
    DataSet = cdsTotChqDepositar
    Left = 632
    Top = 600
  end
  object cdsTotChqDepositar: TClientDataSet
    PersistDataPacket.Data = {
      8F0000009619E0BD0200000018000000040000000000030000008F0009646573
      63726963616F01004A0000000100055749445448020002003C000A6368655F63
      686571756504000100000000000E6474615F76656E63696D656E746F04000600
    ...
    Left = 736
    Top = 600
    object cdsTotChqDepositardescricao: TWideStringField
      DisplayLabel = 'Forma'
      DisplayWidth = 12
      FieldName = 'descricao'
      Size = 30
    end
    object cdsTotChqDepositarche_cheque: TIntegerField
      DisplayLabel = 'Nro cheque'
      DisplayWidth = 10
      FieldName = 'che_cheque'
    end
    object cdsTotChqDepositardta_vencimento: TDateField
      DisplayLabel = 'Vencimento'
      DisplayWidth = 10
      FieldName = 'dta_vencimento'
    end
    object cdsTotChqDepositarvlr_saldo: TFMTBCDField
      DisplayLabel = 'Valor'
      DisplayWidth = 9
      FieldName = 'vlr_saldo'
    end
  end
  object pmTitPrestCta: TPopupMenu
    Left = 150
    Top = 543
    object LocalizarOF1: TMenuItem
      Caption = 'Localizar O.F'
      OnClick = LocalizarOF1Click
    end
  end
  object pmTitAberto: TPopupMenu
    Left = 814
    Top = 547
    object LocalizarOF2: TMenuItem
      Caption = 'Localizar O.F'
      OnClick = LocalizarOF2Click
    end
  end
  object pmOFsPrestCta: TPopupMenu
    Left = 544
    Top = 246
    object Visualizarbaixas1: TMenuItem
      Caption = 'Visualizar baixa(s)'
      OnClick = Visualizarbaixas1Click
    end
  end
  object FIN_PD_M_RBX: TfrxPDFExport
    UseFileCache = True
    ShowProgress = True
  ...
  object FIN_XL_M_RBX: TfrxXLSExport
    UseFileCache = True
    ShowProgress = True
    OverwritePrompt = False
    DataOnly = False
  ...
  object FIN_DB_M_RBX_GER: TfrxDBDataset
    UserName = 'FIN_DB_M_RBX_GER'
    ...
    FieldAliases.Strings = (
      ...
      'che_conta=che_conta'
      'che_cheque=che_cheque'
      'che_banco=che_banco'
      'che_emitente=che_emitente'
      'che_agencia=che_agencia')
    DataSet = dmGeral.FIN_CD_M_RBX_GER
    BCDToCurrency = False
    Left = 50
    Top = 280
  end
  object FIN_DB_M_RBX: TfrxDBDataset
    UserName = 'FIN_DB_M_RBX'
    OnCheckEOF = FIN_DB_M_RBXCheckEOF
    CloseDataSource = False
    DataSet = dmGeral.FIN_CD_M_RBX
    BCDToCurrency = False
    Left = 162
    Top = 280
  end
  object FIN_DB_M_RBX_TIT: TfrxDBDataset
    UserName = 'FIN_DB_M_RBX_TIT'
    CloseDataSource = False
    FieldAliases.Strings = (
      'id_baixa=id_baixa'
      'id_titulo=id_titulo'
    ...
    DataSet = dmGeral.FIN_CD_M_RBX_TIT
    BCDToCurrency = False
    Left = 290
    Top = 280
  end
  object FIN_FR_M_RBX: TfrxReport
    Version = '5.1.9'
    ...
    Datasets = <
      ...
      item
        DataSet = FIN_DB_M_RBX
        DataSetName = 'FIN_DB_M_RBX'
      end
      item
        DataSet = FIN_DB_M_RBX_GER
        DataSetName = 'FIN_DB_M_RBX_GER'
      end
      item
        DataSet = FIN_DB_M_RBX_TIT
        DataSetName = 'FIN_DB_M_RBX_TIT'
      end>
    Variables = <
      item
        Name = ' Externo'
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo6: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'Recebemos do Sr('#170'), [Uppercase(<FIN_DB_M_RBX."int_nomecli">)], o' +
              ' valor de ([FIN_DB_M_RBX."vlr_baixa" #n%2,2n]),'
        ...
        object Memo16: TfrxMemoView
          Left = 565.401980000000000000
          Top = 70.543290000000000000
      ...
      object DetailData1: TfrxDetailData
        ...
        object FIN_DB_M_RBX_TITid_titulo: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FIN_DB_M_RBX_TIT."id_titulo"]')
          ParentFont = False
        end
        object FIN_DB_M_RBX_TITdta_vencimento: TfrxMemoView
          Left = 165.543307086614200000
          Width = 60.472480000000000000
          Height = 15.118120000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[FIN_DB_M_RBX_TIT."dta_vencimento"]')
          ParentFont = False
        end
        object FIN_DB_M_RBX_TITvlr_titulo: TfrxMemoView
          Left = 315.212598425196900000
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FIN_DB_M_RBX_TIT."vlr_titulo"]')
          ParentFont = False
        end
        object FIN_DB_M_RBX_TITvlr_desconto: TfrxMemoView
          Left = 382.110236220472400000
          Width = 64.252010000000000000
          Height = 15.118120000000000000
        ...
        object FIN_DB_M_RBX_TITvlr_cred_utilizado: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FIN_DB_M_RBX_TIT."vlr_cred_utilizado"]')
          ParentFont = False
        end
        object FIN_DB_M_RBX_TITvlr_pagamento: TfrxMemoView
          Left = 579.401574803149600000
          Width = 64.252010000000000000
          Height = 15.118120000000000000
          DataSet = FIN_DB_M_RBX_TIT
          DataSetName = 'FIN_DB_M_RBX_TIT'
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FIN_DB_M_RBX_TIT."vlr_pagamento"]')
          ParentFont = False
        end
        object FIN_DB_M_RBXdta_baixa: TfrxMemoView
          Left = 228.661417322834600000
          Width = 83.149660000000000000
          Height = 15.118120000000000000
          DataField = 'dta_baixa'
          DataSet = FIN_DB_M_RBX
        ...
        object FIN_DB_M_RBX_TITint_numeronf: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[FIN_DB_M_RBX_TIT."int_numeronf"]')
          ParentFont = False
        end
        object FIN_DB_M_RBX_TITvlr_restante: TfrxMemoView
      ...
      object Footer2: TfrxFooter
        ...
        object Memo19: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'Pagamento efetuado com [FIN_DB_M_RBX."int_nomefpg"] em [FIN_DB_M' +
              '_RBX."dta_baixa"]')
          ParentFont = False
        end
        object FIN_DB_M_RBXobservacao: TfrxMemoView
        ...
        object FIN_DB_M_RBXobservacao1: TfrxMemoView
          Left = 78.724490000000000000
          Top = 3.338590000000000000
      ...
      object DetailData5: TfrxDetailData
        ...
        object Memo67: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FIN_DB_M_RBX_GER."vlr_pagamento"]')
          ParentFont = False
        end
        object Memo68: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[FIN_DB_M_RBX_GER."dta_vencimento"]')
          ParentFont = False
        end
        object Memo69: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FIN_DB_M_RBX_GER."che_banco"]')
          ParentFont = False
        end
        object Memo70: TfrxMemoView
          Left = 160.496062990000000000
        ...
        object Memo72: TfrxMemoView
          Left = 209.007874015748000000
          Width = 49.133858270000000000
          Height = 15.118120000000000000
          DataField = 'che_cheque'
          DataSet = FIN_DB_M_RBX_GER
          DataSetName = 'FIN_DB_M_RBX_GER'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FIN_DB_M_RBX_GER."che_cheque"]')
          ParentFont = False
        end
        object Memo73: TfrxMemoView
          Left = 261.543307086614000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[FIN_DB_M_RBX_GER."che_emitente"]')
          ParentFont = False
        end
      end
      object Header7: TfrxHeader
        FillType = ftBrush
        Height = 22.456700240000000000
  ...
  object FIN_FR_M_RBX_DNR: TfrxReport
    Version = '5.1.9'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick]
  ...
  object dsChqOFs: TDataSource
    DataSet = PCP_CD_M_ORS
    Left = 528
    Top = 445
  end
  object dsCheques: TDataSource
    DataSet = BUS_CD_M_REC
    Left = 248
    Top = 541
  end
  object dsBaixasDoCheque: TDataSource
    DataSet = FIN_CD_M_RBX
    Left = 880
    Top = 413
  end
  object dsTitDaBaixa: TDataSource
    DataSet = FIN_CD_M_RBX_GER
    Left = 872
    Top = 533
  end
  object FIN_CD_M_RBX: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'FIN_DP_M_RBX'
    RemoteServer = dmGeral.pcConecao
    Left = 760
    Top = 408
    object FIN_CD_M_RBXid_baixa: TIntegerField
      DisplayLabel = 'Baixa'
      DisplayWidth = 10
      FieldName = 'id_baixa'
    end
    object FIN_CD_M_RBXdta_baixa: TDateField
      DisplayLabel = 'Data'
      DisplayWidth = 10
      FieldName = 'dta_baixa'
    end
    object FIN_CD_M_RBXint_nomecli: TWideStringField
    ...
    object FIN_CD_M_RBXint_nomefpg: TWideStringField
    ...
    object FIN_CD_M_RBXvlr_baixa: TFMTBCDField
      DisplayLabel = 'Valor'
      DisplayWidth = 13
      FieldName = 'vlr_baixa'
      DisplayFormat = '###,###,###,##0.00'
    ...
    object FIN_CD_M_RBXid_empresa: TIntegerField
      DisplayWidth = 10
      FieldName = 'id_empresa'
      Visible = False
    end
    object FIN_CD_M_RBXobservacao: TWideStringField
      DisplayWidth = 100
      FieldName = 'observacao'
      Visible = False
      Size = 100
    end
    object FIN_CD_M_RBXvlr_cred_utilizado: TFMTBCDField
      DisplayWidth = 19
      FieldName = 'vlr_cred_utilizado'
      Visible = False
      Precision = 18
      Size = 4
    end
    object FIN_CD_M_RBXid_forma_pag: TIntegerField
      DisplayWidth = 10
      FieldName = 'id_forma_pag'
      Visible = False
    end
    object FIN_CD_M_RBXid_abertura: TIntegerField
      DisplayWidth = 10
      FieldName = 'id_abertura'
      Visible = False
    end
    object FIN_CD_M_RBXid_cliente: TIntegerField
      DisplayWidth = 10
      FieldName = 'id_cliente'
      Visible = False
    end
    object FIN_CD_M_RBXFIN_SQ_M_RBX_GER: TDataSetField
      DisplayWidth = 10
      FieldName = 'FIN_SQ_M_RBX_GER'
      Visible = False
    end
    object FIN_CD_M_RBXFIN_SQ_M_RBX_TIT: TDataSetField
      DisplayWidth = 10
      FieldName = 'FIN_SQ_M_RBX_TIT'
      Visible = False
    end
    object FIN_CD_M_RBXcod_lme: TWideStringField
      DisplayWidth = 20
      FieldName = 'cod_lme'
      Visible = False
    end
    object FIN_CD_M_RBXrev_lme: TWideStringField
      Alignment = taRightJustify
      DisplayWidth = 5
      FieldName = 'rev_lme'
      Visible = False
    ...
    object FIN_CD_M_RBXid_conta: TIntegerField
      DisplayWidth = 10
      FieldName = 'id_conta'
      Visible = False
    end
    object FIN_CD_M_RBXid_tipo_financeiro: TIntegerField
      DisplayWidth = 10
      FieldName = 'id_tipo_financeiro'
      Visible = False
    end
    object FIN_CD_M_RBXid_plano: TWideStringField
      DisplayWidth = 11
      FieldName = 'id_plano'
      Visible = False
      Size = 11
    end
    object FIN_CD_M_RBXid_ccusto: TIntegerField
      DisplayWidth = 10
      FieldName = 'id_ccusto'
      Visible = False
    end
    object FIN_CD_M_RBXvlr_saldo_credito: TFMTBCDField
      DisplayWidth = 19
      FieldName = 'vlr_saldo_credito'
      Visible = False
      Precision = 18
      Size = 4
    end
    object FIN_CD_M_RBXvlr_credito_disponivel: TFMTBCDField
      DisplayWidth = 19
      FieldName = 'vlr_credito_disponivel'
      Visible = False
      Precision = 18
      Size = 4
    end
    object FIN_CD_M_RBXid_responsavel: TIntegerField
      DisplayWidth = 10
      FieldName = 'id_responsavel'
      Visible = False
    end
    object FIN_CD_M_RBXdta_lancamento: TDateField
      DisplayWidth = 10
      FieldName = 'dta_lancamento'
      Visible = False
    end
    object FIN_CD_M_RBXint_nomeres: TWideStringField
      DisplayWidth = 50
    ...
    object FIN_CD_M_RBXint_nomeccu: TWideStringField
      DisplayWidth = 30
    ...
    object FIN_CD_M_RBXid_maquineta: TIntegerField
      DisplayWidth = 10
      FieldName = 'id_maquineta'
      Visible = False
    end
    object FIN_CD_M_RBXid_recibo: TIntegerField
      DisplayWidth = 10
      FieldName = 'id_recibo'
      Visible = False
    end
    object FIN_CD_M_RBXvlr_a_pagar: TFMTBCDField
      DisplayWidth = 19
      FieldName = 'vlr_a_pagar'
      Visible = False
      Precision = 18
      Size = 4
    end
    object FIN_CD_M_RBXvlr_pago_ger: TFMTBCDField
      DisplayWidth = 19
      FieldName = 'vlr_pago_ger'
      Visible = False
      Precision = 18
      Size = 4
    end
    object FIN_CD_M_RBXvlr_tot_ger: TFMTBCDField
      DisplayWidth = 19
      FieldName = 'vlr_tot_ger'
      Visible = False
      Precision = 18
      Size = 4
    end
  end
  object FIN_CD_M_RBX_GER: TClientDataSet
    Aggregates = <>
    DataSetField = FIN_CD_M_RBXFIN_SQ_M_RBX_GER
    Params = <>
    Left = 760
    Top = 504
    object FIN_CD_M_RBX_GERche_banco: TWideStringField
      DisplayLabel = 'Banco'
      DisplayWidth = 5
      FieldName = 'che_banco'
      Size = 10
    end
    object FIN_CD_M_RBX_GERche_agencia: TWideStringField
      DisplayLabel = 'Ag'#234'ncia'
      DisplayWidth = 8
      FieldName = 'che_agencia'
      Size = 10
    end
    object FIN_CD_M_RBX_GERche_conta: TIntegerField
      DisplayLabel = 'Conta'
      DisplayWidth = 10
      FieldName = 'che_conta'
    end
    object FIN_CD_M_RBX_GERche_cheque: TIntegerField
      DisplayLabel = 'Nro do cheque'
      DisplayWidth = 12
      FieldName = 'che_cheque'
    end
    object FIN_CD_M_RBX_GERdta_vencimento: TDateField
      DisplayLabel = 'Vencimento'
      DisplayWidth = 10
      FieldName = 'dta_vencimento'
    end
    object FIN_CD_M_RBX_GERvlr_pagamento: TFMTBCDField
      DisplayLabel = 'Valor'
      DisplayWidth = 9
      FieldName = 'vlr_pagamento'
      DisplayFormat = '###,###,###,##0.00'
    ...
    object FIN_CD_M_RBX_GERche_emitente: TWideStringField
  ...
  object PCP_CD_M_ORS: TClientDataSet
    Aggregates = <>
    Params = <>
    ...
    Left = 562
    Top = 498
    object PCP_CD_M_ORSid_ors: TIntegerField
      DisplayLabel = 'O.F'
      DisplayWidth = 10
      FieldName = 'id_ors'
    end
    object PCP_CD_M_ORSdta_emissao: TDateField
      DisplayLabel = 'Emiss'#227'o'
      DisplayWidth = 10
      FieldName = 'dta_emissao'
    end
    object PCP_CD_M_ORSid_pedido: TIntegerField
      DisplayLabel = 'Pedido'
      DisplayWidth = 8
      FieldName = 'id_pedido'
    end
    object PCP_CD_M_ORSint_nomecli: TWideStringField
      DisplayLabel = 'Cliente'
      DisplayWidth = 10
      FieldName = 'int_nomecli'
      ProviderFlags = []
    ...
    object PCP_CD_M_ORSvlr_liquido: TFMTBCDField
      DisplayLabel = 'Valor'
      DisplayWidth = 11
      FieldName = 'vlr_liquido'
      Precision = 18
  ...
  object BUS_CD_M_REC: TClientDataSet
    ...
    Left = 344
    Top = 540
    object BUS_CD_M_RECid_titulo: TIntegerField
      DisplayLabel = 'T'#237'tulo'
      DisplayWidth = 7
      FieldName = 'id_titulo'
    end
    object BUS_CD_M_RECid_cliente: TIntegerField
      DisplayLabel = 'C'#243'd.'
      DisplayWidth = 6
      FieldName = 'id_cliente'
    end
    object BUS_CD_M_RECint_nomecli: TWideStringField
      DisplayLabel = 'Cliente'
      DisplayWidth = 11
      FieldName = 'int_nomecli'
      ProviderFlags = []
    ...
    object BUS_CD_M_RECche_cheque: TIntegerField
      DisplayLabel = 'Nro do Cheque'
      DisplayWidth = 13
      FieldName = 'che_cheque'
    end
    object BUS_CD_M_RECdta_vencimento: TDateField
      DisplayLabel = 'Vencimento'
      DisplayWidth = 10
      FieldName = 'dta_vencimento'
    end
    object BUS_CD_M_RECdta_emissao: TDateField
      DisplayLabel = 'Emiss'#227'o'
      DisplayWidth = 10
      FieldName = 'dta_emissao'
    end
    object BUS_CD_M_RECvlr_parcela: TFMTBCDField
      DisplayLabel = 'Valor'
      DisplayWidth = 19
    ...
    object BUS_CD_M_RECche_conta: TIntegerField
      DisplayLabel = 'Conta'
      DisplayWidth = 10
      FieldName = 'che_conta'
    end
    object BUS_CD_M_RECche_banco: TWideStringField
      DisplayLabel = 'Banco'
      DisplayWidth = 10
      FieldName = 'che_banco'
      Size = 10
    end
    object BUS_CD_M_RECche_agencia: TWideStringField
      DisplayLabel = 'Ag'#234'ncia'
      DisplayWidth = 10
      FieldName = 'che_agencia'
      Size = 10
    end
    object BUS_CD_M_RECint_nomefpg: TWideStringField
      DisplayLabel = 'Forma de Pgto'
      DisplayWidth = 30
      FieldName = 'int_nomefpg'
      ProviderFlags = []
    ...
    object BUS_CD_M_RECche_emitente: TWideStringField
      DisplayLabel = 'Emitente'
      DisplayWidth = 50
      FieldName = 'che_emitente'
      Size = 50
    end
    object BUS_CD_M_REChistorico: TWideStringField
      DisplayWidth = 100
      FieldName = 'historico'
      Visible = False
      Size = 100
    end
    object BUS_CD_M_RECid_forma_pag: TIntegerField
      DisplayWidth = 10
      FieldName = 'id_forma_pag'
      Visible = False
    end
