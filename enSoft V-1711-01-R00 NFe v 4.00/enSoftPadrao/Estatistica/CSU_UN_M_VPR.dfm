inherited CSU_FM_M_VPR: TCSU_FM_M_VPR
  Caption = 'CSU_FM_M_VPR'
  ClientHeight = 612
  ExplicitTop = -70
  ExplicitWidth = 1156
  ExplicitHeight = 640
          ...
          object Panel1: TPanel
            ...
            object pnVendedor: TPanel
              ...
              object grdVendedor: TwwDBGrid
                ...
                OnRowChanged = grdVendedorRowChanged
                FixedCols = 0
            ...
            object pnDadosVend: TPanel
              ...
              ParentFont = False
              TabOrder = 1
              object pnDadosVen2Filtro: TPanel
                Left = 1
                Top = 328
                Width = 769
                Height = 232
                ...
                object wwDBGrid2: TwwDBGrid
                  ...
                  Width = 767
                  Height = 126
                  Hint = 'Clique com o direito do mouse para exibir a rota'
                  Selected.Strings = (
                    'emp_fantasia'#9'16'#9'Empresa'
                    'semana'#9'7'#9'Programada'#9'F'#9'Semana'
                    'semana_visitada'#9'10'#9'Visitada'#9'F'#9'Semana'
                    'dta_visita'#9'10'#9'Visitado em'
                    'nome_cli'#9'20'#9'Cliente'
                    'hor_ini'#9'7'#9'Hora ini'
                    'hor_fim'#9'7'#9'Hora fim'
                    'km_inicial'#9'8'#9'Km inicial'
                    'km_final'#9'9'#9'Km Final'
                    'placa'#9'8'#9'placa'#9'F'
                    'nome_carro'#9'12'#9'Carro'#9'F'
                    'gps_latitude'#9'10'#9'Latitude'
                    'gps_longitude'#9'10'#9'Longitude'
                    'obs'#9'100'#9'Obs')
                  IniAttributes.Delimiter = ';;'
                  IniAttributes.UnicodeIniFile = False
                  TitleColor = clBtnFace
                ...
                object wwDBGrid8: TwwDBGrid
                  ...
                  Width = 767
                  Height = 67
                  Hint = 'Clique com o direito do  mouse para exbir as fotos'
                  Selected.Strings = (
                    'caminho_foto'#9'120'#9'Foto'#9'F'
                    'obs'#9'57'#9'Obs'#9#9)
                  IniAttributes.Delimiter = ';;'
                  IniAttributes.UnicodeIniFile = False
                  TitleColor = clBtnFace
              ...
              object Panel2: TPanel
                ...
                object lblAliquotasTaxas: TLabel
                  ...
                  Alignment = taCenter
                  AutoSize = False
                  Caption = 'Per'#237'odo de visitas'
                  Color = 14342874
                  Font.Charset = ANSI_CHARSET
                  Font.Color = clBtnText
                  Font.Height = -11
                ...
                object rgFiltrar: TRadioGroup
                  ...
                  Width = 207
                  Height = 66
                  Caption = ' Filtrar dados do vendedor por'
                  Columns = 2
                  Font.Charset = ANSI_CHARSET
                  Font.Color = clBtnText
                  Font.Height = -11
              ...
              object pnDadosVen1: TPanel
                ...
                object Panel3: TPanel
                  ...
                  object Label11: TLabel
                    ...
                    Width = 187
                    Height = 13
                    Caption = 'Clientes visitados fora da programa'#231#227'o'
                    Font.Charset = ANSI_CHARSET
                    Font.Color = clBtnText
                    Font.Height = -11
                    Font.Name = 'Tahoma'
                  ...
                  object txtQtdPed: TJvValidateEdit
                    Left = 7
                    Top = 24
                    Width = 95
                    Height = 21
                  ...
                  object txtDescTotalPed: TJvValidateEdit
                    Left = 106
                    Top = 24
                    Width = 80
                    Height = 21
                  ...
                  object txtValorPedidos: TJvValidateEdit
                    Left = 192
                    Top = 24
                    Width = 92
                    Height = 21
                  ...
                  object txtQtdVis: TJvValidateEdit
                    Left = 290
                    Top = 24
                    Width = 89
                    Height = 21
                  ...
                  object txtQtdCliProg: TJvValidateEdit
                    Left = 385
                    Top = 24
                    Width = 166
                    Height = 21
                  ...
                  object txtQtdCliForaProg: TJvValidateEdit
                    Left = 557
                    Top = 24
                    Width = 190
                    Height = 21
                    ...
                    object TabSheet1: TTabSheet
                      ...
                      object Panel5: TPanel
                        ...
                        object wwDBGrid1: TwwDBGrid
                          ...
                          Height = 105
                          Selected.Strings = (
                            'id_cliente'#9'10'#9'C'#243'digo'
                            'nome'#9'27'#9'Nome'
                            'endereco'#9'30'#9'Endere'#231'o'
                            'bairro'#9'40'#9'Bairro'
                            'cep'#9'9'#9'CEP'
                            'numero'#9'10'#9'Nro'
                            'tel_fixo'#9'14'#9'Fone Fixo'
                            'tel_movel'#9'14'#9'Celular'
                            'doc_cnpj_cpf'#9'14'#9'Cnpj/Cpf'
                            'int_nomecid'#9'15'#9'Cidade'
                            'int_uf'#9'2'#9'UF')
                          IniAttributes.Delimiter = ';;'
                          IniAttributes.UnicodeIniFile = False
                          TitleColor = clBtnFace
                      ...
                      object Panel6: TPanel
                        ...
                        object Label17: TLabel
                          ...
                          Alignment = taCenter
                          AutoSize = False
                          Caption = 'Clientes Programados Visitados'
                          Color = 15003062
                          Font.Charset = ANSI_CHARSET
                          Font.Color = clBtnText
                          Font.Height = -11
                    ...
                    object TabSheet2: TTabSheet
                      ...
                      object Panel8: TPanel
                        ...
                        object wwDBGrid5: TwwDBGrid
                          ...
                          Selected.Strings = (
                            ...
                            'int_nomefpg'#9'15'#9'Forma de pagamento'#9'F'
                            'dta_vencimento'#9'10'#9'Vencimento'
                            'vlr_titulo'#9'19'#9'Valor')
                          IniAttributes.Delimiter = ';;'
                          IniAttributes.UnicodeIniFile = False
                          TitleColor = clBtnFace
                          FixedCols = 0
                      ...
                      object Panel9: TPanel
                        ...
                        object wwDBGrid6: TwwDBGrid
                          ...
                          Selected.Strings = (
                            ...
                            'int_id_und_venda'#9'3'#9'Und'#9#9
                            'qtde'#9'10'#9'Qtde'#9#9
                            'vlr_unitario'#9'19'#9'Vlr Unit'#225'rio'#9'F'
                            'vlr_bruto'#9'19'#9'Vlr Bruto'#9'F'
                            'vlr_desconto'#9'19'#9'Vlr. Desc'#9'F'
                            'vlr_liquido'#9'19'#9'Vlr Liqu'#237'do'#9'F')
                          IniAttributes.Delimiter = ';;'
                          IniAttributes.UnicodeIniFile = False
                          TitleColor = clBtnFace
                          FixedCols = 0
                      ...
                      object Panel10: TPanel
                        ...
                        object wwDBGrid7: TwwDBGrid
                          ...
                          Height = 105
                          Selected.Strings = (
                            'id_pedido'#9'10'#9'Pedido'#9#9
                            'int_nomecli'#9'15'#9'Cliente'#9'F'
                            'dta_pedido'#9'10'#9'Data'#9#9
                            'int_nomecpg'#9'20'#9'Condi'#231#227'o pgto'#9'F'
                            'vlr_liquido'#9'19'#9'Total'#9'F')
                          IniAttributes.Delimiter = ';;'
                          IniAttributes.UnicodeIniFile = False
                          TitleColor = clBtnFace
                          FixedCols = 0
  ...
  inherited pnlTop: TJvPanel
    inherited pnlCima: TJvPanel
      inherited lblTitulo: TLabel
        Caption = 'Estat'#237'sticas das Visitas a Produtores'
      end
    end
  end
  object pnFoto: TPanel [2]
    Left = 144
    Top = 219
    Width = 269
    Height = 353
  ...
  inherited imgBotoesAtivo: TImageList
    ...
    Top = 427
    Bitmap = {
      494C01010800A8008C0118001800FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesInativo: TImageList
    ...
    Top = 419
    Bitmap = {
      
  ...
  inherited ImgPequena: TImageList
    Left = 1075
    Bitmap = {
      494C010112000001DC010E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  object dsVend: TDataSource
    DataSet = dmGeral.BUS_CD_C_FUN_CRG_GER
    Left = 189
    Top = 202
  end
  object BUS_CD_C_VIT_CON: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'BUS_DP_C_VIT_CON'
    RemoteServer = dmGeral.pcConecao
    Left = 740
    Top = 418
    object BUS_CD_C_VIT_CONemp_fantasia: TWideStringField
      DisplayLabel = 'Empresa'
      DisplayWidth = 16
      FieldName = 'emp_fantasia'
      Size = 50
    end
    object BUS_CD_C_VIT_CONsemana: TIntegerField
      DisplayWidth = 7
      FieldName = 'semana'
    end
    object BUS_CD_C_VIT_CONdta_visita: TDateField
      DisplayLabel = 'Visitado em'
      DisplayWidth = 10
      FieldName = 'dta_visita'
    end
    object BUS_CD_C_VIT_CONnome_cli: TWideStringField
      DisplayLabel = 'Cliente'
      DisplayWidth = 20
      FieldName = 'nome_cli'
      Size = 50
    end
    object BUS_CD_C_VIT_CONhor_ini: TTimeField
      DisplayLabel = 'Hora ini'
      DisplayWidth = 7
      FieldName = 'hor_ini'
    end
    object BUS_CD_C_VIT_CONhor_fim: TTimeField
      DisplayLabel = 'Hora fim'
      DisplayWidth = 7
      FieldName = 'hor_fim'
    end
    object BUS_CD_C_VIT_CONkm_inicial: TFloatField
      DisplayLabel = 'Km inicial'
      DisplayWidth = 8
      FieldName = 'km_inicial'
    end
    object BUS_CD_C_VIT_CONkm_final: TFloatField
      DisplayLabel = 'Km Final'
      DisplayWidth = 9
      FieldName = 'km_final'
    end
    object BUS_CD_C_VIT_CONnome_carro: TWideStringField
      DisplayLabel = 'Carro'
      DisplayWidth = 20
      FieldName = 'nome_carro'
      Size = 50
    end
    object BUS_CD_C_VIT_CONgps_latitude: TFloatField
      DisplayLabel = 'Latitude'
      DisplayWidth = 10
      FieldName = 'gps_latitude'
    end
    object BUS_CD_C_VIT_CONgps_longitude: TFloatField
      DisplayLabel = 'Longitude'
      DisplayWidth = 10
      FieldName = 'gps_longitude'
    end
    object BUS_CD_C_VIT_CONobs: TWideStringField
      DisplayLabel = 'Obs'
      DisplayWidth = 100
      FieldName = 'obs'
      Size = 500
    end
    object BUS_CD_C_VIT_CONid_visita: TIntegerField
      DisplayLabel = 'Visita'
      DisplayWidth = 10
      FieldName = 'id_visita'
      Visible = False
    end
    object BUS_CD_C_VIT_CONid_vendedor: TIntegerField
      FieldName = 'id_vendedor'
      Visible = False
    end
    object BUS_CD_C_VIT_CONdoc_cnpj_cpf: TWideStringField
      FieldName = 'doc_cnpj_cpf'
      Visible = False
      Size = 14
    end
    object BUS_CD_C_VIT_CONid_veiculo: TIntegerField
      FieldName = 'id_veiculo'
      Visible = False
    end
    object BUS_CD_C_VIT_CONrecomendacoes: TWideStringField
      FieldName = 'recomendacoes'
      Visible = False
      Size = 500
    end
    object BUS_CD_C_VIT_CONid_empresa: TIntegerField
      FieldName = 'id_empresa'
      Visible = False
    end
    object BUS_CD_C_VIT_CONnome: TWideStringField
      FieldName = 'nome'
      Visible = False
      Size = 50
    end
    object BUS_CD_C_VIT_CONplaca: TWideStringField
      FieldName = 'placa'
      Visible = False
      Size = 8
    end
    object BUS_CD_C_VIT_CONid_pedido_mobile: TIntegerField
      FieldName = 'id_pedido_mobile'
      Visible = False
    end
    object BUS_CD_C_VIT_CONtipo_mobile: TIntegerField
      FieldName = 'tipo_mobile'
      Visible = False
    end
    object BUS_CD_C_VIT_CONBUS_SQ_C_VIT_FOT_CON: TDataSetField
      FieldName = 'BUS_SQ_C_VIT_FOT_CON'
      Visible = False
    end
    object BUS_CD_C_VIT_CONsemana_visitada: TIntegerField
      FieldName = 'semana_visitada'
    end
  end
  object pmDetalheVis: TPopupMenu
    Left = 468
    Top = 410
    object Exibirrota1: TMenuItem
      Caption = 'Exibir rota'
      OnClick = Exibirrota1Click
    end
  end
  object dsCliCar: TDataSource
    DataSet = cdsCliCar
    Left = 637
    Top = 273
  end
  object dsCliPro: TDataSource
    DataSet = cdsCliPro
    Left = 829
    Top = 273
  end
  object dsCliExt: TDataSource
    DataSet = cdsCliExt
    Left = 1005
    Top = 281
  end
  ...
  object cdsCliCar: TClientDataSet
    Aggregates = <>
    Params = <>
  ...
  object cdsCliPro: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'CAD_DP_C_CLI'
    RemoteServer = dmGeral.pcConecao
  ...
  object cdsCliExt: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'CAD_DP_C_CLI'
    RemoteServer = dmGeral.pcConecao
  ...
  object BUS_CD_C_VIT_FOT_CON: TClientDataSet
    Aggregates = <>
    DataSetField = BUS_CD_C_VIT_CONBUS_SQ_C_VIT_FOT_CON
    Params = <>
    Left = 647
    Top = 489
    object BUS_CD_C_VIT_FOT_CONcaminho_foto: TWideStringField
      DisplayLabel = 'Foto'
      DisplayWidth = 150
      FieldName = 'caminho_foto'
      Size = 255
    end
    object BUS_CD_C_VIT_FOT_CONobs: TWideStringField
      DisplayLabel = 'Obs'
      DisplayWidth = 100
      FieldName = 'obs'
      Size = 255
    end
    object BUS_CD_C_VIT_FOT_CONid_visita: TIntegerField
      DisplayWidth = 10
      FieldName = 'id_visita'
      Visible = False
    end
    object BUS_CD_C_VIT_FOT_CONid_vit_fot: TIntegerField
      DisplayWidth = 10
      FieldName = 'id_vit_fot'
      Visible = False
    end
  end
  object dsoVitFot: TwwDataSource
    DataSet = BUS_CD_C_VIT_FOT_CON
    OnStateChange = dsoStateChange
    Left = 819
    Top = 467
  end
  object pmDetalheVisFot: TPopupMenu
    Left = 548
    Top = 426
