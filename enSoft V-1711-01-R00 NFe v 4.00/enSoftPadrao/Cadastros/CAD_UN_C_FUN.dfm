inherited CAD_FM_C_FUN: TCAD_FM_C_FUN
  ...
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object gbSeguranca: TGroupBox
        ...
        TabOrder = 18
        object pcDadosInf: TPageControl
          Left = 2
          Top = 15
          Width = 749
          Height = 279
          ...
          object tsGeral: TTabSheet
            ...
            object ScrollBox1: TScrollBox
              ...
              object lblSenhaAnterior: TLabel
                Left = 10
                Top = 27
                Width = 83
                Height = 13
              ...
              object Label7: TLabel
                ...
                Width = 255
                Height = 13
                Caption = 'Altera pedido de venda em determinada situa'#231#227'o:'
              end
              object cbbPerfil: TwwDBLookupCombo
                ...
                DataField = 'id_perfil_seg'
                DataSource = dso
                LookupTable = dmGeral.BUS_CD_C_PES
                LookupField = 'id_perfil_seg'
                Options = [loColLines, loRowLines]
                TabOrder = 0
                AutoDropDown = False
                ShowButton = True
              ...
              object dpkExpiraEm: TJvDBDateEdit
                Left = 99
                Top = 47
                Width = 100
                Height = 21
                DataField = 'dta_senha_expira'
                DataSource = dso
                ShowNullDate = False
                TabOrder = 2
              end
              object chkAlteraLimiteCliente: TDBCheckBox
                Left = 20
                Top = 68
                Width = 173
                Height = 17
                Caption = 'Altera Limite de Cliente?'
                DataField = 'seg_alt_lim_cli'
                DataSource = dso
                TabOrder = 3
              end
              object dpkAlteraSituacaoCliente: TDBCheckBox
                Left = 20
                Top = 84
                Width = 173
                Height = 17
                Caption = 'Altera Situa'#231#227'o de Cliente?'
                DataField = 'seg_alt_sit_cli'
                DataSource = dso
                TabOrder = 4
              end
              object chkAlteraPrecoItens: TDBCheckBox
                Left = 20
                Top = 188
                Width = 189
                Height = 17
                Caption = 'Altera Pre'#231'o de Itens?'
                DataField = 'seg_alt_pre_pro'
                DataSource = dso
                TabOrder = 5
              end
              object chkHailitaotaoExclusao: TDBCheckBox
                Left = 282
                Top = 49
                Width = 239
                Height = 17
                Caption = 'Habilita Bot'#227'o de Exclus'#227'o do Funcion'#225'rio?'
                DataField = 'seg_hab_bot_exc'
                DataSource = dso
                TabOrder = 6
              end
              object txtSenhaAnterior: TEdit
                Left = 99
                Top = 24
                Width = 100
                Height = 21
              ...
              object txtConfirmarSenha: TEdit
                Left = 498
                Top = 24
                Width = 100
                Height = 21
              ...
              object DBCheckBox1: TDBCheckBox
                ...
                Width = 254
                Height = 17
                Caption = 'Exibi '#250'ltima compra do item na consulta(F3)'
                DataField = 'seg_vis_ult_cmp_ite'
                DataSource = dso
                TabOrder = 10
              end
              object DBCheckBox2: TDBCheckBox
                ...
                Width = 255
                Height = 17
                Caption = 'Permite Aprovar/Reprovar pedido de compra?'
                DataField = 'seg_apr_rep_cmp_ped'
                DataSource = dso
                TabOrder = 11
              end
              object chbPermitirCancelarOS: TDBCheckBox
                Left = 20
                Top = 114
                Width = 262
                Height = 17
                Caption = 'Permitir cancelar abertura de ordem de servi'#231'o?'
                DataField = 'seg_per_canc_orv'
                DataSource = dso
                TabOrder = 12
              end
              object chbRedefinirSenha: TDBCheckBox
                Left = 282
                Top = 97
                Width = 142
                Height = 17
                Caption = 'Redefinir Senha'
                DataField = 'seg_redef_senha'
                DataSource = dso
                TabOrder = 13
              end
              object chbHabBtnAltFun: TDBCheckBox
                Left = 282
                Top = 65
                Width = 249
                Height = 17
                Caption = 'Habilita Bot'#227'o de Altera'#231#227'o do Funcion'#225'rio?'
                DataField = 'seg_hab_bot_alt_fun'
                DataSource = dso
                TabOrder = 14
              end
              object DBCheckBox3: TDBCheckBox
                ...
                Height = 31
                Caption = 
                  'Exibi alerta dos pedidos de venda com prazo de entrega expirado ' +
                  '?'
                DataField = 'seq_vis_msg_ped_exp_fat'
                DataSource = dso
                TabOrder = 15
                WordWrap = True
              end
              object chkAPG: TDBCheckBox
                Left = 20
                Top = 157
                Width = 205
                Height = 17
                Caption = 'Exibir Agendamento de Pagamento'
                DataField = 'seg_ctc_apg'
                DataSource = dso
                TabOrder = 16
              end
              object chbAlterarVendedorPed: TDBCheckBox
                Left = 282
                Top = 81
                Width = 217
                Height = 17
                Caption = 'Altera Vendedor em Vendas ?'
                DataField = 'seg_alt_vend_ped'
                DataSource = dso
                TabOrder = 17
              end
              object chkEst: TDBCheckBox
                Left = 20
                Top = 172
                Width = 205
                Height = 17
                Caption = 'Exibir Estoque Minimo'
                DataField = 'seq_vis_alert_est_min'
                DataSource = dso
                TabOrder = 18
              end
              object chbExcluirCaixa: TDBCheckBox
                Left = 282
                Top = 114
                Width = 169
                Height = 17
                Caption = 'Excluir Qualquer Caixa'
                DataField = 'excluir_caixa'
                DataSource = dso
                TabOrder = 19
              end
              object DBCheckBox4: TDBCheckBox
                ...
                Width = 169
                Height = 17
                Caption = 'Permite LIBERAR border'#244'?'
                DataField = 'seg_hab_lib_brd'
                DataSource = dso
                TabOrder = 20
              end
              object chbMostarCustoCsuIte: TDBCheckBox
                Left = 282
                Top = 175
                Width = 217
                Height = 17
                Caption = 'Exibir Custo na Consulta do Item'
                DataField = 'seg_vis_custo_csu_ite'
                DataSource = dso
                TabOrder = 21
              end
              object chbZerarEst: TDBCheckBox
                Left = 282
                Top = 144
                Width = 225
                Height = 17
                Caption = 'Permite Zerar Estoque pelo Invent'#225'rio'
                DataField = 'seg_zerar_est'
                DataSource = dso
                TabOrder = 22
              end
              object chbVisNotaCsuIte: TDBCheckBox
                Left = 20
                Top = 207
                Width = 224
                Height = 17
                Caption = 'Visualizar Notas na Consulta de Itens?'
                DataField = 'seg_vis_nota_csu_ite'
                DataSource = dso
                TabOrder = 23
              end
              object DBCheckBox5: TDBCheckBox
                ...
                Width = 225
                Height = 17
                Caption = 'Exibir Aniversariante do m'#234's ?'
                DataField = 'aniversariante_mes'
                DataSource = dso
                TabOrder = 24
              end
              object GroupBox1: TGroupBox
                ...
                Width = 222
                Height = 92
                Caption = 'Permitir Acesso as Empresas'
                TabOrder = 25
                object wwDBGrid1: TwwDBGrid
                  ...
                  Height = 72
                  ControlType.Strings = (
                    'permitir_acesso;CheckBox;True;False')
                  Selected.Strings = (
                    'id_empresa'#9'5'#9'C'#243'd.'#9'T'
                    'int_empfantasia'#9'18'#9'Empresa'#9'F'
                    'permitir_acesso'#9'3'#9#9'F')
              ...
              object DBCheckBox8: TDBCheckBox
                ...
                Width = 135
                Height = 17
                Caption = 'Permite Cancelar OS ?'
                DataField = 'seg_cancelar_os'
                DataSource = dso
                TabOrder = 26
              end
              object DBCheckBox9: TDBCheckBox
                ...
                Width = 113
                Height = 17
                Caption = 'Adm. do Sistema'
                DataField = 'bus_som_ped_sem_pagtos'
                DataSource = dso
                TabOrder = 27
              end
              object chbAltCliped: TDBCheckBox
                Left = 560
                Top = 46
                Width = 105
                Height = 29
                Caption = 'Altera Cliente no Pedido?'
                DataField = 'seg_alt_cli_ped'
                DataSource = dso
                TabOrder = 28
                WordWrap = True
              end
              object DBCheckBox11: TDBCheckBox
                ...
                Width = 153
                Height = 17
                Caption = 'Altera local de t'#237'tulo REC'
                DataField = 'seg_alterar_local_tit_fin'
                DataSource = dso
                TabOrder = 29
              end
              object DBCheckBox12: TDBCheckBox
                ...
                Width = 153
                Height = 26
                Caption = 'Exibir mensagem de cliente em protesto/spc'
                DataField = 'seg_vis_aviso_tit_spc_protesto'
                DataSource = dso
                TabOrder = 30
                WordWrap = True
              end
              object DBCheckBox16: TDBCheckBox
                ...
                Width = 153
                Height = 17
                Caption = 'Altera forma pgto t'#237't. REC'
                DataField = 'seg_alterar_fpg_tit_fin'
                DataSource = dso
                TabOrder = 32
              end
              object wwDBComboBox1: TwwDBComboBox
                ...
                MapList = True
                AllowClearKey = False
                DataField = 'seg_alterar_ped_sit'
                DataSource = dso
                DropDownCount = 8
                ItemHeight = 0
                Items.Strings = (
                  'N'#227'o se aplica'#9'0'
                  'Somente pedido em situa'#231#227'o DIGITADO'#9'1'
                  'Somente pedido em situa'#231#227'o DIGITADO ou APROVADO'#9'2'
                  'Somente pedido em situa'#231#227'o DIGITADO, APROVADO ou EM PRODU'#199#195'O'#9'3')
                Sorted = False
                TabOrder = 33
              ...
              object DBCheckBox17: TDBCheckBox
                ...
                Width = 153
                Height = 26
                Caption = 'Permite alterar o representante no cliente'
                DataField = 'per_alterar_repres'
                DataSource = dso
                TabOrder = 31
                WordWrap = True
              end
              object DBCheckBox18: TDBCheckBox
                ...
                Width = 175
                Height = 45
                Caption = 'Buscar somente pedidos do tipo SEM PAGTOS na importa'#231#227'o das OPs.'
                DataField = 'bus_som_ped_sem_pagtos'
                DataSource = dso
                TabOrder = 34
                WordWrap = True
          ...
          object tsGestaoQualid: TTabSheet
            ...
            object Label9: TLabel
              ...
              Width = 122
              Height = 13
              Caption = 'Comiss'#227'o (%) permitida:'
            end
            object Label10: TLabel
              ...
              Alignment = taCenter
              AutoSize = False
              Caption = 'Condi'#231#227'o de Pagamento n'#227'o Permitida para Vendas'
              Color = 14342874
              ParentColor = False
              Transparent = False
            end
            object DBCheckBox6: TDBCheckBox
              ...
              Width = 286
              Height = 17
              Caption = 'Reimprime etiqueta de produto acabado'
              DataField = 'sgq_reimprime_etq'
              DataSource = dso
              TabOrder = 0
            end
            object DBCheckBox7: TDBCheckBox
              ...
              Width = 286
              Height = 17
              Caption = 'Permite desconto b'#225'sico maior que o permitido'
              DataField = 'seg_per_desc_maior'
              DataSource = dso
              TabOrder = 1
            end
            object DBCheckBox10: TDBCheckBox
              ...
              Width = 262
              Height = 17
              Caption = 'Altera comiss'#227'o no pedido de venda'
              DataField = 'sgq_perm_alt_comissao_ped'
              DataSource = dso
              TabOrder = 2
            end
            object DBCheckBox13: TDBCheckBox
              ...
              Width = 317
              Height = 17
              Caption = 'Permite utilizar o bot'#227'o Gerencia Produ'#231#227'o dos Itens'
              DataField = 'sgq_perm_botao_ger_prod'
              DataSource = dso
              TabOrder = 3
            end
            object DBCheckBox14: TDBCheckBox
              ...
              Width = 317
              Height = 17
              Caption = 'Permite Atualizar o Estoque'
              DataField = 'sgq_perm_atual_contagem'
              DataSource = dso
              TabOrder = 4
            end
            object DBCheckBox15: TDBCheckBox
              ...
              Width = 258
              Height = 17
              Caption = 'Visualizar valor total da carga'
              DataField = 'sgq_vis_vlr_tot_carga'
              DataSource = dso
              TabOrder = 5
            end
            object txtSgqComissaoPerm: TwwDBEdit
              Left = 479
              Top = 27
              Width = 58
              Height = 21
            ...
            object wwDBGrid2: TwwDBGrid
              ...
              Height = 72
              Selected.Strings = (
                'id_condicao_pag'#9'10'#9'C'#243'd.'#9'F'
                'int_nomecpg'#9'30'#9'Condi'#231#227'o de pagamento'#9'F')
              IniAttributes.Delimiter = ';;'
              IniAttributes.UnicodeIniFile = False
              TitleColor = clSilver
              FixedCols = 0
          ...
          object tsProdutorMobile: TTabSheet
            ...
            object chkAltPrecPedApp: TDBCheckBox
              ...
              Width = 283
              Height = 17
              Caption = 'Altera pre'#231'o no pedido de venda no app mobile'
              DataField = 'mob_alt_preco_ped'
              DataSource = dso
              TabOrder = 0
            end
          end
      ...
      object dgCargo: TwwDBGrid
        Left = 467
        Top = 129
        Width = 265
        Height = 44
        Selected.Strings = (
          'int_nomecrg'#9'52'#9'Cargo'#9'F')
        IniAttributes.Delimiter = ';;'
        IniAttributes.UnicodeIniFile = False
        TitleColor = clSilver
        FixedCols = 0
      ...
      object chbHabilitarSeg: TDBCheckBox
        Left = 261
        Top = 200
        Width = 124
        Height = 17
        ...
        Caption = 'Habilitar Seguran'#231'a :'
        DataField = 'seg_habilitar_seg'
        DataSource = dso
        ParentBiDiMode = False
        TabOrder = 17
        OnClick = chbHabilitarSegClick
      end
      object cbbEmpAlocado: TwwDBLookupCombo
        Left = 72
        Top = 177
        Width = 313
        Height = 21
        DropDownAlignment = taLeftJustify
        Selected.Strings = (
          'emp_fantasia'#9'50'#9'Fantasia'#9'F'
          'id_empresa'#9'10'#9'C'#243'digo'#9'F')
        DataField = 'id_empresa_mob'
        DataSource = dso
        LookupTable = dmGeral.BUS_CD_C_PAR
        ...
        PreciseEditRegion = False
        AllowClearKey = False
        OnEnter = cbbEmpAlocadoEnter
      end
      object cbbVndIntExt: TwwDBComboBox
        Left = 467
        Top = 175
        Width = 180
        Height = 21
      ...
      object txtPerComissao: TwwDBEdit
        Left = 467
        Top = 198
        Width = 106
        Height = 21
  ...
  object dsoCrg: TwwDataSource [4]
    DataSet = dmGeral.CAD_CD_C_FUN_CRG
    Left = 1048
    Top = 203
  end
  object pmExcluirCargo: TPopupMenu [5]
    Left = 1104
    Top = 285
    object btnRemoverRegistroCargo: TMenuItem
      Caption = 'Remover Registro'
      OnClick = btnRemoverRegistroCargoClick
    end
  end
  inherited dso: TwwDataSource
    DataSet = dmGeral.CAD_CD_C_FUN
    Left = 1088
  end
  ...
  object dsoEmp: TwwDataSource
    DataSet = dmGeral.CAD_CD_C_FUN_EMP
    Left = 1013
    Top = 256
  end
  object dsFunCpn: TDataSource
    DataSet = dmGeral.CAD_CD_C_FUN_CPN
    Left = 843
    Top = 474
  end
  object pmExcluirCpn: TPopupMenu
    Left = 808
    Top = 397
