...
type
  TPSQ_FM_X_EOC = class(TPAD_FM_X_PSQ)
...
procedure TPSQ_FM_X_EOC.btnPesquisaClick(Sender: TObject);
VAR
id_tpr : string;
begin
  inherited;
...
procedure TPSQ_FM_X_EOC.FormShow(Sender: TObject);
begin
  inherited;
  dbGrid.SetFocus;
end;
