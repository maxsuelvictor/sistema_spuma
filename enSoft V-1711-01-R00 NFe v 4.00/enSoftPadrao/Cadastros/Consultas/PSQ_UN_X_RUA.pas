...
type
  TPSQ_FM_X_RUA = class(TPAD_FM_X_PSQ)
...
procedure TPSQ_FM_X_RUA.btnPesquisaClick(Sender: TObject);
begin
  inherited;
  BUS_CD_C_ITE_LOC.Close;
  BUS_CD_C_ITE_LOC.Data :=
       BUS_CD_C_ITE_LOC.DataRequest( VarArrayOf([dmGeral.CAD_CD_C_PAR.FieldByName('ID_EMPRESA').AsString]));
end;
