...
type
  TPSQ_FM_X_NCM = class(TPAD_FM_X_PSQ)
    BUS_CD_C_NCM: TClientDataSet;
...
procedure TPSQ_FM_X_NCM.btnPesquisaClick(Sender: TObject);
begin
  inherited;
  BUS_CD_C_NCM.Close;
  BUS_CD_C_NCM.Data :=
  BUS_CD_C_NCM.DataRequest(
