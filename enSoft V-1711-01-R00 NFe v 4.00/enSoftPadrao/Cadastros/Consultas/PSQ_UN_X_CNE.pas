...
type
  TPSQ_FM_X_CNE = class(TPAD_FM_X_PSQ)
    BUS_CD_C_CNE: TClientDataSet;
...
procedure TPSQ_FM_X_CNE.btnPesquisaClick(Sender: TObject);
begin
  inherited;
  BUS_CD_C_CNE.Close;
  BUS_CD_C_CNE.Data :=
  BUS_CD_C_CNE.DataRequest(
