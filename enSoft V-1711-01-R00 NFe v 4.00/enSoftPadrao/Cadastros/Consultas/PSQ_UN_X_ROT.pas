...
type
  TPSQ_FM_X_ROT = class(TPAD_FM_X_PSQ)
    BUS_CD_C_ROT: TClientDataSet;
...
procedure TPSQ_FM_X_ROT.btnPesquisaClick(Sender: TObject);
begin
  inherited;
  BUS_CD_C_ROT.Close;
  BUS_CD_C_ROT.Data :=
  BUS_CD_C_ROT.DataRequest(
