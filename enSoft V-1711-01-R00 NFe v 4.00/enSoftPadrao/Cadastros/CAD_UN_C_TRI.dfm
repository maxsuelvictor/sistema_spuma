inherited CAD_FM_C_TRI: TCAD_FM_C_TRI
  Caption = 'Cadastro'
  ClientWidth = 1183
  Position = poDesigned
  ExplicitLeft = -134
    ...
    inherited pnlDados: TPanel
      ...
      object gbxMovimentos: TGroupBox
        ...
        object grdItens: TwwDBGrid
          ...
          Height = 130
          Selected.Strings = (
            'id_empresa'#9'6'#9'C'#243'd.'#9'F'
            'int_nomeemp'#9'23'#9'Empresa'#9'F'
            'id_tipo_mov_estoque'#9'6'#9'C'#243'd.'#9'F'
            'int_nometme'#9'18'#9'Tipo de estoque'#9'F'
            'uf'#9'6'#9'Estado'#9'F'
            'cnt_aliquota'#9'6'#9'Al'#237'quota'#9'F'#9'Contribuinte'
            'cnt_id_st_icm'#9'6'#9'CST'#9'F'#9'Contribuinte'
            'cnt_csosn'#9'7'#9'CSOSN'#9'F'#9'Contribuinte'
            'cnt_reducao'#9'7'#9'% Red'#9'F'#9'Contribuinte'
            'nct_aliquota'#9'6'#9'Al'#237'quota'#9'F'#9'N'#227'o-Contribuinte'
            'nct_id_st_icm'#9'6'#9'CST'#9'F'#9'N'#227'o-Contribuinte'
            'nct_csosn'#9'7'#9'CSOSN'#9'F'#9'N'#227'o-Contribuinte'
            'nct_reducao'#9'7'#9'% Red'#9'F'#9'N'#227'o-Contribuinte')
        ...
        object pnItens: TPanel
          ...
          object lblNaoContribuinteinterno: TLabel
            Left = 237
            Top = 62
            Width = 538
            Height = 18
          ...
          object lblContribuinteInterno: TLabel
            Left = 237
            Top = 1
            Width = 538
            Height = 18
          ...
          object lblPerReducaoInternoNaoContribuinte: TLabel
            Left = 675
            Top = 82
            Width = 55
            Height = 13
          ...
          object lblAliquotaInternoNaoContribuinte: TLabel
            Left = 626
            Top = 82
            Width = 43
            Height = 13
            Caption = 'Al'#237'q. Int.'
            FocusControl = txtDescricao
          end
          object lblCSTInternoNaoContribuinte: TLabel
            Left = 237
            Top = 82
            Width = 18
            Height = 13
          ...
          object lblPerReducaoInternoContribuinte: TLabel
            Left = 700
            Top = 21
            Width = 75
            Height = 13
          ...
          object lblAliquotaInternoContribuinte: TLabel
            Left = 631
            Top = 21
            Width = 63
            Height = 13
          ...
          object lblCSTInternoContribuinte: TLabel
            Left = 238
            Top = 21
            Width = 18
            Height = 13
          ...
          object Label7: TLabel
            ...
            Width = 130
            Height = 13
            Caption = 'Opera'#231#227'o externa Isenta?'
            FocusControl = txtDescricao
          end
          ...
          object Label9: TLabel
            ...
            Width = 129
            Height = 13
            Caption = 'Opera'#231#227'o interna isenta?'
            FocusControl = txtDescricao
          end
          ...
          object Label11: TLabel
            ...
            Width = 137
            Height = 13
            Caption = 'Al'#237'quota ICMS Dispensado'
            FocusControl = txtDescricao
          end
          ...
          object txtPerReducaoInternoNaoContr: TDBEdit
            Left = 675
            Top = 96
            Width = 55
            Height = 21
            Color = clWhite
            DataField = 'nct_reducao'
            DataSource = CAD_DS_C_TRI_REG
            TabOrder = 10
            OnExit = txtPerReducaoInternoNaoContrExit
          end
          object txtAliquotaInternoNaoContr: TDBEdit
            Left = 626
            Top = 96
            Width = 43
            Height = 21
            Color = clWhite
            DataField = 'nct_aliquota'
            DataSource = CAD_DS_C_TRI_REG
            TabOrder = 9
            OnExit = txtAliquotaInternoNaoContrExit
          end
          object txtPerRedInternoContr: TDBEdit
            Left = 700
            Top = 35
            Width = 76
            Height = 21
            Color = clWhite
            DataField = 'cnt_reducao'
            DataSource = CAD_DS_C_TRI_REG
            TabOrder = 6
            OnExit = txtPerRedInternoContrExit
          end
          object txtAliquotaInternoContr: TDBEdit
            Left = 631
            Top = 35
            Width = 64
            Height = 21
            Color = clWhite
            DataField = 'cnt_aliquota'
            DataSource = CAD_DS_C_TRI_REG
            TabOrder = 5
            OnExit = txtAliquotaInternoContrExit
          end
          object cbbCSTInternoContr: TwwDBLookupCombo
            Left = 237
            Top = 35
            Width = 186
            Height = 21
            ...
            AllowClearKey = False
            OnEnter = cbbCSTInternoContrEnter
            OnExit = cbbCSTInternoContrExit
          end
          object cbbCSTInternoNaoContr: TwwDBLookupCombo
            Left = 237
            Top = 96
            Width = 186
            Height = 21
            ...
            Selected.Strings = (
              'DESCRICAO'#9'45'#9'DESCRICAO'#9'F'
              'CODIGO'#9'5'#9'CODIGO'#9'F')
            DataField = 'nct_id_st_icm'
            DataSource = CAD_DS_C_TRI_REG
            LookupTable = dmGeral.BUS_CD_X_ICM_INC
            LookupField = 'CODIGO'
            Color = clWhite
            TabOrder = 7
            AutoDropDown = False
            ...
            PreciseEditRegion = False
            AllowClearKey = False
            OnEnter = cbbCSTInternoNaoContrEnter
            OnExit = cbbCSTInternoNaoContrExit
          end
          ...
          object cbbCodEmpresa: TwwDBLookupCombo
            Left = 3
            Top = 35
            Width = 89
            Height = 21
            DropDownAlignment = taLeftJustify
            Selected.Strings = (
              'emp_fantasia'#9'30'#9'Empresa'#9'F'
            ...
            PreciseEditRegion = False
            AllowClearKey = False
            OnEnter = cbbCodEmpresaEnter
            OnExit = cbbCodEmpresaExit
          end
          object cbbCSTOSNInternoContr: TwwDBLookupCombo
            Left = 434
            Top = 35
            Width = 186
            Height = 21
            ...
            DataField = 'cnt_csosn'
            DataSource = CAD_DS_C_TRI_REG
            LookupTable = dmGeral.BUS_CD_X_ICM_OSN_ICO
            LookupField = 'CODIGO'
            Options = [loRowLines]
            Color = clWhite
            TabOrder = 4
            ...
            AllowClearKey = False
            ShowMatchText = True
            OnEnter = cbbCSTOSNInternoContrEnter
            OnExit = cbbCSTOSNInternoContrExit
          end
          object cbbCSTOSNInternoNaoContr: TwwDBLookupCombo
            Left = 434
            Top = 96
            Width = 186
            Height = 21
            ...
            DataField = 'nct_csosn'
            DataSource = CAD_DS_C_TRI_REG
            LookupTable = dmGeral.BUS_CD_X_ICM_OSN_INC
            LookupField = 'CODIGO'
            Options = [loRowLines]
            Color = clWhite
            TabOrder = 8
            ...
            PreciseEditRegion = False
            AllowClearKey = False
            OnEnter = cbbCSTOSNInternoNaoContrEnter
            OnExit = cbbCSTOSNInternoNaoContrExit
          end
          object cbbInformFiscoInterno: TwwDBLookupCombo
            Left = 237
            Top = 211
            Width = 538
            Height = 21
            ...
            Selected.Strings = (
              ...
              'id_inf'#9'10'#9'C'#243'digo'#9'F')
            DataField = 'id_inf'
            DataSource = CAD_DS_C_TRI_REG
            LookupTable = dmGeral.BUS_CD_C_INF
            LookupField = 'id_inf'
            Style = csDropDownList
            ...
            PreciseEditRegion = False
            AllowClearKey = False
            OnEnter = cbbInformFiscoInternoEnter
            OnExit = cbbInformFiscoInternoExit
          end
          object txtCPAliq: TwwDBEdit
            Left = 736
            Top = 96
            Width = 39
            Height = 21
            DataField = 'nct_aliquota_ecf'
            DataSource = CAD_DS_C_TRI_REG
            TabOrder = 11
          ...
          object txtAliqDest: TDBEdit
            Left = 511
            Top = 157
            Width = 46
            Height = 21
            Color = clWhite
            DataField = 'part_per_aliq_dest'
            DataSource = CAD_DS_C_TRI_REG
            TabOrder = 14
          end
          object chkInsInt: TwwCheckBox
            Left = 295
            Top = 157
            Width = 17
            Height = 20
            ...
            DataField = 'part_per_ope_int_isen'
            DataSource = CAD_DS_C_TRI_REG
            TabOrder = 12
          end
          object chkInsExt: TwwCheckBox
            Left = 434
            Top = 157
            Width = 17
            Height = 20
            ...
            DisplayValueUnchecked = 'False'
            NullAndBlankState = cbUnchecked
            DataField = 'part_per_ope_ext_isen'
            DataSource = CAD_DS_C_TRI_REG
            TabOrder = 13
          end
          object txtPerReducaoDestino: TDBEdit
            Left = 563
            Top = 157
            Width = 57
            Height = 21
            Color = clWhite
            DataField = 'part_per_red_dest'
            DataSource = CAD_DS_C_TRI_REG
            TabOrder = 15
          end
          object txtDisAliq: TwwDBEdit
            Left = 626
            Top = 157
            Width = 149
            Height = 21
            DataField = 'dis_aliquota'
            DataSource = CAD_DS_C_TRI_REG
            TabOrder = 16
            UnboundDataType = wwDefault
            WantReturns = False
  ...
  object CAD_DS_C_TRI_REG: TwwDataSource [4]
    DataSet = dmGeral.CAD_CD_C_TRI_REG
    OnStateChange = dsoStateChange
    Left = 19
    Top = 211
  end
  object DataSource1: TDataSource [5]
    DataSet = dmGeral.BUS_CD_X_ICM_ICO
    Left = 19
    Top = 262
  end
  inherited dso: TwwDataSource
    DataSet = dmGeral.CAD_CD_C_TRI
    Left = 19
    Top = 163
  end
