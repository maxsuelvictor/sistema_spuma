inherited PCP_FM_C_MEQ: TPCP_FM_C_MEQ
  Caption = 'Cadastro'
  ExplicitLeft = -181
  ExplicitTop = 1
  ExplicitWidth = 1156
  ...
  inherited pnlDireita: TPanel
    inherited pnlDados: TPanel
      ...
      object pgDados: TPageControl
        ...
        Width = 569
        Height = 319
        ActivePage = tsDadosVei
        TabOrder = 2
        object tsDados: TTabSheet
          Caption = 'Dados'
          object lblCodAtivoImobilizado: TLabel
            Left = -21
            Top = 38
            Width = 122
            Height = 13
            Caption = 'Cod. Ativo Imobilizado :'
            FocusControl = txtCodAtivoImobilizado
          end
          ...
          object lblEstaComGarantia: TLabel
            Left = 4
            Top = 179
            Width = 97
            Height = 13
            Caption = 'Est'#225' com Garantia?'
          end
          ...
          object Label3: TLabel
            ...
            FocusControl = txtVlrComissao
          end
          object txtCodAtivoImobilizado: TDBEdit
            Left = 107
            Top = 35
            Width = 90
            Height = 21
          ...
          object cbbModelo: TwwDBLookupCombo
            ...
            Selected.Strings = (
              ...
              'id_mde'#9'10'#9'id_mde'#9'F')
            DataField = 'id_mde'
            DataSource = dso
            LookupTable = dmGeral.BUS_CD_C_MDE
            LookupField = 'id_mde'
            Color = clWhite
            TabOrder = 2
            AutoDropDown = False
          ...
          object chkEstaComGatantia: TDBCheckBox
            Left = 105
            Top = 178
            Width = 17
            Height = 17
            DataField = 'gara_existe'
            DataSource = dso
            TabOrder = 4
            OnClick = chkEstaComGatantiaClick
          end
          object dpkDataCompra: TJvDBDateEdit
            Left = 105
            Top = 153
            Width = 90
            Height = 21
            DataField = 'dta_compra'
            DataSource = dso
            ShowNullDate = False
            TabOrder = 5
          end
          object dpkDataCadastro: TJvDBDateEdit
            Left = 415
            Top = 153
            Width = 90
            Height = 21
          ...
          object dpkDataGarantia: TJvDBDateEdit
            Left = 415
            Top = 176
            Width = 90
            Height = 21
            DataField = 'gara_validade'
            DataSource = dso
            ShowNullDate = False
            TabOrder = 7
          end
          object txtIdFabricante: TJvDBComboEdit
            Left = 107
            Top = 57
            Width = 90
            Height = 21
            ...
            TabOrder = 8
            OnButtonClick = txtIdFabricanteButtonClick
            OnExit = txtIdFabricanteExit
          end
          object txtDescFab: TwwDBEdit
            Left = 198
            Top = 57
            Width = 307
            Height = 21
            ...
            WantReturns = False
            WordWrap = False
            OnExit = txtDescFabExit
          end
          object txtVlrHora: TDBEdit
            Left = 105
            Top = 130
            Width = 90
            Height = 21
        ...
        object tsDadosVei: TTabSheet
          ...
          object Label15: TLabel
            ...
            Width = 90
            Height = 13
            Caption = 'Km de Aquisi'#231#227'o :'
            FocusControl = txtkmAqui
          end
          ...
          object DBCheckBox2: TDBCheckBox
            ...
            Caption = 'Equip. Terceiro'
            DataField = 'eqp_terceiro'
            DataSource = dso
            TabOrder = 5
          end
          ...
          object txtchassiserial: TDBEdit
            Left = 84
            Top = 71
            Width = 231
            Height = 21
          ...
          object txtcapavei: TDBEdit
            Left = 84
            Top = 98
            Width = 231
            Height = 21
            Color = clWhite
            DataField = 'cap_veiculo'
            DataSource = dso
            TabOrder = 7
          end
          object cbbRod: TwwDBLookupCombo
            Left = 382
            Top = 98
            Width = 177
            Height = 21
            ...
            DataSource = dso
            LookupTable = dmGeral.BUS_CD_X_VEI_ROD
            LookupField = 'ID_ROD'
          ...
          object cbbCores: TwwDBLookupCombo
            Left = 84
            Top = 125
            Width = 231
            Height = 21
          ...
          object JvDBDateEdit1: TJvDBDateEdit
            ...
            Width = 85
            Height = 21
            DataField = 'dta_aquisicao'
            DataSource = dso
            ShowNullDate = False
            TabOrder = 11
          end
          object txtkmAqui: TDBEdit
            Left = 286
            Top = 152
            Width = 90
            Height = 21
            Color = clWhite
            DataField = 'km_aquisicao'
            DataSource = dso
            TabOrder = 12
          end
          object txtkmatual: TDBEdit
            Left = 469
            Top = 152
            Width = 90
            Height = 21
          ...
          object cbbUfLincenciado: TwwDBComboBox
            Left = 286
            Top = 179
            Width = 42
            Height = 21
          ...
          object cbbAliment: TwwDBLookupCombo
            Left = 84
            Top = 232
            Width = 192
            Height = 21
            ...
            Selected.Strings = (
              'DESCRICAO'#9'30'#9'Descri'#231#227'o'#9'F')
            DataField = 'alimentacao'
            DataSource = dso
            LookupTable = dmGeral.BUS_CD_X_ALV
            LookupField = 'CODIGO'
            Style = csDropDownList
            Color = clWhite
            TabOrder = 18
            ...
            PreciseEditRegion = False
            AllowClearKey = False
            OnEnter = cbbAlimentEnter
          end
          object cbbComb: TwwDBLookupCombo
            Left = 382
            Top = 232
            Width = 177
            Height = 21
            ...
            DataSource = dso
            LookupTable = dmGeral.BUS_CD_X_COV
            LookupField = 'CODIGO'
            Style = csDropDownList
            Color = clWhite
            TabOrder = 19
            ...
            PreciseEditRegion = False
            AllowClearKey = False
            OnEnter = cbbCombEnter
          end
          object cbbCarr: TwwDBLookupCombo
            Left = 84
            Top = 258
            Width = 193
            Height = 21
            ...
            DataSource = dso
            LookupTable = dmGeral.BUS_CD_X_VEI_CAR
            LookupField = 'ID_CAR'
            Style = csDropDownList
            Color = clWhite
            TabOrder = 20
            ...
            PreciseEditRegion = False
            AllowClearKey = False
            OnEnter = cbbCarrEnter
          end
          object txtkml: TDBEdit
            Left = 363
            Top = 259
            Width = 66
            Height = 21
            Color = clWhite
            DataField = 'media_consumo'
            DataSource = dso
            TabOrder = 21
          end
          object txttara: TDBEdit
            Left = 468
            Top = 259
            Width = 90
            Height = 21
          ...
          object cbbModeloVei: TwwDBLookupCombo
            Left = 383
            Top = 125
            Width = 175
            Height = 21
  ...
  inherited pnlTop: TJvPanel
    inherited pnlCima: TJvPanel
      inherited lblTitulo: TLabel
        Caption = 'M'#225'quinas/Equipamentos/Ve'#237'culos'
      end
    end
  end
  inherited dso: TwwDataSource
    DataSet = dmSgq.PCP_CD_C_MEQ
  end
