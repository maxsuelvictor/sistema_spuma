inherited PCP_FM_M_MCP: TPCP_FM_M_MCP
  ExplicitLeft = -190
  ExplicitWidth = 1156
  ExplicitHeight = 538
  PixelsPerInch = 96
  ...
  inherited pnlDireita: TPanel
    inherited pnlDados: TPanel
      ...
      object lblAtendimentoMecanico: TLabel
        Left = 224
        Top = 133
        Width = 441
        Height = 15
        Alignment = taCenter
        AutoSize = False
        Caption = 'Atendimento do Mec'#226'nico da Manuten'#231#227'o'
        Color = 14342874
        ParentColor = False
        Transparent = False
      end
      ...
      object lblTipoManutencao: TLabel
        Left = 443
        Top = 31
        Width = 112
        Height = 13
      ...
      object cbbMaquina: TwwDBLookupCombo
        Left = 224
        Top = 51
        Width = 213
        Height = 21
        ...
        PreciseEditRegion = False
        AllowClearKey = False
        OnEnter = cbbMaquinaEnter
      end
      object txtProblema: TDBEdit
        Left = 224
        Top = 74
        Width = 441
        Height = 21
      ...
      object txtHoraFim: TDBEdit
        Left = 615
        Top = 167
        Width = 50
        Height = 21
        Color = clWhite
        DataField = 'hora_termino_atend'
        DataSource = dso
        TabOrder = 12
      end
      object dpkDataInicio: TJvDBDateEdit
        Left = 260
        Top = 167
        Width = 90
        Height = 21
        DataField = 'dta_inicio_atend'
        DataSource = dso
        ShowNullDate = False
        TabOrder = 9
      end
      object dpkDataFim: TJvDBDateEdit
        Left = 482
        Top = 167
        Width = 90
        Height = 21
        DataField = 'dta_termino_atend'
        DataSource = dso
        ShowNullDate = False
        TabOrder = 11
      end
      object cbbCronograma: TwwDBLookupCombo
        Left = 561
        Top = 51
        Width = 104
        Height = 21
        DropDownAlignment = taLeftJustify
        Selected.Strings = (
          'id_meq'#9'10'#9'id_meq'#9'F')
        DataField = 'id_cme_meq'
        DataSource = dso
        LookupTable = dmGeral.BUS_CD_M_CME
        LookupField = 'id_meq'
        Color = clWhite
        TabOrder = 5
        AutoDropDown = False
      ...
      object dpkDataAutorizacao: TJvDBDateEdit
        Left = 561
        Top = 97
        Width = 104
        Height = 21
        DataField = 'dta_autorizacao'
        DataSource = dso
        ShowNullDate = False
        TabOrder = 8
      end
      object gbTotais: TGroupBox
        ...
        object lblTotalPecasGarantia: TLabel
          Left = 8
          Top = 37
          Width = 50
          Height = 13
        ...
        object lblTotalPecasMaoObra: TLabel
          Left = 140
          Top = 37
          Width = 74
          Height = 13
        ...
        object lblTotalServicosGarantia: TLabel
          Left = 425
          Top = 37
          Width = 50
          Height = 13
        ...
        object lblTotalGarantia: TLabel
          Left = 713
          Top = 37
          Width = 31
          Height = 13
        ...
        object txtTotalMaoObra: TDBEdit
          Left = 637
          Top = 34
          Width = 70
          Height = 21
          Color = clWhite
          DataField = 'total_mobra'
          DataSource = dso
          TabOrder = 4
        end
        object txtTotalPecasGarantia: TDBEdit
          Left = 64
          Top = 34
          Width = 70
          Height = 21
          Color = clWhite
          DataField = 'total_pecas_garantia'
          DataSource = dso
          TabOrder = 0
        end
        object txtTotalPecasMaoObra: TDBEdit
          Left = 220
          Top = 34
          Width = 70
          Height = 21
          Color = clWhite
          DataField = 'total_pecas_mobra'
          DataSource = dso
          TabOrder = 1
        end
        object txtTotalServicosGarantia: TDBEdit
          Left = 481
          Top = 34
          Width = 70
          Height = 21
          Color = clWhite
          DataField = 'total_servicos_garantia'
          DataSource = dso
          TabOrder = 3
        end
        object txtTotalGarantia: TDBEdit
          Left = 750
          Top = 34
          Width = 70
          Height = 21
      ...
      object pcFilhos: TPageControl
        ...
        Width = 827
        Height = 208
        ActivePage = tbiChecklist
        TabOrder = 13
        object tbiChecklist: TTabSheet
          Caption = 'Checklist'
          object dgChecklist: TwwDBGrid
            Left = 2
            Top = 47
            Width = 813
            Height = 130
            TabStop = False
            Selected.Strings = (
              'TEXTO_VERIFICADO'#9'30'#9'O que foi verificado'#9'F'
              'OBSERVACAO'#9'96'#9'Observa'#231#245'es'#9'F')
            ...
            TitleButtons = False
            UseTFields = False
            OnMouseUp = dgChecklistMouseUp
            object dgChecklistIButton: TwwIButton
              Left = -1
              Top = -1
              Width = 22
              Height = 22
              ...
              Glyph.Data = {
                ...
                FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
                B102}
              OnClick = dgChecklistIButtonClick
            end
          end
          object pnlCheckList: TPanel
            ...
            BevelOuter = bvNone
            TabOrder = 1
            OnExit = pnlCheckListExit
            object lblVerificado: TLabel
              Left = 124
              Top = 1
              Width = 58
              Height = 16
            ...
            object lblOqueFoiVerificado: TLabel
              Left = 2
              Top = 1
              Width = 119
              Height = 16
              Alignment = taCenter
              AutoSize = False
              Caption = 'O que Foi Verificado'
              Color = 14342874
              ParentColor = False
              Transparent = False
            end
            object txtOqueFoiVerificado: TDBEdit
              Left = 2
              Top = 19
              Width = 119
              Height = 21
              Color = clWhite
              DataField = 'TEXTO_VERIFICADO'
              DataSource = dsoIve
              TabOrder = 0
            end
            object chkVerificado: TDBCheckBox
              Left = 146
              Top = 21
              Width = 15
              Height = 17
            ...
            object chkSubstituido: TDBCheckBox
              Left = 210
              Top = 21
              Width = 15
              Height = 17
            ...
            object chkLubrificado: TDBCheckBox
              Left = 279
              Top = 21
              Width = 15
              Height = 17
              DataField = 'LUBRIFICADO'
              DataSource = dsoIve
              TabOrder = 3
            end
            object chkAjustado: TDBCheckBox
              Left = 341
              Top = 21
              Width = 15
              Height = 17
            ...
            object chkCompletado: TDBCheckBox
              Left = 404
              Top = 21
              Width = 15
              Height = 17
            ...
            object chkReparado: TDBCheckBox
              Left = 559
              Top = 21
              Width = 15
              Height = 17
            ...
            object txtObservacoes: TDBEdit
              ...
              DataSource = dsoIve
              TabOrder = 10
              OnExit = txtObservacoesExit
            end
          end
          object btnAddChecklist: TBitBtn
            Left = 1
            Top = 23
            Width = 23
            Height = 23
        ...
        object tbiItens: TTabSheet
          ...
          object dgItens: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'int_nomeite'#9'46'#9'Descri'#231#227'o'#9'F'
              'int_nomeund'#9'5'#9'Unidade'#9'F')
            IniAttributes.Delimiter = ';;'
            IniAttributes.UnicodeIniFile = False
            TitleColor = clBtnFace
            FixedCols = 0
          ...
          object pnlItem: TPanel
            ...
            object lblItensDescricao: TLabel
              Left = 73
              Top = -1
              Width = 49
              Height = 13
      ...
      object cbbTipoManutencao: TJvDBComboBox
        Left = 561
        Top = 28
        Width = 104
        Height = 21
        DataField = 'tipo_manutencao'
        DataSource = dso
        ItemHeight = 13
        Items.Strings = (
          'Corretiva'
  ...
  inherited pnlTop: TJvPanel
    inherited pnlCima: TJvPanel
      inherited lblTitulo: TLabel
        Caption = 'Registro de Manuten'#231#227'o Corretiva e Preventiva'
      end
    end
  end
  object dsoIve: TwwDataSource [4]
    DataSet = dmGeral.PCP_CD_M_MCP_IVE
    Left = 1011
    Top = 283
  end
  object dsoSer: TwwDataSource [5]
    DataSet = dmGeral.PCP_CD_M_MCP_SER
    Left = 1011
    Top = 331
  end
  inherited dso: TwwDataSource
    DataSet = dmGeral.PCP_CD_M_MCP
  end
