inherited FAT_FM_M_NFE_FRE: TFAT_FM_M_NFE_FRE
  ClientHeight = 520
  ClientWidth = 1055
  ExplicitTop = -103
  ExplicitWidth = 1061
  ...
  inherited pnlEsquerda: TPanel
    ...
    inherited pnlDatagrid: TPanel
      ...
      inherited dbGrid: TwwDBGrid
        Height = 386
        Selected.Strings = (
          'id_fiscal'#9'11'#9'C'#243'digo'#9'F'
          'dta_emissao'#9'10'#9'Emiss'#227'o'#9'F'
          'numero'#9'31'#9'N'#250'mero'#9'F')
        ExplicitHeight = 386
      end
    end
  end
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object txtSubserie: TDBEdit
        ...
        DataSource = dso
        TabOrder = 5
        OnExit = txtSubserieExit
      end
      object cbbTipoCTE: TwwDBLookupCombo
        Left = 548
        Top = 48
        Width = 153
        Height = 21
        ...
        DataField = 'tipo_cte'
        DataSource = dso
        LookupTable = dmGeral.BUS_CD_X_NFE_CTE
        LookupField = 'CODIGO'
        TabOrder = 10
        AutoDropDown = False
        ShowButton = True
      ...
      object cbbCondPagamento: TwwDBLookupCombo
        Left = 548
        Top = 71
        Width = 153
        Height = 21
        ...
        PreciseEditRegion = False
        AllowClearKey = False
        OnEnter = cbbCondPagamentoEnter
        OnExit = cbbCondPagamentoExit
      end
      object gbICMS: TGroupBox
        ...
        object lblICMSNormalVlrBase: TLabel
          Left = 98
          Top = 24
          Width = 90
          Height = 16
        ...
        object lblICMSNormalVlrICMS: TLabel
          Left = 190
          Top = 24
          Width = 90
          Height = 16
        ...
        object numVlrMercadoria: TwwDBEdit
          Left = 6
          Top = 42
          Width = 90
          Height = 21
          ...
          WantReturns = False
          WordWrap = False
          OnExit = numVlrMercadoriaExit
        end
        object numVlrICMBase: TwwDBEdit
          Left = 98
          Top = 42
          Width = 90
          Height = 21
          ...
          WantReturns = False
          WordWrap = False
          OnExit = numVlrICMBaseExit
        end
        object numVlrICM: TwwDBEdit
          Left = 190
          Top = 42
          Width = 90
          Height = 21
          ...
          WantReturns = False
          WordWrap = False
          OnExit = numVlrICMExit
        end
        object numVlrLiquido: TwwDBEdit
          Left = 282
          Top = 42
          Width = 90
          Height = 21
      ...
      object gbTitulos: TGroupBox
        ...
        object grdTitulos: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'int_nomepct'#9'20'#9'Plano de Contas'#9'F'
            'dta_vencimento'#9'10'#9'Vencimento'#9'F'
            'vlr_titulo'#9'10'#9'Valor'#9'F')
        ...
        object pnTitulos: TPanel
          ...
          object cbbFormaPagamento: TwwDBLookupCombo
            ...
            OnKeyDown = cbbFormaPagamentoKeyDown
          end
          object txt_IdPlanoContas: TwwDBLookupCombo
            Left = 123
            Top = 16
            Width = 123
            Height = 21
            ...
            PreciseEditRegion = False
            AllowClearKey = False
            OnEnter = txt_IdPlanoContasEnter
          ...
          object txtVlrParcela: TwwDBEdit
            Left = 339
            Top = 16
            Width = 60
            Height = 21
        ...
        object btn_Add_Tit: TBitBtn
          ...
          Glyph.Data = {
            ...
            0000}
          TabOrder = 1
          OnClick = btn_Add_TitClick
          OnKeyDown = btn_Add_TitKeyDown
        end
      end
      object gbNff: TGroupBox
        Left = 447
        Top = 207
        Width = 250
        Height = 200
        TabOrder = 17
        object btn_Add_Nff: TBitBtn
          Left = 5
          Top = 18
          Width = 23
          Height = 23
          Glyph.Data = {
            ...
            0000}
          TabOrder = 1
          OnClick = btn_Add_NffClick
        end
        object grdNff: TwwDBGrid
          Left = 5
          Top = 43
          Width = 237
          Height = 150
          Selected.Strings = (
            'nota_frete'#9'12'#9'N'#250'mero'#9'F'
            'int_nomefor'#9'8'#9'Emitente'#9'F'
            'vlr_nota'#9'10'#9'Valor'#9'F')
          IniAttributes.Delimiter = ';;'
          IniAttributes.UnicodeIniFile = False
          TitleColor = clBtnFace
          FixedCols = 0
          ...
          TitleButtons = False
          UseTFields = False
          OnMouseUp = grdNffMouseUp
          object grdNffIButton: TwwIButton
            Left = -1
            Top = -1
            Width = 22
            Height = 22
        ...
        object pnNotas: TPanel
          ...
          object lblNumero2: TLabel
            ...
            Height = 13
            Caption = 'N'#250'mero'
            FocusControl = txtNumeroNfeNff
          end
          object lblEmitente2: TLabel
            Left = 80
            Top = -2
            Width = 59
            Height = 13
          ...
          object txtNumeroNfeNff: TDBEdit
            Left = 2
            Top = 13
            Width = 76
            Height = 21
            ...
            DataSource = dsoNff
            TabOrder = 0
            OnExit = txtNumeroNfeNffExit
          end
          object txtEmitenteNff: TJvDBComboEdit
            Left = 80
            Top = 13
            Width = 75
            Height = 21
            ...
            Glyph.Data = {
              ...
              FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
            TabOrder = 1
            OnButtonClick = txtEmitenteNffButtonClick
            OnExit = txtEmitenteNffExit
          end
          object txtVlrNFF: TwwDBEdit
            Left = 157
            Top = 13
            Width = 58
            Height = 21
      ...
      object cbbModelo: TwwDBLookupCombo
        ...
        DataField = 'MODELO'
        DataSource = dso
        LookupTable = dmGeral.BUS_CD_X_MOD_FRE
        LookupField = 'CODIGO'
  ...
  object dsoTit: TwwDataSource [4]
    DataSet = dmGeral.FAT_CD_M_NFE_TIT
    OnStateChange = dsoStateChange
    Left = 56
    Top = 371
  end
  object dsoNff: TwwDataSource [5]
    DataSet = dmGeral.FAT_CD_M_NFE_NFF
    OnStateChange = dsoStateChange
    Left = 56
    Top = 419
  end
  ...
  inherited imgBotoesAtivo: TImageList
    ...
    Top = 131
    Bitmap = {
      494C01010800A800440118001800FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesInativo: TImageList
    ...
    Top = 275
    Bitmap = {
      
  ...
  inherited ImgPequena: TImageList
    ...
    Top = 131
    Bitmap = {
      494C01011200000194010E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoAz: TImageList
    ...
    Top = 179
    Bitmap = {
      
  ...
  inherited ImgPequenaAz: TImageList
    ...
    Top = 179
    Bitmap = {
      494C0101060000018C010E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
