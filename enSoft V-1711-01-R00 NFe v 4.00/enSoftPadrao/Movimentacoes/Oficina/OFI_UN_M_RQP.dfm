inherited OFI_FM_M_RQP: TOFI_FM_M_RQP
  ClientHeight = 560
  ExplicitWidth = 1156
  ExplicitHeight = 588
  PixelsPerInch = 96
      ...
      object gbItens: TGroupBox
        ...
        object dgItens: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'int_nomeite'#9'25'#9'Descri'#231#227'o'#9'T'
            'int_nomeund'#9'4'#9'Und'#9'T'
            'int_nomemec'#9'15'#9'Mec'#226'nico'#9'T'
            'int_nometer'#9'15'#9'Terceiro'#9'T'
            'qtde'#9'6'#9'Qtde'#9'T'
            'vlr_unitario'#9'11'#9'Vlr. Unit'#225'rio'#9'T'
            'vlr_desconto'#9'11'#9'Vlr. Desconto'#9'T'
            'vlr_liquido'#9'11'#9'Vlr L'#237'quido'#9'T'
  ...
  inherited pnlTop: TJvPanel
    inherited pnlCima: TJvPanel
      inherited lblTitulo: TLabel
        Caption = 'Requisi'#231#227'o de Equipamento'
      end
    end
  end
