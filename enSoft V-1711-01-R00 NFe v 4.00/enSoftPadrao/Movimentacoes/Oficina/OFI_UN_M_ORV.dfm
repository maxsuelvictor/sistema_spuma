inherited OFI_FM_M_ORV: TOFI_FM_M_ORV
  ClientHeight = 569
  ExplicitLeft = -38
  ExplicitWidth = 1156
  ExplicitHeight = 597
  ...
  inherited pnlEsquerda: TPanel
    ...
    inherited pnlDatagrid: TPanel
      ...
      inherited dbGrid: TwwDBGrid
        Height = 342
        Selected.Strings = (
          'id_ordem'#9'17'#9'N'#186' Ordem'#9'F'
          'int_placa'#9'17'#9'Placa'#9'F'
          'dta_emissao'#9'17'#9'Emiss'#227'o'#9'F')
  ...
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object lblCondicaoPag: TLabel
        Left = 576
        Top = 116
        Width = 77
        Height = 13
        Caption = 'Condi'#231#227'o Pag.:'
      end
      ...
      object txtNumeroOrdem: TwwDBEdit
        Left = 66
        Top = 12
        Width = 70
        Height = 21
      ...
      object dpkEntrega: TJvDBDateEdit
        Left = 448
        Top = 12
        Width = 90
        Height = 21
      ...
      object txtCombustivel: TwwDBEdit
        Left = 261
        Top = 62
        Width = 72
        Height = 21
      ...
      object cbbTipoOS: TwwDBLookupCombo
        Left = 67
        Top = 112
        Width = 97
        Height = 21
        ...
        Selected.Strings = (
          ...
          'id_tipo_os'#9'10'#9'id_tipo_os'#9'T')
        DataField = 'id_tipo_os'
        DataSource = dso
        LookupTable = dmGeral.BUS_CD_C_TIO
        LookupField = 'id_tipo_os'
        ...
        AllowClearKey = False
        OnEnter = cbbTipoOSEnter
        OnExit = cbbTipoOSExit
      end
      object cbbCondicaoPag: TwwDBLookupCombo
        Left = 660
        Top = 112
        Width = 100
        Height = 21
        ...
        PreciseEditRegion = False
        AllowClearKey = False
        OnEnter = cbbCondicaoPagEnter
        OnExit = cbbCondicaoPagExit
      end
      ...
      object gbObservacoes: TGroupBox
        ...
        object lblDescricaoProblema: TLabel
          Left = 383
          Top = 18
          Width = 117
          Height = 13
        ...
        object txtReclamacaoCliente: TDBMemo
          ...
          DataSource = dso
          TabOrder = 0
          OnEnter = txtReclamacaoClienteEnter
          OnExit = txtReclamacaoClienteExit
        end
        object txtDescricaoProblema: TDBMemo
          Left = 383
          Top = 31
          Width = 370
          Height = 65
          ...
          DataSource = dso
          TabOrder = 1
          OnEnter = txtDescricaoProblemaEnter
          OnExit = txtDescricaoProblemaExit
        end
      end
      object rgTanqueCombus: TwwRadioGroup
        Left = 344
        Top = 52
        Width = 237
        Height = 31
      ...
      object gpItens: TGroupBox
        ...
        object pnlItens: TPanel
          ...
          object txtDescricaoItem: TwwDBEdit
            Left = 99
            Top = 18
            Width = 404
            Height = 21
        ...
        object dgItens: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'int_nomeite'#9'38'#9'Item'#9'T'
            'int_nomeund'#9'7'#9'Und'#9'T'
            'qtde'#9'5'#9'Qtde'#9'T'
            'vlr_unitario'#9'13'#9'Vlr. Unit'#225'rio'#9'T'
            'per_desconto'#9'12'#9'% Desc.'#9'T'
            'vlr_desconto'#9'12'#9'Vlr. Desc.'#9'T'
            'vlr_liquido'#9'13'#9'Vlr. Liquido'#9'T')
        ...
        object pnlMecTer: TPanel
          ...
          object cbbTerceiro: TwwDBLookupCombo
            Left = 140
            Top = 17
            Width = 130
            Height = 21
            ...
            Selected.Strings = (
              ...
              'id_fornecedor'#9'10'#9'id_fornecedor'#9'F')
            DataField = 'id_terceiro'
            DataSource = dsoIte
            LookupTable = dmGeral.BUS_CD_C_FOR
            LookupField = 'id_fornecedor'
            Color = clWhite
            TabOrder = 1
            AutoDropDown = False
            ShowButton = True
            ...
            AllowClearKey = False
            ShowMatchText = True
            OnEnter = cbbTerceiroEnter
            OnExit = cbbTerceiroExit
          end
      ...
      object cbbOrcamento: TwwDBLookupCombo
        Left = 659
        Top = 139
        Width = 97
        Height = 21
        ...
        Selected.Strings = (
          'id_orcamento'#9'10'#9'Or'#231'amento'#9'T'
          'id_cliente'#9'10'#9'Cod. Cliente'#9'T'
          'dta_orcamento'#9'10'#9'Data'#9'T')
        DataField = 'id_orcamento'
        DataSource = dso
        LookupTable = dmGeral.BUS_CD_M_OCV
        LookupField = 'id_orcamento'
        ...
        PreciseEditRegion = False
        AllowClearKey = False
        OnEnter = cbbOrcamentoEnter
        OnExit = cbbOrcamentoExit
      end
      ...
      object txtVlrProdutos: TwwDBEdit
        Left = 194
        Top = 440
        Width = 77
        Height = 21
      ...
      object txtDescServicos: TwwDBEdit
        Left = 517
        Top = 440
        Width = 77
        Height = 21
      ...
      object txtDescProdutos: TwwDBEdit
        Left = 436
        Top = 440
        Width = 77
        Height = 21
      ...
      object txtDescTerceiro: TwwDBEdit
        Left = 598
        Top = 440
        Width = 77
        Height = 21
      ...
      object txtOSGar: TJvDBComboEdit
        Left = 436
        Top = 112
        Width = 72
        Height = 21
        ClickKey = 114
        DataField = 'id_ordem_orig_gar'
        DataSource = dso
        Glyph.Data = {
          36030000424D3603000000000000360000002800000010000000100000000100
          1800000000000003000000000000000000000000000000000000FFFFFFFFFFFF
        ...
        ReadOnly = True
        TabOrder = 17
        OnButtonClick = txtOSGarButtonClick
      end
      object txtIdFiscal: TJvDBComboEdit
        Left = 248
        Top = 113
        Width = 75
        Height = 21
        ClickKey = 114
        DataField = 'id_fiscal_ref_entrada'
        DataSource = dso
        Glyph.Data = {
          36030000424D3603000000000000360000002800000010000000100000000100
          1800000000000003000000000000000000000000000000000000FFFFFFFFFFFF
        ...
        ReadOnly = True
        TabOrder = 16
        OnButtonClick = txtIdFiscalButtonClick
        OnExit = txtIdFiscalExit
      end
      object txtAnoFab: TwwDBEdit
        Left = 235
        Top = 35
        Width = 46
        Height = 21
      ...
      object cbbAtendente: TwwDBLookupCombo
        ...
        Selected.Strings = (
          ...
          'id_funcionario'#9'10'#9'id_funcionario'#9'T')
  ...
  inherited pnlTop: TJvPanel
    inherited pnlCima: TJvPanel
      inherited lblTitulo: TLabel
        Caption = 'Abertura de Ordem de Servi'#231'os de Ve'#237'culos '
      end
    end
  end
  ...
  object dsoIte: TwwDataSource [4]
    DataSet = dmGeral.OFI_CD_M_ORV_ITE
    Left = 996
    Top = 268
  end
  ...
  inherited imgBotoesAtivo: TImageList
    ...
    Top = 35
    Bitmap = {
      494C010108001801D80218001800FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesInativo: TImageList
    ...
    Top = 211
    Bitmap = {
      
  ...
  inherited ImgPequena: TImageList
    ...
    Top = 59
    Bitmap = {
      494C01011200680128030E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoAz: TImageList
    ...
    Top = 27
    Bitmap = {
      
  ...
  inherited ImgPequenaAz: TImageList
    ...
    Top = 115
    Bitmap = {
      494C01010600600120030E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoVe: TImageList
    ...
    Top = 163
    Bitmap = {
      
  ...
  inherited ImgPequenaVe: TImageList
    ...
    Top = 163
    Bitmap = {
      
  ...
  inherited ImgPequenaLa: TImageList
    Bitmap = {
      494C010106000001EC010E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
      0000000000003600000028000000380000001C00000001002000000000008018
      000000000000000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFFFFFF
  ...
  object OFI_XL_M_ORV: TfrxXLSExport
    UseFileCache = True
    ShowProgress = True
  ...
  object OFI_PD_M_ORV: TfrxPDFExport
    UseFileCache = True
    ShowProgress = True
    OverwritePrompt = False
    DataOnly = False
  ...
  object OFI_DB_M_ORV: TfrxDBDataset
    UserName = 'OFI_DB_M_ORV'
    ...
    FieldAliases.Strings = (
      ...
      'int_nomeeqp=int_nomeeqp'
      'int_modeloeqp=int_modeloeqp'
      'int_serialeqp=int_serialeqp'
      'int_garantiaeqp=int_garantiaeqp'
      'BUS_SQ_R_ORV_TIT_SER=BUS_SQ_R_ORV_TIT_SER'
      'id_meq=id_meq'
      'int_nomemeq=int_nomemeq'
      'int_seriemeq=int_seriemeq'
      'int_modelomeq=int_modelomeq'
      'horimetro=horimetro'
      'int_tipomeq=int_tipomeq'
      'int_placa_meq=int_placa_meq'
      'int_anomodelo_meq=int_anomodelo_meq'
      'int_anofab_meq=int_anofab_meq'
      'int_nomecor_meq=int_nomecor_meq'
      'int_chassi_meq=int_chassi_meq'
      'int_tipomei=int_tipomei'
  ...
  object pmCancelar: TPopupMenu
    OnPopup = pmCancelarPopup
    Left = 1086
    Top = 318
    object btnCancelarRegistro: TMenuItem
      Caption = 'Cancelar Registro'
      OnClick = btnCancelarRegistroClick
    end
  end
  object OFI_DB_M_ORV_PRO: TfrxDBDataset
    UserName = 'OFI_DB_M_ORV_PRO'
    CloseDataSource = False
    FieldAliases.Strings = (
      'id_ordem=id_ordem'
      'id_cor=id_cor'
  ...
  object OFI_DB_M_ORV_SER: TfrxDBDataset
    UserName = 'OFI_DB_M_ORV_SER'
    CloseDataSource = False
    FieldAliases.Strings = (
      'id_ordem=id_ordem'
      'id_cor=id_cor'
  ...
  object OFI_FR_M_ORV: TfrxReport
    Version = '5.1.9'
    ...
    Datasets = <
      ...
      item
        DataSet = OFI_DB_M_ORV
        DataSetName = 'OFI_DB_M_ORV'
      end
      item
        DataSet = OFI_DB_M_ORV_PRO
        DataSetName = 'OFI_DB_M_ORV_PRO'
      end
      item
        DataSet = OFI_DB_M_ORV_SER
        DataSetName = 'OFI_DB_M_ORV_SER'
      end>
    Variables = <
      item
        Name = ' Externo'
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo23: TfrxMemoView
          Left = 562.393940000000000000
          Top = 190.535560000000000000
        ...
        object OFI_DB_M_ORVint_nomecli: TfrxMemoView
          Left = 52.031540000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."id_cliente"] - [OFI_DB_M_ORV."int_nomecli"]')
          ParentFont = False
        end
        object OFI_DB_M_ORVint_enderecocli: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[Trim(<OFI_DB_M_ORV."int_enderecocli">)],N'#186' [Trim(<OFI_DB_M_ORV.' +
              '"int_numerocli">)], [Trim(<OFI_DB_M_ORV."int_bairrocli">)]')
          ParentFont = False
          Formats = <
            item
            end
        ...
        object OFI_DB_M_ORVint_nomecid: TfrxMemoView
          Left = 550.929500000000000000
          Top = 95.267780000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."int_nomecid"] - [OFI_DB_M_ORV."int_ufcid"]')
          ParentFont = False
          Formats = <
            item
            end
        ...
        object OFI_DB_M_ORVint_cepcli: TfrxMemoView
          Left = 417.425480000000000000
          Top = 95.267780000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."int_cepcli"]')
          ParentFont = False
        end
        object OFI_DB_M_ORVint_telfix: TfrxMemoView
          Left = 52.354360000000000000
          Top = 114.165430000000000000
          Width = 187.929190000000000000
          Height = 15.118110240000000000
          DataField = 'int_telfix'
          DataSet = OFI_DB_M_ORV
          DataSetName = 'OFI_DB_M_ORV'
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."int_telfix"]')
          ParentFont = False
        end
        object OFI_DB_M_ORVint_cnpjcpfcli: TfrxMemoView
          Left = 417.425480000000000000
          Top = 76.590600000000000000
          Width = 94.708720000000000000
          Height = 15.118110240000000000
          DataSet = OFI_DB_M_ORV
          DataSetName = 'OFI_DB_M_ORV'
          Font.Charset = DEFAULT_CHARSET
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."int_cnpjcpfcli"]')
          ParentFont = False
        end
        object OFI_DB_M_ORVdta_emissao: TfrxMemoView
          Left = 631.197280000000000000
          Top = 171.960730000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."dta_emissao"] [OFI_DB_M_ORV."hor_emissao"]')
          ParentFont = False
          Formats = <
            item
            end
        ...
        object OFI_DB_M_ORVint_placa: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."int_placa"]')
          ParentFont = False
        end
        object OFI_DB_M_ORVint_nomevei: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."int_nomevei"]')
          ParentFont = False
        end
        object OFI_DB_M_ORVint_modelomve: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."int_modelomve"]')
          ParentFont = False
        end
        object OFI_DB_M_ORVint_chassivei: TfrxMemoView
          Left = 261.464750000000000000
          Top = 171.637910000000000000
          Width = 158.740260000000000000
          Height = 15.118110240000000000
          DataField = 'int_chassivei'
          DataSet = OFI_DB_M_ORV
          DataSetName = 'OFI_DB_M_ORV'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."int_chassivei"]')
          ParentFont = False
        end
        object OFI_DB_M_ORVint_anofabric: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."int_anofabric"]')
          ParentFont = False
        end
        object OFI_DB_M_ORVint_anomodelo: TfrxMemoView
          Left = 259.905690000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."int_anomodelo"]')
          ParentFont = False
        end
        object OFI_DB_M_ORVkm_atual: TfrxMemoView
          Left = 53.590600000000000000
          Top = 224.551330000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."km_atual"]')
          ParentFont = False
        end
        object OFI_DB_M_ORVint_nomecor: TfrxMemoView
          Left = 466.559370000000000000
          Top = 190.535560000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."int_nomecor"]')
          ParentFont = False
        end
        object OFI_DB_M_ORVint_motorvei: TfrxMemoView
          Left = 466.677490000000000000
          Top = 209.433210000000000000
          Width = 106.929190000000000000
          Height = 15.118110240000000000
          DataField = 'int_motorvei'
          DataSet = OFI_DB_M_ORV
          DataSetName = 'OFI_DB_M_ORV'
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."int_motorvei"]')
          ParentFont = False
        end
        object OFI_DB_M_ORVdta_entrega: TfrxMemoView
          Left = 630.677490000000000000
          Top = 190.535560000000000000
          Width = 79.370130000000000000
          Height = 15.118110240000000000
          DataField = 'dta_entrega'
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."dta_entrega"]')
          ParentFont = False
        end
        object OFI_DB_M_ORVid_tipo_os: TfrxMemoView
          Left = 631.079160000000000000
          Top = 209.433210000000000000
          Width = 86.929190000000000000
          Height = 15.118110240000000000
          DataSet = OFI_DB_M_ORV
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."int_nometio"]')
          ParentFont = False
        end
        object ft_tanque: TfrxMemoView
          Left = 466.559370000000000000
          Top = 171.960730000000000000
          Width = 109.929190000000000000
          Height = 15.118110240000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
        ...
        object OFI_DB_M_ORVobs_reclamacao: TfrxMemoView
          Left = 6.236240000000000000
          ...
          Font.Style = [fsBold]
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."obs_reclamacao"]')
          ParentFont = False
        end
        object OFI_DB_M_ORVobs_problema: TfrxMemoView
          Left = 370.645950000000000000
          Top = 272.346630000000000000
          Width = 343.937007870000000000
          Height = 18.897650000000000000
          StretchMode = smActualHeight
          DataField = 'obs_problema'
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."obs_problema"]')
          ParentFont = False
        end
        object Memo35: TfrxMemoView
          Left = 351.630180000000000000
          Top = 114.165430000000000000
        ...
        object OFI_DB_M_ORVint_telmov: TfrxMemoView
          Left = 417.425480000000000000
          Top = 114.165430000000000000
          Width = 172.929190000000000000
          Height = 15.118110240000000000
          DataField = 'int_telmov'
          DataSet = OFI_DB_M_ORV
          DataSetName = 'OFI_DB_M_ORV'
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."int_telmov"]')
          ParentFont = False
        end
        object Memo36: TfrxMemoView
          Left = 215.330860000000000000
          Top = 227.653680000000000000
        ...
        object OFI_DB_M_ORVint_nomeana: TfrxMemoView
          Left = 259.905690000000000000
          Top = 227.653680000000000000
          Width = 157.929141180000000000
          Height = 15.118110240000000000
          DataField = 'int_nomeana'
          DataSet = OFI_DB_M_ORV
          DataSetName = 'OFI_DB_M_ORV'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV."int_nomeana"]')
          ParentFont = False
        end
        object Memo24: TfrxMemoView
          Left = 513.236550000000000000
          Top = 76.590600000000000000
          Width = 47.574830000000000000
          Height = 15.118110240000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
        ...
        object Memo1: TfrxMemoView
          ...
          Font.Style = [fsBold]
          Memo.UTF8W = (
            'Ordem de Servi'#231'o - N'#186' [OFI_DB_M_ORV."id_ordem"]')
          ParentFont = False
        end
      ...
      object DetailData1: TfrxDetailData
        FillType = ftBrush
        Height = 15.677170240000000000
        Top = 461.102660000000000000
        Width = 718.110700000000000000
        DataSet = OFI_DB_M_ORV_PRO
        DataSetName = 'OFI_DB_M_ORV_PRO'
        RowCount = 0
        object OFI_DB_M_ORV_PROid_item: TfrxMemoView
          Left = 3.779530000000000000
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[OFI_DB_M_ORV_PRO."id_item"]')
          ParentFont = False
        end
        object OFI_DB_M_ORV_PROint_nomeite: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV_PRO."int_nomeite"]')
          ParentFont = False
        end
        object OFI_DB_M_ORV_PROint_nomeund: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[OFI_DB_M_ORV_PRO."int_nomeund"]')
          ParentFont = False
        end
        object OFI_DB_M_ORV_PROqtde: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[OFI_DB_M_ORV_PRO."qtde"]')
          ParentFont = False
        end
        object OFI_DB_M_ORV_PROvlr_unitario: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[OFI_DB_M_ORV_PRO."vlr_unitario"]')
          ParentFont = False
        end
        object OFI_DB_M_ORV_PROvlr_desconto: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[OFI_DB_M_ORV_PRO."vlr_desconto"]')
          ParentFont = False
        end
        object OFI_DB_M_ORV_PROvlr_liquido: TfrxMemoView
      ...
      object DetailData2: TfrxDetailData
        ...
        DataSetName = 'OFI_DB_M_ORV_SER'
        RowCount = 0
        object OFI_DB_M_ORV_SERid_item: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[OFI_DB_M_ORV_SER."id_item"]')
          ParentFont = False
        end
        object OFI_DB_M_ORV_SERint_nomeite: TfrxMemoView
          Left = 71.811070000000000000
          Width = 336.378170000000000000
          Height = 15.118120000000000000
          DataField = 'int_nomeite'
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_ORV_SER."int_nomeite"]')
          ParentFont = False
        end
        object OFI_DB_M_ORV_SERint_nomeund: TfrxMemoView
          Left = 409.968770000000000000
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[OFI_DB_M_ORV_SER."int_nomeund"]')
          ParentFont = False
        end
        object OFI_DB_M_ORV_SERqtde: TfrxMemoView
          Left = 442.205010000000000000
          Width = 41.574830000000000000
          Height = 15.118120000000000000
          DataField = 'qtde'
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[OFI_DB_M_ORV_SER."qtde"]')
          ParentFont = False
        end
        object OFI_DB_M_ORV_SERvlr_unitario: TfrxMemoView
          Left = 491.338900000000000000
          Width = 68.031540000000000000
          Height = 15.118120000000000000
          DataSet = OFI_DB_M_ORV_SER
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[OFI_DB_M_ORV_SER."vlr_unitario"]')
          ParentFont = False
        end
        object OFI_DB_M_ORV_SERvlr_desconto: TfrxMemoView
          Left = 566.929500000000000000
          Width = 71.811070000000000000
          Height = 15.118120000000000000
          DataSet = OFI_DB_M_ORV_SER
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[OFI_DB_M_ORV_SER."vlr_desconto"]')
          ParentFont = False
        end
        object OFI_DB_M_ORV_SERvlr_liquido: TfrxMemoView
          Left = 642.520100000000000000
          Width = 71.811070000000000000
          Height = 15.118120000000000000
          DataSet = OFI_DB_M_ORV_SER
      ...
      object MasterData3: TfrxMasterData
        ...
        object Memo44: TfrxMemoView
          Left = 508.016080000000000000
          Top = 95.267780000000000000
          Width = 41.795300000000000000
          Height = 15.118110240000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
        ...
        object Memo97: TfrxMemoView
          Left = 362.630180000000000000
          Top = 114.165430000000000000
          Width = 54.354360000000000000
          Height = 15.118110240000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
  ...
  object OFI_FR_M_ORV_SMP: TfrxReport
    Version = '5.1.9'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick]
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo23: TfrxMemoView
          Left = 562.393940000000000000
          Top = 102.535560000000000000
          Width = 67.252010000000000000
          Height = 15.118110240000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
        ...
        object Memo36: TfrxMemoView
          Left = 206.330860000000000000
          Top = 139.653680000000000000
      ...
      object DetailData1: TfrxDetailData
        ...
        object cmpUnitPec: TfrxMemoView
          Left = 491.338900000000000000
          Width = 68.031540000000000000
          Height = 15.118120000000000000
          DataSet = OFI_DB_M_ORV_PRO
        ...
        object cmpDescPec: TfrxMemoView
          Left = 563.149970000000000000
          Width = 75.590600000000000000
          Height = 15.118120000000000000
          DataSet = OFI_DB_M_ORV_PRO
      ...
      object Header2: TfrxHeader
        ...
        object lblUnitPec: TfrxMemoView
          Left = 487.559370000000000000
          Top = 20.897650000000000000
          Width = 71.811070000000000000
          Height = 17.007874015748030000
        ...
        object lblDescPec: TfrxMemoView
          Left = 566.929500000000000000
          Top = 20.897650000000000000
          Width = 71.811070000000000000
          Height = 17.007874015748030000
      ...
      object Header1: TfrxHeader
        ...
        object lblUnitSer: TfrxMemoView
          Left = 487.559370000000000000
          Top = 20.118120000000000000
          Width = 71.811070000000000000
          Height = 17.007874015748030000
        ...
        object lblDescSer: TfrxMemoView
          Left = 566.929500000000000000
          Top = 20.118120000000000000
          Width = 71.811070000000000000
          Height = 17.007874015748030000
      ...
      object DetailData2: TfrxDetailData
        ...
        object cmpUnitSer: TfrxMemoView
          Left = 491.338900000000000000
          Width = 68.031540000000000000
          Height = 15.118120000000000000
          DataSet = OFI_DB_M_ORV_SER
        ...
        object cmpDescSer: TfrxMemoView
          Left = 566.929500000000000000
          Width = 71.811070000000000000
          Height = 15.118120000000000000
          DataSet = OFI_DB_M_ORV_SER
      ...
      object MasterData3: TfrxMasterData
        ...
        object Memo99: TfrxMemoView
          Left = 207.330860000000000000
          Top = 138.653680000000000000
          Width = 52.795300000000000000
          Height = 15.118110240000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
      ...
      object DetailData3: TfrxDetailData
        ...
        object cmpUnitPec2: TfrxMemoView
          Left = 491.338900000000000000
          Width = 68.031540000000000000
          Height = 15.118120000000000000
          DataSet = OFI_DB_M_ORV_PRO
        ...
        object cmpDescPec2: TfrxMemoView
          Left = 563.149970000000000000
          Width = 75.590600000000000000
          Height = 15.118120000000000000
          DataSet = OFI_DB_M_ORV_PRO
        ...
        object cmpTotPec2: TfrxMemoView
          Left = 646.299630000000000000
          Width = 68.031540000000000000
          Height = 15.118120000000000000
          DataSet = OFI_DB_M_ORV_PRO
      ...
      object Header3: TfrxHeader
        ...
        object lblUnitPec2: TfrxMemoView
          Left = 487.559370000000000000
          Top = 18.897650000000000000
          Width = 71.811070000000000000
          Height = 17.007874020000000000
        ...
        object lblDescPec2: TfrxMemoView
          Left = 566.929500000000000000
          Top = 18.897650000000000000
          Width = 71.811070000000000000
          Height = 17.007874020000000000
        ...
        object lblTotPec2: TfrxMemoView
          Left = 642.520100000000000000
          Top = 18.897650000000000000
          Width = 71.811070000000000000
          Height = 17.007874020000000000
      ...
      object Header4: TfrxHeader
        ...
        object lblUnitSer2: TfrxMemoView
          Left = 487.559370000000000000
          Top = 20.118120000000000000
          Width = 71.811070000000000000
          Height = 17.007874015748030000
        ...
        object lblDescSer2: TfrxMemoView
          Left = 566.929500000000000000
          Top = 20.118120000000000000
          Width = 71.811070000000000000
          Height = 17.007874015748030000
        ...
        object lblTotSer2: TfrxMemoView
          Left = 642.520100000000000000
          Top = 20.118120000000000000
          Width = 71.811070000000000000
          Height = 17.007874015748030000
      ...
      object DetailData4: TfrxDetailData
        ...
        object cmpUnitSer2: TfrxMemoView
          Left = 491.338900000000000000
          Width = 68.031540000000000000
          Height = 15.118120000000000000
          DataSet = OFI_DB_M_ORV_SER
        ...
        object cmpDescSer2: TfrxMemoView
          Left = 566.929500000000000000
          Width = 71.811070000000000000
          Height = 15.118120000000000000
          DataSet = OFI_DB_M_ORV_SER
        ...
        object cmpTotSer2: TfrxMemoView
          Left = 642.520100000000000000
          Width = 71.811070000000000000
          Height = 15.118120000000000000
          DataSet = OFI_DB_M_ORV_SER
