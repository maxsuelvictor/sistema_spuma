...
type
  TOFI_FM_M_RQT = class(TPAD_FM_X_PAD)
...
procedure TOFI_FM_M_RQT.acAlterarExecute(Sender: TObject);
begin
...
procedure TOFI_FM_M_RQT.acCancelarExecute(Sender: TObject);
begin
   if Botoes(dso.DataSet, TAction(Sender).Tag,dmGeral.OFI_CD_M_ORV) then
     begin
       inherited;
...
procedure TOFI_FM_M_RQT.AbrirBuscas;
begin
...
procedure TOFI_FM_M_RQT.acExcluirExecute(Sender: TObject);
begin
  inherited;
  //Botoes(dso.DataSet, TAction(Sender).Tag,dmGeral.OFI_CD_M_ORV);
end;

procedure TOFI_FM_M_RQT.acGravarExecute(Sender: TObject);
var
  codigo: string;
begin
   if (dmGeral.CAD_CD_C_PAR_CTR.FieldByName('orv_id_tipo_mov_estoque').AsString = '') then
  ...
  if MessageDlg('Confirma a Gravação?', mtConfirmation, [mbYes, mbNo], 0) = mrYes then
    begin
     ...
     dmGeral.OFI_CD_M_ORV.Data :=
          dmGeral.OFI_CD_M_ORV.DataRequest(VarArrayOf([0, codigo,'','2','2']));
     AbrirBuscas;
     btnImprimirEspelho.Enabled := true;
    end
   else
...
procedure TOFI_FM_M_RQT.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  dmGeral.OFI_CD_M_ORV.Close;
  FreeAndNil(OFI_FM_M_RQT);
end;

procedure TOFI_FM_M_RQT.FormShow(Sender: TObject);
begin
  inherited;
  dmGeral.OFI_CD_M_ORV.Close;
  dmGeral.OFI_CD_M_ORV.Data := dmGeral.OFI_CD_M_ORV.DataRequest(VarArrayOf([0, '','','2','2']));
...
procedure TOFI_FM_M_RQT.pmCancelarPopup(Sender: TObject);
begin
  inherited;
   if (dmGeral.OFI_CD_M_ORV_ITE.FieldByName('CANCELADA').AsBoolean = False) then
    begin
       OFI_FM_M_RQT.pmCancelar.Items[0].Enabled := True;
    end
  else
    begin
       OFI_FM_M_RQT.pmCancelar.Items[0].Enabled := False;
    end;
end;

procedure TOFI_FM_M_RQT.pnlDespesasExit(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_RQT.pnlItensExit(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_RQT.txtBuscaItemButtonClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_RQT.txtBuscaItemExit(Sender: TObject);
var
...
procedure TOFI_FM_M_RQT.ChamaMecanicoTerceiro;
begin
...
procedure TOFI_FM_M_RQT.txtBuscaItemKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  if key = vk_f7 then
...
procedure TOFI_FM_M_RQT.txtDescricaoProblemaExit(Sender: TObject);
begin
  inherited;
  if btnCancelar.Focused or
       btnGrava.Focused  then
...
procedure TOFI_FM_M_RQT.txtLocalExit(Sender: TObject);
begin
  inherited;
  if btnCancelar.Focused or
       btnGrava.Focused  then
...
procedure TOFI_FM_M_RQT.txtPesquisaKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TOFI_FM_M_RQT.txtQtdeExit(Sender: TObject);
var
...
procedure TOFI_FM_M_RQT.txtTerceiroButtonClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_RQT.txtValorExit(Sender: TObject);
var
  SMPrincipal : TSMClient;
  seq_item: string;
begin
...
procedure TOFI_FM_M_RQT.txtVlrUnitarioExit(Sender: TObject);
var
  SMPrincipal : TSMClient;
  seq_item: string;
begin
...
procedure TOFI_FM_M_RQT.dbGridCalcCellColors(Sender: TObject; Field: TField;
  State: TGridDrawState; Highlight: Boolean; AFont: TFont; ABrush: TBrush);
begin
  inherited;
...
procedure TOFI_FM_M_RQT.dgDespesasIButtonClick(Sender: TObject);
begin
  inherited;
  try
...
procedure TOFI_FM_M_RQT.dgDespesasMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TOFI_FM_M_RQT.dgItensCalcCellColors(Sender: TObject; Field: TField;
  State: TGridDrawState; Highlight: Boolean; AFont: TFont; ABrush: TBrush);
begin
  inherited;
...
procedure TOFI_FM_M_RQT.dgItensDblClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_RQT.dgItensIButtonClick(Sender: TObject);
begin
  inherited;
{ try
    dgItensIButton.Enabled := false;
...
procedure TOFI_FM_M_RQT.dgItensMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TOFI_FM_M_RQT.dpkDataExit(Sender: TObject);
begin
  inherited;
  if btnCancelar.Focused or
       btnGrava.Focused  then
...
procedure TOFI_FM_M_RQT.Atualizar_xBusca;
begin
  if xbusca_item = '' then
     begin
...
procedure TOFI_FM_M_RQT.btnAddDespesasClick(Sender: TObject);
begin
  inherited;
  pnlDespesas.Enabled  := True;
...
procedure TOFI_FM_M_RQT.btnAddItensClick(Sender: TObject);
begin
  inherited;
  pnlItens.Enabled  := True;
...
procedure TOFI_FM_M_RQT.btnAddItensKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
   if Key = vk_F2 then
...
procedure TOFI_FM_M_RQT.btnCancelarRegClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_RQT.btnFiltroClick(Sender: TObject);
begin
  inherited;
    ...
    if (cbbPesquisa.ItemIndex = 0) then
       begin
        ...
        dmGeral.OFI_CD_M_ORV.DataRequest(
                VarArrayOf([cbbPesquisa.ItemIndex,txtPesquisa.Text,'','2']));
       end
    else
       begin
         if (cbbPesquisa.ItemIndex = 5) then
          begin
            ...
            dmGeral.OFI_CD_M_ORV.Data :=
              dmGeral.OFI_CD_M_ORV.DataRequest(
                VarArrayOf([10,txtPesquisa.Text,dmGeral.CAD_CD_C_PAR.FieldByName('ID_EMPRESA').AsString,'2','2']));
          end
         else
          begin
            dmGeral.OFI_CD_M_ORV.Close;
            dmGeral.OFI_CD_M_ORV.Data :=
              dmGeral.OFI_CD_M_ORV.DataRequest(
                VarArrayOf([cbbPesquisa.ItemIndex,txtPesquisa.Text,dmGeral.CAD_CD_C_PAR.FieldByName('ID_EMPRESA').AsString,'2','2']));
         end;
       end;
...
procedure TOFI_FM_M_RQT.btnImprimirEspelhoClick(Sender: TObject);
var
...
procedure TOFI_FM_M_RQT.cbbMecanicoEnter(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_RQT.cbbMecanicoExit(Sender: TObject);
var
  seq_item:string;
begin
  inherited;
...
procedure TOFI_FM_M_RQT.cbbPesquisaChange(Sender: TObject);
begin
  inherited;
  txtPesquisa.Text := '';
...
procedure TOFI_FM_M_RQT.cbbTerceiroEnter(Sender: TObject);
begin
  inherited;
  dmGeral.BusFornecedor(1,'%');
...
procedure TOFI_FM_M_RQT.cbbTerceiroExit(Sender: TObject);
var
  seq_item:string;
begin
  inherited;
...
procedure TOFI_FM_M_RQT.cbbTipoEnter(Sender: TObject);
begin
  inherited;
  dmGeral.BUS_PR_X_ORV_DES_TIP;
  cbbTipo.DropDown;
...
procedure TOFI_FM_M_RQT.cbbTipoExit(Sender: TObject);
begin
  inherited;
  if btnCancelar.Focused or
     btnGrava.Focused then
