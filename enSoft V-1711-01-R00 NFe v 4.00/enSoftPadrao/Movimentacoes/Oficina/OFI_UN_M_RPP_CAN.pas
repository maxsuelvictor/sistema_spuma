...
type
  TOFI_FM_M_RPP_CAN = class(TPAD_FM_X_FRM)
...
var
  OFI_FM_M_RPP_CAN: TOFI_FM_M_RPP_CAN;
...
procedure TOFI_FM_M_RPP_CAN.acSairExecute(Sender: TObject);
begin
  //inherited;
  Close;
end;

procedure TOFI_FM_M_RPP_CAN.btnSalvarClick(Sender: TObject);
begin
  //inherited;
...
procedure TOFI_FM_M_RPP_CAN.FormCreate(Sender: TObject);
begin
  //inherited;

end;

procedure TOFI_FM_M_RPP_CAN.FormShow(Sender: TObject);
begin
//  inherited;
