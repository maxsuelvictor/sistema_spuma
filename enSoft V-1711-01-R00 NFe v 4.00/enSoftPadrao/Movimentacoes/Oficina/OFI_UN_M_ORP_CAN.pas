...
type
  TOFI_FM_M_ORP_CAN = class(TPAD_FM_X_FRM)
...
var
  OFI_FM_M_ORP_CAN: TOFI_FM_M_ORP_CAN;

implementation

{$R *.dfm}

uses uDmGeral, OFI_UN_M_FEP;

procedure TOFI_FM_M_ORP_CAN.btnSalvarClick(Sender: TObject);
begin
  //inherited;
  ...
  Close;
  OFI_FM_M_FEP.btnIncluir.Enabled := false;
  OFI_FM_M_FEP.btnExcluir.Enabled := false;
end;




procedure TOFI_FM_M_ORP_CAN.acSairExecute(Sender: TObject);
begin
 // inherited;
   Close;
end;

procedure TOFI_FM_M_ORP_CAN.FormCreate(Sender: TObject);
begin
 // inherited;

end;

procedure TOFI_FM_M_ORP_CAN.FormShow(Sender: TObject);
begin
 // inherited;
