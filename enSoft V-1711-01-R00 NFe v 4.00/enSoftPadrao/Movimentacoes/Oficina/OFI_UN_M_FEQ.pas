...
type
  TOFI_FM_M_FEQ = class(TPAD_FM_X_PAD)
    gbIOR: TGroupBox;
    lblNOrdem: TLabel;
    lblCliente: TLabel;
    txtNOrdem: TwwDBEdit;
...
procedure TOFI_FM_M_FEQ.acAdicionaExecute(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.acAlterarExecute(Sender: TObject);
begin
...
procedure TOFI_FM_M_FEQ.acCancelarExecute(Sender: TObject);
begin
  inherited;
  if Botoes(dso.DataSet, TAction(Sender).Tag,dmGeral.OFI_CD_M_ORV) then
     begin
...
procedure TOFI_FM_M_FEQ.HabDesabCampos;
begin
...
procedure  TOFI_FM_M_FEQ.HabilDesabCamposCheque;
begin
   dmGeral.BusFormaPgtos(0,dmGeral.OFI_CD_M_ORV_TIT.FieldByName('ID_FORMA_PAG').Text);
...
procedure  TOFI_FM_M_FEQ.HabilDesabCamposChequeServico;
begin
...
procedure TOFI_FM_M_FEQ.lblTituloClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.pnlTitExit(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.pnlTitSerExit(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.acExcluirExecute(Sender: TObject);
begin
  inherited;
//   Botoes(dso.DataSet, TAction(Sender).Tag,dmGeral.OFI_CD_M_ORV);
end;

procedure TOFI_FM_M_FEQ.acGravarExecute(Sender: TObject);
var
  codigo: string;
     ...
     begin
         ...
         dmGeral.OFI_CD_M_ORV.Data :=
                dmGeral.OFI_CD_M_ORV.DataRequest(VarArrayOf([0, codigo,
                                                  dmGeral.CAD_CD_C_PAR.FieldByName('ID_EMPRESA').AsString,'3','3']));
         AbrirBusca;
         txtCredDisp.Text := '';
         xcred_disp := 0;
         btnImprimirEspelho.Enabled := true;
...
procedure TOFI_FM_M_FEQ.AbrirBusca;
begin
  dmGeral.BusFormaPgtos(1,'%');
  dmGeral.BusCondPgto(1,'%');
end;

procedure TOFI_FM_M_FEQ.btmCancelamentoClick(Sender: TObject);
var
  codFiscal:String;
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.BtnaddTitPecSerClick(Sender: TObject);
begin
  inherited;
  pnlTit.Enabled  := True;
...
procedure TOFI_FM_M_FEQ.btnAddTitSerClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.btnFiltroClick(Sender: TObject);
begin
  inherited;
  ...
  try
    ...
    if cbbPesquisa.ItemIndex in [0,1] then
       begin
          ...
          dmGeral.OFI_CD_M_ORV.DataRequest(
                  VarArrayOf([cbbPesquisa.ItemIndex, txtPesquisa.Text,dmGeral.CAD_CD_C_PAR.FieldByName('ID_EMPRESA').AsString,'3','3']));
       end;
    ...
    if cbbPesquisa.ItemIndex in [2,3] then
       begin
          ...
          dmGeral.OFI_CD_M_ORV.Data :=
          dmGeral.OFI_CD_M_ORV.DataRequest(
                  VarArrayOf([cbbPesquisa.ItemIndex+1, txtPesquisa.Text,dmGeral.CAD_CD_C_PAR.FieldByName('ID_EMPRESA').AsString,'3','3']));
       end;
    ...
    if cbbPesquisa.ItemIndex in [4,5] then
       begin
          ...
          dmGeral.OFI_CD_M_ORV.Data :=
          dmGeral.OFI_CD_M_ORV.DataRequest(
                  VarArrayOf([cbbPesquisa.ItemIndex+5, txtPesquisa.Text,dmGeral.CAD_CD_C_PAR.FieldByName('ID_EMPRESA').AsString,'3','3']));
       end;
...
procedure TOFI_FM_M_FEQ.btnImprimirEspelhoClick(Sender: TObject);
var
...
begin
  ...
  if not dmGeral.OFI_CD_M_ORV.IsEmpty then
      begin
        ...
        dmGeral.BusCodigoRevListMestre(true,false,OFI_FM_M_FEQ.Name,xCodLme,xRevLme,nil);
...
procedure TOFI_FM_M_FEQ.btnReaberturaClick(Sender: TObject);
VAR
  codFiscal:String;
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.cbbCondPagEnter(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.cbbCondPagExit(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.cbbFormaPagSerEnter(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.cbbFormaPagSerExit(Sender: TObject);
begin
  inherited;
   if btnCancelar.Focused or
     btnGrava.Focused then
...
procedure TOFI_FM_M_FEQ.cbbFormPagPecSerEnter(Sender: TObject);
begin
  inherited;
   dmGeral.BUS_CD_C_CPG.Close;
  dmGeral.BUS_CD_C_CPG.Data :=
...
procedure TOFI_FM_M_FEQ.cbbFormPagPecSerExit(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.cbbPesquisaChange(Sender: TObject);
begin
  inherited;
  txtPesquisa.Text := '';
...
procedure TOFI_FM_M_FEQ.dbGridCalcCellColors(Sender: TObject; Field: TField;
  State: TGridDrawState; Highlight: Boolean; AFont: TFont; ABrush: TBrush);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.dgTitPecSerIButtonClick(Sender: TObject);
var
  total_cred:currency;
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.dgTitPecSerMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.dgTitPecSerRowChanged(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.dgTitSerIButtonClick(Sender: TObject);
var
  total_cred:currency;
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.dgTitSerMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.dgTitSerRowChanged(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.ExibirFormasPgto;
begin
  dmGeral.BUS_CD_C_CPG.Close;
  dmGeral.BUS_CD_C_CPG.Data :=
          dmGeral.BUS_CD_C_CPG.DataRequest(VarArrayOf([0,dmGeral.OFI_CD_M_ORV.FieldByName('ID_CONDICAO_PAG').AsString]));
...
procedure TOFI_FM_M_FEQ.dpkVencimentoPecSerExit(Sender: TObject);
begin
  inherited;
   if btnCancelar.Focused or
     btnGrava.Focused  then
...
procedure TOFI_FM_M_FEQ.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  dmGeral.OFI_CD_M_ORV.Close;
  FreeAndNil(OFI_FM_M_FEQ);
end;

procedure TOFI_FM_M_FEQ.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.txtAgenciaPecSerExit(Sender: TObject);
begin
  inherited;
  if btnCancelar.Focused or
     btnGrava.Focused  then
...
procedure TOFI_FM_M_FEQ.txtAgenciaSerExit(Sender: TObject);
begin
  inherited;
   if btnCancelar.Focused or
     btnGrava.Focused  then
...
procedure TOFI_FM_M_FEQ.txtBancoPecSerExit(Sender: TObject);
begin
  inherited;
   if btnCancelar.Focused or
     btnGrava.Focused  then
...
procedure TOFI_FM_M_FEQ.txtBancoSerExit(Sender: TObject);
begin
  inherited;
  if btnCancelar.Focused or
     btnGrava.Focused  then
...
procedure TOFI_FM_M_FEQ.txtChequePecSerExit(Sender: TObject);
begin
  inherited;
  if btnCancelar.Focused or
     btnGrava.Focused  then
...
procedure TOFI_FM_M_FEQ.txtChequeSerExit(Sender: TObject);
begin
  inherited;
  if btnCancelar.Focused or
     btnGrava.Focused  then
...
procedure TOFI_FM_M_FEQ.txtContaPecSerExit(Sender: TObject);
begin
  inherited;
  if btnCancelar.Focused or
     btnGrava.Focused  then
...
procedure TOFI_FM_M_FEQ.txtContaSerExit(Sender: TObject);
begin
  inherited;
  if btnCancelar.Focused or
     btnGrava.Focused  then
...
procedure TOFI_FM_M_FEQ.txtCredGerExit(Sender: TObject);
var
  total_cred:currency;
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.txtCredPecasExit(Sender: TObject);
var
  total_cred:currency;
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.txtCredServicoExit(Sender: TObject);
var
  total_cred:currency;
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.txtDiasPecSerExit(Sender: TObject);
begin
  inherited;
   if btnCancelar.Focused or
     btnGrava.Focused  then
...
procedure TOFI_FM_M_FEQ.txtDiasSerExit(Sender: TObject);
begin
  inherited;
  if btnCancelar.Focused or
     btnGrava.Focused  then
...
procedure TOFI_FM_M_FEQ.txtEmitentePecSerExit(Sender: TObject);
 var
  id_titulo: string;
  cheValido:Boolean;
begin
...
procedure TOFI_FM_M_FEQ.txtEmitenteSerExit(Sender: TObject);
 var
  id_titulo: string;
  cheValido:Boolean;
begin
...
procedure TOFI_FM_M_FEQ.txtFpgEntradaButtonClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.txtFpgEntradaEnter(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.txtFpgEntradaExit(Sender: TObject);
begin
  inherited;
  if btnCancelar.Focused or
     btnGrava.Focused  then
...
procedure TOFI_FM_M_FEQ.txtGerFpgButtonClick(Sender: TObject);
begin
  inherited;
  PSQ_FM_X_FPG := TPSQ_FM_X_FPG.Create(Self);
...
procedure TOFI_FM_M_FEQ.txtGerFpgExit(Sender: TObject);
begin
  inherited;
  if btnCancelar.Focused or
     btnGrava.Focused  then
...
procedure TOFI_FM_M_FEQ.txtPesquisaKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.txtQtdeParcExit(Sender: TObject);
var
  valor:Currency;
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.txtValorPecSerExit(Sender: TObject);
var
  id_titulo: string;
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.txtValorSerExit(Sender: TObject);
var
  id_titulo: string;
begin
  inherited;
...
procedure TOFI_FM_M_FEQ.dpkVencimentoSerExit(Sender: TObject);
begin
  inherited;
   if btnCancelar.Focused or
     btnGrava.Focused  then
...
procedure TOFI_FM_M_FEQ.txtVlrEntradaExit(Sender: TObject);
begin
  inherited;
   if btnCancelar.Focused or
     btnGrava.Focused  then
...
procedure TOFI_FM_M_FEQ.txtVlrParcelaExit(Sender: TObject);
var
  valor:Currency;
begin
  inherited;
