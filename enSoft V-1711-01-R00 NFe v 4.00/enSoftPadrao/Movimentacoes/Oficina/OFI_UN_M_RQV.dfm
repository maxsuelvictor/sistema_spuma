inherited OFI_FM_M_RQV: TOFI_FM_M_RQV
  ClientHeight = 560
  ExplicitLeft = -73
  ExplicitWidth = 1156
  ExplicitHeight = 588
  ...
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      ExplicitWidth = 819
      ExplicitHeight = 493
      object gbInfoOrdemServicos: TGroupBox
        Left = 2
        Top = 5
        Width = 807
        Height = 76
        Caption = 'Informa'#231#245'es da Ordem de Servi'#231'os'
        TabOrder = 0
        object lblNumeroOrdem: TLabel
          Left = 13
          Top = 23
          Width = 57
          Height = 13
      ...
      object gbObservacoes: TGroupBox
        ...
        object txtDescricaoProblema: TwwDBEdit
          Left = 4
          Top = 27
          Width = 301
          Height = 147
      ...
      object gbDespesas: TGroupBox
        ...
        object pnlDespesas: TPanel
          ...
          object cbbTipo: TwwDBLookupCombo
            ...
            DropDownAlignment = taLeftJustify
            Selected.Strings = (
              'DESCRICAO'#9'10'#9'DESCRICAO'#9'F'
              'CODIGO'#9'5'#9'CODIGO'#9'F')
            DataField = 'tipo'
            DataSource = dsoDes
            LookupTable = dmGeral.BUS_CD_X_ORV_DES_TIP
            LookupField = 'CODIGO'
            TabOrder = 2
            AutoDropDown = False
            ShowButton = True
        ...
        object btnAddDespesas: TBitBtn
          ...
          Glyph.Data = {
            ...
            0000}
          TabOrder = 1
          OnClick = btnAddDespesasClick
        end
        object dgDespesas: TwwDBGrid
          Left = 3
          Top = 53
          Width = 489
          Height = 121
          Selected.Strings = (
            'dta_despesa'#9'13'#9'Data'#9#9
            'local'#9'26'#9'Local'#9'F'#9
            'int_desctipo'#9'20'#9'Tipo'#9'T'
            'vlr_despesa'#9'12'#9'Valor'#9#9)
          ...
          TitleButtons = False
          UseTFields = False
          OnMouseUp = dgDespesasMouseUp
          object dgDespesasIButton: TwwIButton
            Left = -1
            Top = -1
            Width = 21
            Height = 21
            ...
            Glyph.Data = {
              ...
              FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
              B102}
            OnClick = dgDespesasIButtonClick
          end
        end
      end
      object gbItens: TGroupBox
        ...
        Width = 811
        Height = 221
        Caption = 'Requisi'#231#227'o de Pe'#231'as e Servi'#231'os'
        TabOrder = 3
        ...
        object dgItens: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'int_nomeite'#9'33'#9'Descri'#231#227'o'#9'T'
            'int_nomeund'#9'4'#9'Und'#9'T'
            'int_nomemec'#9'15'#9'Mec'#226'nico'#9'T'
            'int_nometer'#9'15'#9'Terceiro'#9'T'
            'qtde'#9'6'#9'Qtde'#9'T'
            'vlr_unitario'#9'9'#9'Vlr. Unit'#9'T'
            'vlr_desconto'#9'9'#9'Vlr. Desc'#9'T'
            'vlr_liquido'#9'9'#9'Vlr L'#237'quido'#9'T'
            'id_requisicao'#9'9'#9'Cod. Req.'#9'T')
          IniAttributes.Delimiter = ';;'
          IniAttributes.UnicodeIniFile = False
          TitleColor = clBtnFace
          FixedCols = 0
        ...
        object txtVlrDespesas: TwwDBEdit
          Left = 630
          Top = 195
          Width = 78
          Height = 21
  ...
  inherited pnlTop: TJvPanel
    inherited pnlCima: TJvPanel
      inherited lblTitulo: TLabel
        Caption = 'Requisi'#231#227'o de Ve'#237'culos'
      end
    end
  end
  ...
  object dsoDes: TwwDataSource [4]
    DataSet = dmGeral.OFI_CD_M_ORV_DES
    Left = 848
    Top = 32
  end
  object dsoIte: TwwDataSource [5]
  ...
  inherited imgBotoesAtivoLa: TImageList
    Bitmap = {
      
  ...
  object pmCancelar: TPopupMenu
    ...
    Left = 972
    Top = 443
    object btnCancelarReg: TMenuItem
      Caption = 'Cancelar Registro'
      OnClick = btnCancelarRegClick
    end
  end
  object OFI_XL_M_RQV: TfrxXLSExport
    UseFileCache = True
    ShowProgress = True
  ...
  object OFI_FR_M_RQV2: TfrxReport
    Version = '5.1.9'
    ...
    Datasets = <
      ...
      item
        DataSet = OFI_DB_M_RQV
        DataSetName = 'OFI_DB_M_RQV'
      end
      item
        DataSet = OFI_DB_M_RQV_ITE
        DataSetName = 'OFI_DB_M_RQV_ITE'
      end>
    Variables = <
      item
        Name = ' Externo'
    ...
    object Page1: TfrxReportPage
      ...
      ColumnWidth = 42.400000000000000000
      object Header1: TfrxHeader
        ...
        object ft_usuario: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            'Usu'#225'rio: [ft_usuario]')
          ParentFont = False
        end
        object ft_dataSistema: TfrxMemoView
        ...
        object ft_horarioSistema: TfrxMemoView
        ...
        object OFI_DB_M_RQVint_nomecli: TfrxMemoView
          Left = 74.779530000000000000
          Top = 96.385900000000000000
        ...
        object OFI_DB_M_RQVid_ordem: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            ': [OFI_DB_M_RQV."id_ordem"]')
          ParentFont = False
        end
        object OFI_DB_M_RQVint_chassi: TfrxMemoView
          Left = 75.590600000000000000
          Top = 128.181200000000000000
          Width = 226.771800000000000000
          Height = 15.118120000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            ': [OFI_DB_M_RQV."int_chassi"]')
          ParentFont = False
        end
        object OFI_DB_M_RQVint_placavei: TfrxMemoView
          Left = 75.102350000000000000
          Top = 144.519790000000000000
          Width = 226.771800000000000000
          Height = 15.118120000000000000
          DataSet = OFI_DB_M_RQV
          DataSetName = 'OFI_DB_M_RQV'
          ...
          Font.Style = []
          Memo.UTF8W = (
            ': [OFI_DB_M_RQV."int_placavei"]')
          ParentFont = False
        end
        object OFI_DB_M_RQVint_modelomve: TfrxMemoView
          Left = 75.590600000000000000
          Top = 160.976500000000000000
          Width = 226.771800000000000000
          Height = 15.118120000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            ': [OFI_DB_M_RQV."int_modelomve"]')
          ParentFont = False
        end
        object OFI_DB_M_RQVint_nomecor: TfrxMemoView
          Left = 75.590600000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            ': [OFI_DB_M_RQV."int_nomecor"]')
          ParentFont = False
        end
        object OFI_DB_M_RQVint_fabricadovei: TfrxMemoView
          Left = 75.590600000000000000
          Top = 192.992270000000000000
          Width = 226.771800000000000000
          Height = 15.118120000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            ': [OFI_DB_M_RQV."int_fabricadovei"]')
          ParentFont = False
        end
        object Line2: TfrxLineView
          Left = 0.338590000000000000
          Top = 216.448980000000000000
          Width = 302.362400000000000000
          Color = clBlack
          Diagonal = True
        end
      ...
      object DetailData1: TfrxDetailData
        ...
        RowCount = 0
        Stretched = True
        object OFI_DB_M_RQV_ITEqtde: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[OFI_DB_M_RQV_ITE."qtde"]')
          ParentFont = False
        end
        object OFI_DB_M_RQV_ITEid_item: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[OFI_DB_M_RQV_ITE."id_item"]')
          ParentFont = False
        end
        object OFI_DB_M_RQV_ITEint_nomeite: TfrxMemoView
          Left = 50.929190000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[OFI_DB_M_RQV_ITE."int_nomeite"]')
          ParentFont = False
        end
        object Memo15: TfrxMemoView
          Left = 190.771800000000000000
      ...
      object MasterData2: TfrxMasterData
        ...
        object Memo10: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            'Requisi'#231#227'o: [OFI_DB_M_RQV."id_requisicao"]')
          ParentFont = False
        end
        object Memo11: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            'Data: [OFI_DB_M_RQV."dta_requisicao"]')
          ParentFont = False
        end
  ...
  object OFI_PD_M_RQV: TfrxPDFExport
    UseFileCache = True
    ShowProgress = True
    OverwritePrompt = False
    DataOnly = False
  ...
  object OFI_DB_M_RQV: TfrxDBDataset
    UserName = 'OFI_DB_M_RQV'
    CloseDataSource = False
    FieldAliases.Strings = (
      'int_selecao=int_selecao'
      'id_ordem=id_ordem'
      'id_requisicao=id_requisicao'
      'dta_requisicao=dta_requisicao'
      'int_nomevei=int_nomevei'
      'int_placavei=int_placavei'
      'int_chassi=int_chassi'
      'int_fabricadovei=int_fabricadovei'
      'int_modelomve=int_modelomve'
      'int_nomecor=int_nomecor'
      'BUS_SQ_R_RQV_ITE=BUS_SQ_R_RQV_ITE'
      'int_nomecli=int_nomecli')
    DataSet = dmGeral.OFI_CD_R_RQV
    BCDToCurrency = False
    Left = 226
    Top = 240
  end
  object OFI_DB_M_RQV_ITE: TfrxDBDataset
    UserName = 'OFI_DB_M_RQV_ITE'
    OnCheckEOF = OFI_DB_M_RQV_ITECheckEOF
    CloseDataSource = False
    FieldAliases.Strings = (
      'id_ordem=id_ordem'
      'id_cor=id_cor'
    ...
    DataSet = dmGeral.OFI_CD_R_RQV_ITE
    BCDToCurrency = False
    Left = 130
    Top = 240
  end
  object OFI_FR_M_RQV: TfrxReport
    Version = '5.1.9'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick]
    ...
    PrintOptions.Printer = 'Default'
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 42627.378019780100000000
    ReportOptions.LastChange = 42627.378019780100000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
  ...
  object OFI_FR_M_RQV_A4: TfrxReport
    Version = '5.1.9'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick]
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo1: TfrxMemoView
          ...
          Font.Style = [fsBold]
          Memo.UTF8W = (
            'Requisi'#231#227'o de Ve'#237'culo')
          ParentFont = False
        end
        object imgEmpresa1: TfrxPictureView
          Left = 585.008040000000000000
      ...
      object Footer1: TfrxFooter
        ...
        object Memo29: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<OFI_DB_M_RQV_ITE."vlr_liquido">,DetailData1)]')
          ParentFont = False
        end
        object Memo30: TfrxMemoView
          Left = 578.000000000000000000
          Top = 4.472170000000000000
          Width = 69.283550000000000000
          Height = 15.118120000000000000
          DataSet = OFI_DB_M_RQV_ITE
          DataSetName = 'OFI_DB_M_RQV_ITE'
          DisplayFormat.FormatStr = '%2.2n'
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<OFI_DB_M_RQV_ITE."vlr_desconto">,DetailData1)]')
          ParentFont = False
        end
      end
      object MasterData1: TfrxMasterData
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 718.110700000000000000
        Condition = 'OFI_DB_M_RQV."id_requisicao"'
        ReprintOnNewPage = True
        object Line3: TfrxLineView
  ...
  object OFI_FR_M_RQV_8MM: TfrxReport
    Version = '5.1.9'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick]
