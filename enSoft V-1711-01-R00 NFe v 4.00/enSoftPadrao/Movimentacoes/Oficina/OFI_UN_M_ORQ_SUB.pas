...
type
  TOFI_FM_M_ORQ_SUB = class(TPAD_FM_X_PSQ)
    wwDBGrid1: TwwDBGrid;
...
var
  OFI_FM_M_ORQ_SUB: TOFI_FM_M_ORQ_SUB;

implementation

{$R *.dfm}

uses uDmGeral, OFI_UN_M_ORQ;

procedure TOFI_FM_M_ORQ_SUB.btnImportarClick(Sender: TObject);
var
       ...
       if (dmGeral.BUS_CD_M_ORV.RecordCount>0) then
         begin
           ...
           while (NOT dmGeral.BUS_CD_M_ORV.EOF) do
             ...
             OFI_FM_M_ORQ.btnAddItens.Enabled := false;
...
procedure TOFI_FM_M_ORQ_SUB.btnPesquisaClick(Sender: TObject);
begin
  inherited;
...
procedure TOFI_FM_M_ORQ_SUB.dbGridDblClick(Sender: TObject);
begin
 // inherited;

end;

procedure TOFI_FM_M_ORQ_SUB.FormClose(Sender: TObject;
