inherited EST_FM_M_NFC: TEST_FM_M_NFC
  ClientHeight = 536
  ClientWidth = 1201
  ExplicitWidth = 1207
  ExplicitHeight = 564
  ...
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object lblVlrIcmsSubstituido: TLabel
        Left = 664
        Top = 446
        Width = 46
        Height = 13
      ...
      object lblVlrIcmsNormal: TLabel
        Left = 518
        Top = 446
        Width = 46
        Height = 13
      ...
      object lblVlrBaseNormal: TLabel
        Left = 445
        Top = 446
        Width = 41
        Height = 13
      ...
      object lblNotasDisponiveis: TLabel
        Left = 4
        Top = 138
        Width = 300
        Height = 13
        AutoSize = False
        Caption = 'Notas Dispon'#237'veis'
        Color = 14342874
        FocusControl = txtNumero
        ParentColor = False
      end
      ...
      object lblItensDisponiveis: TLabel
        Left = 4
        Top = 268
        Width = 300
        Height = 13
      ...
      object lblIndicadorFrete: TLabel
        Left = 465
        Top = 98
        Width = 100
        Height = 13
        Caption = 'Indicador de Frete :'
      end
      ...
      object txtEmitente: TJvDBComboEdit
        Left = 167
        Top = 24
        Width = 76
        Height = 21
        ...
        TabOrder = 2
        OnButtonClick = txtEmitenteButtonClick
        OnExit = txtEmitenteExit
        OnKeyDown = txtEmitenteKeyDown
      end
      ...
      object dgItensDisponiveis: TwwDBGrid
        Left = 373
        Top = 152
        Width = 506
        Height = 270
        Selected.Strings = (
          ...
          'int_desc_item'#9'19'#9'Descri'#231#227'o'#9'T'
          'int_nometam'#9'4'#9'Tam'#9'T'
          'int_nomecor'#9'10'#9'Cor'#9'T'
          'qtde'#9'5'#9'Qtde'#9'F'
          'vlr_unitario'#9'9'#9'Vlr. Unit'#225'rio'#9'T'
          'vlr_liquido'#9'9'#9'Vlr. L'#237'quido'#9'T')
        IniAttributes.Delimiter = ';;'
        IniAttributes.UnicodeIniFile = False
        TitleColor = clBtnFace
        OnRowChanged = dgItensDisponiveisRowChanged
        FixedCols = 0
        ShowHorzScrollBar = True
        DataSource = dsoItensDisponiveis
        TabOrder = 17
        ...
        TitleButtons = False
        UseTFields = False
        OnEnter = dgItensDisponiveisEnter
        OnExit = dgItensDisponiveisExit
        OnFieldChanged = dgItensDisponiveisFieldChanged
        object dgItensDisponiveisIButton: TwwIButton
          Left = -1
          Top = -1
          Width = 21
          Height = 21
          ...
          Glyph.Data = {
            ...
            FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
            0000}
          OnClick = dgItensDisponiveisIButtonClick
        end
      end
      object dpkDtaEmissao: TJvDBDateEdit
        Left = 513
        Top = 48
        Width = 90
        Height = 21
      ...
      object dgItensDaNota: TwwDBGrid
        Left = 4
        Top = 282
        Width = 356
        Height = 140
        Selected.Strings = (
          'id_item'#9'10'#9'C'#243'digo'#9'F'
          'int_nomeite'#9'19'#9'Descri'#231#227'o'#9'F'
          'int_nometam'#9'4'#9'Tam'#9'F'
          'int_nomecor'#9'10'#9'Cor'#9'F'
          'qtde_sld_orig'#9'6'#9'Saldo'#9'F')
        IniAttributes.Delimiter = ';;'
        IniAttributes.UnicodeIniFile = False
        TitleColor = clBtnFace
        FixedCols = 0
        ShowHorzScrollBar = True
        DataSource = dsoEmiItensNota
        PopupMenu = pmAdicionarNovosItens
        ReadOnly = True
        TabOrder = 16
        TitleAlignment = taLeftJustify
        TitleFont.Charset = DEFAULT_CHARSET
        ...
        TitleButtons = False
        UseTFields = False
        OnDblClick = dgItensDaNotaDblClick
      end
      object dgNotasDisponiveis: TwwDBGrid
        Left = 5
        Top = 152
        Width = 356
        Height = 100
        Selected.Strings = (
          'id_fiscal_dev'#9'12'#9'Controle'#9'T'
          'int_numero'#9'11'#9'N'#250'mero'#9'T'
          'int_serie'#9'8'#9'S'#233'rie'#9'T'
          'int_subserie'#9'9'#9'Sub-S'#233'rie'#9'T'
          'int_dtaemissao'#9'10'#9'Emiss'#227'o'#9'T')
        IniAttributes.Delimiter = ';;'
        IniAttributes.UnicodeIniFile = False
        TitleColor = clBtnFace
        FixedCols = 0
        ShowHorzScrollBar = True
        DataSource = dsoEmiNotas
        PopupMenu = pmAdicionarNovosItens
        ReadOnly = True
        TabOrder = 15
        TitleAlignment = taLeftJustify
        ...
        TitleButtons = False
        UseTFields = False
        OnDblClick = dgNotasDisponiveisDblClick
      end
      object txtEmitenteDescricao: TDBMemo
        Left = 251
        Top = 24
        Width = 425
        Height = 21
      ...
      object dpkDtaDocumento: TJvDBDateEdit
        Left = 685
        Top = 48
        Width = 90
        Height = 21
        ...
        ShowNullDate = False
        TabOrder = 9
        OnExit = dpkDtaDocumentoExit
      end
      object cbbIndFrete: TJvDBComboBox
        Left = 571
        Top = 95
        Width = 204
        Height = 21
  ...
  object dsoEmiNotas: TwwDataSource [4]
    DataSet = dmGeral.FAT_CD_M_NFE_DEV
    Left = 568
    Top = 227
  end
  object dsoEmiItensNota: TwwDataSource [5]
    DataSet = dmGeral.FAT_CD_M_NFE_DEV_ITE
    Left = 560
    Top = 395
  end
  object dsoItensDisponiveis: TwwDataSource [6]
  ...
  inherited imgBotoesAtivo: TImageList
    ...
    Top = 51
    Bitmap = {
      494C01010800A800280218001800FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesInativo: TImageList
    ...
    Top = 475
    Bitmap = {
      
  ...
  inherited ImgPequena: TImageList
    ...
    Top = 51
    Bitmap = {
      494C01011200000178020E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited ImgPequenaVe: TImageList
    ...
    Top = 179
    Bitmap = {
      
  ...
  object pmAdicionarNovosItens: TPopupMenu
    Left = 448
    Top = 243
    object btnAdicionarNovoItem: TMenuItem
      Caption = 'Adicionar Novos Itens a Serem Devolvidos'
      OnClick = btnAdicionarNovoItemClick
    end
  end
end
