inherited EST_FM_M_CTE: TEST_FM_M_CTE
  Caption = 'EST_FM_M_CTE'
  ClientHeight = 519
  ClientWidth = 1225
  ExplicitWidth = 1231
  ExplicitHeight = 547
  ...
  inherited pnlEsquerda: TPanel
    ...
    inherited pnlDatagrid: TPanel
      ...
      inherited dbGrid: TwwDBGrid
        Height = 287
        Selected.Strings = (
          'id_controle'#9'10'#9'C'#243'digo'#9'F'
          'dta_contagem'#9'10'#9'Data'#9'F'
          'dta_movimento'#9'15'#9'Atualizado em'#9'F')
  ...
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object cbbLocalizacao: TwwDBLookupCombo
        Left = 183
        Top = 39
        Width = 148
        Height = 21
        ...
        DataSource = dso
        LookupTable = dmGeral.BUS_CD_C_ITE_LOC_2
        LookupField = 'loca_rua'
        Color = clWhite
        TabOrder = 2
        AutoDropDown = False
        ShowButton = True
        ...
        AllowClearKey = False
        ShowMatchText = True
        OnEnter = cbbLocalizacaoEnter
        OnExit = cbbLocalizacaoExit
      end
      object gbItens: TGroupBox
        ...
        object pnItens: TPanel
          ...
          object txtVlrCusto: TDBEdit
            ...
            DataSource = dsItens
            TabOrder = 6
            OnExit = txtVlrCustoExit
          end
          object txtDiferenca: TDBEdit
            Left = 537
            Top = 13
            Width = 64
            Height = 21
        ...
        object grdItens: TwwDBGrid
          ...
          Height = 242
          Selected.Strings = (
            'id_item'#9'16'#9'C'#243'digo'#9#9
            'int_nomeite'#9'34'#9'Descri'#231#227'o'#9#9
            'int_nomeund'#9'3'#9'Und'#9#9
            'int_nomecor'#9'11'#9'Cor'#9#9
            'int_nometam'#9'11'#9'Tamanho'#9#9
            'num_lote'#9'15'#9'Nro lote'#9#9
            'dta_vencimento'#9'10'#9'Vencimento'#9'F'#9
            'contagem'#9'10'#9'Contagem'#9#9
            'int_rua'#9'4'#9'Rua'#9'F'#9'Localiza'#231#227'o'
            'int_prateleira'#9'4'#9'Prateleira'#9'F'#9'Localiza'#231#227'o'
            'int_escaninho'#9'4'#9'Escaninho'#9'F'#9'Localiza'#231#227'o')
        ...
        object pnlDtaVenc: TPanel
          ...
          object txtDtaVenc: TJvDBDateEdit
            Left = 7
            Top = 20
            Width = 121
            Height = 21
      ...
      object dpkDataIni: TJvDBDateEdit
        Left = 183
        Top = 65
        Width = 90
        Height = 21
        DataField = 'per_inicial'
        DataSource = dso
        ShowNullDate = False
        TabOrder = 4
        OnExit = dpkDataIniExit
      end
      ...
      object chkCorrigirCustoMed: TDBCheckBox
        Left = 361
        Top = 40
        Width = 122
        Height = 17
        BiDiMode = bdRightToLeft
        Caption = 'Corrigir Custo M'#233'dio'
        DataField = 'corrigir_custo_medio'
        DataSource = dso
        ParentBiDiMode = False
        TabOrder = 3
        OnClick = chkCorrigirCustoMedClick
      end
    end
  end
  inherited pnlTop: TJvPanel
    ...
    inherited pnlCima: TJvPanel
      ...
      object Button1: TButton
        ...
        Width = 168
        Height = 25
        Caption = 'Deixar contagem em Aberto'
        TabOrder = 0
        Visible = False
  ...
  object dsItens: TwwDataSource [4]
    DataSet = dmGeral.EST_CD_M_CTE_ITE
  ...
  object EST_PD_M_CTE: TfrxPDFExport
    UseFileCache = True
    ShowProgress = True
  ...
  object EST_XL_M_CTE: TfrxXLSExport
    UseFileCache = True
    ShowProgress = True
    OverwritePrompt = False
    DataOnly = False
  ...
  object EST_DB_M_CTE_ITE: TfrxDBDataset
    UserName = 'EST_DP_M_CTE_ITE'
    ...
    FieldAliases.Strings = (
      ...
      'saldo_estoque_momento=saldo_estoque_momento')
    DataSet = dmGeral.EST_CD_M_CTE_ITE
    BCDToCurrency = False
    Left = 1176
    Top = 472
  end
  object EST_DB_M_CTE: TfrxDBDataset
    UserName = 'EST_DP_M_CTE'
    CloseDataSource = False
    FieldAliases.Strings = (
      'id_controle=id_controle'
      ...
      'EST_SQ_M_CTE_ITE=EST_SQ_M_CTE_ITE'
  ...
  object EST_FR_M_CTE: TfrxReport
    Version = '5.1.9'
    ...
    ReportOptions.CreateDate = 42318.598204178200000000
    ReportOptions.LastChange = 42318.598204178200000000
    ...
    ScriptText.Strings = (
      ...
      '  if cont = 1 then'
      '      begin              '
      '        Memo36.Color:= $00EAEAEA;'
      '        cont := 0;                              '
      '      end            '
      '    else'
      '      begin                                              '
      '        Memo36.Color:= clwhite;'
      '        cont := 1;                              '
      '      end;  '
      'end;'
      ''
    ...
    Datasets = <
      ...
      item
        DataSet = EST_DB_M_CTE
        DataSetName = 'EST_DP_M_CTE'
      end
      item
        DataSet = EST_DB_M_CTE_ITE
        DataSetName = 'EST_DP_M_CTE_ITE'
      end>
    Variables = <
      item
        Name = ' Externa'
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object CAD_DB_R_ALMid_almoxarifado: TfrxMemoView
          Left = 3.779530000000000000
          Width = 52.913378500000000000
          Height = 15.118120000000000000
          DataField = 'id_item'
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[EST_DP_M_CTE_ITE."id_item"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object CAD_DB_R_ALMdescricao: TfrxMemoView
          Left = 60.472480000000000000
          Width = 211.653570160000000000
          Height = 15.118120000000000000
          StretchMode = smMaxHeight
        ...
        object Memo23: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[EST_DP_M_CTE_ITE."int_nometam"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo24: TfrxMemoView
          Left = 430.307360000000000000
          Width = 49.133872910000000000
          Height = 15.118120000000000000
          DataField = 'num_lote'
          DataSet = EST_DB_M_CTE_ITE
          DataSetName = 'EST_DP_M_CTE_ITE'
        ...
        object Memo28: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[EST_DP_M_CTE_ITE."diferenca"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo29: TfrxMemoView
          Left = 668.858663150000000000
          Width = 45.354342910000000000
          Height = 15.118120000000000000
          DataSet = EST_DB_M_CTE_ITE
          DataSetName = 'EST_DP_M_CTE_ITE'
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[EST_DP_M_CTE_ITE."vlr_custo"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo38: TfrxMemoView
          Left = 539.031835360000000000
          Width = 79.370112910000000000
          Height = 15.118120000000000000
          DataSet = EST_DB_M_CTE_ITE
          DataSetName = 'EST_DP_M_CTE_ITE'
          Font.Charset = DEFAULT_CHARSET
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[EST_DP_M_CTE_ITE."saldo_estoque_momento"]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo8: TfrxMemoView
          Left = 102.252010000000000000
          Top = 92.826840000000000000
          Width = 132.842610000000000000
          Height = 15.118120000000000000
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Height = -11
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[EST_DP_M_CTE."int_nomealm"]')
          ParentFont = False
        end
        object Memo9: TfrxMemoView
          Left = 310.126160000000000000
          Top = 92.826840000000000000
          Width = 129.063080000000000000
          Height = 15.118120000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[EST_DP_M_CTE."localizacao"]')
          ParentFont = False
        end
        object Memo10: TfrxMemoView
          Left = 495.323130000000000000
          Top = 92.826840000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[EST_DP_M_CTE."per_inicial"]')
          ParentFont = False
        end
        object Memo12: TfrxMemoView
          Left = 555.795610000000000000
          Top = 92.826840000000000000
          Width = 19.456710000000000000
          Height = 15.118120000000000000
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Height = -11
        ...
        object Memo13: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[EST_DP_M_CTE."per_final"]')
          ParentFont = False
        end
        object Memo30: TfrxMemoView
          Top = 71.811070000000000000
          Width = 98.826840000000000000
          Height = 15.118120000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
        ...
        object Memo31: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[EST_DP_M_CTE."id_controle"]')
          ParentFont = False
        end
        object Memo32: TfrxMemoView
          Left = 204.094620000000000000
          Top = 71.811070000000000000
          Width = 102.606370000000000000
          Height = 15.118120000000000000
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Height = -11
