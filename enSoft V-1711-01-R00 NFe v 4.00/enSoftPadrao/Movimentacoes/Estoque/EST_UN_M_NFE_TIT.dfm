inherited EST_FM_M_NFE_TIT: TEST_FM_M_NFE_TIT
        ...
        object tsTitulos: TTabSheet
          ...
          object grdTitulos: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'int_nomefpg'#9'36'#9'Forma de pagamento'#9'F'
              'DTA_VENCIMENTO'#9'10'#9'Vencimento'#9#9
              'ID_PLANO'#9'11'#9'Plano'#9'F'
              'id_ccusto'#9'10'#9'C'#243'digo'#9'F'
          ...
          object pnTitulos: TPanel
            ...
            object txtHistoricoPag: TDBEdit
              Left = 533
              Top = 13
              Width = 173
              Height = 21
              DataField = 'historico_pag'
              DataSource = dsoTitulos
              TabOrder = 4
            end
          end
