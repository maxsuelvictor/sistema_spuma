inherited EST_FM_M_NFD: TEST_FM_M_NFD
  ...
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object dgItensDisponiveis: TwwDBGrid
        ...
        Height = 259
        ControlType.Strings = (
          'id_st_icm;CustomEdit;cbbCST;F')
        Selected.Strings = (
          'id_item'#9'9'#9'C'#243'digo'#9'T'
      ...
      object dgNotasDisponiveis: TwwDBGrid
        ...
        Height = 100
        Selected.Strings = (
          'id_fiscal_dev'#9'12'#9'Controle'#9'F'
          'int_numero'#9'16'#9'N'#250'mero'#9'F'
          'int_serie'#9'10'#9'S'#233'rie'#9'F'
          'int_subserie'#9'11'#9'Sub-S'#233'rie'#9'F')
        IniAttributes.Delimiter = ';;'
        IniAttributes.UnicodeIniFile = False
        TitleColor = clBtnFace
        FixedCols = 0
      ...
      object txtEmitenteDescricao: TwwDBEdit
        Left = 288
        Top = 41
        Width = 265
        Height = 21
      ...
      object num_Total_VlrDesc: TDBEdit
        Left = 286
        Top = 470
        Width = 70
        Height = 21
      ...
      object cbbCST: TwwDBLookupCombo
        ...
        DataField = 'id_st_icm'
        DataSource = dsoItens
        LookupTable = dmGeral.BUS_CD_X_ICM
        LookupField = 'CODIGO'
        TabOrder = 28
        AutoDropDown = False
        ShowButton = True
  ...
  inherited pnlTop: TJvPanel
    ...
    inherited pnlCima: TJvPanel
      ...
      inherited lblTitulo: TLabel
        Width = 1201
        Caption = 'Nota Fiscal de Devolu'#231#227'o ao Fornecedor'
        ExplicitWidth = 1201
      end
  ...
  inherited imgBotoesAtivo: TImageList
    Bitmap = {
      494C01010800A800100318001800FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesInativo: TImageList
    ...
    Top = 243
    Bitmap = {
      
  ...
  inherited ImgPequena: TImageList
    Bitmap = {
      494C01011200000160030E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoAz: TImageList
    Bitmap = {
      
  ...
  inherited ImgPequenaAz: TImageList
    Bitmap = {
      494C01010600000158030E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoVe: TImageList
    Bitmap = {
      
  ...
  inherited ImgPequenaVe: TImageList
    Bitmap = {
      
  ...
  object dsoEmiNotas: TwwDataSource
    DataSet = dmGeral.FAT_CD_M_NFE_DEV
    Left = 1108
    Top = 389
  end
  object dsoEmiItensNota: TwwDataSource
  ...
  object pmAdicionarNovosItens: TPopupMenu
    Left = 152
    Top = 372
    object btnAdiconarNovosItens: TMenuItem
      Caption = 'Adicionar Novos Itens a Serem Devolvidos'
      OnClick = btnAdiconarNovosItensClick
    end
  end
end
