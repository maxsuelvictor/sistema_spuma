inherited EST_FM_M_NFE: TEST_FM_M_NFE
    ...
    inherited pnlDatagrid: TPanel
      ...
      inherited dbGrid: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'ID_CFO'#9'12'#9'CFOP'#9'F'
          'NUMERO'#9'10'#9'N'#250'mero'#9'F'
          'SERIE'#9'8'#9'S'#233'rie'#9'F'
          'SUB_SERIE'#9'3'#9'Sub-S'#233'rie'#9'F')
  ...
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object btnRetirarCmpPed: TSpeedButton
        Left = 613
        Top = 123
        Width = 23
        Height = 21
      ...
      object btnRetirarIqm: TSpeedButton
        Left = 766
        Top = 123
        Width = 23
        Height = 21
      ...
      object lblCaixa: TLabel
        ...
        Width = 108
        Height = 13
        Caption = 'C'#243'd. Abertura Caixa :'
      end
      ...
      object pcMovimento: TPageControl
        ...
        object tsItens: TTabSheet
          ...
          object grdItens: TwwDBGrid
            ...
            Height = 123
            Selected.Strings = (
              'ID_ITEM'#9'14'#9'Item'#9'F'
              'INT_DESC_ITEM'#9'43'#9'Descri'#231#227'o'#9'F'
              'int_und_venda'#9'7'#9'Und'#9'F'
              'int_nometam'#9'12'#9'Tamanho'#9'F'
              'int_nomecor'#9'16'#9'Cor'#9'F'
              'vlr_unitario'#9'14'#9'Vlr. Unit'#225'rio'#9'F'
              'qtde'#9'13'#9'Qtde'#9'F'
              'vlr_desconto'#9'11'#9'Vlr. Desc.'#9'F'
              'vlr_liquido'#9'13'#9'Vlr. L'#237'quido'#9'F'
              'fre_valor'#9'19'#9'fre_valor'#9'F'
              'vlr_seguro'#9'19'#9'vlr_seguro'#9'F'
              'vlr_outras_desp'#9'19'#9'vlr_outras_desp'#9'F'
              'vlr_icm_desc'#9'19'#9'vlr_icm_desc'#9'F')
          ...
          object pnItens: TPanel
            ...
            object txt_PerIPI: TDBEdit
              ...
              DataSource = dsoItens
              TabOrder = 14
              OnExit = txt_PerIPIExit
            end
            object cbbID_ST_IPI: TwwDBLookupCombo
              Left = 721
              Top = 32
              Width = 36
              Height = 21
              ...
              PreciseEditRegion = False
              AllowClearKey = False
              OnEnter = cbbID_ST_IPIEnter
              OnExit = cbbID_ST_IPIExit
            end
            object cbRAA: TDBCheckBox
              Left = 702
              Top = 34
              Width = 19
              Height = 17
              DataField = 'para_analise_raa'
              DataSource = dsoItens
              TabOrder = 12
              ValueChecked = '1'
              ValueUnchecked = '0'
            end
            object txtVlrBaseIcmIte: TwwDBEdit
              Left = 402
              Top = 32
              Width = 53
              Height = 21
              ...
              WantReturns = False
              WordWrap = False
              OnExit = txtVlrBaseIcmIteExit
            end
            object txtVlrIcmIte: TwwDBEdit
              Left = 457
              Top = 32
              Width = 58
              Height = 21
              ...
              WantReturns = False
              WordWrap = False
              OnExit = txtVlrIcmIteExit
            end
            object txtVlrBaseSubIcmIte: TwwDBEdit
              Left = 518
              Top = 32
              Width = 56
              Height = 21
            ...
            object txtVlrSubIcmIte: TwwDBEdit
              Left = 576
              Top = 32
              Width = 57
              Height = 21
              ...
              WantReturns = False
              WordWrap = False
              OnExit = txtVlrSubIcmIteExit
            end
            object cbbCSTIcm: TwwDBLookupCombo
              Left = 98
              Top = 32
              Width = 42
              Height = 21
              ...
              PreciseEditRegion = False
              AllowClearKey = False
              OnEnter = cbbCSTIcmEnter
              OnExit = cbbCSTIcmExit
            end
          end
          ...
          object pnDadosAdic: TPanel
            ...
            object txtVlrIcmSValor: TwwDBEdit
              Left = 103
              Top = 19
              Width = 58
              Height = 21
              Ctl3D = True
              DataField = 'icm_s_vlr_mva'
              DataSource = dsoItens
              ParentCtl3D = False
              TabOrder = 1
              UnboundDataType = wwDefault
            ...
            object txtPerReducaoICM: TwwDBEdit
              Left = 9
              Top = 19
              Width = 88
              Height = 21
            ...
            object cbbCST_COFINS_Entrada: TwwDBLookupCombo
              ...
              OnExit = cbbCST_COFINS_EntradaExit
            end
          end
          object pnlLote: TPanel
            ...
            object txtLoteVenc: TJvDBDateEdit
              Left = 123
              Top = 22
              Width = 105
              Height = 21
        ...
        object tsTitulos: TTabSheet
          ...
          object grdTitulos: TwwDBGrid
            ...
            Height = 93
            Selected.Strings = (
              'ID_FORMA_PAG'#9'8'#9'C'#243'digo'#9#9
              'int_nomefpg'#9'18'#9'Forma de pagamento'#9'F'
              'DTA_VENCIMENTO'#9'10'#9'Vencimento'#9#9
              'ID_PLANO'#9'11'#9'Plano'#9'F'
              'id_ccusto'#9'8'#9'C'#243'digo'#9'F'
              'int_nomeccu'#9'16'#9'Centro de custo'#9'F'
              'NUM_PARCELA'#9'14'#9'Parcela'#9'F'
              'VLR_TITULO'#9'9'#9'Vlr. Parcela'#9'F'
              'che_agencia'#9'8'#9'Agencia'#9'F'
          ...
          object pnTitulos: TPanel
            ...
            object txtPctDescricao: TDBText
              Left = 182
              Top = 27
              Width = 111
              Height = 21
            ...
            object cbbFormaPgto: TwwDBLookupCombo
              Left = 5
              Top = 27
              Width = 91
              Height = 21
              ...
              PreciseEditRegion = False
              AllowClearKey = False
              OnEnter = cbbFormaPgtoEnter
              OnExit = cbbFormaPgtoExit
            end
            ...
            object txt_IdPlanoContas: TJvDBComboEdit
              Left = 97
              Top = 27
              Width = 82
              Height = 21
              ...
              Glyph.Data = {
                ...
                FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
              TabOrder = 1
              OnButtonClick = txt_IdPlanoContasButtonClick
              OnExit = txt_IdPlanoContasExit
            end
            object pnCheque: TGroupBox
              Left = 487
              Top = -3
              Width = 304
              Height = 54
              ...
              object txtContaCorrente: TwwDBEdit
                Left = 109
                Top = 30
                Width = 59
                Height = 21
      ...
      object gbTotalizacao: TGroupBox
        ...
        object num_Total_VlrMercadoria: TDBEdit
          ...
          DataSource = dso
          TabOrder = 0
          OnExit = num_Total_VlrMercadoriaExit
        end
        ...
        object num_VlrIcmDesc: TwwDBEdit
          Left = 280
          Top = 38
          Width = 75
          Height = 21
      ...
      object cbbCFOP: TwwDBLookupCombo
        Left = 545
        Top = 168
        Width = 244
        Height = 21
        ...
        LookupField = 'id_cfo'
        Options = [loRowLines, loFixedDropDownHeight]
        Color = clWhite
        TabOrder = 22
        AutoDropDown = False
        ShowButton = True
      ...
      object txtCodPedCmp: TJvDBComboEdit
        Left = 545
        Top = 123
        Width = 67
        Height = 21
        ...
        ReadOnly = True
        TabOrder = 16
        OnButtonClick = txtCodPedCmpButtonClick
        OnExit = txtCodPedCmpExit
      end
      object lbl_Fornecedor: TwwDBEdit
        Left = 262
        Top = 28
        Width = 525
        Height = 19
      ...
      object txtCodIqm: TJvDBComboEdit
        ...
        OnExit = txtCodIqmExit
      end
      object txtCaixa: TJvDBComboEdit
        Left = 572
        Top = 5
        Width = 80
        Height = 21
        ...
        Glyph.Data = {
          ...
          FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
        TabOrder = 1
        OnButtonClick = txtCaixaButtonClick
        OnExit = txtCaixaExit
      end
      ...
      object pnlTotalizacao: TPanel
        ...
        object txtVlrLiquidoIte: TwwDBEdit
          Left = 425
          Top = 6
          Width = 82
          Height = 21
          Color = 14342874
          DataField = 'int_tot_vlr_liquido'
          DataSource = dso
          ReadOnly = True
          TabOrder = 0
          UnboundDataType = wwDefault
        ...
        object txtVlrBrutoIte: TwwDBEdit
          Left = 255
          Top = 6
          Width = 81
          Height = 21
          Color = 14342874
          DataField = 'int_tot_vlr_bruto'
          DataSource = dso
          ReadOnly = True
          TabOrder = 1
          UnboundDataType = wwDefault
      ...
      object txtIdPlanoContasFor: TEdit
        Left = 593
        Top = 50
        Width = 82
        Height = 21
        ...
        ReadOnly = True
        TabOrder = 6
        Text = 'txtIdPlanoContasFor'
      end
      object txtDescPctFor: TEdit
        Left = 677
        Top = 50
        Width = 112
        Height = 21
  ...
  object dsoTitulos: TwwDataSource [5]
    ...
    OnDataChange = dsoTitulosDataChange
    Left = 242
    Top = 299
  end
  ...
  object EST_DB_M_NFE: TfrxDBDataset [8]
    UserName = 'EST_DB_M_NFE'
  ...
  object EST_DB_M_NFE_ITE: TfrxDBDataset [9]
    UserName = 'EST_DB_M_NFE_ITE'
    CloseDataSource = False
    DataSet = dmGeral.FAT_CD_M_NFE_ITE
    BCDToCurrency = False
    Left = 138
  ...
  object EST_DB_M_NFE_TIT: TfrxDBDataset [10]
    UserName = 'EST_DB_M_NFE_TIT'
    CloseDataSource = False
    DataSet = dmGeral.FAT_CD_M_NFE_TIT
    BCDToCurrency = False
    Left = 242
  ...
  object EST_FR_M_NFE: TfrxReport [11]
    Version = '5.1.9'
    ...
    Datasets = <
      ...
      item
        DataSet = EST_DB_M_NFE
        DataSetName = 'EST_DB_M_NFE'
      end
      item
        DataSet = EST_DB_M_NFE_ITE
        DataSetName = 'EST_DB_M_NFE_ITE'
      end
      item
        DataSet = EST_DB_M_NFE_TIT
        DataSetName = 'EST_DB_M_NFE_TIT'
      end>
    Variables = <
      item
        Name = ' externo'
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object EST_DB_M_NFEid_tipo_mov_estoque: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[EST_DB_M_NFE."id_tipo_mov_estoque"]')
          ParentFont = False
        end
        ...
        object EST_DB_M_NFEid_transportadora: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[EST_DB_M_NFE."id_transportadora"]')
          ParentFont = False
        end
      ...
      object DetailData1: TfrxDetailData
        ...
        object EST_DB_M_NFE_ITEint_desc_item: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[EST_DB_M_NFE_ITE."int_desc_item"]')
          ParentFont = False
        end
        ...
        object EST_DB_M_NFE_ITEvlr_mercadoria: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[EST_DB_M_NFE_ITE."vlr_mercadoria"]')
          ParentFont = False
        end
        ...
        object EST_DB_M_NFE_ITEicm_n_aliquota: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[EST_DB_M_NFE_ITE."icm_n_aliquota"]')
          ParentFont = False
        end
      ...
      object Footer1: TfrxFooter
        ...
        object Memo79: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<EST_DB_M_NFE_ITE."vlr_liquido">,DetailData1)]')
          ParentFont = False
        end
      end
      ...
      object DetailData2: TfrxDetailData
        ...
        object EST_DB_M_NFE_TITdta_vencimento: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[EST_DB_M_NFE_TIT."dta_vencimento"]')
          ParentFont = False
        end
  ...
  inherited imgBotoesAtivo: TImageList
    ...
    Top = 203
    Bitmap = {
      494C01010800A800540218001800FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesInativo: TImageList
    ...
    Top = 251
    Bitmap = {
      
  ...
  inherited ImgPequena: TImageList
    ...
    Top = 155
    Bitmap = {
      494C010112000001A4020E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoAz: TImageList
    ...
    Top = 251
    Bitmap = {
      
  ...
  inherited ImgPequenaAz: TImageList
    ...
    Top = 155
    Bitmap = {
      494C0101060000019C020E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
