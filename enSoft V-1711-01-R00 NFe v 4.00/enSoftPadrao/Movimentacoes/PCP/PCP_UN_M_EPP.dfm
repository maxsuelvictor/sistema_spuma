inherited PCP_FM_M_EPP: TPCP_FM_M_EPP
  ...
  object PCP_CD_M_EPP_ITE: TClientDataSet
    ...
    object PCP_CD_M_EPP_ITEint_ite_sgq_personalizado: TBooleanField
      FieldName = 'int_ite_sgq_personalizado'
      ProviderFlags = []
    end
    object PCP_CD_M_EPP_ITEid_func_colchoaria: TIntegerField
      FieldName = 'id_func_colchoaria'
    end
    object PCP_CD_M_EPP_ITEint_nomefunc_colc: TWideStringField
      FieldName = 'int_nomefunc_colc'
      ProviderFlags = []
      Size = 50
    end
