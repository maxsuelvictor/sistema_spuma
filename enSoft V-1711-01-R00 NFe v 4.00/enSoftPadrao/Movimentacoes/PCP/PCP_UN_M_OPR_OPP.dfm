inherited PCP_FM_M_OPR_OPP: TPCP_FM_M_OPR_OPP
  Caption = 'PCP_FM_M_OPR_OPP'
  ClientHeight = 548
  ClientWidth = 1004
    ...
    inherited pnlDados: TPanel
      ...
      object pnDados: TPanel
        ...
        object Label4: TLabel
          ...
          Alignment = taCenter
          AutoSize = False
          Caption = 'D'#234' dois cliques no item que deseja alterar os dados da produ'#231#227'o'
          Color = 14342874
        ...
        object grdItensOp: TwwDBGrid
          Left = 0
          Top = 25
          Width = 1004
          Height = 201
          ControlType.Strings = (
            'remanejado;CheckBox;True;False')
          Selected.Strings = (
            'id_opr_opp'#9'5'#9'Seq.'#9'F'
            'id_item'#9'10'#9'C'#243'digo'#9'F'
            'int_nomeite'#9'53'#9'Descri'#231#227'o'#9'F'
            'int_undvenda'#9'3'#9'Und'#9'F'
            'int_nomecor'#9'13'#9'Cor'#9'F'
            'int_nometam'#9'8'#9'Tamanho'#9'F'
            'qtde_a_produzir'#9'13'#9'Qtde a produzir'#9'F'
            'qtde_a_produzir_orig'#9'18'#9'Qtde a produzir Orig.'#9'F'
            'qtde_produzida'#9'13'#9'Qtde produzida'#9'F'
            'saldo_disponivel'#9'14'#9'Saldo Dispon'#237'vel'#9'F')
          ...
          TitleButtons = False
          UseTFields = False
          OnDblClick = grdItensOpDblClick
          GroupFieldName = 'int_uf'
        end
        object Panel1: TPanel
          ...
          object gbItens: TGroupBox
            ...
            object Label8: TLabel
              ...
              Alignment = taCenter
              AutoSize = False
              Caption = 'Produtos para produ'#231#227'o sem pedido de venda'
              Color = 16364464
              Font.Charset = DEFAULT_CHARSET
              Font.Color = clBlack
              Font.Height = -11
            ...
            object pnItens: TPanel
              ...
              object txtDescItem: TDBText
                ...
                DataSource = BUS_DS_M_OPR_OPP_INT
                ParentColor = False
                Transparent = False
              end
              ...
              object txtQtdeAProd: TwwDBEdit
                ...
                WantReturns = False
                WordWrap = False
                OnExit = txtQtdeAProdExit
              end
              object txtMotivoMan: TwwDBEdit
                Left = 729
                Top = 15
                Width = 200
                Height = 21
                DataField = 'motivo_ger_man'
                DataSource = BUS_DS_M_OPR_OPP_INT
                TabOrder = 4
                UnboundDataType = wwDefault
                WantReturns = False
                WordWrap = False
                OnExit = txtMotivoManExit
              end
              object txtQtdeParaOP: TwwDBEdit
                Left = 620
                Top = 15
                Width = 103
                Height = 21
                ...
                WantReturns = False
                WordWrap = False
                OnExit = txtQtdeParaOPExit
              end
              object chGerarBloco: TDBCheckBox
                Left = 476
                Top = 15
                Width = 137
                Height = 17
                Caption = 'Gera bloco de espuma '
                DataField = 'bloco_gerado'
                DataSource = BUS_DS_M_OPR_OPP_INT
                TabOrder = 2
                ValueChecked = '1'
                ValueUnchecked = '0'
            ...
            object grdItensOppMan: TwwDBGrid
              Left = 7
              Top = 79
              Width = 992
              Height = 83
              Selected.Strings = (
                'ID_ITEM'#9'10'#9'C'#243'digo'#9'F'
                'int_nomeite'#9'34'#9'Descri'#231#227'o'#9'F'
                'int_undvenda'#9'3'#9'Und'#9'F'
                'int_nomecor'#9'16'#9'Cor'#9'F'
                'int_nometam'#9'12'#9'Tamanho'#9'F'
                'qtde_a_produzir_orig'#9'13'#9'Qtde a produzir'#9'F'
                'qtde_atender_opr'#9'16'#9'Qtde para esta O.P'#9'F'
                'dta_man'#9'10'#9'Inserido em'#9'F'
                'motivo_ger_man'#9'32'#9'Motivo'#9'F')
              IniAttributes.Delimiter = ';;'
              IniAttributes.UnicodeIniFile = False
              TitleColor = 13750737
              FixedCols = 0
              ...
              TitleButtons = False
              UseTFields = False
              OnMouseUp = grdItensOppManMouseUp
            ...
            object pnlCorTamanho: TPanel
              ...
              object lblMedida: TLabel
                ...
                Width = 240
                Height = 13
                Caption = 'Medida (Para a Produ'#231#227'o) - F3-Itens ou F4-Ped.'
                Visible = False
              end
              ...
              object mmPcpObsIte: TDBMemo
                ...
                Height = 47
                Hint = 
                  '<F3> Para consultar itens;   <F4> Para buscar descri'#231#227'o de item ' +
                  'de um pedido'
                DataField = 'pcp_desc_item_person'
                DataSource = BUS_DS_M_OPR_OPP_INT
                TabOrder = 2
                Visible = False
      ...
      object pnCabecalho: TPanel
        ...
        object Label1: TLabel
          ...
          Width = 143
          Height = 13
          Caption = 'N'#186' da Ordem de Produ'#231#227'o :'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
          Font.Name = 'Segoe UI'
        ...
        object txtEmissao: TJvDBDateEdit
          Left = 505
          Top = 13
          Width = 92
          Height = 21
  ...
  object BUS_DS_M_OPR_OPP_INT: TwwDataSource
    DataSet = BUS_CD_M_OPR_OPP_INT
    Left = 708
    Top = 443
  end
  object BUS_CD_M_OPR_OPP_INT: TClientDataSet
    ...
    BeforePost = BUS_CD_M_OPR_OPP_INTBeforePost
    Left = 864
    Top = 446
    ...
    object BUS_CD_M_OPR_OPP_INTqtde_a_produzir: TFloatField
      ...
      OnChange = BUS_CD_M_OPR_OPP_INTqtde_a_produzirChange
    end
    ...
    object BUS_CD_M_OPR_OPP_INTint_nomeite: TWideStringField
      FieldName = 'int_nomeite'
      ProviderFlags = []
      Size = 100
    end
    object BUS_CD_M_OPR_OPP_INTint_undvenda: TWideStringField
      FieldName = 'int_undvenda'
      ProviderFlags = []
      Size = 3
    end
    object BUS_CD_M_OPR_OPP_INTint_nomecor: TWideStringField
      FieldName = 'int_nomecor'
      ProviderFlags = []
      Size = 40
    end
    object BUS_CD_M_OPR_OPP_INTint_nometam: TWideStringField
      FieldName = 'int_nometam'
      ProviderFlags = []
      Size = 40
    end
    object BUS_CD_M_OPR_OPP_INTdta_alt: TDateField
      FieldName = 'dta_alt'
    end
    object BUS_CD_M_OPR_OPP_INThora_alt: TTimeField
      FieldName = 'hora_alt'
    end
    object BUS_CD_M_OPR_OPP_INTqtde_atender_opr: TFloatField
      FieldName = 'qtde_atender_opr'
      OnChange = BUS_CD_M_OPR_OPP_INTqtde_atender_oprChange
    end
    object BUS_CD_M_OPR_OPP_INTqtde_atender_opr_ext: TFloatField
      FieldName = 'qtde_atender_opr_ext'
    end
    object BUS_CD_M_OPR_OPP_INTsaldo_disponivel: TFloatField
      FieldName = 'saldo_disponivel'
    end
    object BUS_CD_M_OPR_OPP_INTreg_alt: TBooleanField
      FieldName = 'reg_alt'
    end
    object BUS_CD_M_OPR_OPP_INTBUS_SQ_M_OPR_OPP_SOP_INT: TDataSetField
      FieldName = 'BUS_SQ_M_OPR_OPP_SOP_INT'
    end
    object BUS_CD_M_OPR_OPP_INThistorico_alt: TWideStringField
      FieldName = 'historico_alt'
      Size = 500
    end
    object BUS_CD_M_OPR_OPP_INTmotivo_alt: TWideStringField
      FieldName = 'motivo_alt'
      Size = 100
    end
    object BUS_CD_M_OPR_OPP_INTgerado_aut: TBooleanField
      FieldName = 'gerado_aut'
    end
    object BUS_CD_M_OPR_OPP_INTmotivo_ger_man: TWideStringField
      FieldName = 'motivo_ger_man'
      Size = 100
    end
    object BUS_CD_M_OPR_OPP_INTid_resp_man: TIntegerField
      FieldName = 'id_resp_man'
    end
    object BUS_CD_M_OPR_OPP_INTdta_man: TDateField
      FieldName = 'dta_man'
    end
    object BUS_CD_M_OPR_OPP_INThor_man: TTimeField
      FieldName = 'hor_man'
    end
    object BUS_CD_M_OPR_OPP_INTid_busca_item: TWideStringField
      FieldName = 'id_busca_item'
    end
    object BUS_CD_M_OPR_OPP_INTint_nomeres_man: TWideStringField
      FieldName = 'int_nomeres_man'
      ProviderFlags = []
      Size = 50
    end
    object BUS_CD_M_OPR_OPP_INTint_novoreg: TWideStringField
      FieldName = 'int_novoreg'
      ProviderFlags = []
      Size = 1
    end
    object BUS_CD_M_OPR_OPP_INTpcp_desc_item_person: TWideStringField
      FieldName = 'pcp_desc_item_person'
      OnChange = BUS_CD_M_OPR_OPP_INTpcp_desc_item_personChange
      Size = 150
    end
    object BUS_CD_M_OPR_OPP_INTbloco_gerado: TIntegerField
      FieldName = 'bloco_gerado'
    end
  end
end
