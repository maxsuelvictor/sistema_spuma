inherited PCP_FM_M_CPA: TPCP_FM_M_CPA
  Caption = 'PCP_FM_M_CPA'
  ClientHeight = 692
  ClientWidth = 1018
  ExplicitWidth = 1024
  ExplicitHeight = 720
  ...
  inherited pnlEsquerda: TPanel
    ...
    inherited pnlFiltro: TPanel
      ...
      inherited gbxFiltro: TGroupBox
        ...
        inherited cbbPesquisa: TComboBox
          ...
          Items.Strings = (
            'Controle'
            'C'#243'd. respons'#225'vel'
            'Nome respons'#225'vel'
            'C'#243'd. almoxarifado'
            'Nome almoxarifado'
            'C'#243'd barra'
            'Data da entrada')
          ExplicitWidth = 168
    ...
    inherited pnlDatagrid: TPanel
      ...
      inherited dbGrid: TwwDBGrid
        ...
        Height = 475
        Selected.Strings = (
          'id_epp'#9'10'#9'Controle'#9'F'
          'int_nomefun'#9'23'#9'Respons'#225'vel'#9'F')
      ...
      object btnEncerrarContagem: TBitBtn
        Left = 103
        Top = 0
        Width = 107
        Height = 56
        ...
        TabOrder = 1
        OnClick = btnEncerrarContagemClick
      end
      object btnPreparaContagem: TBitBtn
        Left = 0
        Top = 0
        Width = 103
        Height = 56
        Align = alLeft
        Caption = 'Preparar estoque para a Contagem'
        TabOrder = 2
        WordWrap = True
        OnClick = btnPreparaContagemClick
      end
    end
  ...
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object gbItens: TGroupBox
        ...
        object grdItens: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'int_numlote_opr'#9'10'#9'Nro OP'#9'F'
            'int_nomeite'#9'37'#9'Descri'#231#227'o'#9'T'
            'int_undvenda'#9'4'#9'Und'#9'F'
            'int_nometam'#9'8'#9'Tamanho'#9'T'
            'int_nomecor'#9'9'#9'Cor'#9'T')
      ...
      object txtHoraEnt: TcxDBTimeEdit
        Left = 549
        Top = 126
        DataBinding.DataField = 'hor_entrada'
        DataBinding.DataSource = dso
        ParentFont = False
      ...
      object pnInfo: TPanel
        ...
        object lblStatusInsercao: TLabel
          Left = 361
          Top = 10
          Width = 56
          Height = 18
        ...
        object lblUltimaInsercao: TLabel
          Left = 628
          Top = 38
          Width = 158
          Height = 18
          Alignment = taRightJustify
          Caption = 'Ultimo produto inserido: '
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -15
          Font.Name = 'Tahoma'
  ...
  inherited pnlTop: TJvPanel
    ...
    inherited pnlCima: TJvPanel
      ...
      inherited lblTitulo: TLabel
        Width = 1018
        Caption = 'Contagem de Protudos Acabados'
        ExplicitWidth = 1018
      end
  ...
  inherited dso: TwwDataSource
    DataSet = PCP_CD_M_EPP
  end
  inherited imgBotoesAtivo: TImageList
    Left = 995
    Top = 51
    Bitmap = {
      494C01010800A800A80118001800FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesInativo: TImageList
    Bitmap = {
      
  ...
  inherited ImgPequena: TImageList
    Bitmap = {
      494C010112000001F8010E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited ImgPequenaAz: TImageList
    Bitmap = {
      494C010106000001F0010E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoVe: TImageList
    Bitmap = {
      
  ...
  object PCP_CD_M_EPP: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'PCP_DP_M_EPP'
    RemoteServer = dmGeral.pcConecao
    OnNewRecord = PCP_CD_M_EPPNewRecord
    Left = 928
    Top = 408
    object PCP_CD_M_EPPid_epp: TIntegerField
      FieldName = 'id_epp'
    end
    object PCP_CD_M_EPPid_empresa: TIntegerField
      FieldName = 'id_empresa'
    end
    object PCP_CD_M_EPPcod_lme: TWideStringField
      FieldName = 'cod_lme'
    end
    object PCP_CD_M_EPPrev_lme: TWideStringField
      FieldName = 'rev_lme'
      Size = 5
    end
    object PCP_CD_M_EPPid_responsavel: TIntegerField
      FieldName = 'id_responsavel'
    end
    object PCP_CD_M_EPPid_almoxarifado: TIntegerField
      FieldName = 'id_almoxarifado'
    end
    object PCP_CD_M_EPPdta_entrada: TDateField
      FieldName = 'dta_entrada'
    end
    object PCP_CD_M_EPPhor_entrada: TTimeField
      FieldName = 'hor_entrada'
    end
    object PCP_CD_M_EPPint_nomefun: TWideStringField
      FieldName = 'int_nomefun'
      ProviderFlags = []
      Size = 50
    end
    object PCP_CD_M_EPPint_nomealm: TWideStringField
      FieldName = 'int_nomealm'
      ProviderFlags = []
      Size = 50
    end
    object PCP_CD_M_EPPPCP_SQ_M_EPP_ITE: TDataSetField
      FieldName = 'PCP_SQ_M_EPP_ITE'
    end
    object PCP_CD_M_EPPtipo_entrada: TIntegerField
      FieldName = 'tipo_entrada'
    end
  end
  object dsEppIte: TDataSource
    DataSet = PCP_CD_M_EPP_ITE
    Left = 888
    Top = 472
  end
  object PCP_CD_M_EPP_ITE: TClientDataSet
    Aggregates = <>
    DataSetField = PCP_CD_M_EPPPCP_SQ_M_EPP_ITE
    Params = <>
    BeforePost = PCP_CD_M_EPP_ITEBeforePost
    OnNewRecord = PCP_CD_M_EPP_ITENewRecord
    Left = 816
    Top = 408
    object PCP_CD_M_EPP_ITEid_epp: TIntegerField
      FieldName = 'id_epp'
    end
    object PCP_CD_M_EPP_ITEid_epp_ite: TIntegerField
      FieldName = 'id_epp_ite'
    end
    object PCP_CD_M_EPP_ITEid_item: TIntegerField
      FieldName = 'id_item'
    end
    object PCP_CD_M_EPP_ITEid_busca_item: TWideStringField
      FieldName = 'id_busca_item'
      Size = 30
    end
    object PCP_CD_M_EPP_ITEid_cor: TIntegerField
      FieldName = 'id_cor'
    end
    object PCP_CD_M_EPP_ITEid_tamanho: TIntegerField
      FieldName = 'id_tamanho'
    end
    object PCP_CD_M_EPP_ITEcod_barra: TWideStringField
      FieldName = 'cod_barra'
      Size = 50
    end
    object PCP_CD_M_EPP_ITEint_nomeite: TWideStringField
      FieldName = 'int_nomeite'
      ProviderFlags = []
      Size = 100
    end
    object PCP_CD_M_EPP_ITEint_nomecor: TWideStringField
      FieldName = 'int_nomecor'
      ProviderFlags = []
      Size = 40
    end
    object PCP_CD_M_EPP_ITEint_nometam: TWideStringField
      FieldName = 'int_nometam'
      ProviderFlags = []
      Size = 40
    end
    object PCP_CD_M_EPP_ITEint_oprorigem: TIntegerField
      FieldName = 'int_oprorigem'
      ProviderFlags = []
    end
    object PCP_CD_M_EPP_ITEint_opr: TIntegerField
      FieldName = 'int_opr'
      ProviderFlags = []
    end
    object PCP_CD_M_EPP_ITEint_undvenda: TWideStringField
      FieldName = 'int_undvenda'
      ProviderFlags = []
      Size = 3
    end
    object PCP_CD_M_EPP_ITEqtde: TFloatField
      FieldName = 'qtde'
    end
    object PCP_CD_M_EPP_ITEint_tipo_item: TWideStringField
      FieldName = 'int_tipo_item'
      ProviderFlags = []
      Size = 2
    end
    object PCP_CD_M_EPP_ITEint_numlote_opr: TWideStringField
      Alignment = taRightJustify
      FieldName = 'int_numlote_opr'
      ProviderFlags = []
      Size = 15
    end
  end
  object PCP_CD_M_ETQ: TClientDataSet
    ...
    object PCP_CD_M_ETQcontagem: TBooleanField
      FieldName = 'contagem'
    end
  end
end
