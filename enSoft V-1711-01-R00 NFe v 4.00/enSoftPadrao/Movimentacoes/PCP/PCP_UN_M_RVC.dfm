inherited PCP_FM_M_RVC: TPCP_FM_M_RVC
  ExplicitLeft = -190
  ExplicitWidth = 1156
  ExplicitHeight = 538
  PixelsPerInch = 96
  ...
  inherited pnlEsquerda: TPanel
    ...
    inherited pnlDatagrid: TPanel
      inherited dbGrid: TwwDBGrid
        Selected.Strings = (
          'ID_RVC'#9'10'#9'C'#243'digo'#9'F'
          'DTA_REVISAO'#9'43'#9'Data de Revis'#227'o'#9'F')
      end
    end
  end
  inherited pnlDireita: TPanel
    inherited pnlDados: TPanel
      ...
      object lblColchoesRevisados: TLabel
        Left = 7
        Top = 46
        Width = 110
        Height = 30
        Alignment = taCenter
        AutoSize = False
        Caption = '   Colch'#245'es    Revisados'
        Color = 14342874
        ParentColor = False
        Transparent = False
        WordWrap = True
      end
      object lblDefeitosIdentificados: TLabel
        Left = 120
        Top = 46
        Width = 110
        Height = 30
        Alignment = taCenter
        AutoSize = False
        Caption = 'Defeitos Identificados'
        Color = 14342874
        ParentColor = False
        Transparent = False
        WordWrap = True
      end
      object lblColchoesColados: TLabel
        Left = 233
        Top = 46
        Width = 110
        Height = 30
        Alignment = taCenter
        AutoSize = False
        Caption = '    Colch'#245'es     Colados'
        Color = 14342874
        ParentColor = False
        Transparent = False
        WordWrap = True
      end
      object lblModeloColchaoMaiorNDefeitos: TLabel
        Left = 346
        Top = 46
        Width = 110
        Height = 30
        Alignment = taCenter
        AutoSize = False
        Caption = 'Modelo de Colch'#227'o Maior N'#186' de Defeitos'
        Color = 14342874
        ParentColor = False
        Transparent = False
        WordWrap = True
      end
      object lblDefeitoMaiorNOcorrencia: TLabel
        Left = 459
        Top = 46
        Width = 110
        Height = 30
        Alignment = taCenter
        AutoSize = False
        Caption = '    Defeito Maior     N'#186' Ocorr'#234'ncia'
        Color = 14342874
        ParentColor = False
        Transparent = False
        WordWrap = True
      end
      object lblPerIndiceDefeito: TLabel
        Left = 572
        Top = 46
        Width = 110
        Height = 30
      ...
      object dpkDataRevisao: TJvDBDateEdit
        Left = 369
        Top = 2
        Width = 90
        Height = 21
        DataField = 'DTA_REVISAO'
        DataSource = dso
        ShowNullDate = False
        TabOrder = 1
      end
      object txtColchoesRevisados: TDBEdit
        Left = 7
        Top = 79
        Width = 110
        Height = 21
        Color = clWhite
        DataField = 'COL_TOT_ITE_REV'
        DataSource = dso
        TabOrder = 3
      end
      object txtDefeitosIdentificados: TDBEdit
        Left = 120
        Top = 79
        Width = 110
        Height = 21
        Color = clWhite
        DataField = 'COL_TOT_DEF_IDE'
        DataSource = dso
        TabOrder = 4
      end
      object txtColchoesColados: TDBEdit
        Left = 233
        Top = 79
        Width = 110
        Height = 21
        Color = clWhite
        DataField = 'COL_TOT_COL'
        DataSource = dso
        TabOrder = 5
      end
      object txtModeloColchaoMaiorNDefeitos: TDBEdit
        Left = 346
        Top = 79
        Width = 110
        Height = 21
        Color = clWhite
        DataField = 'COL_NUM_MAIOR_DEF'
        DataSource = dso
        TabOrder = 6
      end
      object txtDefeitoMaiorNOcorrencia: TDBEdit
        Left = 459
        Top = 79
        Width = 110
        Height = 21
        Color = clWhite
        DataField = 'DEF_MAIOR_NRO_OCOR'
        DataSource = dso
        TabOrder = 7
      end
      object txtPerIndiceDefeito: TDBEdit
        Left = 572
        Top = 79
        Width = 110
        Height = 21
        Color = clWhite
        DataField = 'INDICE_DEFEITOS'
        DataSource = dso
        TabOrder = 8
      end
      object gbItens: TGroupBox
        ...
        object grdItens: TwwDBGrid
          ...
          Height = 140
          Selected.Strings = (
            'int_nomeite'#9'25'#9'Item'#9'F'
            'int_nomecor'#9'10'#9'Cor'#9'F'
            'int_nometam'#9'10'#9'Tamanho'#9'F'
            'int_nomefuc'#9'25'#9'Respons'#225'vel'#9'F'
            'observacao'#9'29'#9'Observa'#231#227'o'#9'F')
      ...
      object gbSetores: TGroupBox
        ...
        object lblDefeitosSetor: TLabel
          Left = 228
          Top = 5
          Width = 221
          Height = 16
          Alignment = taCenter
          AutoSize = False
          Caption = 'Defeitos do Setor'
          Color = 14342874
          ParentColor = False
          Transparent = False
        end
        object lblDefeitosSelecionados: TLabel
          Left = 452
          Top = 5
          Width = 221
          Height = 16
          Alignment = taCenter
          AutoSize = False
          Caption = 'Defeitos Selecionados'
          Color = 14342874
          ParentColor = False
          Transparent = False
        end
        object btnAddSetor: TBitBtn
          Left = 4
          Top = 24
          Width = 23
          Height = 23
          Glyph.Data = {
            ...
            0000}
          TabOrder = 1
          OnClick = btnAddSetorClick
        end
        object grdSetor: TwwDBGrid
          Left = 5
          Top = 48
          Width = 218
          Height = 100
          Selected.Strings = (
            'int_nomeset'#9'28'#9'Descri'#231#227'o'#9'F')
          IniAttributes.Delimiter = ';;'
          IniAttributes.UnicodeIniFile = False
          TitleColor = clBtnFace
          OnRowChanged = grdSetorRowChanged
          FixedCols = 0
          ShowHorzScrollBar = True
          DataSource = dsoIteSet
          ReadOnly = True
          TabOrder = 2
          TitleAlignment = taLeftJustify
          TitleFont.Charset = DEFAULT_CHARSET
          ...
          TitleButtons = False
          UseTFields = False
          OnMouseUp = grdSetorMouseUp
          object grdSetorIButton: TwwIButton
            Left = -1
            Top = -1
            Width = 22
            Height = 22
        ...
        object dgDefSetor: TwwDBGrid
          Left = 228
          Top = 25
          Width = 221
          Height = 123
          Selected.Strings = (
            'int_nometds'#9'30'#9'Descri'#231#227'o'#9'F')
          IniAttributes.Delimiter = ';;'
          IniAttributes.UnicodeIniFile = False
          TitleColor = clBtnFace
          FixedCols = 0
          ShowHorzScrollBar = True
          DataSource = dsoSetTds
          ...
          TitleButtons = False
          UseTFields = False
          OnDblClick = dgDefSetorDblClick
        end
        object dgDefSelecionado: TwwDBGrid
          Left = 452
          Top = 25
          Width = 221
          Height = 123
          Selected.Strings = (
            'int_nometdf'#9'29'#9'Descri'#231#227'o'#9'F')
          IniAttributes.Delimiter = ';;'
          IniAttributes.UnicodeIniFile = False
          TitleColor = clBtnFace
          FixedCols = 0
          ShowHorzScrollBar = True
          DataSource = dsoIteSetDef
          Options = [dgEditing, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit, dgWordWrap]
          ReadOnly = True
          TabOrder = 4
          TitleAlignment = taLeftJustify
          ...
          TitleButtons = False
          UseTFields = False
          OnDblClick = dgDefSelecionadoDblClick
        end
      end
  ...
  inherited pnlTop: TJvPanel
    inherited pnlCima: TJvPanel
      inherited lblTitulo: TLabel
        Caption = 'Controle de Defeitos na Revis'#227'o dos Colch'#245'es'
      end
    end
  end
  object dsoIte: TwwDataSource [4]
    DataSet = dmGeral.PCP_CD_M_RVC_ITE
    Left = 1011
    Top = 283
  end
  object dsoIteSet: TwwDataSource [5]
    DataSet = dmGeral.PCP_CD_M_RVC_ITE_SET
    Left = 1011
    Top = 331
  end
  object dsoIteSetDef: TwwDataSource [6]
    DataSet = dmGeral.PCP_CD_M_RVC_ITE_SET_DEF
    Left = 1011
    Top = 427
  end
  object dsoSetTds: TwwDataSource [7]
    DataSet = dmGeral.BUS_CD_C_SET_TDS
    Left = 1011
    Top = 379
  end
  inherited dso: TwwDataSource
    DataSet = dmGeral.PCP_CD_M_RVC
  end
