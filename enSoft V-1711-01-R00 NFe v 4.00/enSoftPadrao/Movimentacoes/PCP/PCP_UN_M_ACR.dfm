inherited PCP_FM_M_ACR: TPCP_FM_M_ACR
  ClientHeight = 549
  ExplicitWidth = 1156
  ExplicitHeight = 577
  PixelsPerInch = 96
  ...
  inherited pnlEsquerda: TPanel
    ...
    inherited pnlDatagrid: TPanel
      ...
      inherited dbGrid: TwwDBGrid
        Height = 366
        Selected.Strings = (
          'ID_ACR'#9'10'#9'C'#243'digo'#9'F'
          'NOME_CONSUMIDOR'#9'43'#9'Consumidor'#9'F')
  ...
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object Label7: TLabel
        ...
        Width = 105
        Height = 13
        Caption = 'C'#243'd. Pedido Venda :'
      end
      object txtRevisao: TDBEdit
        Left = 571
        Top = 6
        Width = 100
        Height = 21
      ...
      object gbItens: TGroupBox
        ...
        object grdItens: TwwDBGrid
          ...
          TabStop = False
          ControlType.Strings = (
            'garantia;CheckBox;True;False')
          Selected.Strings = (
            'id_acr_p'#9'10'#9'Seq.'#9'T'
            'id_item'#9'10'#9'C'#243'digo'#9'F'
            'int_desc_pro'#9'34'#9'Descri'#231#227'o'#9'F'
            'int_desc_und'#9'5'#9'Unidade'#9'F'
            'int_nomecor'#9'16'#9'Cor'#9'F'
            'int_nometam'#9'12'#9'Tamanho'#9'F'
            'garantia'#9'5'#9'Garantia'#9'F')
        ...
        object pnlItens: TPanel
          ...
          object dpkDataFabricacao: TJvDBDateEdit
            Tag = 1
            Left = 361
            Top = 21
            Width = 89
          ...
          object dpkDataVenda: TJvDBDateEdit
            Tag = 1
            Left = 543
            Top = 21
            Width = 89
            ...
            ShowNullDate = False
            TabOrder = 4
            OnExit = dpkDataVendaExit
          end
          object chkGarantia: TDBCheckBox
            Left = 319
            Top = 24
            Width = 18
            Height = 16
      ...
      object pcFilhos: TPageControl
        Left = 4
        Top = 317
        Width = 671
        Height = 146
        ActivePage = tbiDefeitoColchao
        TabOrder = 19
        object tbiReclamacaoCliente: TTabSheet
          Caption = 'Reclama'#231#227'o do Cliente'
          object lblDefeitoProduto: TLabel
            Left = 3
            Top = 9
            Width = 100
            Height = 13
            Caption = 'Defeito do Produto'
            FocusControl = txtObservacao
          end
          object txtDefeitoProduto: TDBMemo
            Left = 3
            Top = 23
            Width = 657
            Height = 92
            DataField = 'defeito_produto'
            DataSource = dsoIte
            TabOrder = 0
            OnEnter = txtDefeitoProdutoEnter
            OnExit = txtDefeitoProdutoExit
          end
        end
        object tbiDefeitoColchao: TTabSheet
          Caption = 'Defeito do Colch'#227'o'
          ImageIndex = 1
          object pnlTipoDefeito: TPanel
            Left = 24
            Top = 2
            Width = 291
            Height = 38
            BevelOuter = bvNone
            TabOrder = 0
            OnExit = pnlTipoDefeitoExit
            object lblTipoDefeito: TLabel
              Left = 3
              Top = -1
              Width = 78
              Height = 13
            ...
            object txtTipoDefeitoDescricao: TDBText
              Left = 83
              Top = 15
              Width = 201
              Height = 21
              Color = 14342874
              DataField = 'int_desctdf'
              DataSource = dsoPdt
              ParentColor = False
              Transparent = False
            end
            object txtTipoDefeito: TJvDBComboEdit
              Left = 3
              Top = 15
              Width = 78
              Height = 21
              ...
              Glyph.Data = {
                ...
                FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
              TabOrder = 0
              OnButtonClick = txtTipoDefeitoButtonClick
              OnExit = txtTipoDefeitoExit
            end
          end
          object btnAddTipoDefeito: TBitBtn
            Left = 1
            Top = 15
            Width = 23
            Height = 23
            Glyph.Data = {
              ...
              0000}
            TabOrder = 1
            OnClick = btnAddTipoDefeitoClick
          end
          object dgTipoDefeito: TwwDBGrid
            Left = 0
            Top = 41
            Width = 663
            Height = 77
            Selected.Strings = (
              'id_tdf'#9'10'#9'C'#243'digo'#9'F'
              'int_desctdf'#9'91'#9'Descri'#231#227'o'#9'F')
            IniAttributes.Delimiter = ';;'
            IniAttributes.UnicodeIniFile = False
            TitleColor = clBtnFace
            FixedCols = 0
            ...
            TitleButtons = False
            UseTFields = False
            OnMouseUp = dgTipoDefeitoMouseUp
            object dgTipoDefeitoIButton: TwwIButton
              Left = -1
              Top = -1
              Width = 22
              Height = 22
              ...
              Glyph.Data = {
                ...
                FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
                B102}
              OnClick = dgTipoDefeitoIButtonClick
            end
          end
        end
        object tbiDisposicao: TTabSheet
          ...
          object txtDisposicaoDescricao: TDBText
            Left = 85
            Top = 23
            Width = 228
            Height = 21
            Color = 14342874
            DataField = 'int_descdis'
            DataSource = dsoIte
            ParentColor = False
            Transparent = False
          end
          object txtDisposicao: TJvDBComboEdit
            Left = 2
            Top = 23
            Width = 80
            Height = 21
            ...
            Glyph.Data = {
              ...
              FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
            TabOrder = 0
            OnButtonClick = txtDisposicaoButtonClick
            OnEnter = txtDisposicaoEnter
            OnExit = txtDisposicaoExit
          end
        end
        object tbiAnaliseProduto: TTabSheet
          Caption = 'An'#225'lise do Produto'
          ImageIndex = 3
          object lblDefeitoConstatado: TLabel
            Left = 2
            Top = 3
            Width = 101
            Height = 13
          ...
          object lblSeProcede: TLabel
            Left = 2
            Top = 47
            Width = 133
            Height = 13
            Caption = 'Se n'#227'o procede, justificar:'
            FocusControl = txtObservacao
          end
          object txtDefeitoConstatadoJustificativa: TDBEdit
            Left = 2
            Top = 63
            Width = 467
            Height = 21
            Color = clWhite
            DataField = 'motivo_nao_procede'
            DataSource = dsoIte
            TabOrder = 2
            OnEnter = txtDefeitoConstatadoJustificativaEnter
            OnExit = txtDefeitoConstatadoJustificativaExit
          end
          object txtDefeitoConstatado: TDBEdit
            Left = 2
            Top = 19
            Width = 303
            Height = 21
            Color = clWhite
            DataField = 'defeito_constatado'
            DataSource = dsoIte
            TabOrder = 0
            OnEnter = txtDefeitoConstatadoEnter
            OnExit = txtDefeitoConstatadoExit
          end
          object rgProcede: TDBRadioGroup
            Left = 313
            Top = 5
            Width = 156
            Height = 35
            ...
            Values.Strings = (
              'True'
              'False')
            OnChange = rgProcedeChange
            OnClick = rgProcedeClick
          end
        end
        object tbiReaproveitamentoItens: TTabSheet
          Caption = 'Reaproveitamento de Itens'
          ImageIndex = 7
          object lblResponsavelReaproveitamento: TLabel
            Left = 2
            Top = -1
            Width = 64
            Height = 13
          ...
          object lblReaproveitados: TLabel
            Left = 2
            Top = 39
            Width = 101
            Height = 13
            Caption = 'Reaproveitados [F3]'
            FocusControl = txtObservacao
          end
          object Label5: TLabel
            ...
            Width = 126
            Height = 13
            Caption = 'N'#227'o-Reaproveitados [F3]'
            FocusControl = txtObservacao
          end
          object txtResponsavelReaproveitamentoDescricao: TDBText
            Left = 69
            Top = 15
            Width = 157
            Height = 21
            Color = 14342874
            DataField = 'int_nomeresana'
            DataSource = dsoIte
            ParentColor = False
            Transparent = False
          end
          object txtResponsavelReaproveitamento: TJvDBComboEdit
            Left = 2
            Top = 15
            Width = 64
            Height = 21
            ClickKey = 114
            DataField = 'id_resp_ana'
            DataSource = dsoIte
            Glyph.Data = {
              36030000424D3603000000000000360000002800000010000000100000000100
              1800000000000003000000000000000000000000000000000000FFFFFFFFFFFF
              ...
              FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
            TabOrder = 0
            OnButtonClick = txtResponsavelReaproveitamentoClick
            OnEnter = txtResponsavelReaproveitamentoEnter
            OnExit = txtResponsavelReaproveitamentoExit
          end
          object dpkDtaEntrada: TJvDBDateEdit
            Tag = 1
            Left = 233
            Top = 15
            Width = 90
            Height = 21
            DataField = 'data_entrada_ana'
            DataSource = dsoIte
            ShowNullDate = False
            TabOrder = 1
            OnExit = dpkDtaEntradaExit
          end
          object dpkDtaSaida: TJvDBDateEdit
            Tag = 1
            Left = 326
            Top = 15
            Width = 90
            Height = 21
            DataField = 'data_saida_ana'
            DataSource = dsoIte
            ShowNullDate = False
            TabOrder = 2
            OnExit = dpkDtaSaidaExit
          end
          object dgNaoReaproveitados: TwwDBGrid
            Left = 334
            Top = 55
            Width = 325
            Height = 61
            Selected.Strings = (
              ...
              'int_desc_pro'#9'48'#9'Descri'#231#227'o'#9'F')
            IniAttributes.Delimiter = ';;'
            IniAttributes.UnicodeIniFile = False
            TitleColor = clBtnFace
            FixedCols = 0
            ...
            TitleButtons = False
            UseTFields = False
            OnExit = dgNaoReaproveitadosExit
            OnKeyDown = dgNaoReaproveitadosKeyDown
            object dgNaoReaproveitadosIButton: TwwIButton
              Left = -1
              Top = -1
              Width = 22
              Height = 22
              ...
              Glyph.Data = {
                ...
                FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
                B102}
              OnClick = dgNaoReaproveitadosIButtonClick
            end
          end
          object dgReaproveitados: TwwDBGrid
            Left = 3
            Top = 55
            Width = 325
            Height = 61
            ...
            TitleButtons = False
            UseTFields = False
            OnExit = dgReaproveitadosExit
            OnKeyDown = dgReaproveitadosKeyDown
            object dgReaproveitadosIButton: TwwIButton
              Left = -1
              Top = -1
              Width = 22
              Height = 22
              ...
              Glyph.Data = {
                ...
                FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
                B102}
              OnClick = dgReaproveitadosIButtonClick
            end
          end
        end
        object tbiComentario: TTabSheet
          ...
          object txtComentarios: TDBMemo
            ...
            DataSource = dsoIte
            TabOrder = 0
            OnEnter = txtComentariosEnter
            OnExit = txtComentariosExit
          end
        end
        object tbiMonitoramento: TTabSheet
          Caption = 'Monitoramento'
          ImageIndex = 5
          object pnlMonitoramento: TPanel
            Left = 0
            Top = 0
            Width = 664
            Height = 57
            ...
            object lelAberturaMonitoramento: TLabel
              Left = 513
              Top = 16
              Width = 45
              Height = 13
            ...
            object lblDataMonitoramento: TLabel
              Left = 324
              Top = 0
              Width = 183
              Height = 15
            ...
            object lblHoraMonitoramento: TLabel
              Left = 513
              Top = 0
              Width = 145
              Height = 15
            ...
            object lblEncerramentoMonitoramento: TLabel
              Left = 587
              Top = 16
              Width = 71
              Height = 13
            ...
            object txtResponsavelMonitoramentoDescricao: TDBText
              Left = 85
              Top = 32
              Width = 236
              Height = 21
            ...
            object txtResponsavelMonitoramento: TJvDBComboEdit
              Left = 2
              Top = 32
              Width = 80
              Height = 21
              ClickKey = 114
              DataField = 'id_resp_monitor'
              DataSource = dsoIte
              Glyph.Data = {
                36030000424D3603000000000000360000002800000010000000100000000100
                1800000000000003000000000000000000000000000000000000FFFFFFFFFFFF
                ...
                FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
              TabOrder = 0
              OnButtonClick = txtResponsavelMonitoramentoButtonClick
              OnEnter = txtResponsavelMonitoramentoEnter
              OnExit = txtResponsavelMonitoramentoExit
            end
            object dpkAbertura: TJvDBDateEdit
              Tag = 1
              Left = 324
              Top = 32
              Width = 90
              Height = 21
              DataField = 'data_monitor_abert'
              DataSource = dsoIte
              ShowNullDate = False
              TabOrder = 1
              OnExit = dpkAberturaExit
            end
            object dpkEncerramento: TJvDBDateEdit
              Tag = 1
              Left = 417
              Top = 32
              Width = 90
              Height = 21
              DataField = 'data_monitor_encer'
              DataSource = dsoIte
              ShowNullDate = False
              TabOrder = 2
              OnExit = dpkEncerramentoExit
            end
            object JvDBDateTimePicker1: TJvDBDateTimePicker
              ...
              Width = 68
              Height = 21
              Date = 42419.397046446760000000
              Format = 'hh:mm'
              Time = 42419.397046446760000000
              Kind = dtkTime
              TabOrder = 3
              OnExit = JvDBDateTimePicker1Exit
              DropDownDate = 41942.000000000000000000
              DataField = 'hora_monitor_abert'
              DataSource = dsoIte
            end
            object JvDBDateTimePicker2: TJvDBDateTimePicker
              ...
              Kind = dtkTime
              TabOrder = 4
              OnExit = JvDBDateTimePicker2Exit
              DropDownDate = 41942.000000000000000000
              DataField = 'hora_monitor_encer'
              DataSource = dsoIte
            end
          end
        end
        object tbiRegistroAcoes: TTabSheet
          Caption = 'Reg. de a'#231#245'es'
          ImageIndex = 6
          object ScrollBox1: TScrollBox
            ...
            ParentColor = False
            TabOrder = 0
            object dgRegras: TwwDBGrid
              Left = 2
              Top = 93
              Width = 657
              Height = 91
              ControlType.Strings = (
                'int_desc_sit;RichEdit;;F')
              Selected.Strings = (
                'id_resp_reg_acao'#9'10'#9'C'#243'digo'#9'F'
                'int_nome_fun'#9'25'#9'Respons'#225'vel'#9'F'
                'data_reg_acao'#9'15'#9'Data'#9'F'
                'int_desc_sit'#9'10'#9'Situa'#231#227'o'#9'F'
                'evento_ocorrido_reg_acao'#9'38'#9'Evento Ocorrido'#9'F')
              IniAttributes.Delimiter = ';;'
              IniAttributes.UnicodeIniFile = False
              TitleColor = clBtnFace
              FixedCols = 0
              ...
              TitleButtons = False
              UseTFields = False
              OnMouseUp = dgRegrasMouseUp
              object dgRegrasIButton: TwwIButton
                Left = -1
                Top = -1
                Width = 22
                Height = 22
            ...
            object pnlRegras: TPanel
              ...
              BevelOuter = bvNone
              TabOrder = 1
              OnExit = pnlRegrasExit
              object llDataAcao: TLabel
                Left = 219
                Top = 6
                Width = 67
                Height = 13
              ...
              object lblEventoOcorrido: TLabel
                Left = 4
                Top = 46
                Width = 84
                Height = 13
                Caption = 'Evento Ocorrido'
                FocusControl = txtObservacao
              end
              ...
              object txtResponsavelAcoesDescricao: TDBText
                Left = 70
                Top = 22
                Width = 146
                Height = 21
                Color = 14342874
                DataField = 'int_nome_fun'
                DataSource = dsoPrc
                ParentColor = False
                Transparent = False
              end
              object txtResponsavelAcoes: TJvDBComboEdit
                Left = 3
                Top = 22
                Width = 64
                Height = 21
                ClickKey = 114
                DataField = 'id_resp_reg_acao'
                DataSource = dsoPrc
                Glyph.Data = {
                  36030000424D3603000000000000360000002800000010000000100000000100
                  1800000000000003000000000000000000000000000000000000FFFFFFFFFFFF
                  ...
                  FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
                TabOrder = 0
                OnButtonClick = txtResponsavelAcoesButtonClick
                OnExit = txtResponsavelAcoesExit
              end
              object dpkDataAcao: TJvDBDateEdit
                Tag = 1
                Left = 219
                Top = 22
                Width = 90
                Height = 21
                DataField = 'data_reg_acao'
                DataSource = dsoPrc
                ShowNullDate = False
                TabOrder = 1
              end
              ...
              object txtEventoOcorrido: TDBEdit
                Left = 4
                Top = 62
                Width = 631
                Height = 21
                Color = clWhite
                DataField = 'evento_ocorrido_reg_acao'
                DataSource = dsoPrc
                TabOrder = 3
                OnExit = txtEventoOcorridoExit
              end
            end
            object btnAddRegras: TBitBtn
              Left = 2
              Top = 25
              Width = 23
              Height = 23
      ...
      object dpkDataNf: TJvDBDateEdit
        Tag = 1
        Left = 571
        Top = 146
        Width = 100
        ...
        ShowNullDate = False
        TabOrder = 17
        OnExit = dpkDataNfExit
      end
      object txtCodigo: TJvDBComboEdit
        Left = 422
        Top = 77
        Width = 80
        Height = 21
        ClickKey = 114
        DataField = 'id_busca_clirep'
        DataSource = dso
        Glyph.Data = {
          36030000424D3603000000000000360000002800000010000000100000000100
          1800000000000003000000000000000000000000000000000000FFFFFFFFFFFF
          ...
          FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
        TabOrder = 7
        OnButtonClick = txtCodigoButtonClick
        OnExit = txtCodigoExit
      end
      object cbbIdentificacaoCliente: TwwDBComboBox
        Left = 102
        Top = 77
        Width = 242
        Height = 21
        ...
        ItemHeight = 0
        Items.Strings = (
          'Distribuidor / Logista'#9'0'
          'Consumidor'#9'1'
          'Representante'#9'2')
        Sorted = False
        TabOrder = 6
        UnboundDataType = wwDefault
        OnChange = cbbIdentificacaoClienteChange
        OnEnter = cbbIdentificacaoClienteEnter
        OnExit = cbbIdentificacaoClienteExit
      end
      ...
      object txtNumero: TDBEdit
        ...
        Height = 21
        Color = clWhite
        DataField = 'nro_end_consumidor'
        DataSource = dso
        TabOrder = 11
      end
      object btnImportarPed: TcxButton
        Left = 520
        Top = 29
        Width = 151
        Height = 21
        ...
        TabOrder = 3
        OnClick = btnImportarPedClick
      end
      object btnCriarPed: TcxButton
        Left = 385
        Top = 29
        Width = 117
        Height = 21
        ...
        TabOrder = 2
        OnClick = btnCriarPedClick
      end
      object txtCodPedVenda: TwwDBEdit
        Left = 571
        Top = 54
        Width = 100
        Height = 21
  ...
  inherited pnlTop: TJvPanel
    inherited pnlCima: TJvPanel
      inherited lblTitulo: TLabel
        Caption = 'Atendimento das Reclama'#231#245'es de Clientes'
      end
    end
  end
  object dsoIte: TwwDataSource [4]
    DataSet = dmGeral.PCP_CD_M_ACR_ITE
    Left = 1009
    Top = 280
  end
  object dsoPdt: TwwDataSource [5]
    DataSet = dmGeral.PCP_CD_M_ACR_PDT
    Left = 1009
    Top = 328
  end
  object dsoPrc: TwwDataSource [6]
    DataSet = dmGeral.PCP_CD_M_ACR_PRC
    Left = 1017
    Top = 376
  end
  object dsoPcr: TwwDataSource [7]
    DataSet = dmGeral.PCP_CD_M_ACR_PCR
    Left = 1009
    Top = 424
  end
  object dsoPcn: TwwDataSource [8]
    DataSet = dmGeral.PCP_CD_M_ACR_PCN
    Left = 1009
    Top = 472
  end
  inherited dso: TwwDataSource
    DataSet = dmGeral.PCP_CD_M_ACR
    Left = 1009
    Top = 232
  end
