inherited PCP_FM_M_CAC: TPCP_FM_M_CAC
  ...
  inherited pnlDireita: TPanel
    inherited pnlDados: TPanel
      ...
      object lblDescricaoNaoConformidade: TLabel
        Left = 4
        Top = 58
        Width = 156
        Height = 13
      ...
      object cbbProcesso: TwwDBLookupCombo
        Left = 166
        Top = 32
        Width = 192
        Height = 21
        ...
        AllowClearKey = False
        OnEnter = cbbProcessoEnter
        OnExit = cbbProcessoExit
      end
      object rgCorretivaPreventiva: TDBRadioGroup
        Left = 414
        Top = 0
        Width = 150
        Height = 30
      ...
      object cbbOrigem: TwwDBLookupCombo
        Left = 414
        Top = 32
        Width = 254
        Height = 21
        ...
        PreciseEditRegion = False
        AllowClearKey = False
        OnEnter = cbbOrigemEnter
        OnExit = cbbOrigemExit
      end
      object txtDescricaoNaoConformidade: TDBMemo
        Left = 166
        Top = 55
        Width = 502
        Height = 35
      ...
      object pcMovimento: TPageControl
        ...
        Width = 664
        Height = 316
        ActivePage = tbiAnaliseCausasReaisPotenciais
        TabOrder = 7
        object tbiAnaliseCausasReaisPotenciais: TTabSheet
          Caption = 'An'#225'lise das causas reais ou potenciais'
          object grdAnalise: TwwDBGrid
            Left = 6
            Top = 160
            Width = 640
            Height = 122
            TabStop = False
            Selected.Strings = (
              'tipo_causa'#9'30'#9'Causa'#9'F'
              'MOTIVO'#9'45'#9'Motivo'#9'F'
            ...
            TitleButtons = False
            UseTFields = False
            OnMouseUp = grdAnaliseMouseUp
            object grdAnaliseIButton: TwwIButton
              Left = -1
              Top = -1
              Width = 22
              Height = 22
              ...
              Glyph.Data = {
                ...
                FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
                B102}
              OnClick = grdAnaliseIButtonClick
            end
          end
          object btnAddAnalise: TBitBtn
            Left = 5
            Top = 12
            Width = 23
            Height = 23
          ...
          object pnlAna: TPanel
            ...
            object lblCausaRaiz: TLabel
              Left = 313
              Top = 100
              Width = 55
              Height = 13
              Caption = 'Causa Ra'#237'z'
            end
            ...
            object cbbCausa: TwwDBLookupCombo
              Left = 2
              Top = 13
              Width = 350
              Height = 21
              ...
              DataField = 'tipo_causa'
              DataSource = dsoAna
              LookupTable = dmGeral.BUS_CD_X_CAC_001
              LookupField = 'CODIGO'
              Color = clWhite
              TabOrder = 0
              AutoDropDown = False
            ...
            object txtCausaRaiz: TDBMemo
              Left = 313
              Top = 114
              Width = 305
              Height = 40
              DataField = 'causa_raiz'
              DataSource = dsoAna
              TabOrder = 4
              OnExit = txtCausaRaizExit
            end
          end
        end
        object tsPlanoAcao: TTabSheet
          Caption = 'Planos de A'#231#227'o'
          ImageIndex = 1
          object btnAddPlanoAcao: TBitBtn
            Left = 5
            Top = 12
            Width = 23
            Height = 23
            Glyph.Data = {
              ...
              0000}
            TabOrder = 1
            OnClick = btnAddPlanoAcaoClick
          end
          object grdPlanoAcao: TwwDBGrid
            Left = 6
            Top = 36
            Width = 640
            Height = 246
            TabStop = False
            Selected.Strings = (
              'ACAO'#9'32'#9'A'#231#227'o'#9'F'
              'int_nomeres'#9'33'#9'Respons'#225'vel'#9'F'
              'dta_prazo'#9'15'#9'Prazo'#9'F'
              'dta_efetivo'#9'15'#9'Efetivo'#9'F')
            IniAttributes.Delimiter = ';;'
            IniAttributes.UnicodeIniFile = False
            ...
            TitleButtons = False
            UseTFields = False
            OnMouseUp = grdPlanoAcaoMouseUp
            object grdPlanoAcaoIButton: TwwIButton
              Left = -1
              Top = -1
              Width = 22
              Height = 22
              ...
              Glyph.Data = {
                ...
                FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
                B102}
              OnClick = grdPlanoAcaoIButtonClick
            end
          end
          object pnlPlanoAcao: TPanel
            Left = 27
            Top = 0
            Width = 626
            Height = 35
            ...
            object lblPrazoAte: TLabel
              Left = 436
              Top = -1
              Width = 48
              Height = 13
              Caption = 'Prazo At'#233
            end
            ...
            object dpkPrazoAte: TJvDBDateEdit
              Tag = 1
              Left = 436
              Top = 13
              Width = 90
            ...
            object dpkDataEfetivo: TJvDBDateEdit
              Tag = 1
              Left = 529
              Top = 13
              Width = 90
              Height = 21
              DataField = 'dta_efetivo'
              DataSource = dsoPla
              ShowNullDate = False
              TabOrder = 3
              OnExit = dpkDataEfetivoExit
            end
          end
        end
        object tbiAnaliseCritica: TTabSheet
          Caption = 'An'#225'lise Cr'#237'tica de Fechamento'
          ImageIndex = 2
          object lblVerificarEficacia: TLabel
            Left = 93
            Top = 17
            Width = 145
            Height = 13
            Caption = 'Verificar Efic'#225'cia ap'#243's o dia :'
          end
          object lblEficaciaConformidade: TLabel
            Left = 15
            Top = 63
            Width = 224
            Height = 13
            Caption = 'Efic'#225'cia - A n'#227'o conformidade foi corrigida?'
          end
          object lblFuncionariosEnvolvidos: TLabel
            Left = -1
            Top = 86
            Width = 240
            Height = 13
            Caption = 'Os funcion'#225'rios envolvidos foram informados?'
          end
          object lblRequerTreinamento: TLabel
            ...
            Width = 205
            Height = 13
            Caption = 'Os funcion'#225'rios requerem treinamento?'
          end
          object lblAnexarCopia: TLabel
            Left = 265
            Top = 105
            Width = 174
            Height = 13
            Caption = 'Anexar c'#243'pia da lista de presen'#231'a.'
            Color = clHotLight
            Font.Charset = DEFAULT_CHARSET
          ...
          object lblComentarios: TLabel
            ...
            Width = 145
            Height = 13
            Caption = 'Coment'#225'rios, se necess'#225'rio :'
          end
          object lblDiretor: TLabel
            Left = 197
            Top = 152
            Width = 42
            Height = 13
          ...
          object lblChefeSetor: TLabel
            Left = 158
            Top = 175
            Width = 81
            Height = 13
            Caption = 'Chefe de setor :'
          end
          object lblEficaciaVerificada: TLabel
            Left = 98
            Top = 40
            Width = 141
            Height = 13
            Caption = 'A efic'#225'cia foi verificada em :'
          end
          object cbbEficaciaConformidade: TwwDBLookupCombo
            Left = 245
            Top = 60
            Width = 90
            Height = 21
            ...
            DataField = 'fec_situacao_n_conf'
            DataSource = dso
            LookupTable = dmGeral.BUS_CD_X_CAC_002
            LookupField = 'CODIGO'
            TabOrder = 2
            AutoDropDown = False
            ShowButton = True
            ...
            PreciseEditRegion = False
            AllowClearKey = False
            OnEnter = cbbEficaciaConformidadeEnter
          end
          object chkFuncionariosEnvolvidos: TDBCheckBox
            Left = 245
            Top = 85
            Width = 14
            Height = 17
            DataField = 'fec_func_informados'
            DataSource = dso
            TabOrder = 3
          end
          object chkRequerTreinamento: TDBCheckBox
            Left = 245
            Top = 104
            Width = 14
            Height = 17
            DataField = 'fec_func_treinamento'
            DataSource = dso
            TabOrder = 4
            OnClick = chkRequerTreinamentoClick
          end
          object txtComentarios: TDBEdit
            ...
            Width = 397
            Height = 21
            DataField = 'fec_comentarios'
            DataSource = dso
            TabOrder = 5
          end
          object cbbDiretor: TwwDBLookupCombo
            Left = 245
            Top = 149
            Width = 200
            Height = 21
            ...
            Selected.Strings = (
              'nome'#9'20'#9'nome'#9'F'
              'id_funcionario'#9'10'#9'id_funcionario'#9'F')
            DataField = 'fec_id_resp_diretoria'
            DataSource = dso
            LookupTable = dmGeral.BUS_CD_C_FUN
            LookupField = 'id_funcionario'
            TabOrder = 6
            ...
            PreciseEditRegion = False
            AllowClearKey = False
            OnEnter = cbbDiretorEnter
            OnExit = cbbDiretorExit
          end
          object cbbChefeSetor: TwwDBLookupCombo
            Left = 245
            Top = 172
            Width = 200
            Height = 21
            ...
            PreciseEditRegion = False
            AllowClearKey = False
            OnEnter = cbbChefeSetorEnter
            OnExit = cbbChefeSetorExit
          end
          object dpkEficaciaVerificada: TJvDBDateEdit
            Left = 245
            Top = 37
            Width = 90
            Height = 21
            DataField = 'fec_dta_verificado'
            DataSource = dso
            ShowNullDate = False
            TabOrder = 1
          end
          object dpkVerificarEficacia: TJvDBDateEdit
            Left = 245
            Top = 14
            Width = 90
            Height = 21
            DataField = 'fec_dta_eficacia_apos'
            DataSource = dso
            ShowNullDate = False
            TabOrder = 0
          end
  ...
  inherited pnlTop: TJvPanel
    inherited pnlCima: TJvPanel
      inherited lblTitulo: TLabel
        Caption = 'Controle de A'#231#227'o Corretiva/Preventiva'
      end
    end
  end
  object dsoAna: TwwDataSource [4]
    DataSet = dmGeral.PCP_CD_M_CAC_ANA
    OnStateChange = dsoStateChange
    Left = 1010
    Top = 331
  end
  object dsoPla: TwwDataSource [5]
    DataSet = dmGeral.PCP_CD_M_CAC_PLA
    OnStateChange = dsoStateChange
    Left = 1010
    Top = 283
  end
  inherited dso: TwwDataSource
    DataSet = dmGeral.PCP_CD_M_CAC
    Left = 1010
  end
