inherited PCP_FM_M_CRP: TPCP_FM_M_CRP
  ...
  inherited pnlEsquerda: TPanel
    ...
    inherited pnlDatagrid: TPanel
      inherited dbGrid: TwwDBGrid
        Selected.Strings = (
          'id_crp'#9'10'#9'C'#243'digo'#9'F'
          'DTA_EMISSAO'#9'10'#9'Emiss'#227'o'#9'F'
          'int_nomeres'#9'32'#9'Respons'#225'vel'#9'F')
  ...
  inherited pnlDireita: TPanel
    inherited pnlDados: TPanel
      ...
      object txtNLotePai: TDBEdit
        ...
        TabStop = False
        Color = 14342874
        DataField = 'num_lote_crp'
        DataSource = dso
        Enabled = False
        ReadOnly = True
        TabOrder = 1
      end
      object cbbRecipiente: TwwDBLookupCombo
        Left = 148
        Top = 48
        Width = 165
        Height = 21
        ...
        AllowClearKey = False
        OnEnter = cbbRecipienteEnter
        OnExit = cbbRecipienteExit
      end
      ...
      object gbxBaixas: TGroupBox
        ...
        object grdBaixas: TwwDBGrid
          ...
          TabStop = False
          Selected.Strings = (
            'int_nomeite'#9'27'#9'Item'#9'F'
            'int_nomecor'#9'15'#9'Cor'#9'F'
            'int_nometam'#9'8'#9'Tamanho'#9'F'
            'qtde'#9'7'#9'Qtde'#9'F'
            'num_lote'#9'10'#9'N'#186' do Lote'#9'F'
            'id_opb'#9'8'#9'OPB'#9'F'#9'Produ'#231#227'o de Bloco de Espuma'
            'id_opb_ope'#9'8'#9'OPB OPE'#9'F'#9'Produ'#231#227'o de Bloco de Espuma'
            'id_opb_ibe'#9'8'#9'OPB IBE'#9'F'#9'Produ'#231#227'o de Bloco de Espuma')
          IniAttributes.Delimiter = ';;'
          IniAttributes.UnicodeIniFile = False
          TitleColor = clBtnFace
          FixedCols = 0
          ShowHorzScrollBar = True
          DataSource = dsoBaixas
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
          Font.Name = 'Segoe UI'
  ...
  inherited pnlTop: TJvPanel
    inherited pnlCima: TJvPanel
      inherited lblTitulo: TLabel
        Caption = 'Controle de Recipiente'
      end
    end
  end
  inherited dso: TwwDataSource
    DataSet = dmGeral.PCP_CD_M_CRP
    Left = 1010
  end
  object dsItens: TwwDataSource [5]
    DataSet = dmGeral.PCP_CD_M_CRP_ITE
  ...
  inherited imgBotoesAtivo: TImageList
    Bitmap = {
      494C01010800A800380118001800FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  object dsoBaixas: TwwDataSource [7]
    DataSet = dmGeral.PCP_CD_M_CRP_ITE_BXI
    OnStateChange = dsoStateChange
    Left = 1010
    Top = 283
  end
  inherited imgBotoesInativo: TImageList
    Bitmap = {
      
  ...
  inherited ImgPequena: TImageList
    Bitmap = {
      494C01011200000188010E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoAz: TImageList
    Bitmap = {
      
  ...
  inherited ImgPequenaAz: TImageList
    Bitmap = {
      494C01010600000180010E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoVe: TImageList
    Bitmap = {
      
  ...
  inherited ImgPequenaVe: TImageList
    Bitmap = {
      
