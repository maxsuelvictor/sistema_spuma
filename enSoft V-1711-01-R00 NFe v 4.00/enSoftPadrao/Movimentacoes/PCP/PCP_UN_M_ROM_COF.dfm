object PCP_FM_M_ROM_COF: TPCP_FM_M_ROM_COF
  Left = 0
  Top = 0
  ...
  object pnlPrincipal: TPanel
    ...
    object pnlDados: TPanel
      ...
      object Panel1: TPanel
        ...
        object txtCodCliente: TwwDBEdit
          Left = 109
          Top = 43
          Width = 118
          Height = 24
        ...
        object txtRepresentante: TwwDBEdit
          Left = 835
          Top = 43
          Width = 170
          Height = 24
      ...
      object Panel2: TPanel
        ...
        object grdPedIte: TwwDBGrid
          Left = 0
          Top = 22
          Width = 1016
          Height = 138
          Selected.Strings = (
            'id_item'#9'9'#9'C'#243'd. Item'#9'T'
            'int_nomeite'#9'32'#9'Descri'#231#227'o'#9'T'
            'int_undvenda'#9'3'#9'Und'#9'T'
            'int_nometam'#9'8'#9'Tamanho'#9'T'
            'int_nomecor'#9'12'#9'Cor'#9'T'
            'int_qtde_ped_ite'#9'10'#9'Qtde Total'#9'T'
            'qtde_conferida'#9'10'#9'Qtde Conferida'#9'T'
            'qtde_conj'#9'10'#9'Qtde conjugado'#9'F'
            'qtde_conj_conf'#9'10'#9'Qtde Conj. Conferido'#9'F')
          ...
          TitleButtons = False
          UseTFields = False
          OnCalcCellColors = grdPedIteCalcCellColors
        end
        object GroupBox1: TGroupBox
          ...
          object Label21: TLabel
            ...
            Height = 13
            Caption = 
              '< Itens que precisam digitar a QTDE o sistema ir'#225' buscar os iten' +
              's da O.P da etiqueta pistolada se assim estiver configurada>'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clBlue
            Font.Height = -11
            Font.Name = 'Tahoma'
          ...
          object grdPedIcf: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'cod_barra'#9'20'#9'Cod. Barra'#9'T'
              'int_nomeite'#9'50'#9'Descri'#231#227'o'#9'T'
              'int_undvenda'#9'5'#9'Und'#9'T'
              'int_nometam'#9'9'#9'Tamanho'#9'T'
              'int_nomecor'#9'18'#9'Cor'#9'T')
            IniAttributes.Delimiter = ';;'
            IniAttributes.UnicodeIniFile = False
            TitleColor = clBtnFace
            FixedCols = 0
            ...
            TitleButtons = True
            UseTFields = False
            OnTitleButtonClick = grdPedIcfTitleButtonClick
            OnKeyDown = grdPedIcfKeyDown
            OnMouseUp = grdPedIcfMouseUp
        ...
        object Panel3: TPanel
          ...
          object Label16: TLabel
            ...
            Width = 167
            Height = 18
            Caption = 'Total base box conferido:'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -15
            Font.Name = 'Tahoma'
          ...
          object txtTotalItemConj: TwwDBEdit
            Left = 350
            Top = 6
            Width = 83
            Height = 26
            DataField = 'qtde_total_item_conj'
            DataSource = dsPcpRomPed
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -15
            Font.Name = 'Tahoma'
          ...
          object txtTotalItemConjConf: TwwDBEdit
            Left = 633
            Top = 6
            Width = 83
            Height = 26
            DataField = 'qtde_total_item_conj_conf'
            DataSource = dsPcpRomPed
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -15
        ...
        object Panel5: TPanel
          ...
          object txtTotalItensPed: TEdit
            ...
            ReadOnly = True
            TabOrder = 1
            Text = 'txtTotalItensPed'
          end
          object txtTotalItensConfPed: TEdit
            Left = 876
            Top = 2
            Width = 121
            Height = 26
        ...
        object pnBaseBox: TPanel
          ...
          object Label17: TLabel
            ...
            Alignment = taCenter
            AutoSize = False
            Caption = 'Bases box deste Pedido de Venda'
            Color = 14342874
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -12
          ...
          object grdItensConj: TwwDBGrid
            Left = 1
            Top = 24
            Width = 657
            Height = 70
            Selected.Strings = (
              'id_item'#9'5'#9'C'#243'digo'
              'int_nomeite'#9'35'#9'Descri'#231#227'o'
              'int_undvenda'#9'3'#9'Und'
              'int_nomecor'#9'11'#9'Cor'
              'int_nometam'#9'7'#9'Tamanho'
              'qtde_a_inserir'#9'10'#9'Qtde'
              'qtde_conf'#9'11'#9'Qtde conferida')
            IniAttributes.Delimiter = ';;'
            IniAttributes.UnicodeIniFile = False
            TitleColor = clBtnFace
            FixedCols = 0
  ...
  object acBotoes: TActionList
    Left = 1088
    Top = 323
    object acAdiciona: TAction
      Tag = 2
      Caption = 'Adicionar'
      ImageIndex = 0
    end
  ...
  object imgBotoesInativo: TImageList
    ...
    Top = 323
    Bitmap = {
      494C010108008001AC0218001800FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  object imgBotoesAtivoVe: TImageList
    ColorDepth = cd32Bit
    Height = 24
    Width = 24
    Left = 1088
    Top = 283
    Bitmap = {
      
  ...
  object ImgPequenaVe: TImageList
    ColorDepth = cd32Bit
    Height = 14
    Width = 14
    Left = 920
    Top = 179
    Bitmap = {
      494C010106008401B0020E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  object ImgPequenaAz: TImageList
    ColorDepth = cd32Bit
    Height = 14
    Width = 14
    Left = 1088
    Top = 227
    Bitmap = {
      494C010106007401A0020E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
      0000000000003600000028000000380000001C00000001002000000000008018
  ...
  object imgBotoesAtivoAz: TImageList
    ColorDepth = cd32Bit
    Height = 24
    Width = 24
    Left = 984
    Top = 227
    Bitmap = {
      
  ...
  object imgBotoesAtivo: TImageList
    ...
    Top = 179
    Bitmap = {
      
  ...
  object ImgPequena: TImageList
    ...
    Top = 179
    Bitmap = {
      494C010112007C01A8020E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  object dsoPedIcf: TwwDataSource
    DataSet = dmGeral.PCP_CD_M_ROM_PED_ICF
    Left = 733
    Top = 237
  end
  object dsPcpRomPed: TDataSource
    DataSet = dmGeral.PCP_CD_M_ROM_PED
    Left = 80
    Top = 475
  end
  object cdsTempItemConj: TClientDataSet
    PersistDataPacket.Data = {
      
    ...
    Left = 360
    Top = 212
    object cdsTempItemConjid_item_conjugado: TIntegerField
      DisplayLabel = 'C'#243'digo'
      DisplayWidth = 5
      FieldName = 'id_item_conjugado'
    end
    object cdsTempItemConjint_nomeite: TStringField
      DisplayLabel = 'Descri'#231#227'o'
      DisplayWidth = 35
      FieldName = 'int_nomeite'
      Size = 100
    end
    object cdsTempItemConjqtde_a_inserir: TFloatField
      DisplayLabel = 'Qtde'
      DisplayWidth = 10
      FieldName = 'qtde_a_inserir'
    end
    object cdsTempItemConjid_item: TIntegerField
      DisplayWidth = 10
      FieldName = 'id_item'
    end
    object cdsTempItemConjint_nomecor: TStringField
      DisplayWidth = 20
      FieldName = 'int_nomecor'
    end
    object cdsTempItemConjint_nometam: TStringField
      DisplayWidth = 20
      FieldName = 'int_nometam'
    end
    object cdsTempItemConjqtde_conf: TFloatField
      DisplayWidth = 10
      FieldName = 'qtde_conf'
    end
    object cdsTempItemConjid_cor: TIntegerField
      FieldName = 'id_cor'
      Visible = False
    end
    object cdsTempItemConjid_tamanho: TIntegerField
      FieldName = 'id_tamanho'
      Visible = False
    end
  end
  object dsRomPedIcj: TDataSource
    DataSet = dmGeral.PCP_CD_M_ROM_PED_ICJ
    Left = 464
    Top = 212
  end
end
