inherited PCP_FM_M_RAA: TPCP_FM_M_RAA
  ...
  inherited pnlEsquerda: TPanel
    ...
    inherited pnlDatagrid: TPanel
      ...
      inherited dbGrid: TwwDBGrid
        Height = 401
        Selected.Strings = (
          'id_raa'#9'15'#9'Controle'#9'F'
          'dta_emissao'#9'15'#9'Emiss'#227'o'#9'F'
          'nro_raa'#9'21'#9'Nro RAA'#9'F')
        ExplicitHeight = 401
      end
    end
  end
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object txtCodFabrica: TDBText
        Left = 194
        Top = 23
        Width = 117
        Height = 21
        Color = 14342874
        DataField = 'codigo_fabrica'
        DataSource = dso
        ParentColor = False
        Transparent = False
      end
      ...
      object txtNomeFabric: TDBText
        Left = 487
        Top = 92
        Width = 197
        Height = 21
        Color = 14342874
        DataField = 'int_nomefab'
        DataSource = dso
        ParentColor = False
        Transparent = False
      end
      ...
      object txtGrupoDescricao: TDBText
        Left = 486
        Top = 46
        Width = 198
        Height = 21
        Color = 14342874
        DataField = 'int_nomegru'
        DataSource = dso
        ParentColor = False
        Transparent = False
      end
      ...
      object txtGrupo: TDBText
        ...
        Height = 21
        Color = 14342874
        DataField = 'int_codigru'
        DataSource = dso
        ParentColor = False
        Transparent = False
      end
      object txtIdItem: TDBText
        Left = 78
        Top = 23
        Width = 51
        Height = 21
      ...
      object txtIdFornecedor: TDBText
        Left = 78
        Top = 46
        Width = 51
        Height = 21
      ...
      object deEmissao: TJvDBDateEdit
        Left = 78
        Top = 0
        Width = 90
        Height = 21
      ...
      object deRecebimento: TJvDBDateEdit
        Left = 394
        Top = 0
        Width = 90
        Height = 21
        Hint = 'Data do recebimento do representante'
        DataField = 'dta_recebimento_item'
        DataSource = dso
      ...
      object txtNroRAA: TJvDBComboEdit
        Left = 600
        Top = 0
        Width = 84
        Height = 21
        ...
        ReadOnly = True
        TabOrder = 3
        OnButtonClick = txtNroRAAButtonClick
      end
      object txtQtdeAmostra: TwwDBEdit
        Left = 238
        Top = 138
        Width = 73
        Height = 21
        DataField = 'qtde_amostra'
        DataSource = dso
        TabOrder = 9
      ...
      object txtCodFabricante: TJvDBComboEdit
        Left = 394
        Top = 93
        Width = 90
        Height = 21
        ...
        Glyph.Data = {
          ...
          FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
        TabOrder = 5
        OnButtonClick = txtCodFabricanteButtonClick
        OnExit = txtCodFabricanteExit
      end
      ...
      object deAnalise: TJvDBDateEdit
        Left = 394
        Top = 115
        Width = 90
        Height = 21
        DataField = 'dta_analise'
        DataSource = dso
        ShowNullDate = False
        TabOrder = 7
      end
      ...
      object gbPlanoAcao: TGroupBox
        ...
        object grdPlano: TwwDBGrid
          ...
          TabStop = False
          Selected.Strings = (
            'id_responsavel'#9'6'#9'C'#243'digo'#9'F'
            'int_nomeres'#9'23'#9'Respons'#225'vel'#9'F'
            'dta_prazo'#9'15'#9'Prazo'#9'F'
            'dta_executado'#9'15'#9'Executado em'#9'F'
            'acao_necessaria'#9'15'#9'A'#231#227'o necess'#225'ria'#9'F'
            'observacao'#9'24'#9'Observa'#231#227'o'#9'F')
          IniAttributes.Delimiter = ';;'
          IniAttributes.UnicodeIniFile = False
          TitleColor = 13750737
          FixedCols = 0
          ShowHorzScrollBar = True
          DataSource = dsRaaItens
          TabOrder = 2
        ...
        object pnItens: TPanel
          ...
          object Label11: TLabel
            ...
            Width = 81
            Height = 13
            Caption = 'A'#231#227'o necess'#225'ria'
          end
          ...
          object deExecutadoEm: TJvDBDateEdit
            Left = 252
            Top = 14
            Width = 90
            Height = 21
            DataField = 'dta_executado'
            DataSource = dsRaaItens
            ShowNullDate = False
            TabOrder = 2
          end
          object txtAcaoNecess: TwwDBEdit
            Left = 345
            Top = 14
            Width = 150
            Height = 21
            DataField = 'acao_necessaria'
            DataSource = dsRaaItens
            TabOrder = 3
            UnboundDataType = wwDefault
            WantReturns = False
      ...
      object rg_Pergunta1: TDBRadioGroup
        Left = 5
        Top = 167
        Width = 306
        Height = 35
        Caption = 'Quantidade da amostra '#233' suficiente para os testes?'
        Columns = 3
        DataField = 'PERGUNTA_1'
        DataSource = dso
        Items.Strings = (
          'N'#227'o'
          'Sim'
      ...
      object rg_Pergunta2: TDBRadioGroup
        Left = 5
        Top = 205
        Width = 306
        Height = 35
        Caption = 'Qualidade do produto est'#225' de acordo com o solicitado?'
        Columns = 3
        DataField = 'PERGUNTA_2'
        DataSource = dso
        Items.Strings = (
          'N'#227'o'
          'Sim'
      ...
      object rg_Pergunta3: TDBRadioGroup
        Left = 4
        Top = 243
        Width = 307
        Height = 35
        Caption = 'O material atendeu as expectativas?'
        Columns = 3
        DataField = 'PERGUNTA_3'
        DataSource = dso
        Items.Strings = (
          'N'#227'o'
          'Sim'
      ...
      object rg_Pergunta4: TDBRadioGroup
        Left = 4
        Top = 281
        Width = 307
        Height = 35
        Caption = 'O material precisa de alguma adapta'#231#227'o?'
        Columns = 3
        DataField = 'PERGUNTA_4'
        DataSource = dso
        Items.Strings = (
          'N'#227'o'
          'Sim'
      ...
      object rg_Pergunta5: TDBRadioGroup
        Left = 336
        Top = 167
        Width = 349
        Height = 35
        Caption = 'Necessita de mais amostras para concluir os testes? '
        Columns = 3
        DataField = 'PERGUNTA_5'
        DataSource = dso
        Items.Strings = (
          'N'#227'o'
          'Sim'
      ...
      object rg_Pergunta6: TDBRadioGroup
        Left = 336
        Top = 205
        Width = 349
        Height = 35
        Caption = 'Necessidade de an'#225'lise em laborat'#243'rio? '
        Columns = 3
        DataField = 'PERGUNTA_6'
        DataSource = dso
        Items.Strings = (
          'N'#227'o'
          'Sim'
      ...
      object rg_Pergunta7: TDBRadioGroup
        Left = 336
        Top = 243
        Width = 349
        Height = 35
        Caption = 'Espessura X Larg. X Comp. est'#227'o de acordo com o especificado?'
        Columns = 3
        DataField = 'PERGUNTA_7'
        DataSource = dso
        Items.Strings = (
          'N'#227'o'
          'Sim'
      ...
      object rg_Pergunta8: TDBRadioGroup
        Left = 336
        Top = 281
        Width = 349
        Height = 35
        Caption = 'Gramatura/peso est'#227'o de acordo com o especificado?'
        Columns = 3
        DataField = 'PERGUNTA_8'
        DataSource = dso
        Items.Strings = (
          'N'#227'o'
          'Sim'
      ...
      object rgResultado: TDBRadioGroup
        Left = 5
        Top = 326
        Width = 233
        Height = 32
        ...
        Values.Strings = (
          ...
          '1'
          '')
        OnClick = rgResultadoClick
      end
      object chkIncorporaItem: TDBCheckBox
        Left = 336
        Top = 334
        Width = 237
        Height = 17
        Caption = 'Incorpora o item na estrutura do produto?'
        DataField = 'incorpora_item'
        DataSource = dso
        TabOrder = 20
        ValueChecked = '1'
        ValueUnchecked = '0'
  ...
  inherited pnlTop: TJvPanel
    inherited pnlCima: TJvPanel
      ...
      inherited lblTitulo: TLabel
        Caption = 'An'#225'lise de Amostra - RAA'
        ExplicitWidth = 1014
      end
    end
  end
  object dsRaaItens: TwwDataSource [4]
    DataSet = dmGeral.PCP_CD_M_RAA_ITE
    OnStateChange = dsoStateChange
    Left = 1011
    Top = 283
  end
  inherited dso: TwwDataSource
    DataSet = dmGeral.PCP_CD_M_RAA
  end
  inherited imgBotoesAtivo: TImageList
    Bitmap = {
      494C01010800A8000C0118001800FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesInativo: TImageList
    Bitmap = {
      
  ...
  inherited ImgPequena: TImageList
    Bitmap = {
      494C0101120000015C010E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoAz: TImageList
    Bitmap = {
      
  ...
  inherited ImgPequenaAz: TImageList
    Bitmap = {
      494C01010600000154010E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoVe: TImageList
    Bitmap = {
      
  ...
  inherited ImgPequenaVe: TImageList
    Bitmap = {
      
