inherited CMP_FM_M_SOL: TCMP_FM_M_SOL
  ClientWidth = 1231
  ExplicitWidth = 1237
  ExplicitHeight = 538
  PixelsPerInch = 96
  ...
  inherited pnlEsquerda: TPanel
    ...
    inherited pnlDatagrid: TPanel
      ...
      inherited dbGrid: TwwDBGrid
        Height = 278
        Selected.Strings = (
          'ID_SOLICITACAO'#9'10'#9'Controle'#9'F'
          'DTA_SOLICITACAO'#9'14'#9'Data'#9'F'
          'int_nomefun'#9'28'#9'Respons'#225'vel'#9'F')
        TitleColor = 13750737
    ...
    inherited pnlBotoes: TPanel
      ...
      object btnImprimirSolicitacao: TBitBtn
        Left = 0
        Top = 53
        Width = 311
        Height = 50
        ...
        ParentFont = False
        TabOrder = 6
        OnClick = btnImprimirSolicitacaoClick
      end
    end
  ...
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object gbItens: TGroupBox
        ...
        object pnItens: TPanel
          ...
          object txtObsItens: TwwDBEdit
            ...
            WantReturns = False
            WordWrap = False
            OnExit = txtObsItensExit
          end
          object txtEstMinimo: TwwDBEdit
            Tag = 2
            Left = 422
            Top = 14
            Width = 62
          ...
          object txtDescItem: TwwDBEdit
            ...
            WantReturns = False
            WordWrap = False
            OnEnter = txtDescItemEnter
            OnExit = txtDescItemExit
          end
          object cbbUnd: TwwDBLookupCombo
            Left = 318
            Top = 14
            Width = 44
            Height = 21
            ...
            Selected.Strings = (
              'id_unidade'#9'3'#9'id_unidade'#9'F')
            DataField = 'und_item'
            DataSource = dsoItens
        ...
        object grdItens: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'desc_item'#9'47'#9'Descri'#231#227'o'#9'F'
            'und_item'#9'5'#9'Und'#9'F'
            'int_nomecor'#9'16'#9'Cor'#9'F'
            'int_nometam'#9'12'#9'Tamanho'#9'F'
            'QTDE'#9'11'#9'Qtde'#9'F')
      ...
      object deSolicitacao: TJvDBDateEdit
        Left = 285
        Top = 9
        Width = 89
        Height = 21
        DataField = 'DTA_SOLICITACAO'
        DataSource = dso
        ReadOnly = True
        Color = 14342874
        ShowNullDate = False
  ...
  object dsoItens: TwwDataSource [4]
    DataSet = dmGeral.CMP_CD_M_SOL_ITE
    Left = 1098
    Top = 297
  end
  object CMP_FR_M_SOL: TfrxReport [5]
    Version = '5.1.9'
    ...
    Datasets = <
      item
        DataSet = CMP_DB_M_SOL
        DataSetName = 'CMP_DB_M_SOL'
      end
      item
        DataSet = CMP_DB_M_SOL_ITE
        DataSetName = 'CMP_DB_M_SOL_ITE'
      end>
    Variables = <
      item
        Name = ' externo'
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo1: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'SOLICITA'#199#195'O DE MATERIAIS')
          ParentFont = False
        end
        ...
        object CMP_DB_M_SOLint_nomeset: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[CMP_DB_M_SOL."int_nomeset"]')
          ParentFont = False
        end
        object CMP_DB_M_SOLint_nomefun: TfrxMemoView
          Left = 245.669450000000000000
          Top = 45.354360000000000000
          Width = 241.889920000000000000
          Height = 15.118120000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[CMP_DB_M_SOL."int_nomefun"]')
          ParentFont = False
        end
        object CMP_DB_M_SOLmotivo: TfrxMemoView
          Left = 245.669450000000000000
          Top = 60.472480000000000000
          Width = 241.889920000000000000
          Height = 15.118120000000000000
        ...
        object CMP_DB_M_SOLobs: TfrxMemoView
          Left = 245.669450000000000000
          Top = 75.590600000000000000
          Width = 241.889920000000000000
          Height = 15.118120000000000000
        ...
        object CMP_DB_M_SOLid_solicitacao: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[CMP_DB_M_SOL."id_solicitacao"]')
          ParentFont = False
        end
        object CMP_DB_M_SOLdta_solicitacao: TfrxMemoView
          Left = 559.370440000000000000
          Top = 45.354360000000000000
          Width = 154.960730000000000000
          Height = 15.118120000000000000
      ...
      object MasterData1: TfrxMasterData
        ...
        object CMP_DB_M_SOL_ITEid_item: TfrxMemoView
          Left = 11.338590000000000000
          Width = 37.795300000000000000
          Height = 15.118120000000000000
          DataField = 'id_item'
  ...
  object CMP_XL_M_SOL: TfrxXLSExport [6]
    UseFileCache = True
    ShowProgress = True
  ...
  object CMP_PD_M_SOL: TfrxPDFExport [7]
    UseFileCache = True
    ShowProgress = True
    OverwritePrompt = False
    DataOnly = False
  ...
  object CMP_DB_M_SOL: TfrxDBDataset [8]
    UserName = 'CMP_DB_M_SOL'
    CloseDataSource = False
    DataSet = dmGeral.CMP_CD_M_SOL
    BCDToCurrency = False
    Left = 1184
    Top = 291
  end
  object CMP_DB_M_SOL_ITE: TfrxDBDataset [9]
    UserName = 'CMP_DB_M_SOL_ITE'
    OnCheckEOF = CMP_DB_M_SOL_ITECheckEOF
    CloseDataSource = False
  ...
  inherited imgBotoesAtivo: TImageList
    ...
    Top = 51
    Bitmap = {
      494C01010800A800500118001800FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesInativo: TImageList
    ...
    Top = 195
    Bitmap = {
      
  ...
  inherited ImgPequena: TImageList
    ...
    Top = 51
    Bitmap = {
      494C010112000001A0010E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoVe: TImageList
    ...
    Top = 147
    Bitmap = {
      
  ...
  inherited ImgPequenaVe: TImageList
    ...
    Top = 147
    Bitmap = {
      
  ...
  object CMP_FR_M_SOL_REQ: TfrxReport
    Version = '5.1.9'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick]
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo1: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'REQUISI'#199#195'O E SOLICITA'#199#195'O DE COMPRAS')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo5: TfrxMemoView
          Left = 138.888469660000000000
          Top = 34.015770000000000000
          Width = 67.206150340000000000
          Height = 18.897650000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
        ...
        object Memo6: TfrxMemoView
          Left = 206.094620000000000000
          Top = 34.015770000000000000
          Width = 184.040326210000000000
          Height = 18.897650000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
        ...
        object Memo20: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            'DATA DE REQUISI'#199#195'O : [CMP_DB_M_SOL."dta_solicitacao"]')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo23: TfrxMemoView
          Left = 488.134946210000000000
          Top = 34.015770000000000000
          Width = 229.975753790000000000
          Height = 18.897650000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
        ...
        object Memo41: TfrxMemoView
          Left = 66.896551720000000000
          Top = 34.205798280000000000
          Width = 71.626533110000000000
          Height = 18.897650000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
