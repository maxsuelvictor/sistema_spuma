inherited CMP_FM_M_COT: TCMP_FM_M_COT
  ExplicitTop = -93
  ExplicitWidth = 1156
  ExplicitHeight = 538
  PixelsPerInch = 96
  ...
  inherited pnlEsquerda: TPanel
    ...
    inherited pnlDatagrid: TPanel
      ...
      inherited dbGrid: TwwDBGrid
        Height = 278
        Selected.Strings = (
          'id_cotacao'#9'10'#9'Controle'#9'F'
          'dta_cotacao'#9'15'#9'Data'#9'F'
          'int_nomeres'#9'27'#9'Respons'#225'vel'#9'F')
    ...
    inherited pnlBotoes: TPanel
      ...
      object btnImprimirCotacao: TBitBtn
        Left = -1
        Top = 53
        Width = 310
        Height = 50
  ...
  inherited pnlDireita: TPanel
    inherited pnlDados: TPanel
      ...
      object gbItens: TGroupBox
        ...
        object grdItens: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'int_nomeite'#9'30'#9'Descri'#231#227'o'#9'F'
            'int_undcom'#9'3'#9'Und'#9'F'
      ...
      object gbFornecedores: TGroupBox
        ...
        TabOrder = 7
        object grdFornecedores: TwwDBGrid
          Left = 6
          Top = 52
          Width = 608
          Height = 100
          Selected.Strings = (
            'id_fornecedor'#9'13'#9'C'#243'digo'#9'F'
            'int_nomefor'#9'80'#9'Nome'#9'F')
          IniAttributes.Delimiter = ';;'
          IniAttributes.UnicodeIniFile = False
          TitleColor = 13750737
          FixedCols = 0
          ShowHorzScrollBar = True
          DataSource = dsoFornecedores
          Options = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit, dgWordWrap]
          TabOrder = 2
          TitleAlignment = taLeftJustify
          TitleFont.Charset = DEFAULT_CHARSET
          ...
          TitleButtons = False
          UseTFields = False
          OnMouseUp = grdFornecedoresMouseUp
          object grdFornecedoresIButton: TwwIButton
            Left = -1
            Top = -1
            Width = 23
            Height = 22
            ...
            Glyph.Data = {
              ...
              FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
              B102}
            OnClick = grdFornecedoresIButtonClick
          end
        end
        object btn_Add_Forn: TBitBtn
          Left = 6
          Top = 28
          Width = 23
          Height = 23
      ...
      object btnImportaSolicitacao: TcxButton
        ...
        Width = 119
        Height = 21
        Caption = 'Importar Solicita'#231#227'o'
        TabOrder = 5
        TabStop = False
        OnClick = btnImportaSolicitacaoClick
      end
      object txtResponsavel: TJvDBComboEdit
        Left = 121
        Top = 23
        Width = 80
        Height = 21
        ...
        Glyph.Data = {
          ...
          FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
        TabOrder = 3
        OnButtonClick = txtResponsavelButtonClick
        OnExit = txtResponsavelExit
      end
  ...
  object dsoItens: TwwDataSource [4]
    DataSet = dmGeral.CMP_CD_M_COT_ITE
    Left = 1000
    Top = 283
  end
  object dsoFornecedores: TwwDataSource [5]
    DataSet = dmGeral.CMP_CD_M_COT_FOR
    Left = 1000
    Top = 331
  end
  object CMP_FR_M_COT: TfrxReport [6]
    Version = '5.1.9'
    ...
    ReportOptions.LastChange = 41897.441621747700000000
    ...
    Datasets = <
      item
        DataSet = BUS_DB_C_FOR
        DataSetName = 'BUS_DB_C_FOR'
      end
      item
      ...
      item
        DataSet = CMP_DB_M_COT
        DataSetName = 'CMP_DB_M_COT'
      end
      item
        DataSet = CMP_DB_M_COT_FIT
        DataSetName = 'CMP_DB_M_COT_FIT'
      end>
    Variables = <>
    Style = <>
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object CMP_DB_M_COT_FITvlr_desconto: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[CMP_DB_M_COT_FIT."vlr_desconto"]')
          ParentFont = False
        end
        object CMP_DB_M_COT_FITvlr_total: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[CMP_DB_M_COT_FIT."vlr_total"]')
          ParentFont = False
        end
        object CMP_DB_M_COT_FITipi: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[CMP_DB_M_COT_FIT."ipi"]')
          ParentFont = False
        end
        object CMP_DB_M_COT_FITprazo: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[CMP_DB_M_COT_FIT."prazo"]')
          ParentFont = False
        end
        object CMP_DB_M_COT_FITvlr_unitario: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[CMP_DB_M_COT_FIT."vlr_unitario"]')
          ParentFont = False
        end
        object CMP_DB_M_COT_FITqtde: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[CMP_DB_M_COT_FIT."qtde"]')
          ParentFont = False
        end
        object CMP_DB_M_COT_FITint_undcom: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[CMP_DB_M_COT_FIT."int_undcom"]')
          ParentFont = False
        end
        object CMP_DB_M_COT_FITid_item: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[CMP_DB_M_COT_FIT."id_item"]')
          ParentFont = False
        end
        object CMP_DB_M_COT_FITint_nomeite: TfrxMemoView
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 718.110700000000000000
        Condition = 'CMP_DB_M_COT_FIT."id_fornecedor"'
        KeepTogether = True
        StartNewPage = True
        ...
        object Memo1: TfrxMemoView
          ...
          Font.Style = [fsBold]
          Memo.UTF8W = (
            'Requisi'#231#227'o para Cota'#231#227'o')
          ParentFont = False
        end
        ...
        object Memo7: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'CAD_DB_C_PAR."emp_bairro"]. CEP: [CAD_DB_C_PAR."emp_cep"], [CAD_' +
              'DB_C_PAR."int_nomecid"] - [CAD_DB_C_PAR."int_uf"].')
          ParentFont = False
          WordBreak = True
        end
        object Memo8: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[CAD_DB_C_PAR."emp_telefone"] / FAX: [CAD_DB_C_PAR."emp_fax"]')
          ParentFont = False
          WordWrap = False
        end
        ...
        object Memo12: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FormatMaskText('#39'00\.000\.000\/0000\-00;0;_'#39',<CAD_DB_C_PAR."emp_' +
              'cnpj">)] / IE: [CAD_DB_C_PAR."emp_ie"]')
          ParentFont = False
          WordWrap = False
          Formats = <
            item
        ...
        object Memo17: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[BUS_DB_C_FOR."tel_fixo"] / FAX: [BUS_DB_C_FOR."fax"]')
          ParentFont = False
          WordWrap = False
        end
        ...
        object Memo19: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FormatMaskText('#39'00\.000\.000\/0000\-00;0;_'#39',<BUS_DB_C_FOR."doc_' +
              'cnpj">)] / IE: [BUS_DB_C_FOR."doc_ie"]')
          ParentFont = False
          WordWrap = False
        end
        ...
        object Memo23: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[BUS_DB_C_FOR."endereco"], n'#186' [BUS_DB_C_FOR."numero"], [BUS_DB_C' +
              '_FOR."bairro"]. CEP: [BUS_DB_C_FOR."cep"], [BUS_DB_C_FOR."int_no' +
              'mecid"] - [BUS_DB_C_FOR."int_uf"].')
          ParentFont = False
          WordBreak = True
        end
        ...
        object CMP_DB_M_COTdta_cotacao: TfrxMemoView
          Left = 389.291590000000000000
  ...
  object CMP_XL_M_COT: TfrxXLSExport [7]
    UseFileCache = True
    ShowProgress = True
  ...
  object CMP_PD_M_COT: TfrxPDFExport [8]
    UseFileCache = True
    ShowProgress = True
    OverwritePrompt = False
    DataOnly = False
  ...
  object CMP_DB_M_COT_FIT: TfrxDBDataset [9]
    UserName = 'CMP_DB_M_COT_FIT'
    OnCheckEOF = CMP_DB_M_COT_FITCheckEOF
    CloseDataSource = False
    DataSet = dmGeral.CMP_CD_M_COT_FIT
    BCDToCurrency = False
    Left = 1098
    Top = 331
  end
  object CMP_DB_M_COT: TfrxDBDataset [10]
    UserName = 'CMP_DB_M_COT'
    CloseDataSource = False
    DataSet = dmGeral.CMP_CD_M_COT
    BCDToCurrency = False
    Left = 1098
    Top = 283
  end
  object BUS_DB_C_FOR: TfrxDBDataset [11]
    UserName = 'BUS_DB_C_FOR'
    CloseDataSource = False
  ...
  inherited imgBotoesAtivo: TImageList
    Bitmap = {
      494C01010800A800400118001800FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesInativo: TImageList
    Bitmap = {
      
  ...
  inherited ImgPequena: TImageList
    Bitmap = {
      494C01011200000190010E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoAz: TImageList
    Bitmap = {
      
  ...
  inherited ImgPequenaAz: TImageList
    Bitmap = {
      494C01010600000188010E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoVe: TImageList
    Bitmap = {
      
  ...
  inherited ImgPequenaVe: TImageList
    Bitmap = {
      
