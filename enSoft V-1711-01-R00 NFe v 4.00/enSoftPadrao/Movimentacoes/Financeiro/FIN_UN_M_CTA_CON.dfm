inherited FIN_FM_M_CTA_CON: TFIN_FM_M_CTA_CON
  ClientHeight = 544
  ClientWidth = 1144
  ExplicitLeft = -105
  ExplicitWidth = 1150
  ...
  inherited pnlEsquerda: TPanel
    ...
    inherited pnlFiltro: TPanel
      ...
      inherited gbxFiltro: TGroupBox
        inherited cbbPesquisa: TComboBox
          Width = 126
          ItemIndex = 1
          Text = 'Data da Concilia'#231#227'o'
          OnChange = cbbPesquisaChange
          Items.Strings = (
            'Controle'
            'Data da Concilia'#231#227'o'
    ...
    inherited pnlDatagrid: TPanel
      ...
      inherited dbGrid: TwwDBGrid
        Height = 410
        Selected.Strings = (
          'id_conciliacao'#9'19'#9'C'#243'digo'#9'F'
          'dta_conciliacao'#9'15'#9'Data'#9'F'
          'int_nomectc'#9'18'#9'Conta'#9'F')
        ExplicitHeight = 410
      end
    end
  end
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object lblDataConciliacao: TLabel
        Left = 92
        Top = 33
        Width = 108
        Height = 13
      ...
      object Label5: TLabel
        ...
        Width = 155
        Height = 13
        Caption = 'Total movimento relacionado :'
      end
      ...
      object txtControle: TDBEdit
        ...
        TabStop = False
        Color = 14342874
        DataField = 'id_conciliacao'
        DataSource = dso
        ReadOnly = True
        TabOrder = 5
      end
      object dpkDataConciliacao: TJvDBDateEdit
        Left = 206
        Top = 30
        Width = 90
        Height = 21
        DataField = 'dta_conciliacao'
        DataSource = dso
        Color = clWhite
        ShowNullDate = False
        TabOrder = 0
        OnExit = dpkDataConciliacaoExit
      end
      object cbbContaCorrente: TwwDBLookupCombo
        ...
        DataField = 'id_conta'
        DataSource = dso
        LookupTable = dmGeral.BUS_CD_C_CTC
      ...
      object gbMovimentoGerado: TGroupBox
        Left = 434
        Top = 54
        Width = 393
        Height = 290
        ...
        object txtHistorico: TDBText
          Left = 71
          Top = 253
          Width = 319
          Height = 17
          DataField = 'historico'
          DataSource = dsoConCxbDet
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -9
          Font.Name = 'Segoe UI'
        ...
        object gdMovConDet: TwwDBGrid
          ...
          TabStop = False
          ControlType.Strings = (
            'int_natureza;RichEdit;;F'
            'int_selecao;CheckBox;True;False'
            'vlr_juros;CustomEdit;txtJuros;F'
            'vlr_desconto;CustomEdit;txtDesconto;F'
            'vlr_desconto_ope;CustomEdit;txtDescOpe;F')
          Selected.Strings = (
            'id_plano'#9'16'#9'Plano de Contas'#9'T'
            'vlr_titulo'#9'10'#9'Vlr. T'#237'tulo'#9'T'
            'vlr_desconto'#9'7'#9'Desc.'#9'F'
            'vlr_desconto_ope'#9'9'#9'Desc. Ope'#9'F'
            'vlr_juros'#9'7'#9'Juros'#9'F'
            'vlr_lancamento'#9'11'#9'Vlr. Total'#9'T')
          IniAttributes.Delimiter = ';;'
          IniAttributes.UnicodeIniFile = False
          TitleColor = clBtnFace
          OnRowChanged = gdMovConDetRowChanged
          OnCellChanged = gdMovConDetCellChanged
          FixedCols = 0
          ...
          TitleButtons = False
          UseTFields = False
          OnCalcCellColors = gdMovConDetCalcCellColors
          OnFieldChanged = gdMovConDetFieldChanged
          object dgMovConDetIButton: TwwIButton
            Left = -1
            Top = -1
            Width = 21
            Height = 22
            ...
            Glyph.Data = {
              ...
              FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
              0000}
            OnClick = dgMovConDetIButtonClick
          end
        end
        object pcNovoMov: TPageControl
          Left = 7
          Top = 38
          Width = 332
          Height = 116
          ActivePage = tsTitPagar
          TabOrder = 0
          object tsSugestao: TTabSheet
            Caption = 'Sugest'#227'o'
            OnShow = tsSugestaoShow
            ...
            object lblVlrLancamento: TLabel
              Left = 216
              Top = 51
              Width = 82
              Height = 13
            ...
            object txtHistoricoSugest: TDBEdit
              Left = 16
              Top = 21
              Width = 296
              Height = 21
              DataField = 'historico'
              DataSource = dsoConCxbAux
              Enabled = False
              TabOrder = 0
            end
            object cbbPlanoContasSugest: TwwDBLookupCombo
              Left = 16
              Top = 65
              Width = 185
              Height = 21
              ...
              PreciseEditRegion = False
              AllowClearKey = False
              OnEnter = cbbPlanoContasSugestEnter
            end
            object txtVlrLanctoSugest: TwwDBEdit
              Left = 216
              Top = 65
              Width = 96
              Height = 21
          ...
          object tsNovoMov: TTabSheet
            Caption = 'Novo movimento'
            ImageIndex = 1
            OnShow = tsNovoMovShow
            ...
            object dbHistoricoNmov: TDBEdit
              Left = 15
              Top = 21
              Width = 199
              Height = 21
            ...
            object cbbPlanoContasNmov: TwwDBLookupCombo
              Left = 15
              Top = 64
              Width = 199
              Height = 21
              ...
              DataField = 'id_plano'
              DataSource = dsoConCxbAux
              LookupTable = dmGeral.BUS_CD_C_PCT2
              LookupField = 'id_plano'
              Options = [loColLines, loRowLines, loTitles]
              Style = csDropDownList
              TabOrder = 2
              ...
              PreciseEditRegion = False
              AllowClearKey = False
              OnEnter = cbbPlanoContasNmovEnter
            end
            object cbbTipoFinNmov: TwwDBLookupCombo
              Left = 224
              Top = 21
              Width = 90
              Height = 21
              ...
              AllowClearKey = False
              ShowMatchText = True
              OnEnter = cbbTipoFinNmovEnter
            end
            object txtVlrLanctoNmov: TwwDBEdit
              Left = 224
              Top = 64
              Width = 90
              Height = 21
          ...
          object tsTransferencia: TTabSheet
            ...
            object Label11: TLabel
              ...
              Width = 107
              Height = 13
              Caption = 'Tipo financeiro trans'
            end
            object cbbContaCorrTransf: TwwDBLookupCombo
              Left = 4
              Top = 65
              Width = 198
              Height = 21
              ...
              DataField = 'id_conta'
              DataSource = dsoConCxbAux
              LookupTable = dmGeral.BUS_CD_C_CTC_EXP
              LookupField = 'id_conta'
              Style = csDropDownList
              Color = clWhite
              TabOrder = 2
              ...
              AllowClearKey = False
              ShowMatchText = True
              OnEnter = cbbContaCorrTransfEnter
            end
            object cbbTipoFinTransf: TwwDBLookupCombo
              Left = 208
              Top = 24
              Width = 113
              Height = 21
              ...
              AllowClearKey = False
              ShowMatchText = True
              OnEnter = cbbTipoFinTransfEnter
            end
            object cbbPlanoContasTransf: TwwDBLookupCombo
              Left = 4
              Top = 24
              Width = 198
              Height = 21
              ...
              PreciseEditRegion = False
              AllowClearKey = False
              OnEnter = cbbPlanoContasTransfEnter
            end
            object wwDBLookupCombo1: TwwDBLookupCombo
              ...
              Selected.Strings = (
                'descricao'#9'40'#9'descricao'#9'F'
                'id_conta'#9'10'#9'id_conta'#9'F')
              DataField = 'id_tipo_financeiro_transf'
              DataSource = dsoConCxbAux
          ...
          object tsTitReceber: TTabSheet
            Caption = 'Contas a Receber'
            ImageIndex = 3
            OnShow = tsTitReceberShow
            ...
            object cbbPlanoRec: TwwDBLookupCombo
              Left = 98
              Top = 30
              Width = 145
              Height = 21
            ...
            object txtClientes: TJvDBComboEdit
              ...
              TabOrder = 0
              OnButtonClick = txtClientesButtonClick
              OnExit = txtClientesExit
            end
            object txtHistoricoRec: TwwDBEdit
              Left = 193
              Top = 56
              Width = 127
              Height = 21
          ...
          object tsTitPagar: TTabSheet
            Caption = 'Contas a Pagar'
            ImageIndex = 4
            OnEnter = tsTitPagarEnter
            OnShow = tsTitPagarShow
            ...
            object txtVlrLancamentoPag: TwwDBEdit
              Left = 42
              Top = 61
              Width = 80
              Height = 21
            ...
            object cbbPlanoPag: TwwDBLookupCombo
              Left = 98
              Top = 34
              Width = 135
              Height = 21
              ...
              PreciseEditRegion = False
              AllowClearKey = False
              OnEnter = cbbPlanoPagEnter
            end
            object txtCodFor: TJvDBComboEdit
              Left = 73
              Top = 11
              Width = 79
              Height = 21
              ...
              Glyph.Data = {
                ...
                FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
              TabOrder = 0
              OnButtonClick = txtCodForButtonClick
              OnExit = txtCodForExit
            end
            object txtHistoricoPag: TwwDBEdit
              Left = 196
              Top = 61
              Width = 121
              Height = 21
        ...
        object btnBuscaMovNConc: TBitBtn
          Left = 277
          Top = 15
          Width = 105
          Height = 19
        ...
        object txtDescOpe: TwwDBEdit
          Left = 200
          Top = 219
          Width = 90
          Height = 21
          DataField = 'vlr_desconto_ope'
          DataSource = dsoConCxbDet
          TabOrder = 11
          UnboundDataType = wwDefault
          WantReturns = False
          WordWrap = False
          OnEnter = txtDescOpeEnter
          OnExit = txtDescOpeExit
        end
      end
      ...
      object gbExtratoBco: TGroupBox
        Left = 1
        Top = 61
        Width = 431
        Height = 391
        Caption = ' Extrato do banco (Arquivo *.ofx) '
        TabOrder = 2
        TabStop = True
        object Label2: TLabel
          ...
          Height = 13
          Caption = 
            'Click no grid abaixo e tecle <F3> para selecionar o arquivo de e' +
            'xtrato banc'#225'rio'
        end
        object grdCxb: TwwDBGrid
          AlignWithMargins = True
          Left = 7
          Top = 40
          Width = 413
          ...
          Margins.Bottom = 0
          ControlType.Strings = (
            'int_origem;RichEdit;;F'
            'int_debcre;RichEdit;;F'
            'int_selecao;ImageIndex;Original Size'
            'selecao;ImageIndex;Original Size')
          Selected.Strings = (
            'selecao'#9'3'#9#9'F'
            'dta_movimento'#9'12'#9'Data'#9'F'
            'documento'#9'14'#9'Doc'#9'F'
            'historico'#9'28'#9'Hist'#243'rico'#9'F'
            'vlr_lancamento'#9'14'#9'Valor'#9'F')
          IniAttributes.Delimiter = ';;'
          IniAttributes.UnicodeIniFile = False
          TitleColor = clBtnFace
          OnRowChanged = grdCxbRowChanged
          OnCellChanged = grdCxbCellChanged
          FixedCols = 0
          ShowHorzScrollBar = True
          DataSource = dsoConCxb
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -9
          Font.Name = 'Segoe UI'
          ...
          TitleButtons = False
          UseTFields = False
          OnCalcCellColors = grdCxbCalcCellColors
          OnKeyDown = grdCxbKeyDown
          OnMouseUp = grdCxbMouseUp
          ImageList = imgGrid
          TitleImageList = imgGrid
        end
        object pnMsgCxb: TPanel
          Left = 102
          Top = 344
          Width = 247
          Height = 25
      ...
      object txtDiferencaMovtos: TEdit
        Left = 343
        Top = 468
        Width = 85
        Height = 21
      ...
      object pnLancExistente: TPanel
        ...
        object PageControl1: TPageControl
          ...
          object TabSheet1: TTabSheet
            Caption = 'Movimentos Existentes'
            object grdMovExist: TwwDBGrid
              AlignWithMargins = True
              Left = 2
              Top = 0
              Width = 334
              ...
              Selected.Strings = (
                ...
                'historico'#9'22'#9'Hist'#243'rico'#9'F'
                'id_plano'#9'17'#9'Plano de contas'#9'F'
                'vlr_lancamento'#9'14'#9'Valor'#9'F')
              IniAttributes.Delimiter = ';;'
              IniAttributes.UnicodeIniFile = False
              TitleColor = clBtnFace
              OnCellChanged = grdMovExistCellChanged
              FixedCols = 0
              ShowHorzScrollBar = True
              Align = alClient
              Ctl3D = True
          ...
          object tsGrdRec: TTabSheet
            ...
            object wwDBGrid1: TwwDBGrid
              ...
              Selected.Strings = (
                ...
                'id_titulo'#9'6'#9'C'#243'd. T'#237't'#9'T'
                'int_nomefpg'#9'13'#9'Forma Pag.'#9'T'
                'dta_vencimento'#9'10'#9'Vencimento'#9'T'
                'vlr_saldo'#9'10'#9'Valor'#9'T'
                'car_taxa_ope'#9'7'#9'Taxa(%)'#9'F')
              IniAttributes.Delimiter = ';;'
              IniAttributes.UnicodeIniFile = False
              TitleColor = clBtnFace
              FixedCols = 0
          ...
          object tsGrdPag: TTabSheet
            ...
            object wwDBGrid2: TwwDBGrid
              ...
              Selected.Strings = (
                'int_selecao'#9'2'#9#9'F'
                'id_titulo'#9'9'#9'C'#243'd. T'#237'tulo'#9'T'
                'int_nomefpg'#9'17'#9'Forma Pag.'#9'T'
                'dta_vencimento'#9'10'#9'Vencimento'#9'T'
                'vlr_saldo'#9'10'#9'Valor'#9'T')
              IniAttributes.Delimiter = ';;'
              IniAttributes.UnicodeIniFile = False
        ...
        object Panel6: TPanel
          ...
          DesignSize = (
            45
            131)
          object btnSairMovExist: TBitBtn
            Left = -1
            Top = 96
            Width = 46
            Height = 26
            ...
            ParentFont = False
            TabOrder = 0
            OnClick = btnSairMovExistClick
          end
          object btnOkMovExist: TBitBtn
            AlignWithMargins = True
            Left = 3
            Top = 64
            Width = 36
  ...
  object dsoConCxbDet: TwwDataSource
    DataSet = dmGeral.FIN_CD_M_CON_CXB_DET
    Left = 652
    Top = 331
  end
  object dsoCta: TwwDataSource
    DataSet = dmGeral.BUS_CD_M_CTA
    Left = 484
    Top = 387
  end
  object dsoConCxb: TwwDataSource
    DataSet = dmGeral.FIN_CD_M_CON_CXB
    Left = 580
    Top = 331
  end
  object odOfx: TOpenDialog
    DefaultExt = '*.ofx'
    Filter = 'Arquivos OFX (*.OFX)|*.OFX'
    Title = 'Selecione a NFe'
    Left = 576
    Top = 384
  end
  object pmConCxb: TPopupMenu
    Left = 416
    Top = 332
    object Desfazerrelaocomasmovimentaes1: TMenuItem
      Caption = 'Desfazer rela'#231#227'o com as movimenta'#231#245'es'
      OnClick = Desfazerrelaocomasmovimentaes1Click
    end
  end
  object dsoConCxbAux: TwwDataSource
    DataSet = dmGeral.FIN_CD_M_CON_CXB_AUX
    Left = 652
    Top = 395
  end
  object imgGrid: TImageList
    ...
    Bitmap = {
      ...
      
      ...
      
      ...
      
      ...
      
      ...
      
  ...
  object dsoRec: TwwDataSource
    DataSet = dmGeral.BUS_CD_M_REC_2
    Left = 594
    Top = 271
  end
  object dsoPag: TwwDataSource
    DataSet = dmGeral.BUS_CD_M_PAG
    Left = 602
    Top = 207
  end
  object cdsTitulos: TClientDataSet
    ...
    Left = 474
    Top = 207
    object cdsTitulosid_controle: TIntegerField
      FieldName = 'id_controle'
    end
    object cdsTitulosid_titulo_rec: TIntegerField
      FieldName = 'id_titulo_rec'
    end
    object cdsTitulosid_titulo_pag: TIntegerField
      FieldName = 'id_titulo_pag'
    end
    object cdsTitulosvlr_lancamento: TCurrencyField
      FieldName = 'vlr_lancamento'
    end
    object cdsTituloshistorico: TStringField
      FieldName = 'historico'
      Size = 100
    end
    object cdsTitulosdta_movimento: TDateField
      FieldName = 'dta_movimento'
    end
    object cdsTitulosnum_doc: TIntegerField
      FieldName = 'num_doc'
    end
    object cdsTitulosid_plano: TStringField
      FieldName = 'id_plano'
      Size = 11
    end
    ...
    object cdsTitulosint_selecao: TBooleanField
      FieldName = 'int_selecao'
    end
    object cdsTitulosid_tipo_financeiro: TIntegerField
