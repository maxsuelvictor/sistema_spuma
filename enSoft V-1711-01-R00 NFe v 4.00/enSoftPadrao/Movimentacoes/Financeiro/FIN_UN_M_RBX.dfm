inherited FIN_FM_M_RBX: TFIN_FM_M_RBX
  ...
  inherited pnlEsquerda: TPanel
    ...
    inherited pnlDatagrid: TPanel
      ...
      inherited dbGrid: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'INT_NOMECLI'#9'28'#9'Cliente'#9'F'
          'int_nomeres'#9'10'#9'Respons'#225'vel'#9'T')
        PopupMenu = pmRbx
        ExplicitHeight = 389
      end
    end
    inherited pnlBotoes: TPanel
      ...
      object btnImprimeRecibo: TcxButton
        Left = 2
        Top = 55
        Width = 153
        Height = 48
  ...
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object lblContaCorrente1: TLabel
        Left = 390
        Top = 66
        Width = 85
        Height = 13
      ...
      object gbTitulos: TGroupBox
        ...
        object grdTitulos: TwwDBGrid
          ...
          TabStop = False
          Selected.Strings = (
            'int_id_ors'#9'9'#9'O.F'#9'F'
            'num_parcela'#9'11'#9'N'#186' do T'#237'tulo'#9'F'
            'dta_vencimento'#9'11'#9'Vencimento'#9'F'
            'atraso'#9'5'#9'Atraso'#9'F'
            'per_desconto'#9'6'#9'% Desc.'#9'F'
            'vlr_desconto'#9'13'#9'Vlr. Desconto'#9'F'
            'vlr_cred_utilizado'#9'10'#9'Vlr. Cr'#233'dito'#9'F'
            'vlr_a_pagar'#9'12'#9'Vlr. A Pagar'#9'F'
            'vlr_pagamento'#9'12'#9'Vlr. Pago'#9'F'
            'vlr_restante'#9'12'#9'Vlr. Restante'#9'F')
          IniAttributes.Delimiter = ';;'
          IniAttributes.UnicodeIniFile = False
          TitleColor = clBtnFace
          FixedCols = 0
          ShowHorzScrollBar = True
          DataSource = FIN_DS_M_RBX_TIT
      ...
      object gbNovTtulos: TGroupBox
        ...
        object pnlNovoTit: TPanel
          ...
          object dpkVencimentoChe: TJvDBDateEdit
            Left = 3
            Top = 23
            Width = 86
            Height = 21
            DataField = 'dta_vencimento'
            DataSource = FIN_DS_M_RBX_GER
            ShowNullDate = False
            TabOrder = 0
            OnExit = dpkVencimentoCheExit
          end
          object txtVlrPagoChe: TDBEdit
            Left = 93
            Top = 23
            Width = 87
            Height = 21
        ...
        object btn_Add_Cheques: TBitBtn
          Left = 7
          Top = 35
          Width = 23
          Height = 23
        ...
        object dgNovoTit: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'vlr_pagamento'#9'14'#9'Valor'#9'F'
            'che_banco'#9'10'#9'Banco'#9'F'
            'che_agencia'#9'10'#9'Ag'#234'ncia'#9'F'
            'che_conta'#9'15'#9'Conta'#9'F'
            'che_cheque'#9'15'#9'Cheque'#9'F'
            'che_emitente'#9'31'#9'Emitente'#9'F')
          IniAttributes.Delimiter = ';;'
          IniAttributes.UnicodeIniFile = False
          TitleColor = clBtnFace
          FixedCols = 0
          ...
          object dgChequePreIButton: TwwIButton
            Left = -1
            Top = -1
            Width = 22
            Height = 22
            ...
            Glyph.Data = {
              ...
              FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
              B102}
            OnClick = dgChequePreIButtonClick
          end
        end
      end
      ...
      object cbbContaCorrente: TwwDBLookupCombo
        ...
        DropDownAlignment = taLeftJustify
        Selected.Strings = (
          'descricao'#9'40'#9'Descri'#231#227'o '#9'F'#9
      ...
      object txtTotalGeralPago: TwwDBEdit
        Left = 629
        Top = 333
        Width = 90
        Height = 21
      ...
      object txtVlrTotGer: TwwDBEdit
        Left = 629
        Top = 503
        Width = 90
        Height = 21
        Color = 14342874
        DataField = 'vlr_tot_ger'
        DataSource = dso
        ReadOnly = True
        TabOrder = 18
        UnboundDataType = wwDefault
      ...
      object btnVisualizaPedidos: TBitBtn
        Left = 8
        Top = 501
        Width = 199
        Height = 25
        Caption = 'Visualizar pedidos prestado conta'
        TabOrder = 19
        TabStop = False
        OnClick = btnVisualizaPedidosClick
      end
      object chkFazConciliacao: TDBCheckBox
        Left = 496
        Top = 163
        Width = 183
        Height = 17
        Alignment = taLeftJustify
        Caption = 'Baixar com concilia'#231#227'o banc'#225'ria'
        DataField = 'faz_conciliacao'
        DataSource = dso
        TabOrder = 13
        OnClick = chkFazConciliacaoClick
      end
    end
  ...
  object FIN_DS_M_RBX_TIT: TwwDataSource [4]
    DataSet = dmGeral.FIN_CD_M_RBX_TIT
    OnStateChange = dsoStateChange
    Left = 1067
    Top = 355
  end
  object FIN_DS_M_RBX_GER: TwwDataSource [5]
  ...
  inherited imgBotoesAtivo: TImageList
    ...
    Top = 35
    Bitmap = {
      494C01010800A800640218001800FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesInativo: TImageList
    ...
    Top = 243
    Bitmap = {
      
  ...
  inherited ImgPequena: TImageList
    Bitmap = {
      494C010112000001B4020E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoAz: TImageList
    ...
    Top = 83
    Bitmap = {
      
  ...
  inherited ImgPequenaAz: TImageList
    Bitmap = {
      494C010106000001AC020E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoVe: TImageList
    ...
    Top = 131
    Bitmap = {
      
  ...
  inherited ImgPequenaVe: TImageList
    Bitmap = {
      
  ...
  object pmRbx: TPopupMenu
    Left = 112
    Top = 405
    object mpExibPedPrestConta: TMenuItem
      Caption = 'Exibir pedidos pretado conta'
      OnClick = mpExibPedPrestContaClick
    end
  end
  object FIN_FR_M_RBX_TST: TfrxReport
    Version = '5.1.9'
    ...
    ReportOptions.CreateDate = 43257.438497847220000000
    ReportOptions.LastChange = 43257.438497847220000000
    ...
    object Page1: TfrxReportPage
      ...
      object DetailData4: TfrxDetailData
        ...
        RowCount = 0
        Stretched = True
        object FIN_DB_M_RBX_GERvlr_pagamento2: TfrxMemoView
          Left = 48.755905510000000000
          Width = 45.354360000000000000
          Height = 15.118120000000000000
          DataSet = FIN_DB_M_RBX_GER
          DataSetName = 'FIN_DB_M_RBX_GER'
        ...
        object FIN_DB_M_RBX_GERdta_vencimento2: TfrxMemoView
          Left = 0.755905511811024000
          Width = 45.354360000000000000
          Height = 15.118120000000000000
          DataField = 'dta_vencimento'
        ...
        object FIN_DB_M_RBX_GERche_banco: TfrxMemoView
          Left = 129.385900000000000000
          Width = 26.456710000000000000
          Height = 15.118120000000000000
          DataField = 'che_agencia'
        ...
        object FIN_DB_M_RBX_GERche_conta: TfrxMemoView
          Left = 160.496062990000000000
          Width = 45.354330710000000000
          Height = 15.118120000000000000
          DataField = 'che_conta'
        ...
        object FIN_DB_M_RBX_GERche_banco1: TfrxMemoView
          Left = 96.708720000000000000
          Width = 30.236240000000000000
          Height = 15.118120000000000000
          DataField = 'che_banco'
        ...
        object FIN_DB_M_RBX_GERche_cheque: TfrxMemoView
          Left = 209.007874015748000000
          Width = 49.133858270000000000
          Height = 15.118120000000000000
          DataField = 'che_cheque'
        ...
        object FIN_DB_M_RBX_GERche_emitente: TfrxMemoView
          Left = 261.543307086614000000
          Width = 90.708661420000000000
          Height = 15.118120000000000000
          DataField = 'che_emitente'
      ...
      object Footer6: TfrxFooter
        ...
        object rlblAssinaturaFinanceiro: TfrxMemoView
          Left = 226.771800000000000000
  ...
  object FIN_FR_M_RBX_DNR_TST: TfrxReport
    Version = '5.1.9'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick]
    ...
    PrintOptions.Printer = 'Padr'#227'o'
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 43257.572875266200000000
    ReportOptions.LastChange = 43257.572875266200000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
