inherited FIN_FM_M_REC: TFIN_FM_M_REC
  ...
  inherited pnlEsquerda: TPanel
      ...
      inherited gbxFiltro: TGroupBox
        inherited cbbPesquisa: TComboBox
          ...
          Items.Strings = (
            ...
            'Plano de Contas'
            'Forma de Pagamento'
            'Local de T'#237'tulos'
            'Nro cheque'
            'Emitente chq'
            'Hist'#243'rico'
            'T'#237't. vencidos do cliente...'
            'Valor do t'#237'tulo'
            'Noso n'#250'mero'
            'C'#243'd. do t'#237'tulo'
            'Nota Fiscal')
          ExplicitWidth = 145
        end
    ...
    inherited pnlDatagrid: TPanel
      ...
      inherited dbGrid: TwwDBGrid
        ...
        Selected.Strings = (
          'int_selecao'#9'4'#9#9'F'
          'ID_TITULO'#9'10'#9'C'#243'digo'#9'T'
          'INT_NOMECLI'#9'36'#9'Cliente'#9'T')
        ...
        PopupMenu = pmRec
        ReadOnly = False
        OnFieldChanged = dbGridFieldChanged
        ExplicitHeight = 325
      end
    end
    inherited pnlBotoes: TPanel
      ...
      object BitBtn1: TBitBtn
        ...
        Width = 154
        Height = 50
        Caption = 'Reimprimir Recibo de NF'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Tahoma'
  ...
  inherited pnlDireita: TPanel
    ...
    inherited pnlDados: TPanel
      ...
      object txtVlrTitulo: TDBMemo
        ...
        OnKeyPress = txtVlrTituloKeyPress
      end
      ...
      object cbbPlanoContas: TwwDBLookupCombo
        ...
        Options = [loColLines, loRowLines, loSearchOnBackspace]
        Style = csDropDownList
        TabOrder = 7
        AutoDropDown = False
        ShowButton = True
    ...
    object mmoReciboBoleto: TMemo
      ...
      Lines.Strings = (
          ...
          'dth=75%>&nbsp;</td><td '
        'width=25% '
        'valign=bottom><p align=center><font size=2><b>Comprovante de '
        'Entrega</b></font></td></tr></table>'
        
          '<table border=1 cellpadding=1 cellspacing=0 width=730><tr><td co' +
          'lspan=3 width=320><table '
        'border=0 '
  ...
  inherited dso: TwwDataSource
    DataSet = dmGeral.FIN_CD_M_REC
    OnDataChange = dsoDataChange
  end
  inherited imgBotoesAtivo: TImageList
    Bitmap = {
      494C01010800A800DC0118001800FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesInativo: TImageList
    Bitmap = {
      
  ...
  inherited ImgPequena: TImageList
    Bitmap = {
      494C0101120000012C020E000E00FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  inherited imgBotoesAtivoVe: TImageList
    Bitmap = {
      
  ...
  inherited ImgPequenaVe: TImageList
    Bitmap = {
      
  ...
  object FAT_PD_M_CXA_NFE: TfrxPDFExport
    UseFileCache = True
    ShowProgress = True
  ...
  object FAT_XL_M_CXA_NFE: TfrxXLSExport
    UseFileCache = True
    ShowProgress = True
    OverwritePrompt = False
    DataOnly = False
  ...
  object FAT_DP_M_CXA_NFE: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'id_fiscal_ref_comp=id_fiscal_ref_comp'
      'id_ordem_gar=id_ordem_gar'
      'id_seq_fat_gar=id_seq_fat_gar'
      'dis_icm_dispensado=dis_icm_dispensado'
      'ped_mod_frete=ped_mod_frete'
      'ped_vlr_frete=ped_vlr_frete')
  ...
  object FAT_DP_M_CXA_NFE_TIT: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'int_docimpresso=int_docimpresso')
    DataSet = dmGeral.BUS_CD_M_NFE_TIT
    BCDToCurrency = False
    Left = 71
    Top = 352
  end
  object pmRec: TPopupMenu
    Left = 208
    Top = 279
    object Alterarolocaldottulo1: TMenuItem
      Caption = 'Alterar o local do t'#237'tulo'
      OnClick = Alterarolocaldottulo1Click
    end
    object Alteraaformadepagamento1: TMenuItem
      Caption = 'Alterar a forma de pagamento'
      OnClick = Alteraaformadepagamento1Click
    end
  end
end
