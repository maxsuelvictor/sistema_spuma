...
type
  ...
  private
    ...
    FFIN_DP_M_PCR_DES_INTDataRequestCommand: TDBXCommand;
    FFIN_DP_M_PCR_INTDataRequestCommand: TDBXCommand;
  ...
  public
    ...
    function FIN_DP_M_PCR_DES_INTDataRequest(Sender: TObject; Input: OleVariant): OleVariant;
    function FIN_DP_M_PCR_INTDataRequest(Sender: TObject; Input: OleVariant): OleVariant;
    ...
    function enVerCreditoCli(Cliente: string): Currency;
    function enVerSaldoDiaCxa(IdEmpresa: Integer; IdConta: Integer; IdAbertura: Integer): Currency;
    function enGerPeqDesp(IdFornecedor: Integer; IdAbertura: Integer; IdLocalTit: Integer; IdFormaPag: Integer; IdCcusto: Integer; IdEmpresa: Integer; IdPlano: string; Historico: string; DtaEmissao: TDateTime; DtaVencto: TDateTime; DtaOrig: TDateTime; VlrLancto: Currency): string;
    procedure enDesfazerFat(IdFiscal: Integer; BUS_CD_M_NFE: TClientDataSet; var FIN_CD_M_CTA: TClientDataSet; var FIN_CD_M_REC: TClientDataSet; var FIN_CD_M_REC_PAG: TClientDataSet; var FIN_CD_M_RCR: TClientDataSet; var FIN_CD_M_CTA_RCR: TClientDataSet; var FAT_CD_M_PED: TClientDataSet; var OFI_CD_M_ORV: TClientDataSet; ReabrePed: string);
    ...
    function enCancelNfe(id_fiscal: Integer; CanStatus: string; CanProtocolo: string; ReabrePed: string): string;
    function enGerarNfe(id_fiscal: Integer): string;
...
function TSMClient.FIN_DP_M_PCR_DES_INTDataRequest(Sender: TObject; Input: OleVariant): OleVariant;
begin
  if FFIN_DP_M_PCR_DES_INTDataRequestCommand = nil then
  begin
    FFIN_DP_M_PCR_DES_INTDataRequestCommand := FDBXConnection.CreateCommand;
    FFIN_DP_M_PCR_DES_INTDataRequestCommand.CommandType := TDBXCommandTypes.DSServerMethod;
    FFIN_DP_M_PCR_DES_INTDataRequestCommand.Text := 'TSM.FIN_DP_M_PCR_DES_INTDataRequest';
    FFIN_DP_M_PCR_DES_INTDataRequestCommand.Prepare;
  end;
  if not Assigned(Sender) then
    FFIN_DP_M_PCR_DES_INTDataRequestCommand.Parameters[0].Value.SetNull
  else
  begin
    FMarshal := TDBXClientCommand(FFIN_DP_M_PCR_DES_INTDataRequestCommand.Parameters[0].ConnectionHandler).GetJSONMarshaler;
    try
      FFIN_DP_M_PCR_DES_INTDataRequestCommand.Parameters[0].Value.SetJSONValue(FMarshal.Marshal(Sender), True);
      if FInstanceOwner then
        Sender.Free
    finally
      FreeAndNil(FMarshal)
  ...
  FFIN_DP_M_PCR_DES_INTDataRequestCommand.Parameters[1].Value.AsVariant := Input;
  FFIN_DP_M_PCR_DES_INTDataRequestCommand.ExecuteUpdate;
  Result := FFIN_DP_M_PCR_DES_INTDataRequestCommand.Parameters[2].Value.AsVariant;
end;

function TSMClient.FIN_DP_M_PCR_INTDataRequest(Sender: TObject; Input: OleVariant): OleVariant;
begin
  if FFIN_DP_M_PCR_INTDataRequestCommand = nil then
  begin
    FFIN_DP_M_PCR_INTDataRequestCommand := FDBXConnection.CreateCommand;
    FFIN_DP_M_PCR_INTDataRequestCommand.CommandType := TDBXCommandTypes.DSServerMethod;
    FFIN_DP_M_PCR_INTDataRequestCommand.Text := 'TSM.FIN_DP_M_PCR_INTDataRequest';
    FFIN_DP_M_PCR_INTDataRequestCommand.Prepare;
  end;
  if not Assigned(Sender) then
    FFIN_DP_M_PCR_INTDataRequestCommand.Parameters[0].Value.SetNull
  else
  begin
    FMarshal := TDBXClientCommand(FFIN_DP_M_PCR_INTDataRequestCommand.Parameters[0].ConnectionHandler).GetJSONMarshaler;
    try
      FFIN_DP_M_PCR_INTDataRequestCommand.Parameters[0].Value.SetJSONValue(FMarshal.Marshal(Sender), True);
      if FInstanceOwner then
        Sender.Free
    finally
      FreeAndNil(FMarshal)
  ...
  FFIN_DP_M_PCR_INTDataRequestCommand.Parameters[1].Value.AsVariant := Input;
  FFIN_DP_M_PCR_INTDataRequestCommand.ExecuteUpdate;
  Result := FFIN_DP_M_PCR_INTDataRequestCommand.Parameters[2].Value.AsVariant;
end;
...
function TSMClient.enVerCreditoCli(Cliente: string): Currency;
begin
  ...
  Result := FenVerCreditoCliCommand.Parameters[1].Value.AsCurrency;
end;
...
function TSMClient.enGerPeqDesp(IdFornecedor: Integer; IdAbertura: Integer; IdLocalTit: Integer; IdFormaPag: Integer; IdCcusto: Integer; IdEmpresa: Integer; IdPlano: string; Historico: string; DtaEmissao: TDateTime; DtaVencto: TDateTime; DtaOrig: TDateTime; VlrLancto: Currency): string;
begin
  ...
  FenGerPeqDespCommand.Parameters[5].Value.SetInt32(IdEmpresa);
  FenGerPeqDespCommand.Parameters[6].Value.SetWideString(IdPlano);
  FenGerPeqDespCommand.Parameters[7].Value.SetWideString(Historico);
  FenGerPeqDespCommand.Parameters[8].Value.AsDateTime := DtaEmissao;
  FenGerPeqDespCommand.Parameters[9].Value.AsDateTime := DtaVencto;
  FenGerPeqDespCommand.Parameters[10].Value.AsDateTime := DtaOrig;
  FenGerPeqDespCommand.Parameters[11].Value.AsCurrency := VlrLancto;
  FenGerPeqDespCommand.ExecuteUpdate;
  Result := FenGerPeqDespCommand.Parameters[12].Value.GetWideString;
end;
...
begin
  ...
  FenDesfazerFatCommand.Parameters[9].Value.SetWideString(ReabrePed);
...
function TSMClient.enCancelNfe(id_fiscal: Integer; CanStatus: string; CanProtocolo: string; ReabrePed: string): string;
begin
  ...
  Result := FenCancelNfeCommand.Parameters[4].Value.GetWideString;
end;

function TSMClient.enGerarNfe(id_fiscal: Integer): string;
begin
  ...
  Result := FenGerarNfeCommand.Parameters[1].Value.GetWideString;
end;
...
begin
  ...
  FFIN_DP_M_PCR_DES_INTDataRequestCommand.DisposeOf;
  FFIN_DP_M_PCR_INTDataRequestCommand.DisposeOf;
